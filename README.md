...
# 26. Execute Hardened Microsoft Enterprise Engines (Async 202, Graph Connector, Fabric Delta)
tgs copilot hardened --action graph_connector --name "tagisan_skills"
tgs copilot hardened --action fabric_delta --name "lakehouse_gold" --target "SELECT * FROM metrics"
