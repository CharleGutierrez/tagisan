---
name: simd-arm-sve2-scalable-vectors
description: "Scalable Vector Extension 2 length-agnostic vector processing on ARM servers"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "performance"
  - "simd arm sve2 scalable vectors"
  - "simd-arm-sve2-scalable-vectors"
  - "simd-arm-sve2-scalable-vectors execute"
  - "simd-arm-sve2-scalable-vectors verify"
---

# Simd Arm Sve2 Scalable Vectors Skill

The `simd-arm-sve2-scalable-vectors` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ARM Architecture Reference Manual** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tensor Engine / SIMD`.
...
```json
{
  "skill": "simd-arm-sve2-scalable-vectors",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "ARM Architecture Reference Manual",
