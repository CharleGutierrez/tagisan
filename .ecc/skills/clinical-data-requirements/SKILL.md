...
description: "Use this skill when defining clinical data model requirements for Health Cloud: HL7/FHIR\
  \ data mapping, interoperability requirements, FHIR R4-aligned object activation,\
  \ CodeableConcept constraints, and middleware translation requirements. NOT for\
  \ the field-level mapping work itself \u2014 use data/fhir-data-mapping. NOT for\
  \ choosing legacy HC24__ EHR objects vs standard clinical objects \u2014 use data/health-cloud-data-model."
---
