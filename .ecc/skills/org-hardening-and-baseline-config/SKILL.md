...
description: "Use when defining or reviewing baseline org hardening settings, especially Security\
  \ Health Check gaps, clickjack and browser protections, CSP and CORS governance,\
  \ password/session policies, network restrictions, and release-update hygiene. NOT\
  \ for feature-level app permissions or record-sharing design \u2014 use security/security-health-check."
---
