---
name: composio-freshdesk-tickets
description: "Freshdesk ticket routing, SLA status monitoring, and satisfaction surveys"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio freshdesk tickets"
  - "composio-dev"
  - "composio-freshdesk-tickets"
  - "composio-freshdesk-tickets execute"
  - "composio-freshdesk-tickets verify"
  - "enterprise"
  - "freshdesk"
---

# Composio Freshdesk Tickets Skill

The `composio-freshdesk-tickets` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-freshdesk-tickets",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
