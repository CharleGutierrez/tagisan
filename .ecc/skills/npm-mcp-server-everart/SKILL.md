---
name: npm-mcp-server-everart
description: "AI image generation and style-conditioned visual asset synthesis"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server everart"
  - "npm-mcp-server-everart"
  - "npm-mcp-server-everart execute"
  - "npm-mcp-server-everart verify"
  - "server"
---

# Npm Mcp Server Everart Skill

The `npm-mcp-server-everart` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
