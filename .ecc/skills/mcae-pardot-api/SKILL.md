...
description: "Account Engagement (Pardot) REST API v5 from code \u2014 creating, reading and querying\
  \ Prospects, Visitors, Visitor Activities and Form Handlers. Trigger keywords: Pardot\
  \ API, Account Engagement API, prospect sync, visitor tracking API, form handler\
  \ integration, MCAE REST API. NOT for connector setup, business unit provisioning\
  \ or User Sync \u2014 use admin/mcae-pardot-setup. NOT for Marketing Cloud Engagement\
  \ (Email Studio, Journey Builder) APIs \u2014 use apex/marketing-cloud-api."
---
# MCAE (Pardot) API v5
