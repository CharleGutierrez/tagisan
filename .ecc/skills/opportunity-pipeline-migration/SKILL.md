...
description: "Use when migrating historical Opportunity records into Salesforce \u2014 covering\
  \ stage history recreation, amount and close date mapping, product line item load\
  \ sequencing (Product2 \u2192 Price Book \u2192 OpportunityLineItem), team member\
  \ (OpportunityTeamMember) and revenue split (OpportunitySplit) loading, and Pricebook2\
  \ assignment. NOT for sequencing a whole multi-object migration with automation\
  \ bypass and rollback \u2014 use data/data-migration-planning. NOT for opportunity\
  \ record types, stages and sales process setup \u2014 use admin/opportunity-management."
---
