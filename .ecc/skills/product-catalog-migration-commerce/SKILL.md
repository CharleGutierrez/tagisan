...
description: "Use when migrating product catalog data into Salesforce B2B Commerce \u2014 covers\
  \ category hierarchy, product attributes, images, pricing, and variant structure\
  \ using the Commerce Import API. NOT for configuring categories, entitlement policies\
  \ and variants after the load \u2014 use admin/commerce-product-catalog. NOT for\
  \ migrating the CPQ (SBQQ) catalog \u2014 use data/product-catalog-migration-cpq."
---
