...
description: "Sandbox refresh cycles, sandbox templates, post-refresh automation via the SandboxPostCopy\
  \ Apex interface, and data handling during refresh. NOT for sandbox type selection\
