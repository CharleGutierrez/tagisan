...
description: "Use when configuring access controls, sharing, or site security for authenticated\
  \ or guest Experience Cloud (community) users: external OWD, Sharing Sets, Share\
  \ Groups, CSP, clickjack protection, guest user record access. NOT for internal\
  \ sharing model configuration (use sharing-and-visibility) \u2014 use data/external-user-data-sharing."
---
