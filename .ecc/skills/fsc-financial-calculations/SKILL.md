...
description: "Custom financial calculation logic in Financial Services Cloud \u2014 portfolio performance\
  \ metrics (IRR, TWR), wealth rollup recalculation after bulk loads, custom Apex\
  \ aggregation for objects outside native FSC rollup scope, Data Processing Engine\
  \ writeback. NOT for disabling FSC's built-in triggers, Compliant Data Sharing,\
  \ or FSC action handlers \u2014 use apex/fsc-apex-extensions. NOT for declarative\
  \ rollup and Rollup-by-Lookup setup in the FSC admin UI \u2014 use admin/financial-account-setup."
---
