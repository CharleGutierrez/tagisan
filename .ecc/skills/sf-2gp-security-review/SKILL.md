...
description: Use when user asks for a 2GP security review, AppExchange readiness check, or pass/fail
  prediction for Apex, LWC, SOQL. Do NOT use for general security patterns.
...
---
