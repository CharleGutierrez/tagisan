...
description: "Spring-physics layout transitions, gesture tracking, and enter/exit animations"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Motion for React Docs"
tags:
  - bun
  - framer
  - frontend
...
triggers:
  ...
  - "framer-motion-spring-physics"
  - "framer-motion-spring-physics execute"
  - "framer-motion-spring-physics verify"
  - "frontend"
  - "full-stack"
  - "motion"
---

# Framer Motion Spring Physics Skill

The `framer-motion-spring-physics` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Motion for React Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "framer-motion-spring-physics",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Motion for React Docs",
