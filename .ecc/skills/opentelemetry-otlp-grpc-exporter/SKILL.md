...
description: "Streaming distributed traces and span events over OTLP gRPC to Jaeger/Datadog"
version: 1.0.0
...
triggers:
  ...
  - "opentelemetry-otlp-grpc-exporter"
  - "opentelemetry-otlp-grpc-exporter execute"
  - "opentelemetry-otlp-grpc-exporter verify"
  - "otlp"
---

# Opentelemetry Otlp Grpc Exporter Skill

The `opentelemetry-otlp-grpc-exporter` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OpenTelemetry (opentelemetry.io)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Telemetry Module`.
...
```json
{
  "skill": "opentelemetry-otlp-grpc-exporter",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "OpenTelemetry (opentelemetry.io)",
