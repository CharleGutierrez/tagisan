...
description: "Use when modeling, loading, or troubleshooting Salesforce product and pricebook data\
  \ \u2014 covering the Product2 \u2192 Pricebook2 \u2192 PricebookEntry three-object\
  \ chain, standard pricebook constraints, bulk load sequencing (Product2 \u2192 Standard\
  \ PBE \u2192 custom Pricebook2 \u2192 custom PBE), UseStandardPrice inheritance,\
  \ and product hierarchy strategies. NOT for adding products in Setup \u2014 use\
  \ admin/products-and-pricebooks. NOT for SBQQ CPQ catalogs \u2014 use data/product-catalog-migration-cpq."
---
