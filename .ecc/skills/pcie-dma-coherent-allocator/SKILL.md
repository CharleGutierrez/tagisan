---
name: pcie-dma-coherent-allocator
description: "Contiguous physical memory DMA allocation for GPU-host zero-copy transfer"
version: 1.0.0
...
triggers:
  ...
  - "hardware"
  - "kernel"
  - "pcie dma coherent allocator"
  - "pcie-dma-coherent-allocator"
  - "pcie-dma-coherent-allocator execute"
  - "pcie-dma-coherent-allocator verify"
---

# Pcie Dma Coherent Allocator Skill

The `pcie-dma-coherent-allocator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PCI-SIG Specifications** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tensor Engine / CUDA`.
...
- **Subsystem Binding**: `Tensor Engine / CUDA`
...
```json
{
  "skill": "pcie-dma-coherent-allocator",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "PCI-SIG Specifications",
  "integration_target": "Tensor Engine / CUDA",
