---
name: mitre-t1053-cron-persistence-sentinel
description: "Monitoring modifications to /etc/cron*, crontab, and systemd timers to block stealth persistence"
version: 1.0.0
...
triggers:
  ...
  - "edr"
  - "mitre"
  - "mitre t1053 cron persistence sentinel"
  - "mitre-t1053-cron-persistence-sentinel"
  - "mitre-t1053-cron-persistence-sentinel execute"
  - "mitre-t1053-cron-persistence-sentinel verify"
---

# Mitre T1053 Cron Persistence Sentinel Skill

The `mitre-t1053-cron-persistence-sentinel` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / FileWatch`.
...
- **Subsystem Binding**: `AgentShield / FileWatch`
...
```json
{
  "skill": "mitre-t1053-cron-persistence-sentinel",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "AgentShield / FileWatch",
