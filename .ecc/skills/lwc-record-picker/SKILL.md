...
description: "lightning-record-picker base component (Winter '24 GA): object/record filter, displayInfo/matchingInfo,\
  \ graph-ql filters, accessibility. Replaces ad-hoc lookup inputs. NOT for a fully\
  \ custom typeahead lookup \u2014 use lwc/lwc-custom-lookup."
---
# LWC Record Picker
