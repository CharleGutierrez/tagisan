---
name: swarm-transitive-blast-radius
description: "Computing the ripple effect of symbol refactoring across modules and call sites"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Program Analysis / Petgraph"
tags:
  - blast
  - consensus
  - debate
...
triggers:
  ...
  - "moa"
  - "multi-agent"
  - "swarm transitive blast radius"
  - "swarm-transitive-blast-radius"
  - "swarm-transitive-blast-radius execute"
  - "swarm-transitive-blast-radius verify"
---

# Swarm Transitive Blast Radius Skill

The `swarm-transitive-blast-radius` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Program Analysis / Petgraph** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `tgs graph`.
...
```json
{
  "skill": "swarm-transitive-blast-radius",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Program Analysis / Petgraph",
  "integration_target": "tgs graph",
