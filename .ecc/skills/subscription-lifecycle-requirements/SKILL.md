...
description: "Use when documenting, reviewing, or gathering requirements for Salesforce CPQ subscription\
  \ lifecycle behavior: how amendments, renewals, upgrades, downgrades, and cancellations\
  \ must work for a specific business. Trigger keywords: subscription requirements,\
  \ amendment requirements, renewal requirements, proration requirements, co-termination,\
  \ subscription ledger, upgrade downgrade policy. NOT for configuring CPQ amendments\
  \ and renewals \u2014 use admin/contract-and-renewal-management. NOT for amendment\
  \ architecture \u2014 use architect/subscription-management-architecture."
---
