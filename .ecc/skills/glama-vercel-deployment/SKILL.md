---
name: glama-vercel-deployment
description: "Vercel edge deployment status inspection, build logs, and environment variables"
version: 1.0.0
...
triggers:
  - "deployment"
  - "glama"
  - "glama vercel deployment"
  - "glama-ai"
  - "glama-vercel-deployment"
  - "glama-vercel-deployment execute"
  - "glama-vercel-deployment verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Vercel Deployment Skill

The `glama-vercel-deployment` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
