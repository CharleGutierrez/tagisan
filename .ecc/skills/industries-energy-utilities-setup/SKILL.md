...
description: 'Operational setup guide for Salesforce Energy and Utilities Cloud: license activation,
  permission sets, industry-specific object configuration (ServicePoint, Meter, MeterReading,
  Consumption, ServiceAccount, ServiceContract, RatePlan), CIS/billing system integration,
  and service order management. NOT for generic admin setup, NOT for reading or querying
