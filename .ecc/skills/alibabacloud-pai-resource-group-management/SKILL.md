...
description: "End-to-end Alibaba Cloud PAI ResourceGroup (resource pool) lifecycle management via\
  \ `aliyun paistudio`. Covers list / get / create / update / delete of ResourceGroups\
  \ (general computing ECS or Lingjun GPU), read-only inspection of MachineGroups,\
  \ and bind/unbind UserVpc. Use when the user asks to list / get / create / update\
  \ / delete PAI resource groups, inspect machine groups, bind/unbind UserVpc, or\
  \ audit resource-group capacity. Trigger phrases: \"PAI resource group\", \"PAI\
  \ resource pool\", \"Lingjun resource group\", \"create PAI resource group\", \"\
  list PAI resource groups\", \"PAI machine group\", \"Lingjun resource group (\u7075\
  \u9A8F\u8D44\u6E90\u7EC4)\", \"PAI resource pool (PAI \u8D44\u6E90\u6C60)\", \"\
  PAI \u8D44\u6E90\u7EC4\"."
---
