...
description: "Use when configuring delegated administration to allow non-system-admin users to\
  \ manage specific user groups, reset passwords, assign permission sets, or administer\
  \ custom objects. NOT for creating, deactivating or licensing users yourself \u2014\
  \ use admin/user-management. NOT for auto-assigning permission sets from user attributes\
  \ \u2014 use admin/user-access-policies."
---
