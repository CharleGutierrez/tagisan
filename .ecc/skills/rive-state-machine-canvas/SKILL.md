---
name: rive-state-machine-canvas
description: "Interactive vector state-machine animations driven by AI agent telemetry states"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Rive Runtime Docs"
tags:
  - bun
  - canvas
  - frontend
...
triggers:
  ...
  - "full-stack"
  - "machine"
  - "rive state machine canvas"
  - "rive-state-machine-canvas"
  - "rive-state-machine-canvas execute"
  - "rive-state-machine-canvas verify"
---

# Rive State Machine Canvas Skill

The `rive-state-machine-canvas` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Rive Runtime Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "rive-state-machine-canvas",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Rive Runtime Docs",
