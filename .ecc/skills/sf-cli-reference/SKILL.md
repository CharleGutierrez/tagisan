...
description: "Use when looking up Salesforce CLI sf commands \u2014 org login, project deploy,\
  \ apex run test, data query, package install, scratch org creation. Do NOT use for\
  \ web documentation lookup or Apex code patterns."
---
