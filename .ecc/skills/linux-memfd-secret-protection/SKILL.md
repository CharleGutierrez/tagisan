---
name: linux-memfd-secret-protection
description: "Anonymous file memory inaccessible to kernel page tables or debugging tools"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux memfd secret protection"
  - "linux-memfd-secret-protection"
  - "linux-memfd-secret-protection execute"
  - "linux-memfd-secret-protection verify"
  - "low-level"
  - "memfd"
---

# Linux Memfd Secret Protection Skill

The `linux-memfd-secret-protection` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `AgentShield / Security`.
...
- **Subsystem Binding**: `AgentShield / Security`
...
```json
{
  "skill": "linux-memfd-secret-protection",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "AgentShield / Security",
