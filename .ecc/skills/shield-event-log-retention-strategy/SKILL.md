...
description: "Use when designing Salesforce Shield Event Monitoring retention, SIEM routing, and\
  \ storage-tier strategy \u2014 which event types to keep, for how long, where, and\
  \ how to answer audit queries across hot/warm/cold tiers. Triggers: 'shield event\
  \ log retention'. NOT for enabling Shield (see salesforce-shield-deployment) \u2014\
  \ use security/event-monitoring."
---
