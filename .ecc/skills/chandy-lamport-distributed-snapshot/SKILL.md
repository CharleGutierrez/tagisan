...
description: "Recording global state snapshots of running multi-agent swarms without pausing workers"
version: 1.0.0
...
triggers:
  ...
  - "chandy-lamport-distributed-snapshot"
  - "chandy-lamport-distributed-snapshot execute"
  - "chandy-lamport-distributed-snapshot verify"
  - "distributed"
  - "lamport"
  - "opentelemetry"
---

# Chandy Lamport Distributed Snapshot Skill

The `chandy-lamport-distributed-snapshot` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ACM Transactions** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Session Persistence`.
...
```json
{
  "skill": "chandy-lamport-distributed-snapshot",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "ACM Transactions",
