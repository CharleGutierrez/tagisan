---
name: smithery-bigquery-sql
description: "BigQuery dataset querying, partitioning analysis, and schema inspection"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery bigquery sql"
  - "smithery-ai"
  - "smithery-bigquery-sql"
  - "smithery-bigquery-sql execute"
  - "smithery-bigquery-sql verify"
---

# Smithery Bigquery Sql Skill

The `smithery-bigquery-sql` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
