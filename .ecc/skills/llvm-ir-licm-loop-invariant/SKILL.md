---
name: llvm-ir-licm-loop-invariant
description: "Hoisting loop-invariant computations outside innermost hot loops"
version: 1.0.0
...
triggers:
  ...
  - "invariant"
  - "licm"
  - "llvm ir licm loop invariant"
  - "llvm-ir-licm-loop-invariant"
  - "llvm-ir-licm-loop-invariant execute"
  - "llvm-ir-licm-loop-invariant verify"
---

# Llvm Ir Licm Loop Invariant Skill

The `llvm-ir-licm-loop-invariant` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
```json
{
  "skill": "llvm-ir-licm-loop-invariant",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
