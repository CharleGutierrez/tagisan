---
name: composio-paypal-payouts
description: "PayPal payment transaction auditing and payout execution verification"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio paypal payouts"
  - "composio-dev"
  - "composio-paypal-payouts"
  - "composio-paypal-payouts execute"
  - "composio-paypal-payouts verify"
  - "enterprise"
  - "payouts"
---

# Composio Paypal Payouts Skill

The `composio-paypal-payouts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
