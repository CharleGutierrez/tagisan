---
name: sf-build-fix
description: "Auto-fix Salesforce build errors \u2014 Apex compilation, metadata conflicts, dependencies,\
  \ test failures. Use when build errors block deployment. Do NOT use for writing\
