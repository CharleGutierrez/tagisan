...
description: Plan, price, provision, and verify one Alibaba Cloud ECS spot instance with minimal
  VPC networking, restricted SSH access, a managed key pair, configurable system-disk
  size, and optional scheduled release. Use when Codex must buy, launch, or reproduce
  a complete preemptible/spot ECS workflow rather than only manage an existing instance.
...
---
