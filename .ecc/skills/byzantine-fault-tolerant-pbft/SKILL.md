---
name: byzantine-fault-tolerant-pbft
description: "Practical Byzantine Fault Tolerance withstanding malicious and compromised agent nodes"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "OSDI Research (Castro & Liskov)"
tags:
  - byzantine
  - distributed
  - fault
...
triggers:
  ...
  - "byzantine-fault-tolerant-pbft"
  - "byzantine-fault-tolerant-pbft execute"
  - "byzantine-fault-tolerant-pbft verify"
  - "distributed"
  - "fault"
  - "opentelemetry"
  - "osdi"
...
# Byzantine Fault Tolerant Pbft Skill

The `byzantine-fault-tolerant-pbft` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OSDI Research (Castro & Liskov)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Consensus Engine`.
...
```json
{
  "skill": "byzantine-fault-tolerant-pbft",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "OSDI Research (Castro & Liskov)",
