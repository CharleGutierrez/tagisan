---
name: linux-sysfs-cpu-frequency-governor
description: "CPU scaling governor tuning to 'performance' mode during adversarial swarm execution"
version: 1.0.0
...
triggers:
  ...
  - "hardware"
  - "kernel"
  - "linux sysfs cpu frequency governor"
  - "linux-sysfs-cpu-frequency-governor"
  - "linux-sysfs-cpu-frequency-governor execute"
  - "linux-sysfs-cpu-frequency-governor verify"
---

# Linux Sysfs Cpu Frequency Governor Skill

The `linux-sysfs-cpu-frequency-governor` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Engine / HostConfig`.
...
- **Subsystem Binding**: `Engine / HostConfig`
...
```json
{
  "skill": "linux-sysfs-cpu-frequency-governor",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Engine / HostConfig",
