---
name: composio-clickup-tasks
description: "ClickUp space hierarchy navigation, custom task fields, and time tracking"
version: 1.0.0
...
triggers:
  ...
  - "clickup"
  - "composio"
  - "composio clickup tasks"
  - "composio-clickup-tasks"
  - "composio-clickup-tasks execute"
  - "composio-clickup-tasks verify"
  - "composio-dev"
  - "enterprise"
---

# Composio Clickup Tasks Skill

The `composio-clickup-tasks` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
