...
description: "Configure Salesforce Translation Workbench and translate custom labels, picklist\
  \ values, field labels, page layout sections, or the Experience Cloud language switcher.\
  \ Triggers: 'how to add a language to Salesforce', 'translate custom labels', 'Translation\
  \ Workbench setup', 'picklist value translation', 'RTL language support'. NOT for\
  \ creating the Custom Label records or referencing them from Apex/LWC \u2014 use\
  \ admin/custom-label-management. NOT for locale formatting and RTL layout inside\
  \ a component \u2014 use lwc/lwc-internationalization."
---
