---
name: npm-mcp-server-notion
description: "Notion API blocks, databases, and page tree sync for developer wikis"
version: 1.0.0
...
triggers:
  ...
  - "npm-mcp-server-notion"
  - "npm-mcp-server-notion execute"
  - "npm-mcp-server-notion verify"
  - "server"
---

# Npm Mcp Server Notion Skill

The `npm-mcp-server-notion` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
