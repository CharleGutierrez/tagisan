---
name: pypi-mcp-server-pillow-imaging
description: "Image format conversion, thumbnail generation, and metadata cleaning"
version: 1.0.0
...
triggers:
  ...
  - "pillow"
  - "pypi"
  - "pypi mcp server pillow imaging"
  - "pypi-mcp-server-pillow-imaging"
  - "pypi-mcp-server-pillow-imaging execute"
  - "pypi-mcp-server-pillow-imaging verify"
---

# Pypi Mcp Server Pillow Imaging Skill

The `pypi-mcp-server-pillow-imaging` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-pillow-imaging",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
