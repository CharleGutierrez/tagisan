---
name: pypi-mcp-server-statsmodels
description: "Econometric time-series modeling, ARIMA forecasting, and statistical hypothesis tests"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server statsmodels"
  - "pypi-mcp-server-statsmodels"
  - "pypi-mcp-server-statsmodels execute"
  - "pypi-mcp-server-statsmodels verify"
  - "server"
  - "statsmodels"
---

# Pypi Mcp Server Statsmodels Skill

The `pypi-mcp-server-statsmodels` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-statsmodels",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
