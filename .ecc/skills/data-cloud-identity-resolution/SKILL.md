...
description: "Use this skill when configuring or troubleshooting Data Cloud identity resolution\
  \ rulesets \u2014 matching rules, reconciliation rules, unified profiles, and cross-device\
  \ identity linking. Trigger keywords: identity resolution ruleset, unified individual,\
  \ match rule, reconciliation rule, unified profile, cross-device identity, Data\
  \ Cloud deduplication, cluster creation. NOT for CRM duplicate and matching rules\
  \ \u2014 use admin/duplicate-management. NOT for overall Data Cloud layer and activation\
  \ design \u2014 use architect/data-cloud-architecture."
---
