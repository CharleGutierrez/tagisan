...
description: "Use when building or reviewing an LWC Custom Property Editor for Flow screen or action\
  \ configuration. Triggers: custom property editor, Flow configuration editor, builderContext.\
  \ NOT for a Flow screen component with no design-time editor \u2014 use lwc/lwc-in-flow-screens.\
  \ NOT for deciding whether a property editor is warranted \u2014 use flow/flow-custom-property-editors."
---
