---
name: vllm-chunked-prefill-pipelining
description: "Interleaving large prompt prefill chunks with decode tokens to stabilize generation latency"
version: 1.0.0
...
triggers:
  ...
  - "gguf"
  - "pipelining"
  - "vllm chunked prefill pipelining"
  - "vllm-chunked-prefill-pipelining"
  - "vllm-chunked-prefill-pipelining execute"
  - "vllm-chunked-prefill-pipelining verify"
---

# Vllm Chunked Prefill Pipelining Skill

The `vllm-chunked-prefill-pipelining` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **vLLM Documentation** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Scheduler`.
...
- **Subsystem Binding**: `Tensor Engine / Scheduler`
...
```json
{
  "skill": "vllm-chunked-prefill-pipelining",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "vLLM Documentation",
  "integration_target": "Tensor Engine / Scheduler",
