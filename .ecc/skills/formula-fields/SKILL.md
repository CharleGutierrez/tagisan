---
name: formula-fields
description: "Use when designing, reviewing, or troubleshooting Salesforce formula fields. Triggers:\
  \ 'formula field', 'cross-object formula', 'null handling', 'compile size', 'HYPERLINK',\
  \ 'IMAGE', 'why is formula slow'. NOT for a formula field slowing a SOQL query or\
  \ blocking an index \u2014 use apex/formula-field-performance-and-limits. NOT for\
  \ Formula resources inside a Flow \u2014 use flow/flow-formula-and-expression-patterns."
---
