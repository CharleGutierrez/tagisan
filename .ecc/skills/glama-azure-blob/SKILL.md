---
name: glama-azure-blob
description: "Azure Blob storage container exploration and binary asset transfer"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-azure-blob"
  - "glama-azure-blob execute"
  - "glama-azure-blob verify"
  - "mcp"
---

# Glama Azure Blob Skill

The `glama-azure-blob` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
