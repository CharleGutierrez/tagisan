---
name: simd-arm-neon-fp16-vectorizer
description: "ARM64 NEON vector registers and half-precision floating point operations for Apple Silicon"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "low-level"
  - "simd arm neon fp16 vectorizer"
  - "simd-arm-neon-fp16-vectorizer"
  - "simd-arm-neon-fp16-vectorizer execute"
  - "simd-arm-neon-fp16-vectorizer verify"
---

# Simd Arm Neon Fp16 Vectorizer Skill

The `simd-arm-neon-fp16-vectorizer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ARM Architecture Reference Manual** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tensor Engine / SIMD`.
...
- **Subsystem Binding**: `Tensor Engine / SIMD`
...
```json
{
  "skill": "simd-arm-neon-fp16-vectorizer",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "ARM Architecture Reference Manual",
  "integration_target": "Tensor Engine / SIMD",
