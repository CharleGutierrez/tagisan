...
[**Tips and Tricks**](https://r3f.docs.pmnd.rs/advanced/pitfalls#tips-and-tricks)
...
[**Avoid setState in loops**](https://r3f.docs.pmnd.rs/advanced/pitfalls#avoid-setstate-in-loops)
...
[**Handle animations in loops**](https://r3f.docs.pmnd.rs/advanced/pitfalls#handle-animations-in-loops)
...
[**Do not bind to fast state reactively**](https://r3f.docs.pmnd.rs/advanced/pitfalls#do-not-bind-to-fast-state-reactively)
...
[**Don't mount indiscriminately**](https://r3f.docs.pmnd.rs/advanced/pitfalls#don't-mount-indiscriminately)
...
[**Don't re-create objects in loops**](https://r3f.docs.pmnd.rs/advanced/pitfalls#don't-re-create-objects-in-loops)
...
[**`useLoader` instead of plain loaders**](https://r3f.docs.pmnd.rs/advanced/pitfalls#useloader-instead-of-plain-loaders)
