...
[**On-demand rendering**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#on-demand-rendering)
...
[![](https://codesandbox.io/api/v1/sandboxes/wvgxp/screenshot.png)](https://codesandbox.io/s/wvgxp)
...
[**Re-using geometries and materials**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#re-using-geometries-and-materials)
...
[![](https://codesandbox.io/api/v1/sandboxes/dix1y/screenshot.png)](https://codesandbox.io/s/dix1y)
...
[**Instancing**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#instancing)
...
[![](https://codesandbox.io/api/v1/sandboxes/h873k/screenshot.png)](https://codesandbox.io/s/h873k)
...
[**Level of detail**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#level-of-detail)
...
[![](https://codesandbox.io/api/v1/sandboxes/12nmp/screenshot.png)](https://codesandbox.io/s/12nmp)
...
[**Nested loading**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#nested-loading)
...
[![](https://codesandbox.io/api/v1/sandboxes/7duy8/screenshot.png)](https://codesandbox.io/s/7duy8)
...
[**Performance monitoring**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#performance-monitoring)
...
[**Movement regression**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#movement-regression)
...
[![](https://codesandbox.io/api/v1/sandboxes/pz0q6/screenshot.png)](https://codesandbox.io/s/pz0q6)
...
[**Enable concurrency**](https://r3f.docs.pmnd.rs/advanced/scaling-performance#enable-concurrency)
...
For more on how to use this API, see [use startTransition for expensive ops](https://r3f.docs.pmnd.rs/advanced/pitfalls#%E2%9C%85-use-starttransition-for-expensive-ops).
