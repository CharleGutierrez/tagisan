...
description: "Judging whether Salesforce data is fit to train an Einstein model: feature field\
  \ selection, outcome definition, data quality and fill-rate thresholds, leakage\
  \ detection. Trigger keywords: Einstein Discovery data requirements, training data\
  \ for Einstein, ML feature engineering, Einstein Prediction Builder data prep, AI\
  \ model training data. NOT for authoring the story in CRM Analytics Studio \u2014\
  \ use admin/einstein-discovery-setup. NOT for setting up the prediction itself \u2014\
  \ use agentforce/einstein-prediction-builder."
---
