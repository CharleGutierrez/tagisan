...
description: "Use this skill when designing or evaluating the architecture of a Salesforce Commerce\
  \ implementation that involves choosing between B2B Commerce (on Core, Lightning\
  \ platform) and B2C Commerce (Salesforce Commerce Cloud / SFCC). Trigger keywords:\
  \ B2B vs B2C architecture, SFCC vs B2B Commerce, Commerce Cloud platform decision,\
  \ B2B data model architecture, B2C storefront architecture, commerce infrastructure\
  \ comparison, platform selection architecture. NOT for implementation mechanics\
  \ \u2014 use admin/b2b-commerce-store-setup or admin/b2c-commerce-store-setup for\
  \ configuration work. NOT for requirements gathering \u2014 use admin/b2b-vs-b2c-requirements\
  \ for pre-build platform selection based on buyer journey. NOT for D2C vs B2B feature\
  \ comparisons within Lightning-based Commerce."
---
