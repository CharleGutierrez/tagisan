...
description: "Use when planning or executing a migration from change-set-based deployments to Salesforce\
  \ DX source-driven development. Trigger keywords: 'migrate from change sets', 'move\
  \ to SFDX', 'convert metadata to source format'. NOT for greenfield SFDX project\
  \ setup (use sf-cli-and-sfdx-essentials), unlocked package \u2014 use apex/sf-cli-and-sfdx-essentials."
---
