---
name: composio-intercom-conversations
description: "Intercom live chat message history retrieval and automated agent replies"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio intercom conversations"
  - "composio-dev"
  - "composio-intercom-conversations"
  - "composio-intercom-conversations execute"
  - "composio-intercom-conversations verify"
  - "conversations"
  - "enterprise"
---

# Composio Intercom Conversations Skill

The `composio-intercom-conversations` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-intercom-conversations",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
