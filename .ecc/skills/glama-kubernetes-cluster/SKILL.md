---
name: glama-kubernetes-cluster
description: "Kubernetes cluster resource inspection, pod log streaming, and deployment patch"
version: 1.0.0
...
triggers:
  - "cluster"
  - "glama"
  - "glama kubernetes cluster"
  - "glama-ai"
  - "glama-kubernetes-cluster"
  - "glama-kubernetes-cluster execute"
  - "glama-kubernetes-cluster verify"
  - "kubernetes"
  - "mcp"
---

# Glama Kubernetes Cluster Skill

The `glama-kubernetes-cluster` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "glama-kubernetes-cluster",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Glama.ai",
