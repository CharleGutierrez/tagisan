...
description: "Use this skill when building record forms or data tables with Salesforce standard\
  \ base components: lightning-record-form, lightning-record-edit-form, lightning-record-view-form,\
  \ and lightning-datatable. Covers component selection. NOT for custom forms backed\
  \ by Apex wire methods or @wire(getRecord) with fully manual f \u2014 use lwc/lwc-data-table."
---
