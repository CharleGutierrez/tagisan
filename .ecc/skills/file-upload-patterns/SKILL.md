...
description: "Upload files in LWC: lightning-file-upload, manual multipart, large-file chunked\
  \ upload, and ContentDocument associations. NOT for ContentDocument query patterns\
  \ \u2014 use data/salesforce-files-architecture."
---
