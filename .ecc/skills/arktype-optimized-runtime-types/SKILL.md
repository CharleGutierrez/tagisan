---
name: arktype-optimized-runtime-types
description: "Sub-nanosecond syntax-driven runtime type checking using 100% TypeScript syntax"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "ArkType Documentation"
tags:
  - arktype
  - bun
  - frontend
...
triggers:
  - "arktype"
  - "arktype optimized runtime types"
  - "arktype-optimized-runtime-types"
  - "arktype-optimized-runtime-types execute"
  - "arktype-optimized-runtime-types verify"
  - "bun"
  - "frontend"
  - "full-stack"
  - "optimized"
...
# Arktype Optimized Runtime Types Skill

The `arktype-optimized-runtime-types` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArkType Documentation** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Structured Output`.
...
```json
{
  "skill": "arktype-optimized-runtime-types",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "ArkType Documentation",
