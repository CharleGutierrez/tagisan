---
name: zapier-salesloft-cadence
description: "Salesloft cadence step execution, email tracking, and CRM syncing"
version: 1.0.0
...
triggers:
  ...
  - "saas"
  - "salesloft"
  - "zapier salesloft cadence"
  - "zapier-salesloft-cadence"
  - "zapier-salesloft-cadence execute"
  - "zapier-salesloft-cadence verify"
---

# Zapier Salesloft Cadence Skill

The `zapier-salesloft-cadence` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-salesloft-cadence",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
