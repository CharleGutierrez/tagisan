---
name: swc-ecmascript-minifier
description: "Rust-based ECMAScript AST optimization, dead branch dropping, and scope mangling"
version: 1.0.0
...
triggers:
  ...
  - "swc-ecmascript-minifier"
  - "swc-ecmascript-minifier execute"
  - "swc-ecmascript-minifier verify"
---

# Swc Ecmascript Minifier Skill

The `swc-ecmascript-minifier` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SWC Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Polyglot Runtimes`.
...
- **Subsystem Binding**: `Polyglot Runtimes`
...
```json
{
  "skill": "swc-ecmascript-minifier",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "SWC Docs",
  "integration_target": "Polyglot Runtimes",
