...
description: "Consent management architecture across Marketing Cloud and CRM: data model design,\
  \ cross-system sync patterns, and compliance design for GDPR/CCPA. Trigger keywords:\
  \ consent data model, ContactPointConsent, ContactPointTypeConsent, Individual object,\
  \ CRM system of record, MC consent sync, opt-in opt-out architecture, data use purpose,\
  \ lawful basis. NOT for Subscription or Preference Center setup, publication lists\
  \ and unsubscribe handling \u2014 use admin/consent-management-marketing. NOT for\
  \ right-to-be-forgotten and data subject requests in CRM \u2014 use security/gdpr-data-privacy."
---
