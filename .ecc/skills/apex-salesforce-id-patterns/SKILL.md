...
description: "Use when working with Salesforce Ids in Apex \u2014 validating Id format, detecting\
  \ the target sObject type from a string Id, or safely handling 15 vs 18-character\
  \ Ids. Trigger keywords: Id prefix, Id.valueOf, Id.getSobjectType, 15-char, 18-char,\
  \ case-insensitive Id. NOT for hardcoded Profile or RecordType Ids \u2014 use apex/apex-hardcoded-id-elimination.\
  \ NOT for bulk Id collection patterns \u2014 use apex/apex-collections-patterns."
---
