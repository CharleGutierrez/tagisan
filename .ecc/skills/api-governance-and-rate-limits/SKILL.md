...
description: "Monitor and govern Salesforce API consumption: per-user limits, org allocation, lightning-rest\
  \ limits, and backoff. NOT for designing new endpoints \u2014 use security/api-security-and-rate-limiting."
---
