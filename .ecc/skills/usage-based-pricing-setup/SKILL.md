...
description: 'Usage-based pricing in Revenue Cloud: metered billing, usage records, rating, tiering,
  consumption schedules. NOT for choosing a CPQ pricing method (List, Block, Cost
  Plus Markup, Percent of Total) - use admin/pricing-model-design. NOT for legacy
  Salesforce Billing (blng__) schedules and invoice runs - use admin/billing-schedule-setup.'
---
