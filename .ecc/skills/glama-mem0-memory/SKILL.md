---
name: glama-mem0-memory
description: "Persistent multi-turn agent memory extraction, storage, and context recall"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-mem0-memory"
  - "glama-mem0-memory execute"
  - "glama-mem0-memory verify"
  - "mcp"
  - "mem0"
  - "memory"
---

# Glama Mem0 Memory Skill

The `glama-mem0-memory` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / MemoryBackend`.
