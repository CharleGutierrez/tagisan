---
name: sf-eval
description: Evaluate and benchmark Salesforce skill quality. Compares AI-generated code with vs
  without skill context, scores against a Salesforce-specific rubric (security, governor
  limits, bulkification, patterns, completeness), and produces a comparison report.
  Use to run benchmarks, verify skill value, or check Apex code quality. Activate
  on mentions of "evaluate skills", "benchmark", "skill quality", "run eval", or "compare
  with/without skills".
...
---
