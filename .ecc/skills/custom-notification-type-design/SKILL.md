...
description: "Use when designing Custom Notification Types that fire via Flow, Apex, or Process\
  \ Builder to Lightning bell, desktop, mobile (push), and Slack. Covers channel enablement,\
  \ targeting, deliverability, consent, and anti-spam discipline. NOT for actually\
  \ sending one from Flow or Apex, or the recipient limit \u2014 use admin/custom-notification-types.\
  \ NOT for email templates and alerts \u2014 use admin/email-templates-and-alerts."
---
