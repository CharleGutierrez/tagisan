---
name: npm-mcp-server-brave-search
description: "Brave Search Web & Local API connector for accurate live queries"
version: 1.0.0
...
triggers:
  ...
  - "npm-mcp-server-brave-search"
  - "npm-mcp-server-brave-search execute"
  - "npm-mcp-server-brave-search verify"
  - "search"
---

# Npm Mcp Server Brave Search Skill

The `npm-mcp-server-brave-search` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "npm-mcp-server-brave-search",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "NPM Registry",
