...
description: "Use this skill when deploying a trained Einstein Discovery model to production records\
  \ declaratively \u2014 activating a prediction definition, mapping output fields\
  \ to page layouts, adding the Einstein Discovery Action to a Flow, running bulk\
  \ predict jobs, and monitoring model health via Model Manager UI. Trigger keywords:\
  \ prediction definition activation, bulk predict job, Einstein Discovery Flow action,\
  \ Model Manager, prediction field mapping, model refresh activation, scoring job,\
  \ Einstein Discovery recommendations on record. NOT for authoring the story in CRM\
  \ Analytics Studio \u2014 use admin/einstein-discovery-setup. NOT for programmatic\
  \ scoring through the API \u2014 use agentforce/einstein-discovery-development."
---
