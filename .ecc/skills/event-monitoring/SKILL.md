...
description: "Shield Event Monitoring: event log types, downloading logs via REST API and SOQL,\
  \ real-time event monitoring with streaming API, and threat detection policies.\
  \ NOT for debug logs \u2014 use apex/debug-logs-and-developer-console. NOT for custom\
  \ platform event publishing/subscribing \u2014 use apex/platform-events-apex."
---
# Event Monitoring
