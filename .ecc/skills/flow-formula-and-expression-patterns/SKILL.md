...
description: "Author NULL-safe, type-correct, performance-aware Formula resources and condition\
  \ expressions in Flow: lazy re-evaluation, BLANKVALUE/ISBLANK guards, ISPICKVAL\
  \ vs =. NOT for record-level formula fields on objects \u2014 use admin/formula-fields.\
  \ NOT for Validation Rule formulas \u2014 use admin/validation-rules."
---
