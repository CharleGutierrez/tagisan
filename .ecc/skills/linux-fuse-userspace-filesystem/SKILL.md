---
name: linux-fuse-userspace-filesystem
description: "Filesystem in Userspace implementation for virtualized agent artifact sandboxes"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux fuse userspace filesystem"
  - "linux-fuse-userspace-filesystem"
  - "linux-fuse-userspace-filesystem execute"
  - "linux-fuse-userspace-filesystem verify"
---

# Linux Fuse Userspace Filesystem Skill

The `linux-fuse-userspace-filesystem` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `FileCRUD / Sandbox`.
...
- **Subsystem Binding**: `FileCRUD / Sandbox`
...
```json
{
  "skill": "linux-fuse-userspace-filesystem",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "FileCRUD / Sandbox",
