...
description: "Use this skill when designing the FSC client onboarding process \u2014 mapping document\
  \ collection touchpoints, approval steps, compliance checkpoint sequencing, and\
  \ welcome journey handoffs. Trigger keywords: client onboarding design, onboarding\
  \ workflow requirements, document collection flow, compliance checkpoint, welcome\
  \ journey, intake process design. NOT for configuring the Action Plan template itself\
  \ \u2014 use admin/fsc-action-plans. NOT for OmniScript screen and branching requirements\
  \ \u2014 use admin/omniscript-flow-design-requirements."
---
