...
description: 'Configure pricebooks, tiered pricing, promotions, coupon codes, and cart discounts
  for B2B or D2C Commerce stores. Trigger keywords: WebStorePricebook, BuyerGroupPricebook,
  PriceAdjustmentSchedule, PromotionsCartCalculator, commerce coupon, cart-level discount,
  tiered price, Commerce promotion. NOT for Sales Cloud pricebooks and PricebookEntry
  - use admin/products-and-pricebooks. NOT for CPQ quote pricing and discount schedules
  - use admin/cpq-pricing-rules.'
---
