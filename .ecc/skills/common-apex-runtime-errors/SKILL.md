...
description: "Diagnosing and resolving common Apex runtime exceptions: NullPointerException, QueryException,\
  \ DmlException, ListException, LimitException, TypeException. Use when debugging\
  \ Apex runtime failures or writing defensive code. NOT for structuring try/catch\
  \ \u2014 use apex/exception-handling. NOT for a cross-cutting error framework \u2014\
  \ use apex/error-handling-framework. NOT for governor-limit prevention \u2014 use\
