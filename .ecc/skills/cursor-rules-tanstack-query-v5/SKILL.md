---
name: cursor-rules-tanstack-query-v5
description: "TanStack Query v5 optimistic mutations, query keys, and garbage collection"
version: 1.0.0
...
triggers:
  - "bun"
  - "cursor"
  - "cursor rules tanstack query v5"
  - "cursor-rules-tanstack-query-v5"
  - "cursor-rules-tanstack-query-v5 execute"
  - "cursor-rules-tanstack-query-v5 verify"
  - "frontend"
  - "full-stack"
  - "query"
---

# Cursor Rules Tanstack Query V5 Skill

The `cursor-rules-tanstack-query-v5` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-tanstack-query-v5",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
