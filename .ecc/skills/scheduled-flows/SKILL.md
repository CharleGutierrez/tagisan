...
description: "Use when designing or reviewing schedule-triggered flows for recurring automation,\
  \ replacement of time-based workflow patterns, bounded record selection, idempotent\
  \ processing, and escalation to Apex when volume is too high. Triggers: 'scheduled\
  \ flow design', 'nightly flow job', 'time based workflow replacement', 'schedule\
  \ triggered flow limits'. NOT for record-triggered scheduled paths \u2014 use flow/flow-time-based-patterns.\
  \ NOT for large-scale batch processing \u2014 use apex/batch-apex-patterns."
---
