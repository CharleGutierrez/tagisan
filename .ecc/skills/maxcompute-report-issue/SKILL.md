---
name: maxcompute-report-issue
description: "Use when the user wants to file an upstream bug / issue / feature request against\
  \ the maxcompute-semantic skill itself (\"report a bug\", \"file an issue\", \"\u63D0\
  \ issue\", \"file this upstream\"). Routes to the internal Aone workitem tracker\
  \ when the `a1` CLI is present, otherwise to GitHub Issues."
---
