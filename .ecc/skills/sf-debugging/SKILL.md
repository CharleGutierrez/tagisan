---
name: sf-debugging
description: "Salesforce debugging \u2014 debug logs, SOQL explain plan, Flow debug, LWC DevTools,\
  \ error resolution. Use when diagnosing Apex exceptions, governor breaches, or Flow\
  \ failures. Do NOT use for tests or build errors."
---
