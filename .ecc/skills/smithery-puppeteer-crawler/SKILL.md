---
name: smithery-puppeteer-crawler
description: "Headless DOM automation, screenshot diffing, and form submission"
version: 1.0.0
...
triggers:
  ...
  - "puppeteer"
  - "smithery"
  - "smithery puppeteer crawler"
  - "smithery-puppeteer-crawler"
  - "smithery-puppeteer-crawler execute"
  - "smithery-puppeteer-crawler verify"
---

# Smithery Puppeteer Crawler Skill

The `smithery-puppeteer-crawler` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-puppeteer-crawler",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
