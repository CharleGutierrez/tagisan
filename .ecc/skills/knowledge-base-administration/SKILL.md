...
description: "Use this skill when setting up, configuring, or managing Salesforce Lightning Knowledge\
  \ \u2014 enabling the feature, designing record types on Knowledge__kav, configuring\
  \ Data Categories for organization and visibility control, setting up publishing\
  \ workflows, and layering approval processes. Trigger keywords: Lightning Knowledge\
  \ setup, Knowledge article record types, Data Category visibility, Knowledge publishing\
  \ workflow, Knowledge__kav configuration. NOT for converting Classic Article Types\
  \ to Lightning \u2014 use admin/knowledge-classic-to-lightning. NOT for bulk-loading\
  \ articles from an external help center \u2014 use data/knowledge-article-import."
---
