...
description: "Use when writing, reviewing, or designing Apex triggers. Triggers: 'trigger', 'trigger\
  \ handler', 'trigger framework', 'recursion', 'before insert', 'after update', 'one\
  \ trigger per object'. NOT for Flow-based automation \u2014 use admin/flow-for-admins\
  \ for declarative automation decisions."
---
