---
name: composio-zoom-meeting-transcripts
description: "Zoom cloud recording transcript download and AI meeting summarization"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio zoom meeting transcripts"
  - "composio-dev"
  - "composio-zoom-meeting-transcripts"
  - "composio-zoom-meeting-transcripts execute"
  - "composio-zoom-meeting-transcripts verify"
  - "enterprise"
  - "meeting"
---

# Composio Zoom Meeting Transcripts Skill

The `composio-zoom-meeting-transcripts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-zoom-meeting-transcripts",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
