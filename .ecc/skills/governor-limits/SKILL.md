...
description: "Use when writing, reviewing, or troubleshooting Apex that risks hitting Salesforce\
  \ governor limits. Triggers: 'too many SOQL queries', 'too many DML statements',\
  \ 'CPU time limit', 'bulkification', 'Queueable vs Batch'. NOT for the 100-callout-per-transaction\
  \ ceiling \u2014 use integration/callout-limits-and-async-patterns. NOT for org-level\
  \ capacity planning \u2014 use architect/limits-and-scalability-planning. NOT for\
  \ runtime Limits class guard clauses \u2014 use apex/apex-limits-monitoring."
---
