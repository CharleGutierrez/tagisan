---
name: tokenizer-sentencepiece-unigram
description: "Unigram language model tokenization for Llama and Mistral family architectures"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "Google Research Docs"
tags:
  - ai
  - cuda
  - gguf
...
triggers:
  ...
  - "tokenizer-sentencepiece-unigram"
  - "tokenizer-sentencepiece-unigram execute"
  - "tokenizer-sentencepiece-unigram verify"
---

# Tokenizer Sentencepiece Unigram Skill

The `tokenizer-sentencepiece-unigram` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Google Research Docs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tokenizer Engine`.
...
```json
{
  "skill": "tokenizer-sentencepiece-unigram",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Google Research Docs",
