---
name: linux-mprotect-w-xor-x
description: "Write-XOR-Execute memory permission enforcement preventing shellcode injection"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux mprotect w xor x"
  - "linux-mprotect-w-xor-x"
  - "linux-mprotect-w-xor-x execute"
  - "linux-mprotect-w-xor-x verify"
  - "low-level"
  - "mprotect"
---

# Linux Mprotect W Xor X Skill

The `linux-mprotect-w-xor-x` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `AgentShield / Runtime`.
...
- **Subsystem Binding**: `AgentShield / Runtime`
...
```json
{
  "skill": "linux-mprotect-w-xor-x",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "AgentShield / Runtime",
