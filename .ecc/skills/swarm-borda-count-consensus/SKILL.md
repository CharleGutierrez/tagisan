---
name: swarm-borda-count-consensus
description: "Ranked-choice Borda count scoring aggregating multiple agent refactoring proposals"
version: 1.0.0
...
triggers:
  ...
  - "debate"
  - "moa"
  - "swarm borda count consensus"
  - "swarm-borda-count-consensus"
  - "swarm-borda-count-consensus execute"
  - "swarm-borda-count-consensus verify"
---

# Swarm Borda Count Consensus Skill

The `swarm-borda-count-consensus` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Voting Theory / Social Choice** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Consensus Voting Engine`.
...
```json
{
  "skill": "swarm-borda-count-consensus",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Voting Theory / Social Choice",
