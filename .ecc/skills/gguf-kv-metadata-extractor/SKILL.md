---
name: gguf-kv-metadata-extractor
description: "Extracting context length, attention heads, rope frequency, and block counts"
version: 1.0.0
...
triggers:
  ...
  - "ggml/gguf"
  - "gguf"
  - "gguf kv metadata extractor"
  - "gguf-kv-metadata-extractor"
  - "gguf-kv-metadata-extractor execute"
  - "gguf-kv-metadata-extractor verify"
---

# Gguf Kv Metadata Extractor Skill

The `gguf-kv-metadata-extractor` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **GGML/GGUF Spec** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Deep Model Inspection`.
...
- **Subsystem Binding**: `Deep Model Inspection`
...
```json
{
  "skill": "gguf-kv-metadata-extractor",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "GGML/GGUF Spec",
  "integration_target": "Deep Model Inspection",
