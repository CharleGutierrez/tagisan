---
name: smithery-exa-semantic-search
description: "Neural semantic web search optimized for developer documentation"
version: 1.0.0
...
triggers:
  ...
  - "search"
  - "semantic"
  - "smithery exa semantic search"
  - "smithery-exa-semantic-search"
  - "smithery-exa-semantic-search execute"
  - "smithery-exa-semantic-search verify"
---

# Smithery Exa Semantic Search Skill

The `smithery-exa-semantic-search` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-exa-semantic-search",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
