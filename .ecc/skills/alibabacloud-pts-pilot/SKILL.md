...
description: "Router skill for Alibaba Cloud PTS (Performance Testing Service) operations. Resolves\
  \ the user's PTS intent and delegates execution to the appropriate sub-skill. Itself\
  \ does NOT execute any CLI / API / business logic. Triggers \"PTS\", \"\u538B\u6D4B\
  \", \"\u6027\u80FD\u6D4B\u8BD5\", \"stress testing\", \"performance testing\", \"\
  JMeter\", \"load testing\", \"\u538B\u6D4B\u8C03\u4F18\"."
---
