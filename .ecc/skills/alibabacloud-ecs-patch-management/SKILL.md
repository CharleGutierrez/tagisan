...
description: "Alibaba Cloud ECS Patch Management Skill. Use for scanning and installing OS patches\
  \ on ECS instances via OOS (Operation Orchestration Service). Triggers: \"patch\
  \ management\", \"scan patches\", \"install patches\", \"OS update\", \"security\
  \ patches\", \"ACS-ECS-BulkyApplyPatchBaseline\", \"oos patch\", \"\u7CFB\u7EDF\u8865\
  \u4E01\u626B\u63CF\", \"\u7CFB\u7EDF\u8865\u4E01\u5B89\u88C5\"."
---
