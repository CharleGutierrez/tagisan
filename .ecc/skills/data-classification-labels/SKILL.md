...
description: "Classify Salesforce fields by data sensitivity and compliance category using the\
  \ four built-in classification attributes (SecurityClassification, ComplianceGroup,\
  \ BusinessOwnerId, BusinessStatus). Covers Metadata API. NOT for data masking, Shield\
  \ Platform Encryption, or runtime access control enforcement \u2014 use data/data-quality-and-governance."
---
