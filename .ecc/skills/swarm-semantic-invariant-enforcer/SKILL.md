---
name: swarm-semantic-invariant-enforcer
description: "Enforcing zero SLA on speed but strict mathematical guarantee on schema completeness"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Tagisan Architectural Standard"
tags:
  - consensus
  - debate
  - enforcer
...
triggers:
  ...
  - "invariant"
  - "moa"
  - "swarm semantic invariant enforcer"
  - "swarm-semantic-invariant-enforcer"
  - "swarm-semantic-invariant-enforcer execute"
  - "swarm-semantic-invariant-enforcer verify"
---

# Swarm Semantic Invariant Enforcer Skill

The `swarm-semantic-invariant-enforcer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tagisan Architectural Standard** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Semantic Invariant Guard`.
...
- **Subsystem Binding**: `Semantic Invariant Guard`
...
```json
{
  "skill": "swarm-semantic-invariant-enforcer",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Tagisan Architectural Standard",
  "integration_target": "Semantic Invariant Guard",
