...
description: "Find + fix bug current author introduced in last week, cwd. Triggers\u2014proactive\
  \ recent-change fix, empty prompt, triage recent commits. Root cause = author\u2019\
  s own diffs."
---
# Recent Code Bugfix
