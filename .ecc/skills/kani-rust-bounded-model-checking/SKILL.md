---
name: kani-rust-bounded-model-checking
description: "Bounded model checking for unsafe Rust transmutes and pointer offset bounds"
version: 1.0.0
...
triggers:
  ...
  - "kani-rust-bounded-model-checking"
  - "kani-rust-bounded-model-checking execute"
  - "kani-rust-bounded-model-checking verify"
---

# Kani Rust Bounded Model Checking Skill

The `kani-rust-bounded-model-checking` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Kani Rust Verifier Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Kani Formal Verifier`.
...
```json
{
  "skill": "kani-rust-bounded-model-checking",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Kani Rust Verifier Docs",
