---
name: dpdk-poll-mode-driver-tuning
description: "PMD core affinity assignment and RX/TX descriptor ring size optimization"
version: 1.0.0
...
triggers:
  - "dpdk"
  - "dpdk poll mode driver tuning"
  - "dpdk-org"
  - "dpdk-poll-mode-driver-tuning"
  - "dpdk-poll-mode-driver-tuning execute"
  - "dpdk-poll-mode-driver-tuning verify"
  - "driver"
  - "hardware"
  - "kernel"
---

# Dpdk Poll Mode Driver Tuning Skill

The `dpdk-poll-mode-driver-tuning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **DPDK.org** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / HardwareEngine`.
...
- **Subsystem Binding**: `Native Rust / HardwareEngine`
...
```json
{
  "skill": "dpdk-poll-mode-driver-tuning",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "DPDK.org",
  "integration_target": "Native Rust / HardwareEngine",
