---
name: agent-subagent-fanout-barrier
description: "Concurrent subagent dispatch with Tokio JoinSet barrier synchronization"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Distributed Systems / Tokio"
tags:
  - agent
  - barrier
  - consensus
...
triggers:
  - "agent"
  - "agent subagent fanout barrier"
  - "agent-subagent-fanout-barrier"
  - "agent-subagent-fanout-barrier execute"
  - "agent-subagent-fanout-barrier verify"
  - "barrier"
  - "consensus"
  - "debate"
  - "distributed"
...
# Agent Subagent Fanout Barrier Skill

The `agent-subagent-fanout-barrier` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Distributed Systems / Tokio** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Subagent Dispatcher`.
...
- **Subsystem Binding**: `Subagent Dispatcher`
...
```json
{
  "skill": "agent-subagent-fanout-barrier",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Distributed Systems / Tokio",
  "integration_target": "Subagent Dispatcher",
