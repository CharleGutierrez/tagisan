---
name: smithery-redis-cache
description: "In-memory key-value caching, pub/sub messaging, and session states"
version: 1.0.0
...
triggers:
  ...
  - "redis"
  - "smithery"
  - "smithery redis cache"
  - "smithery-redis-cache"
  - "smithery-redis-cache execute"
  - "smithery-redis-cache verify"
---

# Smithery Redis Cache Skill

The `smithery-redis-cache` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
