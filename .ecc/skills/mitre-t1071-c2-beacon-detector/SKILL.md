---
name: mitre-t1071-c2-beacon-detector
description: "Detecting periodic outbound HTTP/DNS beaconing patterns indicative of Command & Control"
version: 1.0.0
...
triggers:
  ...
  - "detector"
  - "edr"
  - "mitre t1071 c2 beacon detector"
  - "mitre-t1071-c2-beacon-detector"
  - "mitre-t1071-c2-beacon-detector execute"
  - "mitre-t1071-c2-beacon-detector verify"
---

# Mitre T1071 C2 Beacon Detector Skill

The `mitre-t1071-c2-beacon-detector` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Network`.
...
- **Subsystem Binding**: `AgentShield / Network`
...
```json
{
  "skill": "mitre-t1071-c2-beacon-detector",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "AgentShield / Network",
