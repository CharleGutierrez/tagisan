---
name: sre-postmortem-timeline-generator
description: "Synthesizing chronological incident timelines, root causes, and prevention items"
version: 1.0.0
...
triggers:
  ...
  - "postmortem"
  - "resilience"
  - "sre postmortem timeline generator"
  - "sre-postmortem-timeline-generator"
  - "sre-postmortem-timeline-generator execute"
  - "sre-postmortem-timeline-generator verify"
---

# Sre Postmortem Timeline Generator Skill

The `sre-postmortem-timeline-generator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SRE Best Practices** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Failure Forensic Expert`.
...
- **Subsystem Binding**: `Failure Forensic Expert`
...
```json
{
  "skill": "sre-postmortem-timeline-generator",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "SRE Best Practices",
  "integration_target": "Failure Forensic Expert",
