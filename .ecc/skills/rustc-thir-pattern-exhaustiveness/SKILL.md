---
name: rustc-thir-pattern-exhaustiveness
description: "THIR match pattern exhaustiveness and unreachable branch diagnostic repair"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "rustc dev guide (doc.rust-lang.org)"
tags:
  - ast
  - compiler
  - exhaustiveness
...
triggers:
  ...
  - "formal-methods"
  - "pattern"
  - "rustc thir pattern exhaustiveness"
  - "rustc-thir-pattern-exhaustiveness"
  - "rustc-thir-pattern-exhaustiveness execute"
  - "rustc-thir-pattern-exhaustiveness verify"
---

# Rustc Thir Pattern Exhaustiveness Skill

The `rustc-thir-pattern-exhaustiveness` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **rustc dev guide (doc.rust-lang.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Self-Healing Compiler (autofix)`.
...
- **Subsystem Binding**: `Self-Healing Compiler (autofix)`
...
```json
{
  "skill": "rustc-thir-pattern-exhaustiveness",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "rustc dev guide (doc.rust-lang.org)",
  "integration_target": "Self-Healing Compiler (autofix)",
