...
description: "Alibaba Cloud DocMind intelligent document parsing tool. Supports PDF, Word, PPT,\
  \ Excel, images and more, outputting structured Markdown/JSON/HTML. Offers two invocation\
  \ modes \u2014 V2 API direct access and Alibaba Cloud POP \u2014 with automatic\
  \ routing based on credential availability. Use when the user needs to parse documents,\
  \ extract content (text/tables/images), convert documents to Markdown, or mentions\
  \ \"docmind\", \"document parsing\", \"parse file\", etc."
---
