---
name: linux-perf-events-hardware-pmc
description: "Hardware Performance Monitoring Counter analysis for cache misses and branch mispredictions"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux perf events hardware pmc"
  - "linux-perf-events-hardware-pmc"
  - "linux-perf-events-hardware-pmc execute"
  - "linux-perf-events-hardware-pmc verify"
  - "low-level"
---

# Linux Perf Events Hardware Pmc Skill

The `linux-perf-events-hardware-pmc` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Engine / Telemetry`.
...
- **Subsystem Binding**: `Engine / Telemetry`
...
```json
{
  "skill": "linux-perf-events-hardware-pmc",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Engine / Telemetry",
