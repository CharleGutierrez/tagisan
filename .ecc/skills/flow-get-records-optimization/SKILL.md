...
description: "Optimize Get Records in Flow \u2014 filters, field selection, sort/limit, caching,\
  \ avoiding queries in loops. Triggers: get records, flow SOQL, flow query limit.\
  \ NOT for Apex SOQL tuning \u2014 use flow/flow-governor-limits-deep-dive. NOT for\
  \ loop bulkification failures \u2014 use flow/flow-bulkification."
---
