...
description: "CRITICAL: Use for ratatui widgets and UI components. Triggers on: Block, Paragraph, List, Table, Tabs, Chart, Gauge, Scrollbar, Canvas, Widget, StatefulWidget, ListState, TableState, ListItem, Row, Cell, BarChart, Sparkline, LineGauge, Clear, render_widget, render_stateful_widget, \"custom widget\", \"create widget\", \"ratatui widget\", 组件, 控件, 列表, 表格, 进度条, 图表, 自定义组件"
---
