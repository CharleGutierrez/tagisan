...
description: "Salesforce Shield Field Audit Trail: configuration, retention policies, querying\
  \ archived field data, compliance requirements. NOT for field history tracking (use\
  \ field-history-tracking) \u2014 use data/field-history-tracking."
---
# Field Audit Trail
