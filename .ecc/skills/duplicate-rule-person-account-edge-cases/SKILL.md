...
description: "Duplicate Rules and Matching Rules for Person Accounts \u2014 PA shape, lead convert,\
  \ PII. Triggers: person account duplicate rule, PA matching, IsPersonAccount filter.\
  \ NOT for general B2B duplicate management \u2014 use admin/duplicate-management.\
  \ NOT for Person Account enablement \u2014 use data/person-accounts."
---
