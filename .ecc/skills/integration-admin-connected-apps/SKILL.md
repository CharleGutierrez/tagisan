...
description: "Use when managing Connected Apps for integration purposes \u2014 configuring OAuth\
  \ policies, IP restrictions, refresh token expiry, pre-authorization assignment\
  \ via profile or permission set, and monitoring connected app usage via EventLogFile.\
  \ NOT for choosing which OAuth grant flow to implement \u2014 use integration/oauth-flows-and-connected-apps.\
  \ NOT for decoding a specific OAuth error such as invalid_grant \u2014 use admin/connected-app-troubleshooting."
---
