...
description: "Use when a Salesforce Flow throws a runtime error, sends an unhandled fault email,\
  \ or produces unexpected results in production or sandbox. Triggers: 'Flow error\
  \ email', 'Flow failed at element', 'null reference in Flow', 'Flow SOQL limit error',\
  \ 'Flow DML in loop error'. NOT for changing who receives fault emails or suppressing\
  \ noisy ones \u2014 use flow/flow-error-notification-patterns. NOT for designing\
  \ fault paths before anything fails \u2014 use flow/fault-handling. NOT for org-wide\
  \ error alerting and trends \u2014 use flow/flow-error-monitoring."
---
