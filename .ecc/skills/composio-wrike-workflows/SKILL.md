---
name: composio-wrike-workflows
description: "Wrike enterprise project blueprint cloning and resource allocation"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio wrike workflows"
  - "composio-dev"
  - "composio-wrike-workflows"
  - "composio-wrike-workflows execute"
  - "composio-wrike-workflows verify"
  - "enterprise"
  - "saas"
---

# Composio Wrike Workflows Skill

The `composio-wrike-workflows` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-wrike-workflows",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
