---
name: cursor-rules-tailwind-v4-theme
description: "Tailwind CSS v4 @theme CSS-first configuration and OKLCH color token palettes"
version: 1.0.0
...
triggers:
  - "bun"
  - "cursor"
  - "cursor rules tailwind v4 theme"
  - "cursor-rules-tailwind-v4-theme"
  - "cursor-rules-tailwind-v4-theme execute"
  - "cursor-rules-tailwind-v4-theme verify"
  - "frontend"
  - "full-stack"
  - "rules"
---

# Cursor Rules Tailwind V4 Theme Skill

The `cursor-rules-tailwind-v4-theme` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-tailwind-v4-theme",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
