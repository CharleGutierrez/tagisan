---
name: composio-onelogin-directory
description: "OneLogin directory user provisioning and active directory synchronization"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio onelogin directory"
  - "composio-dev"
  - "composio-onelogin-directory"
  - "composio-onelogin-directory execute"
  - "composio-onelogin-directory verify"
  - "directory"
  - "enterprise"
---

# Composio Onelogin Directory Skill

The `composio-onelogin-directory` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-onelogin-directory",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
