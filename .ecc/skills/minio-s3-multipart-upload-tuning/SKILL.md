---
name: minio-s3-multipart-upload-tuning
description: "Optimizing S3 multipart upload chunk sizes for high-throughput model weight checkpointing"
version: 1.0.0
...
triggers:
  - "distributed"
  - "minio"
  - "minio s3 multipart upload tuning"
  - "minio-s3-multipart-upload-tuning"
  - "minio-s3-multipart-upload-tuning execute"
  - "minio-s3-multipart-upload-tuning verify"
  - "multipart"
  - "opentelemetry"
  - "resilience"
---

# Minio S3 Multipart Upload Tuning Skill

The `minio-s3-multipart-upload-tuning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MinIO Documentation** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Colibrì Storage`.
...
```json
{
  "skill": "minio-s3-multipart-upload-tuning",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "MinIO Documentation",
