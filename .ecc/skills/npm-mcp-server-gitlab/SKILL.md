---
name: npm-mcp-server-gitlab
description: "GitLab project repository, issue tracker, and CI/CD pipeline automation"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server gitlab"
  - "npm-mcp-server-gitlab"
  - "npm-mcp-server-gitlab execute"
  - "npm-mcp-server-gitlab verify"
  - "server"
---

# Npm Mcp Server Gitlab Skill

The `npm-mcp-server-gitlab` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
