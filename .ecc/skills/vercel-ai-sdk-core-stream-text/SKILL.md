---
name: vercel-ai-sdk-core-stream-text
description: "Streaming LLM completions using streamText and structured tools via streamObject"
version: 1.0.0
...
triggers:
  ...
  - "full-stack"
  - "sdk"
  - "vercel ai sdk core stream text"
  - "vercel-ai-sdk-core-stream-text"
  - "vercel-ai-sdk-core-stream-text execute"
  - "vercel-ai-sdk-core-stream-text verify"
---

# Vercel Ai Sdk Core Stream Text Skill

The `vercel-ai-sdk-core-stream-text` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Vercel AI SDK Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Interface / SSE`.
...
- **Subsystem Binding**: `Web Interface / SSE`
...
```json
{
  "skill": "vercel-ai-sdk-core-stream-text",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Vercel AI SDK Docs",
  "integration_target": "Web Interface / SSE",
