---
name: fault-handling
description: "Use when designing, reviewing, or troubleshooting Salesforce Flow fault handling,\
  \ error logging, and bulk-safe automation paths. Triggers: 'fault connector', '$Flow.FaultMessage',\
  \ 'flow failed', 'record-triggered flow rollback', 'screen flow error'. NOT for\
  \ diagnosing a fault email you already got \u2014 use flow/flow-runtime-error-diagnosis.\
  \ NOT for Apex exception handling \u2014 use apex/exception-handling."
---
