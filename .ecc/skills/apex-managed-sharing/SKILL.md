...
description: "Sharing records programmatically via Apex: Share objects, row cause, Apex sharing\
  \ reason, sharing recalculation, with/without sharing patterns. NOT for declarative\
  \ sharing rules \u2014 use admin/sharing-and-visibility. NOT for recalc job runtime\
  \ \u2014 use data/sharing-recalculation-performance."
---
