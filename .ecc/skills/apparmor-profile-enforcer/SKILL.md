---
name: apparmor-profile-enforcer
description: "Enforcing path-based AppArmor security profiles on child execution environments"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "AppArmor Documentation"
tags:
  - agentshield
  - apparmor
  - defense
...
triggers:
  - "agentshield"
  - "apparmor"
  - "apparmor profile enforcer"
  - "apparmor-profile-enforcer"
  - "apparmor-profile-enforcer execute"
  - "apparmor-profile-enforcer verify"
  - "defense"
  - "edr"
  - "enforcer"
---

# Apparmor Profile Enforcer Skill

The `apparmor-profile-enforcer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **AppArmor Documentation** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Linux`.
...
```json
{
  "skill": "apparmor-profile-enforcer",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "AppArmor Documentation",
