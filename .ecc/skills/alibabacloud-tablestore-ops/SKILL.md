...
description: "Alibaba Cloud Tablestore (OTS) Read-Only Operations Skill. Use for querying Tablestore\
  \ instances and data tables via Aliyun CLI. Triggers: \"tablestore\", \"ots\", \"\
  \u8868\u683C\u5B58\u50A8\", \"list instance\", \"describe instance\", \"list table\"\
  , \"describe table\", \"aliyun otsutil\""
---
