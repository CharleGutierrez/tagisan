---
name: glama-stripe-billing
description: "Stripe payment intent inspection, customer balance audits, and webhook events"
version: 1.0.0
...
triggers:
  - "billing"
  - "glama"
  - "glama stripe billing"
  - "glama-ai"
  - "glama-stripe-billing"
  - "glama-stripe-billing execute"
  - "glama-stripe-billing verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Stripe Billing Skill

The `glama-stripe-billing` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
