...
description: "Migrate Process Builder processes to record-triggered Flows using the native Migrate\
  \ to Flow tool or manual rebuild. Covers conversion tool usage, pattern mapping,\
  \ order-of-execution changes, testing migrated flows, and bulk behavior improvements.\
  \ NOT for Workflow Rule migration \u2014 use flow/workflow-rule-to-flow-migration.\
  \ NOT for designing net-new automation \u2014 use admin/process-automation-selection."
---
