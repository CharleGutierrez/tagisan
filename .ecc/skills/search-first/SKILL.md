---
name: search-first
description: "Use when researching existing Salesforce tools, Apex libraries, or metadata patterns\
  \ before writing custom code. Search-first workflow with agent. Do NOT use for implementing\
  \ code \u2014 only for discovery and evaluation."
---
