...
description: "Dynamic pod scaling based on custom queue depth and inference request backlog"
version: 1.0.0
...
triggers:
  ...
  - "kubernetes-horizontal-pod-autoscaling"
  - "kubernetes-horizontal-pod-autoscaling execute"
  - "kubernetes-horizontal-pod-autoscaling verify"
  - "opentelemetry"
---

# Kubernetes Horizontal Pod Autoscaling Skill

The `kubernetes-horizontal-pod-autoscaling` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Kubernetes Documentation** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `K8s Operator`.
...
```json
{
  "skill": "kubernetes-horizontal-pod-autoscaling",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Kubernetes Documentation",
