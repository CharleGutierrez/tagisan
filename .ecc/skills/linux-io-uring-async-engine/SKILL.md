---
name: linux-io-uring-async-engine
description: "Linux io_uring submission/completion queue submission for zero-syscall async I/O"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux io uring async engine"
  - "linux-io-uring-async-engine"
  - "linux-io-uring-async-engine execute"
  - "linux-io-uring-async-engine verify"
---

# Linux Io Uring Async Engine Skill

The `linux-io-uring-async-engine` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Tokio / FileCRUD`.
...
- **Subsystem Binding**: `Native Tokio / FileCRUD`
...
```json
{
  "skill": "linux-io-uring-async-engine",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Native Tokio / FileCRUD",
