...
description: "Use this skill when architecting how Health Cloud connects to external EHR/EMR systems\
  \ via FHIR R4 \u2014 integration pattern selection, transformation layer design,\
  \ MuleSoft Accelerator usage, and EMR bidirectional sync topology. NOT for writing\
  \ the FHIR calls or HL7 v2 conversion in Apex \u2014 use apex/fhir-integration-patterns.\
  \ NOT for mapping a FHIR resource to an object \u2014 use data/fhir-data-mapping."
---
