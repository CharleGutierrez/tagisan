---
name: axe-core-a11y-wcag-compliance
description: "Automated accessibility auditing validating WCAG 2.2 AA contrast and ARIA roles"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Deque axe-core Docs"
tags:
  - a11y
  - axe
  - bun
...
triggers:
  ...
  - "axe-core-a11y-wcag-compliance"
  - "axe-core-a11y-wcag-compliance execute"
  - "axe-core-a11y-wcag-compliance verify"
  - "bun"
  - "compliance"
  - "core"
---

# Axe Core A11y Wcag Compliance Skill

The `axe-core-a11y-wcag-compliance` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Deque axe-core Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "axe-core-a11y-wcag-compliance",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Deque axe-core Docs",
