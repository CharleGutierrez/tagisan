---
name: ebpf-uprobe-userspace-tracer
description: "Userspace function symbol hooking for zero-overhead runtime telemetry"
version: 1.0.0
...
triggers:
  - "ebpf"
  - "ebpf uprobe userspace tracer"
  - "ebpf-io"
  - "ebpf-uprobe-userspace-tracer"
  - "ebpf-uprobe-userspace-tracer execute"
  - "ebpf-uprobe-userspace-tracer verify"
  - "hardware"
  - "kernel"
  - "low-level"
---

# Ebpf Uprobe Userspace Tracer Skill

The `ebpf-uprobe-userspace-tracer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **eBPF.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / aya-rs / Telemetry`.
...
- **Subsystem Binding**: `Native Rust / aya-rs / Telemetry`
...
```json
{
  "skill": "ebpf-uprobe-userspace-tracer",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "eBPF.io",
  "integration_target": "Native Rust / aya-rs / Telemetry",
