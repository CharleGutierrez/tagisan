...
description: "Use this skill when building or debugging headless B2C Commerce storefront order\
  \ submission using the Salesforce Commerce API (SCAPI) ShopAPI Orders endpoint or\
  \ the legacy OCAPI /orders resource \u2014 order creation, SLAS authentication for\
  \ shopper order access, order amendment, order status retrieval, and order-event\
  \ notifications and webhooks. NOT for OrderSummary, FulfillmentOrder, or other OMS\
  \ Connect API work \u2014 use admin/commerce-order-management. NOT for shopper login,\
  \ basket, or checkout calls \u2014 use apex/headless-commerce-api."
---
