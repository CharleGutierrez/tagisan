...
description: "Scheduled batch ERP sync \u2014 timing, idempotency, error queues, Bulk API vs REST\
  \ tradeoffs. Triggers: ERP sync schedule, nightly integration batch, ERP Salesforce\
  \ sync. NOT for event-driven sync \u2014 use integration/event-driven-architecture-patterns.\
  \ NOT for Bulk API job design \u2014 use data/bulk-api-patterns."
---
