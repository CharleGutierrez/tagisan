...
description: "Grant row-level access programmatically via __Share records when declarative sharing\
  \ rules cannot express the policy. NOT for OWD, role hierarchy, or criteria-based\
  \ sharing rule design \u2014 use admin/sharing-and-visibility."
---
