...
description: "Use when designing, reviewing, or debugging Salesforce Flows from an Admin perspective.\
  \ Triggers: 'flow', 'automation', 'record-triggered flow', 'screen flow', 'scheduled\
  \ flow', 'flow error', 'flow interview'. NOT for Flow debug mode, Run As user, or\
  \ Flow test suites \u2014 use flow/flow-debugging. NOT for building an OmniStudio\
  \ OmniScript \u2014 use omnistudio/omniscript-design-patterns."
---
