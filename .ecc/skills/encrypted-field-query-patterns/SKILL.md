...
description: "Design SOQL, filters, reporting, and indexes against Shield Platform Encryption fields.\
  \ Trigger keywords: Shield Platform Encryption, encrypted field query, probabilistic\
  \ vs deterministic encryption, encrypted SOQL filter. NOT for Classic Encryption\
  \ (deprecated), field-level security policy, or tenant secret k \u2014 use security/platform-encryption."
---
