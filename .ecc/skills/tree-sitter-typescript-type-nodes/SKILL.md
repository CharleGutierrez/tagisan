---
name: tree-sitter-typescript-type-nodes
description: "Syntax tree pattern matching for TypeScript interfaces, unions, and generics"
version: 1.0.0
...
triggers:
  ...
  - "nodes"
  - "sitter"
  - "tree sitter typescript type nodes"
  - "tree-sitter-typescript-type-nodes"
  - "tree-sitter-typescript-type-nodes execute"
  - "tree-sitter-typescript-type-nodes verify"
---

# Tree Sitter Typescript Type Nodes Skill

The `tree-sitter-typescript-type-nodes` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tree-sitter Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
```json
{
  "skill": "tree-sitter-typescript-type-nodes",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Tree-sitter Docs",
