---
name: sre-error-budget-burn-rate-alert
description: "Multiwindow multi-burn-rate alerting firing before SLO thresholds are breached"
version: 1.0.0
...
triggers:
  ...
  - "distributed"
  - "error"
  - "sre error budget burn rate alert"
  - "sre-error-budget-burn-rate-alert"
  - "sre-error-budget-burn-rate-alert execute"
  - "sre-error-budget-burn-rate-alert verify"
---

# Sre Error Budget Burn Rate Alert Skill

The `sre-error-budget-burn-rate-alert` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Google SRE Handbook** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Telemetry Module`.
...
```json
{
  "skill": "sre-error-budget-burn-rate-alert",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Google SRE Handbook",
