...
def generate_html(scan_dir):
    ...
    escaped_scan_name = escape_html(scan_name)
...
<head>
    ...
    <title>Security Scan Report - {escaped_scan_name}</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/marked/12.0.0/marked.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/dompurify/3.4.14/purify.min.js" integrity="sha512-+G1tsz5n01KTeX7oUT/Lm5P2B+n9RUogC98t4E8MseH9YUac2D2uPaNSbsYDOOSZr2YQ1BfeCxk8KXZXvhctEA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <style>
        :root {{
            --bg-primary: #ffffff;
            --bg-secondary: #f6f8fa;
...
<body>
    <div class="header">
        ...
        <div class="scan-id">{escaped_project_name}</div>
    </div>
    ...
    <div class="footer">
        Generated by Security Scan Power | {escaped_scan_name}
    </div>
