...
description: "Use this skill when configuring Health Cloud referral management: setting up ClinicalServiceRequest-based\
  \ referrals, provider search, referral status workflows, and network management.\
  \ NOT for referrals in Financial Services Cloud \u2014 use admin/fsc-referral-management.\
  \ NOT for care team workflow and transition-of-care design \u2014 use admin/care-coordination-requirements."
---
