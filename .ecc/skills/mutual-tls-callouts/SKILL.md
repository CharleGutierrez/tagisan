...
description: "Configure mTLS for Apex callouts using Named Credentials with client certificate\
  \ authentication. NOT for standard TLS or API key auth \u2014 use architect/integration-security-architecture."
---
# Mutual TLS Callouts
