...
description: "Use when analyzing B2C Commerce storefront metrics (conversion funnel, cart abandonment,\
  \ product performance, revenue trends) via the Business Manager Reports and Dashboards\
  \ app, or when deriving B2B Commerce analytics. NOT for CRM Analytics platform configuration,\
  \ Einstein Analytics, or Experience Cloud analytics \u2014 use data/analytics-data-governance."
---
