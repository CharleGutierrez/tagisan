...
description: "Use when configuring Remote Site Settings to allow Apex callouts to external URLs,\
  \ or distinguishing them from CSP Trusted Sites for Lightning component resource\
  \ loading. NOT for storing an endpoint and its auth as a Named Credential \u2014\
  \ use integration/named-credentials-setup. NOT for allow-listing a URL the browser\
  \ itself loads (script, iframe, fetch) \u2014 use security/csp-and-trusted-urls."
---
