...
description: "Use when designing or reviewing Lightning Web Components for slow initial load, heavy\
  \ rerenders, large-list rendering, payload reduction, and lazy instantiation choices\
  \ such as `lwc:if`, tabs, or dynamic components. Triggers: 'slow lwc', 'rerenders\
  \ too much', 'key index', 'dynamic import', 'large list lag'. NOT for 1,000+ row\
  \ lists \u2014 use lwc/lwc-virtualized-lists. NOT for a slow record page overall\
  \ \u2014 use admin/lightning-app-builder-advanced."
---
# LWC Performance
