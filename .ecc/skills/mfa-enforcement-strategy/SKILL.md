...
description: "Org-wide MFA rollout strategy, phased enablement, exception governance, and audit.\
  \ Triggers: MFA rollout plan, MFA policy, MFA governance. NOT for per-user-type\
  \ enforcement patterns \u2014 use security/mfa-enforcement-patterns."
---
