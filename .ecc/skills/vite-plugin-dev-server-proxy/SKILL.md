---
name: vite-plugin-dev-server-proxy
description: "Vite rollup-based bundling, ES module serving, and API proxy routing"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Vite Documentation (vite.dev)"
tags:
  - bun
  - dev
  - frontend
...
triggers:
  ...
  - "full-stack"
  - "plugin"
  - "vite plugin dev server proxy"
  - "vite-plugin-dev-server-proxy"
  - "vite-plugin-dev-server-proxy execute"
  - "vite-plugin-dev-server-proxy verify"
---

# Vite Plugin Dev Server Proxy Skill

The `vite-plugin-dev-server-proxy` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Vite Documentation (vite.dev)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Developer Experience`.
...
- **Subsystem Binding**: `Web Developer Experience`
...
```json
{
  "skill": "vite-plugin-dev-server-proxy",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Vite Documentation (vite.dev)",
  "integration_target": "Web Developer Experience",
