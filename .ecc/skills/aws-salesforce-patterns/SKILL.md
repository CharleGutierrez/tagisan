...
description: "AWS integration patterns for Salesforce \u2014 pick between Amazon AppFlow, Event\
  \ Relay \u2192 EventBridge, Amazon S3 ingestion paths, and direct Apex \u2192 Lambda\
  \ callouts. Decision matrix + AppFlow deep dive (Salesforce as source / destination,\
  \ OAuth Authorization-Code vs JWT, REST vs Bulk 2.0 API, 15 GB / run cap). NOT for\
  \ Azure \u2014 use integration/azure-salesforce-patterns. NOT for Event Relay setup\
  \ steps \u2014 use integration/event-relay-configuration."
---
