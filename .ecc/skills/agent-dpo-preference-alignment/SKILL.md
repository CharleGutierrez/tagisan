---
name: agent-dpo-preference-alignment
description: "Direct Preference Optimization scoring for ranking multi-agent code completions"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent dpo preference alignment"
  - "agent-dpo-preference-alignment"
  - "agent-dpo-preference-alignment execute"
  - "agent-dpo-preference-alignment verify"
  - "alignment"
  - "arxiv"
  - "consensus"
  - "debate"
...
# Agent Dpo Preference Alignment Skill

The `agent-dpo-preference-alignment` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Consensus Engine`.
...
```json
{
  "skill": "agent-dpo-preference-alignment",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
