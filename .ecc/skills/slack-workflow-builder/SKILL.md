...
description: "Use this skill when designing or troubleshooting Slack Workflow Builder workflows\
  \ that call Salesforce \u2014 especially the Salesforce connector step Run a Flow,\
  \ mapping inputs/outputs, handling failures, and understanding limits. Triggers\
  \ on: Slack Workflow Builder Salesforce, Run a Flow from Slack, autolaunched flow\
  \ from Slack, Slack automation calling Salesforce. NOT for sending a Slack message\
  \ or creating a channel FROM a Salesforce Flow \u2014 use flow/flow-for-slack. NOT\
  \ for first connecting the org to the Slack workspace \u2014 use integration/slack-salesforce-integration-setup."
---
