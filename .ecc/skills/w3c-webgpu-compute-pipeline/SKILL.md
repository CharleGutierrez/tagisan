---
name: w3c-webgpu-compute-pipeline
description: "WGSL compute shaders for in-browser matrix multiplication and image processing"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "W3C WebGPU Specification"
tags:
  - bun
  - compute
  - frontend
...
triggers:
  ...
  - "full-stack"
  - "pipeline"
  - "w3c webgpu compute pipeline"
  - "w3c-webgpu-compute-pipeline"
  - "w3c-webgpu-compute-pipeline execute"
  - "w3c-webgpu-compute-pipeline verify"
---

# W3c Webgpu Compute Pipeline Skill

The `w3c-webgpu-compute-pipeline` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **W3C WebGPU Specification** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Multimodal / Vision`.
...
- **Subsystem Binding**: `Multimodal / Vision`
...
```json
{
  "skill": "w3c-webgpu-compute-pipeline",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "W3C WebGPU Specification",
  "integration_target": "Multimodal / Vision",
