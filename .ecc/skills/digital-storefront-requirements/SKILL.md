...
description: "Use when gathering or evaluating requirements for a Salesforce Commerce Cloud digital\
  \ storefront \u2014 branding strategy, content management approach, personalization,\
  \ mobile experience, and accessibility compliance. Trigger keywords: SFRA branding,\
  \ PWA Kit storefront, composable storefront, storefront accessibility, WCAG Commerce\
  \ Cloud, overlay cartridge branding, mobile storefront, storefront personalization,\
  \ content slots. NOT for building the site in Business Manager \u2014 use admin/b2c-commerce-store-setup.\
  \ NOT for SCAPI design, Managed Runtime and caching strategy \u2014 use architect/headless-commerce-architecture."
---
