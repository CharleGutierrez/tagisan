---
name: agent-human-in-the-loop-interrupt
description: "Injecting human review pause points prior to irreversible filesystem or cloud mutations"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent human in the loop interrupt"
  - "agent-human-in-the-loop-interrupt"
  - "agent-human-in-the-loop-interrupt execute"
  - "agent-human-in-the-loop-interrupt verify"
  - "consensus"
  - "debate"
  - "human"
  - "interrupt"
...
# Agent Human In The Loop Interrupt Skill

The `agent-human-in-the-loop-interrupt` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LangGraph Documentation** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Safety Approval`.
...
- **Subsystem Binding**: `Safety Approval`
...
```json
{
  "skill": "agent-human-in-the-loop-interrupt",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "LangGraph Documentation",
  "integration_target": "Safety Approval",
