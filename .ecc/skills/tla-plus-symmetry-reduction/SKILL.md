---
name: tla-plus-symmetry-reduction
description: "Symmetry set permutations to prune combinatorial state explosion during TLC checks"
version: 1.0.0
...
triggers:
  ...
  - "plus"
  - "reduction"
  - "tla plus symmetry reduction"
  - "tla-plus-symmetry-reduction"
  - "tla-plus-symmetry-reduction execute"
  - "tla-plus-symmetry-reduction verify"
---

# Tla Plus Symmetry Reduction Skill

The `tla-plus-symmetry-reduction` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **TLA+ Foundation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `TLA+ Consensus Checker`.
...
- **Subsystem Binding**: `TLA+ Consensus Checker`
...
```json
{
  "skill": "tla-plus-symmetry-reduction",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "TLA+ Foundation",
  "integration_target": "TLA+ Consensus Checker",
