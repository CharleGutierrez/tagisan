---
name: agent-sliding-window-attention-pruning
description: "Evicting low-attention conversational tokens to maintain bounded context latency"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent sliding window attention pruning"
  - "agent-sliding-window-attention-pruning"
  - "agent-sliding-window-attention-pruning execute"
  - "agent-sliding-window-attention-pruning verify"
  - "ai"
  - "attention"
  - "consensus"
  - "debate"
...
# Agent Sliding Window Attention Pruning Skill

The `agent-sliding-window-attention-pruning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Context Manager`.
...
- **Subsystem Binding**: `Context Manager`
...
```json
{
  "skill": "agent-sliding-window-attention-pruning",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "AI Research",
  "integration_target": "Context Manager",
