...
description: "Use when designing or reviewing list views, compact layouts, highlights panels, and\
  \ search-result presentation so users can scan, find, and act on records quickly\
  \ across desktop and mobile. Triggers: 'too many list views', 'compact layout not\
  \ showing the right fields', 'search layouts vs list views', 'mobile highlights\
  \ panel'. NOT for page layouts or record types \u2014 use admin/record-types-and-page-layouts.\
  \ NOT for Dynamic Forms \u2014 use admin/dynamic-forms-and-actions."
---
