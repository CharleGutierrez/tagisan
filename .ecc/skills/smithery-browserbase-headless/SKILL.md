---
name: smithery-browserbase-headless
description: "Cloud headless Chromium fleet with automated anti-bot bypass and scraping"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery browserbase headless"
  - "smithery-browserbase-headless"
  - "smithery-browserbase-headless execute"
  - "smithery-browserbase-headless verify"
---

# Smithery Browserbase Headless Skill

The `smithery-browserbase-headless` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-browserbase-headless",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
