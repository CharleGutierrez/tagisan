---
name: libloading-ffi-symbol-lookup
description: "Dynamic shared object (.so/.dll) loading and C-ABI function symbol binding"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "libloading Docs (docs.rs)"
tags:
  - ast
  - compiler
  - ffi
...
triggers:
  ...
  - "formal-methods"
  - "libloading"
  - "libloading ffi symbol lookup"
  - "libloading-ffi-symbol-lookup"
  - "libloading-ffi-symbol-lookup execute"
  - "libloading-ffi-symbol-lookup verify"
---

# Libloading Ffi Symbol Lookup Skill

The `libloading-ffi-symbol-lookup` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **libloading Docs (docs.rs)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Plugin Tier D (Native)`.
...
- **Subsystem Binding**: `Plugin Tier D (Native)`
...
```json
{
  "skill": "libloading-ffi-symbol-lookup",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "libloading Docs (docs.rs)",
  "integration_target": "Plugin Tier D (Native)",
