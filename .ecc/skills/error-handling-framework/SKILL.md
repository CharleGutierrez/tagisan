...
description: "Use when designing a cross-cutting Apex error handling framework: custom exception\
  \ hierarchies, centralized rollback-safe logging via Platform Events, BatchApexErrorEvent\
  \ processing, correlation ID threading across async, Error_Log__c design, AuraHandledException\
  \ boundary. NOT for a single try/catch or DmlException question \u2014 use apex/exception-handling.\
  \ NOT for dead-letter, circuit-breaker and event-replay design in an integration\
  \ \u2014 use integration/error-handling-in-integrations."
---
