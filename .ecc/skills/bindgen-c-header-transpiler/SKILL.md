---
name: bindgen-c-header-transpiler
description: "Automated C header file parsing and idiomatic Rust extern "C" binding generation"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "rust-bindgen Docs"
tags:
  - ast
  - bindgen
  - compiler
...
triggers:
  - "ast"
  - "bindgen"
  - "bindgen c header transpiler"
  - "bindgen-c-header-transpiler"
  - "bindgen-c-header-transpiler execute"
  - "bindgen-c-header-transpiler verify"
  - "compiler"
  - "formal-methods"
  - "header"
---

# Bindgen C Header Transpiler Skill

The `bindgen-c-header-transpiler` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **rust-bindgen Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Baremetal / HardwareEngine`.
...
- **Subsystem Binding**: `Baremetal / HardwareEngine`
...
```json
{
  "skill": "bindgen-c-header-transpiler",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "rust-bindgen Docs",
  "integration_target": "Baremetal / HardwareEngine",
