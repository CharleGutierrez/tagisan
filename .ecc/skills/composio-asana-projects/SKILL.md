---
name: composio-asana-projects
description: "Asana portfolio project tracking, milestone updates, and dependency graphs"
version: 1.0.0
...
triggers:
  ...
  - "asana"
  - "composio"
  - "composio asana projects"
  - "composio-asana-projects"
  - "composio-asana-projects execute"
  - "composio-asana-projects verify"
  - "composio-dev"
  - "enterprise"
---

# Composio Asana Projects Skill

The `composio-asana-projects` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
