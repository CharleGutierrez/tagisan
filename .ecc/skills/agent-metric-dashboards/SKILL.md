...
description: "Build the executive KPI dashboard for Agentforce: adoption, deflection, latency,\
  \ cost, quality \u2014 KPI definitions, data sources, CRM Analytics lenses, alert\
  \ thresholds. NOT for the platform's own session tracing, Agent Analytics and health\
  \ monitoring \u2014 use agentforce/agentforce-observability. NOT for scoring agent\
  \ answer quality offline \u2014 use agentforce/agentforce-eval-harness."
---
