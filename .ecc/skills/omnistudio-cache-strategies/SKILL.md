...
description: "Configure caching on DataRaptors and Integration Procedures for response-time gains.\
  \ Triggers: OmniStudio cache, DataRaptor cache, IP cache TTL. NOT for IP-specific\
  \ cacheable design \u2014 use omnistudio/integration-procedure-cacheable-patterns."
---
