...
description: "Use when diagnosing failures, unexpected output, or silent errors in OmniScript,\
  \ DataRaptor, or Integration Procedure assets. Triggers: 'omniscript not working',\
  \ 'dataraptor returns empty', 'integration procedure. NOT for Apex debugging, LWC\
  \ console errors unrelated to OmniStudio, or Flow fault path d \u2014 use omnistudio/omnistudio-performance."
---
