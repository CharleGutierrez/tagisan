...
description: "Use when analyzing Experience Cloud site analytics including login metrics, member\
  \ engagement, page view tracking, and content performance. Triggers: Experience\
  \ Cloud site analytics, community member engagement data, portal login tracking,\
  \ page view reports community, GA4 Experience Cloud integration. NOT for CRM Analytics\
  \ / Tableau CRM \u2014 use admin/einstein-analytics-basics. NOT for designing reputation\
  \ levels and the engagement program itself \u2014 use admin/community-engagement-strategy."
---
