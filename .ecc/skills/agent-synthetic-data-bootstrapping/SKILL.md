---
name: agent-synthetic-data-bootstrapping
description: "Bootstrapping domain instruction datasets using high-capability teacher models"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent synthetic data bootstrapping"
  - "agent-synthetic-data-bootstrapping"
  - "agent-synthetic-data-bootstrapping execute"
  - "agent-synthetic-data-bootstrapping verify"
  - "anthropic"
  - "bootstrapping"
  - "consensus"
  - "data"
...
# Agent Synthetic Data Bootstrapping Skill

The `agent-synthetic-data-bootstrapping` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Anthropic Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Dataset Generator`.
...
- **Subsystem Binding**: `Dataset Generator`
...
```json
{
  "skill": "agent-synthetic-data-bootstrapping",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Anthropic Research",
  "integration_target": "Dataset Generator",
