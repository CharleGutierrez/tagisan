---
name: selinux-type-enforcement-context
description: "Auditing SELinux security contexts and type enforcement transitions on Fedora/RHEL"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "SELinux Project Reference"
tags:
  - agentshield
  - context
  - defense
...
triggers:
  ...
  - "edr"
  - "enforcement"
  - "selinux type enforcement context"
  - "selinux-type-enforcement-context"
  - "selinux-type-enforcement-context execute"
  - "selinux-type-enforcement-context verify"
---

# Selinux Type Enforcement Context Skill

The `selinux-type-enforcement-context` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SELinux Project Reference** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Linux`.
...
- **Subsystem Binding**: `AgentShield / Linux`
...
```json
{
  "skill": "selinux-type-enforcement-context",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "SELinux Project Reference",
  "integration_target": "AgentShield / Linux",
