---
name: postman-honeycomb-traces
description: "Honeycomb high-cardinality distributed trace query and anomaly markers"
version: 1.0.0
...
triggers:
  ...
  - "honeycomb"
  - "postman"
  - "postman honeycomb traces"
  - "postman-honeycomb-traces"
  - "postman-honeycomb-traces execute"
  - "postman-honeycomb-traces verify"
  - "saas"
---

# Postman Honeycomb Traces Skill

The `postman-honeycomb-traces` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-honeycomb-traces",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
