---
name: riscv-vector-extension-rvv
description: "RISC-V standard vector extension (RVV 1.0) matrix assembly kernels"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "performance"
  - "riscv vector extension rvv"
  - "riscv-vector-extension-rvv"
  - "riscv-vector-extension-rvv execute"
  - "riscv-vector-extension-rvv verify"
---

# Riscv Vector Extension Rvv Skill

The `riscv-vector-extension-rvv` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **RISC-V ISA Specification** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Baremetal / QEMU Emulator`.
...
```json
{
  "skill": "riscv-vector-extension-rvv",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "RISC-V ISA Specification",
