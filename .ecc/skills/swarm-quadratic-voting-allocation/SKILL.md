---
name: swarm-quadratic-voting-allocation
description: "Quadratic token budget allocation to prioritize critical bug fixes during triage"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Mechanism Design / ArXiv"
tags:
  - allocation
  - consensus
  - debate
...
triggers:
  ...
  - "mechanism"
  - "moa"
  - "swarm quadratic voting allocation"
  - "swarm-quadratic-voting-allocation"
  - "swarm-quadratic-voting-allocation execute"
  - "swarm-quadratic-voting-allocation verify"
---

# Swarm Quadratic Voting Allocation Skill

The `swarm-quadratic-voting-allocation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Mechanism Design / ArXiv** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Consensus Voting Engine`.
...
```json
{
  "skill": "swarm-quadratic-voting-allocation",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Mechanism Design / ArXiv",
