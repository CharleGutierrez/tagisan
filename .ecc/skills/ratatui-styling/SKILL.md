...
description: "CRITICAL: Use for ratatui styling, colors, and text. Triggers on: Style, Color, Modifier, Stylize, Span, Line, Text, fg, bg, bold, italic, underline, red, green, blue, yellow, \"ratatui color\", \"ratatui style\", \"styled text\", \"text styling\", 样式, 颜色, 字体, 加粗, 斜体, 下划线, ratatui 颜色, ratatui 样式"
---
