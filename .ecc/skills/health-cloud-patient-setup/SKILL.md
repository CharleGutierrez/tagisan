...
description: 'Configure patient or member records in Salesforce Health Cloud: Person Account enablement,
  patient record types, care team role configuration, patient card customization,
  clinical data display. Trigger keywords: patient setup, Health Cloud person account,
  patient card component, care team roles, clinical data display. NOT for Person Accounts
  outside Health Cloud - use data/person-accounts. NOT for enrolling a patient into
  a care program - use admin/care-program-management.'
---
