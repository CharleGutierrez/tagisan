...
description: "Diagnose why a request was blocked by Alibaba Cloud WAF. Retrieves block logs, identifies\
  \ the triggering rule, and provides remediation guidance. Supports disabling problematic\
  \ rules and managing WAF log collection settings. Use when users report being blocked\
  \ by WAF, encounter 405/block error pages, see \"Your request has been blocked\"\
  \ messages, or need to investigate and fix WAF interception issues. Trigger words:\
  \ \"WAF block query\", \"blocked by WAF\", \"405 troubleshooting\", \"request blocked\"\
  , \"checkresponse\", \"intercept query\", \"WAF\u62E6\u622A\", \"\u88ABWAF\u62E6\
  \u622A\", \"disable WAF rule\", \"enable WAF log\""
---
