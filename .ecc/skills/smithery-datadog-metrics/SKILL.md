---
name: smithery-datadog-metrics
description: "APM trace querying, metric dashboard evaluation, and alert verification"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery datadog metrics"
  - "smithery-datadog-metrics"
  - "smithery-datadog-metrics execute"
  - "smithery-datadog-metrics verify"
---

# Smithery Datadog Metrics Skill

The `smithery-datadog-metrics` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-datadog-metrics",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
