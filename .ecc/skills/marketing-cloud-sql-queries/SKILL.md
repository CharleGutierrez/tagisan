...
description: "Use this skill when writing, debugging, or optimizing SQL Query Activities in Salesforce\
  \ Marketing Cloud Automation Studio. Trigger keywords: SFMC SQL, Marketing Cloud\
  \ query activity, system data views, _Sent _Open _Click, Automation Studio SQL,\
  \ SELECT INTO data extension. NOT for the schema, fields, and retention of the _Sent\
  \ / _Open / _Click data views themselves \u2014 use apex/marketing-cloud-data-views.\
  \ NOT for tuning a slow SOQL query against Salesforce CRM sObjects \u2014 use data/soql-query-optimization."
---
