---
name: cursor-rules-svelte-5-runes
description: "Svelte 5 $state, $derived, and $effect runes for fine-grained reactive stores"
version: 1.0.0
...
triggers:
  - "bun"
  - "cursor"
  - "cursor rules svelte 5 runes"
  - "cursor-rules-svelte-5-runes"
  - "cursor-rules-svelte-5-runes execute"
  - "cursor-rules-svelte-5-runes verify"
  - "frontend"
  - "full-stack"
  - "rules"
---

# Cursor Rules Svelte 5 Runes Skill

The `cursor-rules-svelte-5-runes` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-svelte-5-runes",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
