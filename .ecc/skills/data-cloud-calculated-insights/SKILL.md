...
description: 'Create, design, and maintain Calculated Insights in Data Cloud: SQL authoring, dimension
  and measure definition, scheduling, streaming insights. Trigger keywords: calculated
  insight, CI SQL, insight measure, insight dimension, streaming insight, insight
  schedule, Data Cloud metric, insight refresh. NOT for segment filters, audiences
  and activation - use admin/data-cloud-segmentation. NOT for ingestion, DLO to DMO
  mapping and identity resolution - use data/data-cloud-data-streams.'
---
