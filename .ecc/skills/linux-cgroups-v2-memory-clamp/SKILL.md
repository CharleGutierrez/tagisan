---
name: linux-cgroups-v2-memory-clamp
description: "Control Group v2 memory.high and memory.max hard limits preventing OOM freezes"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux cgroups v2 memory clamp"
  - "linux-cgroups-v2-memory-clamp"
  - "linux-cgroups-v2-memory-clamp execute"
  - "linux-cgroups-v2-memory-clamp verify"
---

# Linux Cgroups V2 Memory Clamp Skill

The `linux-cgroups-v2-memory-clamp` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Engine / ProcessManager`.
...
- **Subsystem Binding**: `Engine / ProcessManager`
...
```json
{
  "skill": "linux-cgroups-v2-memory-clamp",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Engine / ProcessManager",
