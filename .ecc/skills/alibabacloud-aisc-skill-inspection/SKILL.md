...
description: "Submit Alibaba Cloud AISC Skill file security scans, poll scan tasks, diagnose API\
  \ or upload failures, and interpret scan reports for malicious code, prompt injection,\
  \ hardcoded credentials, sensitive data, risky configuration, and other Skill package\
  \ security findings. Use when the user asks whether a Skill package or Skill file\
  \ is safe, wants to scan/check/detect a Skill package, provides one or more Skill\
  \ download URLs for AISC security detection, asks to run or poll CreateSkillFileCheck/ListSubTasks,\
  ...
  \ scanning. Trigger phrases include AISC scan, Skill security check, Skill file\
  \ check, Skill \u5B89\u5168\u68C0\u6D4B, Skill \u6587\u4EF6\u5B89\u5168\u626B\u63CF\
  , \u626B\u63CF Skill \u5305, \u68C0\u6D4B Skill \u662F\u5426\u5B89\u5168, and \u68C0\
  \u67E5 Skill \u6587\u4EF6\u6709\u6CA1\u6709\u6076\u610F\u4EE3\u7801/\u654F\u611F\
  \u51ED\u636E/prompt \u6CE8\u5165."
---
