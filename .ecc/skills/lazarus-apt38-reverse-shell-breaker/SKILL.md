---
name: lazarus-apt38-reverse-shell-breaker
description: "Detecting /dev/tcp, mkfifo netcat, and python pty interactive reverse shell signatures"
version: 1.0.0
...
triggers:
  ...
  - "cyber"
  - "defense"
  - "lazarus apt38 reverse shell breaker"
  - "lazarus-apt38-reverse-shell-breaker"
  - "lazarus-apt38-reverse-shell-breaker execute"
  - "lazarus-apt38-reverse-shell-breaker verify"
---

# Lazarus Apt38 Reverse Shell Breaker Skill

The `lazarus-apt38-reverse-shell-breaker` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cyber Threat Intelligence** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield APT Defense`.
...
- **Subsystem Binding**: `AgentShield APT Defense`
...
```json
{
  "skill": "lazarus-apt38-reverse-shell-breaker",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Cyber Threat Intelligence",
  "integration_target": "AgentShield APT Defense",
