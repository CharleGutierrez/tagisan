...
description: "Configure and manage Field Service Lightning work orders: work types, work order\
  \ line items, service appointments, status flow, and auto-creation via maintenance\
  \ plans. NOT for choosing which technician gets the appointment (work rules, scheduling\
  \ policies) \u2014 use admin/fsl-scheduling-policies. NOT for setting up the technicians,\
  \ their skills or capacity \u2014 use admin/fsl-resource-management."
---
