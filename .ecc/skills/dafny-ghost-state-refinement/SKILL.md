---
name: dafny-ghost-state-refinement
description: "Ghost variables and ghost methods for specifying abstract behavioral invariants"
version: 1.0.0
...
triggers:
  ...
  - "compiler"
  - "dafny"
  - "dafny ghost state refinement"
  - "dafny-ghost-state-refinement"
  - "dafny-ghost-state-refinement execute"
  - "dafny-ghost-state-refinement verify"
  - "formal-methods"
  - "ghost"
---

# Dafny Ghost State Refinement Skill

The `dafny-ghost-state-refinement` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Dafny Language Reference** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "dafny-ghost-state-refinement",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Dafny Language Reference",
