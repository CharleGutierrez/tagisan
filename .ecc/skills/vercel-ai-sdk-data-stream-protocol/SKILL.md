---
name: vercel-ai-sdk-data-stream-protocol
description: "Encoding tool calls, text deltas, and metadata into standardized SSE data streams"
version: 1.0.0
...
triggers:
  ...
  - "vercel-ai-sdk-data-stream-protocol"
  - "vercel-ai-sdk-data-stream-protocol execute"
  - "vercel-ai-sdk-data-stream-protocol verify"
---

# Vercel Ai Sdk Data Stream Protocol Skill

The `vercel-ai-sdk-data-stream-protocol` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Vercel AI SDK Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Ollama / HTTP Daemon`.
...
- **Subsystem Binding**: `Ollama / HTTP Daemon`
...
```json
{
  "skill": "vercel-ai-sdk-data-stream-protocol",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Vercel AI SDK Docs",
  "integration_target": "Ollama / HTTP Daemon",
