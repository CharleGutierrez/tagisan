...
description: "Use when designing, governing, or troubleshooting Slack Connect channel sharing between\
  \ two independent organizations. Trigger phrases: external Slack channel collaboration,\
  \ cross-org Slack channel setup. NOT for Salesforce for Slack app setup or internal\
  \ single-workspace channels \u2014 use integration/slack-salesforce-integration-setup."
---
