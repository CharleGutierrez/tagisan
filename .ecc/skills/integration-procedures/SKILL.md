...
description: "Use when building, reviewing, or debugging OmniStudio Integration Procedures. Triggers:\
  \ 'integration procedure', 'IP', 'HTTP action', 'DataRaptor', 'rollbackOnError',\
  \ 'failureResponse'. Triggers: 'integration procedure'. NOT for Apex-only integrations\
  \ unless the main design choice is whether OmniStudio is st \u2014 use omnistudio/omnistudio-security."
---
