...
description: "Migrating Visualforce pages and components to Lightning Web Components: controller-to-Apex-method\
  \ translation, viewstate replacement, custom URL parameter handling, PageReference-to-NavigationMixin\
  \ mapping, Lightning Out. NOT for new LWC development from scratch (use lwc-fundamentals)\
  \ or Aura-to-LWC migration \u2014 use lwc/navigation-and-routing."
---
