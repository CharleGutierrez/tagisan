...
description: "Use when writing Apex that validates, extracts, or transforms strings with Pattern/Matcher\
  \ or String regex methods. Covers catastrophic backtracking, the 1M char input cap,\
  \ anchored vs unanchored matching, and replaceAll reserved `$`/`\\` chars. NOT for\
  \ String.split or String.format \u2014 use apex/apex-string-and-regex. NOT for Flow\
  \ REGEX() \u2014 use flow/flow-formula-and-expression-patterns."
---
