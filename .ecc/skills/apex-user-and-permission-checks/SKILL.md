...
description: "Use when Apex needs to check what the running user is, can see, or can do \u2014\
  \ via UserInfo, FeatureManagement, FeatureManagement.checkPermission, or FeatureManagement.checkPermissionType.\
  \ Covers custom permissions, permission sets, user licenses, and profile checks.\
  \ NOT for CRUD/FLS enforcement \u2014 use apex/apex-stripinaccessible-and-fls-enforcement.\
  \ NOT for creating or assigning custom permissions in Setup \u2014 use admin/custom-permissions."
---
