---
name: postman-splunk-oncall
description: "Splunk On-Call (VictorOps) routing keys, incident logs, and timeline posts"
version: 1.0.0
...
triggers:
  ...
  - "oncall"
  - "postman"
  - "postman splunk oncall"
  - "postman-splunk-oncall"
  - "postman-splunk-oncall execute"
  - "postman-splunk-oncall verify"
  - "saas"
---

# Postman Splunk Oncall Skill

The `postman-splunk-oncall` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
