---
name: rate-limiter-leaky-bucket-traffic
description: "Smooth rate-limiting queue ensuring steady egress request cadence to LLM providers"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "Distributed Rate Limiting Specs"
tags:
  - bucket
  - distributed
  - leaky
...
triggers:
  ...
  - "limiter"
  - "opentelemetry"
  - "rate limiter leaky bucket traffic"
  - "rate-limiter-leaky-bucket-traffic"
  - "rate-limiter-leaky-bucket-traffic execute"
  - "rate-limiter-leaky-bucket-traffic verify"
---

# Rate Limiter Leaky Bucket Traffic Skill

The `rate-limiter-leaky-bucket-traffic` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Distributed Rate Limiting Specs** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Provider Hub`.
...
```json
{
  "skill": "rate-limiter-leaky-bucket-traffic",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Distributed Rate Limiting Specs",
