...
description: "Standards for Salesforce dev documentation \u2014 README, ADR, runbook, release note\
  \ templates. Triggers: dev documentation standards, ADR template, runbook Salesforce.\
  \ NOT for automated release notes \u2014 use devops/release-notes-automation."
---
