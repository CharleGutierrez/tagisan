...
description: 'Use when building a Lightning record page in App Builder or when the page users see
  is not the one you assigned. Trigger keywords: configure lightning record page,
  lightning app builder, flexipage, record page assignment, org default vs app default,
  activate lightning page. NOT for page speed - use admin/lightning-page-performance-tuning.
  NOT for page layout to Dynamic Forms migration - use admin/dynamic-forms-migration.
  NOT for related list columns - use admin/related-list-configuration.'
---
