...
description: "Use this skill when configuring object-specific quick actions or global actions in\
  \ Salesforce: choosing between action types, editing action layouts, pre-filling\
  \ fields with predefined values, and adding actions to Lightning page layouts or\
  \ mobile navigation. Trigger keywords: quick action, global action, action layout,\
  \ pre-fill fields, predefined values, Salesforce mobile actions. NOT for building\
  \ an LWC that runs as a quick action \u2014 use lwc/lwc-quick-actions. NOT for converting\
  \ Classic JavaScript or URL buttons \u2014 use admin/custom-button-to-action-migration."
---
