...
description: "Use this skill when identifying, querying, or troubleshooting the built-in system\
  \ data views in Salesforce Marketing Cloud (_Sent, _Open, _Click, _Bounce, _Subscribers,\
  \ _Job). Trigger keywords: SFMC system data views, underscore data views, _Subscribers\
  \ status, _Job metadata, data retention marketing cloud, data view schema, MC engagement\
  \ reporting SQL. NOT for writing or debugging the Query Activity SQL itself \u2014\
  \ use data/marketing-cloud-sql-queries. NOT for designing the target Data Extension\
  \ the query writes into \u2014 use data/data-extension-design."
---
