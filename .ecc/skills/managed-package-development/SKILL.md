...
description: "Building or maintaining Salesforce first-generation managed packages (1GP) for ISV\
  \ distribution: namespace registration, packaging org structure, PostInstall/UninstallHandler\
  \ Apex, push upgrades, Flow version management, subscriber org considerations. NOT\
  \ for choosing between unmanaged, unlocked, 1GP and 2GP \u2014 use devops/package-development-strategy.\
  \ NOT for 2GP packaging \u2014 use devops/second-generation-managed-packages."
---
