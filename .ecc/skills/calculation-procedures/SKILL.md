...
description: "Build and troubleshoot Calculation Procedures (Expression Sets) and Calculation Matrices.\
  \ Triggers: calculation procedure, expression set, calculation matrix, decision\
  \ matrix, pricing calculation, lookup step, matrix versioning. NOT for pricing/rating\
  \ design decisions \u2014 use omnistudio/calculation-procedure-design."
---
