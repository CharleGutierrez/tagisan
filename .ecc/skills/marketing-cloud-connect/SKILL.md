...
description: "Use this skill when configuring or troubleshooting Marketing Cloud Connect (MC Connect)\
  \ \u2014 the managed package that links a Salesforce org to a Marketing Cloud account.\
  \ Covers connector user setup, synchronized data sources, scope configuration, tracking\
  \ sync, and triggered sends. NOT for MCAE/Pardot connector setup \u2014 use admin/mcae-pardot-setup.\
  \ NOT for synced data extension failures \u2014 use data/marketing-cloud-data-sync."
---
