---
name: composio-monday-boards
description: "Monday.com work OS board column updates, item groups, and status triggers"
version: 1.0.0
...
triggers:
  ...
  - "boards"
  - "composio"
  - "composio monday boards"
  - "composio-dev"
  - "composio-monday-boards"
  - "composio-monday-boards execute"
  - "composio-monday-boards verify"
  - "enterprise"
---

# Composio Monday Boards Skill

The `composio-monday-boards` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
