...
description: "Use when conducting a formal Salesforce Well-Architected Framework (WAF) review of\
  \ an org or solution design. Covers all three pillars: Trusted (security, compliance),\
  \ Easy (user experience, adoption), and Adaptable (scalability, maintainability).\
  \ Produces a structured assessment with findings and recommendations. Triggers:\
  \ well-architected review, WAF assessment, org architecture review, architecture\
  \ health check, trusted easy adaptable. NOT for a security-only deep-dive \u2014\
  \ use architect/security-architecture-review. NOT for a dead-code and automation-overlap\
  \ audit \u2014 use architect/technical-debt-assessment."
---
