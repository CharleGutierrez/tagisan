---
name: mitre-t1055-process-injection-blocker
description: "Blocking ptrace, process_vm_writev, and /proc/$PID/mem tampering by spawned tools"
version: 1.0.0
...
triggers:
  ...
  - "edr"
  - "injection"
  - "mitre t1055 process injection blocker"
  - "mitre-t1055-process-injection-blocker"
  - "mitre-t1055-process-injection-blocker execute"
  - "mitre-t1055-process-injection-blocker verify"
---

# Mitre T1055 Process Injection Blocker Skill

The `mitre-t1055-process-injection-blocker` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Seccomp`.
...
- **Subsystem Binding**: `AgentShield / Seccomp`
...
```json
{
  "skill": "mitre-t1055-process-injection-blocker",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "AgentShield / Seccomp",
