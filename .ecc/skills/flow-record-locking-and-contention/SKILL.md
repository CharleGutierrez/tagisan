...
description: "Diagnose and prevent UNABLE_TO_LOCK_ROW + parent-record contention in record-triggered,\
  \ scheduled, and screen flows by mapping the implicit lock chain and applying decouple\
  \ patterns (Platform Events, Queueable handoff, Scheduled Paths). NOT for general\
  \ flow bulkification \u2014 see flow-bulkification \u2014 use apex/record-locking-and-contention."
---
