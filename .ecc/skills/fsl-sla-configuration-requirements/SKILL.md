...
description: "Use this skill to configure SLA enforcement for Salesforce Field Service (FSL) using\
  \ Work Order entitlement processes: designing entitlement processes of type Work\
  \ Order, defining FSL milestones (response time, on-site arrival, resolution), wiring\
  \ milestone actions, and aligning Business Hours with service territory Operating\
  \ Hours. NOT for Case SLAs and Case entitlement processes \u2014 use admin/entitlements-and-milestones.\
