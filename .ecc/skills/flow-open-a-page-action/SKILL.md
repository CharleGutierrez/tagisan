...
description: "Use when a Screen Flow needs to send the user to another page \u2014 the native Open\
  \ a Page action (Summer '26) that opens a Salesforce record or an external URL directly\
  \ from a flow. NOT for launching or embedding a flow \u2014 use flow/screen-flows.\
  \ NOT for a custom navigation LWC \u2014 use flow/flow-screen-lwc-components."
---
