...
description: "Education Cloud (EDA \u2014 Education Data Architecture) setup: student success hub,\
  \ advisor workflows, enrollment management, academic data model. NOT for the EDA\
  \ object model in depth (Affiliations, Course_Connection__c) \u2014 use data/eda-data-model-and-patterns.\
  \ NOT for SIS enrollment sync \u2014 use integration/sis-integration-patterns."
---
