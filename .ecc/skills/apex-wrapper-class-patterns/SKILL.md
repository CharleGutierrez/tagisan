...
description: "Use when designing wrapper or inner classes in Apex to combine SObjects with computed\
  \ fields, shape data for LWC consumption, or sort collections with Comparable or\
  \ Comparator. Trigger keywords: wrapper class, inner class, Comparable, Comparator,\
  \ @AuraEnabled fields, @JsonAccess. NOT for JSON serialization mechanics \u2014\
  \ use apex/apex-json-serialization. NOT for LWC data-binding patterns \u2014 use\
