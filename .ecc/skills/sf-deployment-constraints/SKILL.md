...
description: "Enforce deployment safety \u2014 validation-only first, test coverage gates, metadata\
  \ ordering, rollback readiness. Use when deploying or packaging ANY Salesforce metadata.\
  \ Do NOT use for local dev or scratch org pushes."
---
