...
description: "Design Calculation Procedures and Matrices for pricing, rating, and rules-heavy scoring.\
  \ Triggers: calculation procedure, calculation matrix, expression set, decision\
  \ matrix. NOT for Salesforce CPQ price rules \u2014 use admin/cpq-pricing-rules.\
  \ NOT for Flow decision logic \u2014 use flow/flow-decision-element-patterns."
---
