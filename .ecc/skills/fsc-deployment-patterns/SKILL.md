...
description: "Use when planning or executing metadata deployments for Financial Services Cloud\
  \ (FSC) \u2014 including Person Account enablement sequencing, Account record-type\
  \ ordering, Compliant Data Sharing (CDS) activation. NOT for general metadata deployment\
  \ (use devops/pre-deployment-checklist) or FSC architecture \u2014 use architect/fsc-architecture-patterns."
---
