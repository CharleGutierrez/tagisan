---
name: sf-apex-cursor
description: "Apex Cursor API for paginating large SOQL results (up to 50M records) \u2014 cursor\
  \ navigation, Queueable chaining, LWC pagination. Use when paginating queries or\
  \ migrating from OFFSET. Do NOT use for small result sets."
---
# Apex Cursor
