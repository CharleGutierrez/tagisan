...
description: "Enable Microsoft Teams for Employee Service (ITSM) in Salesforce \u2014 the Salesforce\
  \ Go feature service-cloud-itsm-teams-integration gating Teams-based IT Desk and\
  \ IT Service collaboration. Use this for: 'enable Teams for employee service', 'turn\
  \ on ITSM Teams integration', 'enable Microsoft Teams for IT Service', 'set up Salesforce\
  \ IT Desk Teams app', 'enable ITSMTeamsEnabled', 'why can't I enable the Teams org\
  \ preference', or any request to enable/verify this Salesforce Go feature. DO NOT\
  \ TRIGGER for configuring the TeamsNotifications notification-channel preference\
  \ or for enabling the Swarming feature itself (service-itsm-swarming-configure)."
---
