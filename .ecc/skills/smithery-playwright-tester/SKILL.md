---
name: smithery-playwright-tester
description: "Multi-browser E2E testing, trace recording, and accessibility checks"
version: 1.0.0
...
triggers:
  ...
  - "playwright"
  - "smithery"
  - "smithery playwright tester"
  - "smithery-ai"
  - "smithery-playwright-tester"
  - "smithery-playwright-tester execute"
  - "smithery-playwright-tester verify"
---

# Smithery Playwright Tester Skill

The `smithery-playwright-tester` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-playwright-tester",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
