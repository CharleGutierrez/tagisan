---
name: smithery-chroma-db
description: "Embedded vector collection storage, document embeddings, and querying"
version: 1.0.0
...
triggers:
  ...
  - "smithery-ai"
  - "smithery-chroma-db"
  - "smithery-chroma-db execute"
  - "smithery-chroma-db verify"
---

# Smithery Chroma Db Skill

The `smithery-chroma-db` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / VectorStoreBackend`.
