...
description: "Design the engagement model for an Experience Cloud community: reputation levels,\
  \ ideation, and content contribution strategy. Triggers: 'community engagement strategy',\
  \ 'gamification Experience Cloud', 'reputation levels setup', 'ideation community\
  \ portal', 'member recognition program'. NOT for blocking, flagging or approving\
  \ what members post \u2014 use admin/experience-cloud-moderation. NOT for measuring\
  \ logins, page views or engagement after launch \u2014 use data/community-analytics-data."
---
