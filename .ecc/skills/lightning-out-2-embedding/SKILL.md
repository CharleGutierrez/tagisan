...
description: "Use when embedding a custom Lightning web component into an external, non-Salesforce\
  \ web app (React, Angular, Vue, or plain JavaScript) with Lightning Out 2.0 \u2014\
  \ the Winter '26 GA feature built on Lightning Web Runtime that renders each. NOT\
  \ for the legacy Aura-based Lightning Out (beta) or its $Lightning \u2014 use lwc/tableau-embedding-in-lightning."
---
