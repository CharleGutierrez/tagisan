---
name: nvme-atomic-write-units
description: "NVMe Atomic Write Unit Normal (AWUN) verification for crash-consistent database commits"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "nvm"
  - "nvme atomic write units"
  - "nvme-atomic-write-units"
  - "nvme-atomic-write-units execute"
  - "nvme-atomic-write-units verify"
---

# Nvme Atomic Write Units Skill

The `nvme-atomic-write-units` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NVM Express Specification** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `FileCRUD / Safety`.
