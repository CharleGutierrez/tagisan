---
name: gguf-v3-header-zero-copy-parser
description: "Parsing GGUF v2/v3 metadata, tensor shapes, and offsets in 56 microseconds via memmap2"
version: 1.0.0
...
triggers:
  ...
  - "ggml/gguf"
  - "gguf"
  - "gguf v3 header zero copy parser"
  - "gguf-v3-header-zero-copy-parser"
  - "gguf-v3-header-zero-copy-parser execute"
  - "gguf-v3-header-zero-copy-parser verify"
---

# Gguf V3 Header Zero Copy Parser Skill

The `gguf-v3-header-zero-copy-parser` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **GGML/GGUF Spec** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `In-Process GGUF Tensor Engine`.
...
```json
{
  "skill": "gguf-v3-header-zero-copy-parser",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "GGML/GGUF Spec",
