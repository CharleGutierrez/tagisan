...
description: "Use when designing or reviewing Salesforce multi-currency behavior, especially irreversible\
  \ activation, `CurrencyIsoCode`, `convertCurrency()`, dated exchange rates, and\
  \ Advanced Currency Management tradeoffs. Triggers: 'multi currency', 'advanced\
  \ currency management', 'CurrencyIsoCode', 'dated exchange rate', 'convertCurrency'.\
  \ NOT for what convertCurrency() allows in WHERE/ORDER BY or querying CurrencyType\
  \ and DatedConversionRate \u2014 use data/currency-management-patterns. NOT for\
  \ wrong converted amounts in Sales Cloud reports and roll-ups \u2014 use architect/multi-currency-sales-architecture."
---
