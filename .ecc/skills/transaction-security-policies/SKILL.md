...
description: "Transaction Security policy creation and configuration: condition builder, enhanced\
  \ policies, enforcement actions (block, MFA, notification, end session), real-time\
  \ monitoring mode, and policy troubleshooting. NOT for Event Monitoring log analysis\
  \ or Shield Event Monitoring setup \u2014 use security/event-monitoring."
---
