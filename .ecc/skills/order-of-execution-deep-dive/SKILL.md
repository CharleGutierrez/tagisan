...
description: "Complete reference for the Salesforce record save order of execution: all 20 steps\
  \ from DB load through commit, covering trigger placement, validation rule sequencing,\
  \ Flow execution timing, workflow field update re-fire behavior, and recursion patterns.\
  \ Use when debugging unexpected automation behavior, designing multi-layer automation,\
  \ or analyzing trigger vs Flow execution order. NOT for trigger framework design\
  \ \u2014 use apex/trigger-framework. NOT for record-triggered Flow design \u2014\
  \ use flow/record-triggered-flow-patterns."
---
