---
name: llvm-ir-mem2reg-ssa
description: "Promoting alloca memory operations into Static Single Assignment (SSA) phi-nodes"
version: 1.0.0
...
triggers:
  ...
  - "llvm ir mem2reg ssa"
  - "llvm-ir-mem2reg-ssa"
  - "llvm-ir-mem2reg-ssa execute"
  - "llvm-ir-mem2reg-ssa verify"
  - "mem2reg"
---

# Llvm Ir Mem2reg Ssa Skill

The `llvm-ir-mem2reg-ssa` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
