...
description: "Use when configuring OmniStudio at the org level: enabling Standard Runtime, selecting\
  \ the Runtime Namespace, assigning Permission Set Licenses, toggling feature settings,\
  \ and granting Experience Cloud community access. Trigger keywords: OmniStudio Settings,\
  \ Standard OmniStudio Runtime, managed package runtime, runtime namespace, OmniStudio\
  \ Permission Set, OmniStudio PSL. NOT for moving an org off the vlocity namespace\
  \ \u2014 use omnistudio/vlocity-to-native-omnistudio-migration. NOT for deciding\
  \ whether to adopt OmniStudio \u2014 use architect/omnistudio-vs-standard-decision."
---
