...
description: 'Revenue Intelligence setup: activating the RI app and its CRM Analytics assets, Einstein
  deal insights, the opportunity-change waterfall, and forecast-accuracy analytics
  for sales leaders. NOT for configuring the Pipeline Inspection view, its metrics
  and review cadence - use admin/pipeline-review-design. NOT for forecast types, categories,
  rollups and quotas - use admin/collaborative-forecasts.'
---
