...
description: "Visualforce development \u2014 pages, controllers, extensions, ViewState, JS Remoting,\
  \ LWC migration. Use when maintaining VF pages, building PDFs, or planning VF-to-LWC\
  \ migration. Do NOT use for LWC, Aura, or Flow."
---
