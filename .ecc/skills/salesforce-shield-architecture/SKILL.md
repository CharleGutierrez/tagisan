...
description: "Salesforce Shield as an architectural choice \u2014 Platform Encryption + Event Monitoring\
  \ + Field Audit Trail as three SEPARATELY-LICENSED components, none of which ship\
  \ in any standard edition. Covers BYOK vs Cache-Only Key Service (CCKM) tradeoffs,\
  \ probabilistic vs deterministic encryption schemes, the field-type encryption blocklist\
  \ (Formula, Roll-Up Summary, indexed External ID), Field Audit Trail's 10-year retention\
  \ model, and why every Shield design starts with a license confirmation. NOT for\
  \ setting up one Shield feature \u2014 use security/platform-encryption, security/event-monitoring\
  \ or security/field-audit-trail. NOT for HIPAA control mapping \u2014 use architect/hipaa-compliance-architecture.\
  \ NOT for FedRAMP, FISMA or Government Cloud control mapping \u2014 use architect/government-cloud-compliance."
---
