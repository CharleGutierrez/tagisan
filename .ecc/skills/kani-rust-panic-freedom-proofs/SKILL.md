---
name: kani-rust-panic-freedom-proofs
description: "Mathematical verification that memory accesses cannot trigger out-of-bounds panics"
version: 1.0.0
...
triggers:
  ...
  - "freedom"
  - "kani"
  - "kani rust panic freedom proofs"
  - "kani-rust-panic-freedom-proofs"
  - "kani-rust-panic-freedom-proofs execute"
  - "kani-rust-panic-freedom-proofs verify"
---

# Kani Rust Panic Freedom Proofs Skill

The `kani-rust-panic-freedom-proofs` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Kani Rust Verifier Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Kani Formal Verifier`.
...
```json
{
  "skill": "kani-rust-panic-freedom-proofs",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Kani Rust Verifier Docs",
