...
description: "Deployment automation architecture on Salesforce: pipeline orchestration, branch\
  \ strategy, environment topology, quality gates, release trains. Selecting between\
  \ Copado, Gearset, Flosum, and native SFDX + GitHub Actions. NOT for cloud-specific\
  \ deploy mechanics (Industries, Marketing Cloud, Data Cloud) \u2014 use architect/cloud-specific-deployment-architecture.\
  \ NOT for CI/CD tool tutorials."
---
