...
description: "Use when designing retry-safe integrations with Salesforce \u2014 including external\
  \ ID upsert strategies, idempotency key management for inbound calls, Platform Event\
  \ replay safety, and Outbound Message retry handling. NOT for stopping duplicate\
  \ records users create, via matching and duplicate rules \u2014 use admin/duplicate-management.\
  \ NOT for the retry schedule itself \u2014 exponential backoff, jitter, circuit\
  \ breaker \u2014 use integration/retry-and-backoff-patterns."
---
