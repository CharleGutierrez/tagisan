---
name: local-embedding-bge-large-en
description: "Generating 1024-dimensional dense semantic embeddings locally with zero network calls"
version: 1.0.0
...
triggers:
  ...
  - "embedding"
  - "gguf"
  - "local embedding bge large en"
  - "local-embedding-bge-large-en"
  - "local-embedding-bge-large-en execute"
  - "local-embedding-bge-large-en verify"
---

# Local Embedding Bge Large En Skill

The `local-embedding-bge-large-en` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Hugging Face Hub** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Memory / Embeddings`.
...
- **Subsystem Binding**: `Memory / Embeddings`
...
```json
{
  "skill": "local-embedding-bge-large-en",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Hugging Face Hub",
  "integration_target": "Memory / Embeddings",
