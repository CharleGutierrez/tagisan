---
name: yara-x-webshell-signature-scan
description: "Detecting PHP, JSP, and ASPX webshell signatures in created workspace files"
version: 1.0.0
...
triggers:
  ...
  - "mitre"
  - "scan"
  - "yara x webshell signature scan"
  - "yara-x-webshell-signature-scan"
  - "yara-x-webshell-signature-scan execute"
  - "yara-x-webshell-signature-scan verify"
---

# Yara X Webshell Signature Scan Skill

The `yara-x-webshell-signature-scan` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **YARA-X Project Reference** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `FileCRUD / Safety`.
...
```json
{
  "skill": "yara-x-webshell-signature-scan",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "YARA-X Project Reference",
