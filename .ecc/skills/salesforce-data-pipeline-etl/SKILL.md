...
description: "Export large Salesforce datasets to a lakehouse via Bulk API 2.0, CDC streams, or\
  \ Salesforce Data Pipelines. NOT for ad-hoc exports \u2014 use data/etl-vs-api-data-patterns."
---
