---
name: postman-opsgenie-alerts
description: "Opsgenie alert deduplication, responder assignment, and voice escalation"
version: 1.0.0
...
triggers:
  ...
  - "opsgenie"
  - "postman"
  - "postman opsgenie alerts"
  - "postman-opsgenie-alerts"
  - "postman-opsgenie-alerts execute"
  - "postman-opsgenie-alerts verify"
---

# Postman Opsgenie Alerts Skill

The `postman-opsgenie-alerts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
