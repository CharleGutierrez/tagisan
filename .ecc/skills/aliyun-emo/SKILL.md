---
name: aliyun-emo
description: Use when generating expressive portrait videos from a person image and speech audio
  with Alibaba Cloud Model Studio EMO (`emo-v1`). Use when creating non-Wan avatar
  clips with stronger expression style control from a detected portrait image.
...
---
Category: provider
