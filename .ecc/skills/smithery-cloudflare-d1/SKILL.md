---
name: smithery-cloudflare-d1
description: "Serverless edge relational SQL query execution and schema migrations"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery cloudflare d1"
  - "smithery-ai"
  - "smithery-cloudflare-d1"
  - "smithery-cloudflare-d1 execute"
  - "smithery-cloudflare-d1 verify"
---

# Smithery Cloudflare D1 Skill

The `smithery-cloudflare-d1` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
