---
name: oxc-isolated-declarations-dts
description: "Generating TypeScript .d.ts declaration files in Rust without running tsc"
version: 1.0.0
...
triggers:
  ...
  - "frontend"
  - "full-stack"
  - "oxc isolated declarations dts"
  - "oxc-isolated-declarations-dts"
  - "oxc-isolated-declarations-dts execute"
  - "oxc-isolated-declarations-dts verify"
---

# Oxc Isolated Declarations Dts Skill

The `oxc-isolated-declarations-dts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Oxc Project Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Self-Healing Compiler`.
...
- **Subsystem Binding**: `Self-Healing Compiler`
...
```json
{
  "skill": "oxc-isolated-declarations-dts",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Oxc Project Docs",
  "integration_target": "Self-Healing Compiler",
