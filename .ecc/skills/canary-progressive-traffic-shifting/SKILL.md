---
name: canary-progressive-traffic-shifting
description: "Gradual 10% -> 25% -> 100% traffic shifting with automated rollback on error spikes"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "Cloud Native Deployment Specs"
tags:
  - canary
  - cloud
  - distributed
...
triggers:
  ...
  - "canary-progressive-traffic-shifting"
  - "canary-progressive-traffic-shifting execute"
  - "canary-progressive-traffic-shifting verify"
  - "cloud"
  - "distributed"
  - "opentelemetry"
  - "progressive"
...
# Canary Progressive Traffic Shifting Skill

The `canary-progressive-traffic-shifting` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cloud Native Deployment Specs** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Canary Rollback Sentinel`.
...
- **Subsystem Binding**: `Canary Rollback Sentinel`
...
```json
{
  "skill": "canary-progressive-traffic-shifting",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Cloud Native Deployment Specs",
  "integration_target": "Canary Rollback Sentinel",
