...
description: "Use Connect REST API for Chatter, feeds, communities, and CMS content instead of\
  \ querying underlying SObjects. NOT for custom business object CRUD \u2014 use integration/graphql-api-patterns."
---
