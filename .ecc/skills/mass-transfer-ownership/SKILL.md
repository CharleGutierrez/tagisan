...
description: "Use when re-assigning record OwnerId across many records \u2014 territory realignment,\
  \ employee departure, region split, integration cleanup. Triggers: 'mass transfer\
  \ accounts', 'reassign opportunities to new owner', 'transfer all records on user\
  \ deactivation', 'OwnerId migration'. NOT for auto-assigning new records \u2014\
  \ use admin/assignment-rules. NOT for territory assignment data \u2014 use data/territory-data-alignment."
---
