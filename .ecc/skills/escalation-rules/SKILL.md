...
description: "Configure and troubleshoot Salesforce Case Escalation Rules: time-based escalation\
  \ entries, business hours configuration, escalation actions (email alerts and reassignment),\
  \ and diagnosing why cases are not escalating. NOT for SLA milestone timers \u2014\
  \ use admin/entitlements-and-milestones. NOT for case routing on creation \u2014\
  \ use admin/assignment-rules."
---
# Escalation Rules
