...
description: "Add Stripe payments to a web app \u2014 Checkout Sessions, Payment Intents, subscriptions,\
  \ webhooks, customer portal, and pricing pages. Covers the decision of which Stripe\
  \ API to use, produces working integration code, and handles webhook verification.\
  \ No MCP server needed \u2014 uses Stripe npm package directly. Triggers: 'add payments',\
  \ 'stripe', 'checkout', 'subscription', 'payment form', 'pricing page', 'billing',\
  \ 'accept payments', 'stripe webhook', 'customer portal'."
---
# Stripe Payments
