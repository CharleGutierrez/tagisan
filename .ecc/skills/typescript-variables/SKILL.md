...
description: Apply, review, and explain TypeScript variable conventions. Use automatically for
  tasks involving variable declarations, const assertions, enum alternatives, literal-union
  state modelling, boolean flags, or choosing between null and undefined.
...
---
# Variables
