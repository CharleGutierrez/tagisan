---
name: composio-google-docs-generator
description: "Google Docs template population, heading styling, and PDF export"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio google docs generator"
  - "composio-dev"
  - "composio-google-docs-generator"
  - "composio-google-docs-generator execute"
  - "composio-google-docs-generator verify"
  - "docs"
  - "enterprise"
---

# Composio Google Docs Generator Skill

The `composio-google-docs-generator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-google-docs-generator",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
