...
description: "Deploy SSL certificates to Alibaba Cloud products (CDN/SLB/WAF/ALB/NLB/OSS/ESA, etc.).\
  \ One-click or batch deployment via CAS DeploymentJob API, with progress tracking,\
  \ failure diagnosis, rollback, and HTTPS verification. Activate when user says \"\
  deploy certificate to CDN\", \"deploy to SLB\", \"one-click deploy certificate\"\
  , \"push certificate to cloud\", \"\u90E8\u7F72\u8BC1\u4E66\u5230 CDN\", \"\u90E8\
  \u7F72\u5230 SLB\", \"\u4E00\u952E\u90E8\u7F72\u8BC1\u4E66\", \"\u8BC1\u4E66\u63A8\
  \u9001\u5230\u4E91\u4EA7\u54C1\"."
---
