---
name: composio-okta-identity
description: "Okta user provisioning, group assignment, and MFA status verification"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio okta identity"
  - "composio-dev"
  - "composio-okta-identity"
  - "composio-okta-identity execute"
  - "composio-okta-identity verify"
  - "enterprise"
  - "identity"
---

# Composio Okta Identity Skill

The `composio-okta-identity` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
