---
name: glama-aws-lambda-runner
description: "Serverless AWS Lambda function invocation, log retrieval, and payload testing"
version: 1.0.0
...
triggers:
  - "aws"
  - "glama"
  - "glama aws lambda runner"
  - "glama-ai"
  - "glama-aws-lambda-runner"
  - "glama-aws-lambda-runner execute"
  - "glama-aws-lambda-runner verify"
  - "lambda"
  - "mcp"
---

# Glama Aws Lambda Runner Skill

The `glama-aws-lambda-runner` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
