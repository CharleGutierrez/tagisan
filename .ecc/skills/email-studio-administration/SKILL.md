...
description: "Use when building, configuring, or troubleshooting email sends in Marketing Cloud\
  \ Email Studio and Content Builder. Triggers: 'dynamic content', 'send classification',\
  \ 'A/B test email', 'Content Builder template', 'triggered send', 'suppression list',\
  \ 'Commercial vs Transactional'. NOT for MCAE (Pardot) \u2014 use admin/mcae-pardot-setup.\
  \ NOT for Journey Builder orchestration \u2014 use admin/journey-builder-administration."
---
