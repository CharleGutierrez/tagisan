...
description: 'MaxCompute Quota Management Skill. Use for managing MaxCompute/ODPS quota resources
  including pay-as-you-go quota creation, query, and listing operations. Triggers:
  "MaxCompute quota", "ODPS quota", "create quota", "list quotas", "quota management",
  "CU management".'
---
