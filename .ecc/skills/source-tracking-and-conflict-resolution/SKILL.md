...
description: "Use when diagnosing and resolving SFDX source-tracking conflicts between a local\
  \ project and a Salesforce org. Trigger keywords: source tracking, conflict, --force-overwrite,\
  \ --ignore-conflicts, maxRevision.json, sf project retrieve, source:status. NOT\
  \ for Git merge conflicts, DevOps Center pipeline conflicts, or change-set deployments\
  \ \u2014 use devops/metadata-api-retrieve-deploy."
---
