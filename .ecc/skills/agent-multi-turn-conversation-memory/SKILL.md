---
name: agent-multi-turn-conversation-memory
description: "Managing episodic, semantic, and working memory tiers across long-lived sessions"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Semantic Kernel Specs"
tags:
  - agent
  - consensus
  - conversation
...
triggers:
  - "agent"
  - "agent multi turn conversation memory"
  - "agent-multi-turn-conversation-memory"
  - "agent-multi-turn-conversation-memory execute"
  - "agent-multi-turn-conversation-memory verify"
  - "consensus"
  - "conversation"
  - "debate"
  - "memory"
...
# Agent Multi Turn Conversation Memory Skill

The `agent-multi-turn-conversation-memory` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Semantic Kernel Specs** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `MemoryBackend`.
...
- **Subsystem Binding**: `MemoryBackend`
...
```json
{
  "skill": "agent-multi-turn-conversation-memory",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Semantic Kernel Specs",
  "integration_target": "MemoryBackend",
