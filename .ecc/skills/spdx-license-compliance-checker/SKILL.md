---
name: spdx-license-compliance-checker
description: "Verifying software licenses against approved enterprise policies (MIT, Apache, BSD)"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "SPDX Standards"
tags:
  - agentshield
  - checker
  - compliance
...
triggers:
  ...
  - "spdx-license-compliance-checker"
  - "spdx-license-compliance-checker execute"
  - "spdx-license-compliance-checker verify"
---

# Spdx License Compliance Checker Skill

The `spdx-license-compliance-checker` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SPDX Standards** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Cargo Deny / Legal`.
...
- **Subsystem Binding**: `Cargo Deny / Legal`
...
```json
{
  "skill": "spdx-license-compliance-checker",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "SPDX Standards",
  "integration_target": "Cargo Deny / Legal",
