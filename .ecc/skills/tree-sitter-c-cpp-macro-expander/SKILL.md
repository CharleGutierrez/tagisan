---
name: tree-sitter-c-cpp-macro-expander
description: "C/C++ AST preprocessor directive mapping and symbol binding resolution"
version: 1.0.0
...
triggers:
  ...
  - "expander"
  - "formal-methods"
  - "tree sitter c cpp macro expander"
  - "tree-sitter-c-cpp-macro-expander"
  - "tree-sitter-c-cpp-macro-expander execute"
  - "tree-sitter-c-cpp-macro-expander verify"
---

# Tree Sitter C Cpp Macro Expander Skill

The `tree-sitter-c-cpp-macro-expander` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tree-sitter Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
```json
{
  "skill": "tree-sitter-c-cpp-macro-expander",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Tree-sitter Docs",
