...
description: "Planning and executing metadata rollbacks and emergency hotfixes in Salesforce orgs.\
  \ Use when a production deployment causes regression and needs to be reverted, or\
  \ when an urgent fix must bypass the normal release pipeline. NOT for routine CI/CD\
  \ pipeline setup (use continuous-integration-testing) \u2014 use admin/change-management-and-deployment."
---
