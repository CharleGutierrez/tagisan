...
description: "Component-driven development, visual regression test stories, and accessibility"
version: 1.0.0
...
triggers:
  ...
  - "storybook-component-isolation"
  - "storybook-component-isolation execute"
  - "storybook-component-isolation verify"
---

# Storybook Component Isolation Skill

The `storybook-component-isolation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Storybook Documentation** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "storybook-component-isolation",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Storybook Documentation",
