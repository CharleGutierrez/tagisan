---
name: gguf-tokenizer-bpe-unpacker
description: "Extracting Byte-Pair Encoding vocabularies and regex merge tables from GGUF headers"
version: 1.0.0
...
triggers:
  ...
  - "ggml/gguf"
  - "gguf"
  - "gguf tokenizer bpe unpacker"
  - "gguf-tokenizer-bpe-unpacker"
  - "gguf-tokenizer-bpe-unpacker execute"
  - "gguf-tokenizer-bpe-unpacker verify"
---

# Gguf Tokenizer Bpe Unpacker Skill

The `gguf-tokenizer-bpe-unpacker` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **GGML/GGUF Spec** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `In-Process Tokenizer`.
...
- **Subsystem Binding**: `In-Process Tokenizer`
...
```json
{
  "skill": "gguf-tokenizer-bpe-unpacker",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "GGML/GGUF Spec",
  "integration_target": "In-Process Tokenizer",
