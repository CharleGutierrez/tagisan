---
name: postman-fastly-vcl
description: "Fastly VCL service configuration diffing, edge dictionary updates, and purges"
version: 1.0.0
...
triggers:
  ...
  - "postman fastly vcl"
  - "postman-fastly-vcl"
  - "postman-fastly-vcl execute"
  - "postman-fastly-vcl verify"
  - "saas"
---

# Postman Fastly Vcl Skill

The `postman-fastly-vcl` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
