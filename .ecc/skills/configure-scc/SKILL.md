---
name: configure-scc
description: Use when setting up SCC for Salesforce Apex and LWC development. Interactive wizard
  to install profiles, modules, and customize the harness for your org.
...
---
# Configure SCC
