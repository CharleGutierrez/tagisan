---
name: opentelemetry-metric-counter-histogram
description: "Recording high-resolution inference duration histograms and token counters"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "OpenTelemetry (opentelemetry.io)"
tags:
  - counter
  - distributed
  - histogram
...
triggers:
  ...
  - "metric"
  - "opentelemetry"
  - "opentelemetry metric counter histogram"
  - "opentelemetry-metric-counter-histogram"
  - "opentelemetry-metric-counter-histogram execute"
  - "opentelemetry-metric-counter-histogram verify"
---

# Opentelemetry Metric Counter Histogram Skill

The `opentelemetry-metric-counter-histogram` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OpenTelemetry (opentelemetry.io)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Telemetry Module`.
...
```json
{
  "skill": "opentelemetry-metric-counter-histogram",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "OpenTelemetry (opentelemetry.io)",
