...
description: "Design FlexCard layout, data sources, states, actions, and child-card iteration.\
  \ Triggers: FlexCard, card states, flyout, child card. NOT for FlexCard state across\
  \ navigation \u2014 use omnistudio/flexcard-state-management. NOT for admin requirements\
  \ \u2014 use admin/flexcard-requirements."
---
