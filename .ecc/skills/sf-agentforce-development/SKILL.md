...
description: "Agentforce agent development \u2014 Agent Script, topics/subagents, actions, testing,\
  \ metadata. Use when building Agentforce agents, Apex InvocableMethod actions, or\
  \ agent SOQL patterns. Do NOT use for non-Agentforce Apex or Flow-only automation."
---
