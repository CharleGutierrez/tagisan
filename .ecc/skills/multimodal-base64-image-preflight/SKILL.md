---
name: multimodal-base64-image-preflight
description: "Validating image dimensions, computing perceptual hash, and sanitizing EXIF metadata"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "W3C Media Specs"
tags:
  - ai
  - base64
  - cuda
...
triggers:
  ...
  - "gguf"
  - "image"
  - "multimodal base64 image preflight"
  - "multimodal-base64-image-preflight"
  - "multimodal-base64-image-preflight execute"
  - "multimodal-base64-image-preflight verify"
---

# Multimodal Base64 Image Preflight Skill

The `multimodal-base64-image-preflight` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **W3C Media Specs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tool view_image / -i`.
...
- **Subsystem Binding**: `Tool view_image / -i`
...
```json
{
  "skill": "multimodal-base64-image-preflight",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "W3C Media Specs",
  "integration_target": "Tool view_image / -i",
