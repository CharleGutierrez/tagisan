---
name: dafny-pre-post-condition-proofs
description: "Synthesizing 'requires' preconditions and 'ensures' postconditions for critical logic"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "Dafny Language Reference"
tags:
  - ast
  - compiler
  - condition
...
triggers:
  ...
  - "condition"
  - "dafny"
  - "dafny pre post condition proofs"
  - "dafny-pre-post-condition-proofs"
  - "dafny-pre-post-condition-proofs execute"
  - "dafny-pre-post-condition-proofs verify"
  - "formal-methods"
---

# Dafny Pre Post Condition Proofs Skill

The `dafny-pre-post-condition-proofs` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Dafny Language Reference** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "dafny-pre-post-condition-proofs",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Dafny Language Reference",
