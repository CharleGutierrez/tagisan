---
name: sigstore-cosign-signature-verify
description: "Validating OIDC keyless container and WebAssembly signatures with transparency logs"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "Sigstore Project Docs"
tags:
  - agentshield
  - cosign
  - defense
...
triggers:
  ...
  - "edr"
  - "mitre"
  - "sigstore cosign signature verify"
  - "sigstore-cosign-signature-verify"
  - "sigstore-cosign-signature-verify execute"
  - "sigstore-cosign-signature-verify verify"
---

# Sigstore Cosign Signature Verify Skill

The `sigstore-cosign-signature-verify` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Sigstore Project Docs** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Plugin Tier A (WASM)`.
...
- **Subsystem Binding**: `Plugin Tier A (WASM)`
...
```json
{
  "skill": "sigstore-cosign-signature-verify",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Sigstore Project Docs",
  "integration_target": "Plugin Tier A (WASM)",
