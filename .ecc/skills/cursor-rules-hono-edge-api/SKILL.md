---
name: cursor-rules-hono-edge-api
description: "Ultrafast Hono framework routing on Bun, Cloudflare Workers, and Deno"
version: 1.0.0
...
triggers:
  ...
  - "bun"
  - "cursor"
  - "cursor rules hono edge api"
  - "cursor-rules-hono-edge-api"
  - "cursor-rules-hono-edge-api execute"
  - "cursor-rules-hono-edge-api verify"
  - "edge"
  - "frontend"
---

# Cursor Rules Hono Edge Api Skill

The `cursor-rules-hono-edge-api` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-hono-edge-api",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
