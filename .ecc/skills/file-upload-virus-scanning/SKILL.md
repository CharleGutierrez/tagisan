...
description: "Use when designing malware and content scanning for files uploaded to Salesforce\
  \ (Files, Attachments, ContentVersion) \u2014 external scanning service callouts,\
  \ quarantine patterns, and user-facing messaging. Triggers: 'virus scan salesforce\
  \ upload', 'malware scan. NOT for field-level data validation \u2014 use integration/file-and-document-integration."
---
