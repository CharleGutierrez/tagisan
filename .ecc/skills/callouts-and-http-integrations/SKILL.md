...
description: "Use when building, reviewing, or debugging outbound Apex HTTP callouts, Named Credentials,\
  \ request/response handling, timeout behavior, or mock-based tests. Triggers: 'HttpRequest',\
  \ 'Named Credential', 'callout exception', 'uncommitted work pending', 'HttpCalloutMock'.\
  \ NOT for exposing Apex as an inbound REST endpoint \u2014 use apex/apex-rest-services.\
  \ NOT for SOAP callouts generated from a WSDL \u2014 use apex/apex-wsdl2apex-patterns.\
  \ NOT for the per-transaction callout ceiling or moving callouts async to stay under\
  \ it \u2014 use integration/callout-limits-and-async-patterns."
---
