---
name: linux-procfs-oom-score-adj
description: "OOM killer score adjustment ensuring Tagisan daemon survives system memory exhaustion"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux procfs oom score adj"
  - "linux-procfs-oom-score-adj"
  - "linux-procfs-oom-score-adj execute"
  - "linux-procfs-oom-score-adj verify"
  - "low-level"
---

# Linux Procfs Oom Score Adj Skill

The `linux-procfs-oom-score-adj` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Engine / Daemon`.
...
- **Subsystem Binding**: `Engine / Daemon`
...
```json
{
  "skill": "linux-procfs-oom-score-adj",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Engine / Daemon",
