...
description: "Use this skill to create, configure, or tune Field Service Lightning scheduling policies\
  \ \u2014 including work rules (pass/fail filters) and service objectives (weighted\
  \ ranking criteria). Covers the four default policies, custom policy design, work\
  \ rule type selection, and objective weighting strategy. NOT for running or tuning\
  \ the Optimizer itself \u2014 use admin/fsl-scheduling-optimization-design. NOT\
  \ for resource skills and preferences \u2014 use admin/fsl-resource-management.\
