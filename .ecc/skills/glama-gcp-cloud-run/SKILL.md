---
name: glama-gcp-cloud-run
description: "Google Cloud Run service status checking, revision deployments, and logs"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-gcp-cloud-run"
  - "glama-gcp-cloud-run execute"
  - "glama-gcp-cloud-run verify"
  - "mcp"
---

# Glama Gcp Cloud Run Skill

The `glama-gcp-cloud-run` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
