...
description: 'Use when narrowing access that sharing already granted. Trigger keywords: restriction
  rule, recordFilter, userCriteria, RestrictionRule metadata, hide records, restrict
  visibility. NOT for list-view scope only - use admin/scoping-rules.'
---
# Restriction Rules
