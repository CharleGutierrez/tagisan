...
description: "Configuring User Access Policies (UAP) to automatically assign or revoke permission\
  \ sets and permission set groups based on user attributes. Use when automating permission\
  \ provisioning on user create/update without Apex triggers. Covers policy configuration,\
  \ filter criteria, evaluation order, and PSL assignment. NOT for permission set\
  \ design \u2014 use admin/permission-set-architecture. NOT for delegated user admin\
  \ \u2014 use admin/delegated-administration."
---
