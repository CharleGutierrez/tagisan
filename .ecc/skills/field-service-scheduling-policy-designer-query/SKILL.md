...
description: "Designs the four policy-level settings for a Salesforce Field Service scheduling\
  \ policy \u2014 name, optimization mode (In-Day vs Global), commit mode, and description\
  \ \u2014 and delegates to work rule design when complete. Use this skill when a\
  \ user wants to design, configure, or set up a Field Service scheduling policy's\
