---
name: pypi-mcp-server-seaborn-plots
description: "Statistical data visualization, heatmaps, and distribution plots"
version: 1.0.0
...
triggers:
  ...
  - "plots"
  - "pypi"
  - "pypi mcp server seaborn plots"
  - "pypi-mcp-server-seaborn-plots"
  - "pypi-mcp-server-seaborn-plots execute"
  - "pypi-mcp-server-seaborn-plots verify"
  - "seaborn"
---

# Pypi Mcp Server Seaborn Plots Skill

The `pypi-mcp-server-seaborn-plots` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-seaborn-plots",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
