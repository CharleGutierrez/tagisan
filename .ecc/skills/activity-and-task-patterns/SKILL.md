...
description: "Task and Event objects: polymorphic WhatId/WhoId, Activity object model, ActivityHistory\
  \ vs OpenActivity, activity timeline customization, bulk task creation, Einstein\
  \ Activity Capture boundaries. NOT for turning on EAC or calendar sync \u2014 use\
  \ admin/einstein-activity-capture-setup. NOT for Email-to-Case \u2014 use admin/case-management-setup."
---
