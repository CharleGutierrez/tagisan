---
name: composio-coda-workspace
description: "Coda document table mutations, canvas formulas, and pack interactions"
version: 1.0.0
...
triggers:
  ...
  - "coda"
  - "composio"
  - "composio coda workspace"
  - "composio-coda-workspace"
  - "composio-coda-workspace execute"
  - "composio-coda-workspace verify"
  - "composio-dev"
  - "enterprise"
---

# Composio Coda Workspace Skill

The `composio-coda-workspace` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
