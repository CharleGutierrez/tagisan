---
name: composio-ping-identity-sso
description: "PingFederate SAML/OIDC session validation and federated identity checks"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio ping identity sso"
  - "composio-dev"
  - "composio-ping-identity-sso"
  - "composio-ping-identity-sso execute"
  - "composio-ping-identity-sso verify"
  - "enterprise"
  - "identity"
---

# Composio Ping Identity Sso Skill

The `composio-ping-identity-sso` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-ping-identity-sso",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
