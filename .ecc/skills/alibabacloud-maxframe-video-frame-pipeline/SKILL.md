...
description: "This skill should be used when the user asks to \"build a frame extraction job\"\
  \ / \"\u89C6\u9891\u62BD\u5E27 / \u62BD\u5173\u952E\u5E27\", \"label driving images\
  \ with a VLM\" / \"\u56FE\u50CF\u6253\u6807 / image labeling with Qwen-VL\", \"\
  compute image embeddings\" / \"\u56FE\u50CF\u5411\u91CF\u5316 / multi-modal embedding\"\
  , \"build a video_table / image_table / clip_dir_table for AI FUNC\", \"\u626B OSS\
  \ \u5EFA video meta \u8868\", or mentions driving-scene / ADAS / \u667A\u9A7E /\
  \ \u667A\u80FD\u9A7E\u9A76 / \u81EA\u52A8\u9A7E\u9A76 / \u8DEF\u6D4B / \u884C\u8F66\
  \u8BB0\u5F55\u4EEA / \u5EA7\u8231 video or image pipelines on MaxFrame + OSS + ODPS.\
  \ Not for audio (use driving-audio-maxframe-job)."
---
