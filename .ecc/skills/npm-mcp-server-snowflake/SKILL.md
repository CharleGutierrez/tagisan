---
name: npm-mcp-server-snowflake
description: "Snowflake warehouse queries and data lake introspection"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server snowflake"
  - "npm-mcp-server-snowflake"
  - "npm-mcp-server-snowflake execute"
  - "npm-mcp-server-snowflake verify"
  - "server"
  - "snowflake"
---

# Npm Mcp Server Snowflake Skill

The `npm-mcp-server-snowflake` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "npm-mcp-server-snowflake",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "NPM Registry",
