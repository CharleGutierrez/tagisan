...
description: "Use this skill when configuring or extending search on an Experience Cloud site \u2014\
  \ covering Search Manager scope configuration, LWR vs Aura search component selection,\
  \ federated search setup, guest user search access, and custom search result components.\
  \ NOT for SOSL/SOQL query development \u2014 use lwc/experience-cloud-lwc-components."
---
