...
description: "Model and verify unlocked package dependencies, version pinning, and promotion. NOT\
  \ for 1GP managed packages \u2014 use devops/multi-package-development."
---
