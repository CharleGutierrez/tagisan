...
description: "Custom Notification Types for desktop/mobile push alerts from Flow or Apex: type\
  \ creation, target channels, Messaging.CustomNotification invocation, recipient\
  \ limits, bulk notification patterns. NOT for choosing channels, consent, or notification-fatigue\
  \ policy \u2014 use admin/custom-notification-type-design. NOT for email alerts\
  \ \u2014 use admin/email-templates-and-alerts."
---
