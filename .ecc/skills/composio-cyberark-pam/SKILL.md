---
name: composio-cyberark-pam
description: "CyberArk privileged access security credential rotation and vault retrieval"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio cyberark pam"
  - "composio-cyberark-pam"
  - "composio-cyberark-pam execute"
  - "composio-cyberark-pam verify"
  - "composio-dev"
  - "cyberark"
  - "enterprise"
---

# Composio Cyberark Pam Skill

The `composio-cyberark-pam` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
