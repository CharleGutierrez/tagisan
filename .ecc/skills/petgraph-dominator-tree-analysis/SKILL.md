---
name: petgraph-dominator-tree-analysis
description: "Computing immediate dominator nodes for control flow graphs and loop preheaders"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "Petgraph Docs (docs.rs)"
tags:
  - analysis
  - ast
  - compiler
...
triggers:
  ...
  - "dominator"
  - "formal-methods"
  - "petgraph dominator tree analysis"
  - "petgraph-dominator-tree-analysis"
  - "petgraph-dominator-tree-analysis execute"
  - "petgraph-dominator-tree-analysis verify"
---

# Petgraph Dominator Tree Analysis Skill

The `petgraph-dominator-tree-analysis` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Petgraph Docs (docs.rs)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
```json
{
  "skill": "petgraph-dominator-tree-analysis",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Petgraph Docs (docs.rs)",
