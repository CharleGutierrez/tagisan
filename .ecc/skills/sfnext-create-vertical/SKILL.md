...
description: "Create a new Storefront Next vertical (brand theme / storefront variant) by editing\
  \ brand design tokens, typography, dark mode, and the Figma kit. Use when asked\
  \ to create a new vertical, brand, theme, or storefront variant, re-skin the storefront,\
  \ or change the brand palette. Covers the brand.css token layer, semantic token\
  \ rules, fixture-based local development, and the extension-vs-base decision. NOT\
  \ for engineering component patterns \u2014 see sfnext-components."
---
