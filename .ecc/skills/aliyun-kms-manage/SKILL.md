...
description: Use when managing Alibaba Cloud Key Management Service (KMS) via OpenAPI/SDK, including
  the user needs key lifecycle/resource operations, policy/configuration changes,
  status inspection, or troubleshooting KMS API workflows.
...
---
Category: service
