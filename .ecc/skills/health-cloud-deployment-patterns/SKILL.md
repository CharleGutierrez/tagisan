...
description: "Use when planning or executing a Health Cloud deployment to production or a full\
  \ sandbox, including managed package installation sequencing, Permission Set License\
  \ assignment, care plan template setup, HIPAA compliance. NOT for Health Cloud data\
  \ model design or Apex extensions in Health Cloud \u2014 use data/health-cloud-data-model."
---
