...
description: "Use this skill when designing or evaluating the overall Marketing Cloud data architecture\
  \ \u2014 covering Data Extension schema design (sendable vs. non-sendable), Contact\
  \ Key/SubscriberKey linkage across All Subscribers and attribute DEs, Data Relationship\
  \ definitions for AMPscript Lookup and Query Activity joins, and CRM-to-MC data\
  \ flow patterns (MC Connect Synchronized DEs vs. SFTP file imports). Trigger keywords:\
  \ MC data model, relational data extensions, CRM to Marketing Cloud data flow, Contact\
  \ Key linkage, data architecture, sendable DE design, normalized DE model, SFTP\
  \ import strategy, synchronized data extension architecture. NOT for one Data Extension's\
  \ keys and retention \u2014 use data/data-extension-design. NOT for diagnosing MC\
  \ Connect synchronized DE sync failures \u2014 use data/marketing-cloud-data-sync."
---
