---
name: sre-root-cause-analysis-triage
description: "Correlating correlated log spikes, span failures, and recent commits for instant RCA"
version: 1.0.0
...
triggers:
  ...
  - "opentelemetry"
  - "resilience"
  - "sre root cause analysis triage"
  - "sre-root-cause-analysis-triage"
  - "sre-root-cause-analysis-triage execute"
  - "sre-root-cause-analysis-triage verify"
---

# Sre Root Cause Analysis Triage Skill

The `sre-root-cause-analysis-triage` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SRE Best Practices** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Failure Forensic Expert`.
...
```json
{
  "skill": "sre-root-cause-analysis-triage",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "SRE Best Practices",
