...
description: "Driver-level XDP packet filtering dropping malicious packets at 10M+ pps"
version: 1.0.0
...
triggers:
  ...
  - "ebpf-io"
  - "ebpf-xdp-ddos-mitigation"
  - "ebpf-xdp-ddos-mitigation execute"
  - "ebpf-xdp-ddos-mitigation verify"
  - "hardware"
  - "kernel"
---

# Ebpf Xdp Ddos Mitigation Skill

The `ebpf-xdp-ddos-mitigation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **eBPF.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / AgentShield`.
...
- **Subsystem Binding**: `Native Rust / AgentShield`
...
```json
{
  "skill": "ebpf-xdp-ddos-mitigation",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "eBPF.io",
  "integration_target": "Native Rust / AgentShield",
