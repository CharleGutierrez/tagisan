...
description: "Use when transforming structured data inside Apex \u2014 CSV \u2192 JSON, XML \u2192\
  \ SObject list, JSON \u2192 flattened CSV, or schema-mapping a third-party payload\
  \ to a Salesforce model \u2014 and the existing options (`JSON.deserialize`, `Dom.Document`\
  \ traversal) are too fragile. NOT for MuleSoft Anypoint DataWeave running off-platform\
  \ (use architect/mulesoft-anypoint-architecture) \u2014 use apex/apex-json-serialization."
---
# DataWeave for Apex
