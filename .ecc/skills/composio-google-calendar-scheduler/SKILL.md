---
name: composio-google-calendar-scheduler
description: "Google Calendar event conflict resolution and multi-calendar booking"
version: 1.0.0
...
triggers:
  ...
  - "calendar"
  - "composio"
  - "composio google calendar scheduler"
  - "composio-dev"
  - "composio-google-calendar-scheduler"
  - "composio-google-calendar-scheduler execute"
  - "composio-google-calendar-scheduler verify"
  - "enterprise"
---

# Composio Google Calendar Scheduler Skill

The `composio-google-calendar-scheduler` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-google-calendar-scheduler",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
