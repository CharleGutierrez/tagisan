---
name: smithery-sentry-telemetry
description: "Real-time error tracking, exception stack trace inspection, and RCA triage"
version: 1.0.0
...
triggers:
  ...
  - "sentry"
  - "smithery"
  - "smithery sentry telemetry"
  - "smithery-ai"
  - "smithery-sentry-telemetry"
  - "smithery-sentry-telemetry execute"
  - "smithery-sentry-telemetry verify"
---

# Smithery Sentry Telemetry Skill

The `smithery-sentry-telemetry` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-sentry-telemetry",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
