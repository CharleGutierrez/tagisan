---
name: local-reranker-bge-reranker-v2
description: "Cross-encoder scoring calculating precise relevance between queries and retrieved chunks"
version: 1.0.0
...
triggers:
  ...
  - "gguf"
  - "hugging"
  - "local reranker bge reranker v2"
  - "local-reranker-bge-reranker-v2"
  - "local-reranker-bge-reranker-v2 execute"
  - "local-reranker-bge-reranker-v2 verify"
---

# Local Reranker Bge Reranker V2 Skill

The `local-reranker-bge-reranker-v2` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Hugging Face Hub** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Memory / Retrieval`.
...
- **Subsystem Binding**: `Memory / Retrieval`
...
```json
{
  "skill": "local-reranker-bge-reranker-v2",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Hugging Face Hub",
  "integration_target": "Memory / Retrieval",
