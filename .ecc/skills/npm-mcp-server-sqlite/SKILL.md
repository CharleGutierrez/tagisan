---
name: npm-mcp-server-sqlite
description: "SQLite database querying, schema dump, and transaction rollback testing"
version: 1.0.0
...
triggers:
  ...
  - "npm-mcp-server-sqlite"
  - "npm-mcp-server-sqlite execute"
  - "npm-mcp-server-sqlite verify"
  - "server"
  - "sqlite"
---

# Npm Mcp Server Sqlite Skill

The `npm-mcp-server-sqlite` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
