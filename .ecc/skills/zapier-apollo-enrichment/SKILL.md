---
name: zapier-apollo-enrichment
description: "Apollo.io B2B lead contact enrichment, domain lookups, and verified emails"
version: 1.0.0
...
triggers:
  ...
  - "enterprise"
  - "saas"
  - "zapier apollo enrichment"
  - "zapier-apollo-enrichment"
  - "zapier-apollo-enrichment execute"
  - "zapier-apollo-enrichment verify"
---

# Zapier Apollo Enrichment Skill

The `zapier-apollo-enrichment` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-apollo-enrichment",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
