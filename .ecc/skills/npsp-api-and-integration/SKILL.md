...
description: "NPSP programmatic integration patterns: BDI gift processing API for bulk gift ingestion,\
  \ ERD Schedules and Installments API for recurring donation data, and wealth screening\
  \ integration via AppExchange managed packages. NOT for a one-off historical gift\
  \ migration through the NPSP Data Importer \u2014 use data/gift-history-import.\
  \ NOT for choosing the payment gateway or wealth-screening architecture \u2014 use\
  \ architect/fundraising-integration-patterns. NOT for Nonprofit Cloud (NPC) native\
  \ APIs or NPSP PMM."
---
