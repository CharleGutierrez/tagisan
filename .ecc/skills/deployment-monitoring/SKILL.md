...
description: "Live and historical status of a Salesforce metadata deployment: Metadata API checkDeployStatus,\
  \ REST deployRequest polling, the Deployment Status Setup page, DeployResult status\
  \ enum, component error triage, deploy queue concurrency, 30-day history limit.\
  \ NOT for whether the change actually works now that it landed \u2014 use devops/post-deployment-validation.\
  \ NOT for reverting a bad deploy \u2014 use devops/rollback-and-hotfix-strategy."
---
