...
description: "Use this skill when designing or diagnosing end-to-end integration between Salesforce\
  \ B2B or D2C Commerce and external systems \u2014 including ERP pricing/inventory,\
  \ PIM product sync, payment gateways, shipping providers, tax engines, and order\
  \ management systems (OMS). Covers CartExtension Apex namespace (PricingCartCalculator,\
  \ ShippingCartCalculator, InventoryCartCalculator), RegisteredExternalService custom\
  \ metadata, payment gateway architecture, and Product2 External ID patterns. NOT\
  \ for CommercePayments adapter implementation \u2014 use apex/commerce-payment-integration.\
  \ NOT for generic non-commerce Salesforce integration (Platform Events, MuleSoft,\
  \ REST APIs), NOT for storefront UI or LWC development."
---
