...
description: "Custom Report Type design \u2014 when to create a CRT vs use the standard, A-with-B-without\
  \ and A-without-B joins, primary/secondary/related-via-lookup objects, the 60-field\
  \ display limit, and field-set vs cross-join layouts. NOT for building the report\
  \ or dashboard itself once the report type exists \u2014 use admin/reports-and-dashboards-fundamentals."
---
