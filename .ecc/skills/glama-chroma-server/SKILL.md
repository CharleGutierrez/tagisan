---
name: glama-chroma-server
description: "ChromaDB vector store connector for document embeddings and similarity search"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-chroma-server"
  - "glama-chroma-server execute"
  - "glama-chroma-server verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Chroma Server Skill

The `glama-chroma-server` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / VectorStoreBackend`.
