---
name: npm-mcp-server-linear
description: "Linear engineering workflow automation and team velocity inspection"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server linear"
  - "npm-mcp-server-linear"
  - "npm-mcp-server-linear execute"
  - "npm-mcp-server-linear verify"
  - "server"
---

# Npm Mcp Server Linear Skill

The `npm-mcp-server-linear` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
