---
name: model-abliteration-refusal-removal
description: "Mathematical orthogonalization of refusal direction vectors in attention weights"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "ArXiv Research (FailSpy)"
tags:
  - abliteration
  - ai
  - arxiv
...
triggers:
  ...
  - "cuda"
  - "gguf"
  - "model abliteration refusal removal"
  - "model-abliteration-refusal-removal"
  - "model-abliteration-refusal-removal execute"
  - "model-abliteration-refusal-removal verify"
---

# Model Abliteration Refusal Removal Skill

The `model-abliteration-refusal-removal` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv Research (FailSpy)** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Abliterated Mode`.
...
- **Subsystem Binding**: `Abliterated Mode`
...
```json
{
  "skill": "model-abliteration-refusal-removal",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "ArXiv Research (FailSpy)",
  "integration_target": "Abliterated Mode",
