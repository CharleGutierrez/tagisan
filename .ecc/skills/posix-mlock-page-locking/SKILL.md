---
name: posix-mlock-page-locking
description: "Memory locking preventing tensor page swapping into disk swap space"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "mlock"
  - "posix mlock page locking"
  - "posix-mlock-page-locking"
  - "posix-mlock-page-locking execute"
  - "posix-mlock-page-locking verify"
---

# Posix Mlock Page Locking Skill

The `posix-mlock-page-locking` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **POSIX IEEE 1003.1** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `GGUF Engine / Allocator`.
...
- **Subsystem Binding**: `GGUF Engine / Allocator`
...
```json
{
  "skill": "posix-mlock-page-locking",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "POSIX IEEE 1003.1",
  "integration_target": "GGUF Engine / Allocator",
