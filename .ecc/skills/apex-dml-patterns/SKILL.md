...
description: "Use when choosing between DML statements and Database class methods, handling partial\
  \ success, or using Database.DMLOptions for assignment rules and duplicate handling.\
  \ Trigger keywords: 'Database.insert allOrNone false', 'partial DML success apex',\
  \ 'SaveResult isSuccess', 'database merge apex', 'DML exception handling'. NOT for\
  \ savepoint placement and rollback after a failure \u2014 use apex/apex-savepoint-and-rollback.\
  \ NOT for SOQL query patterns \u2014 use apex/soql-fundamentals."
---
# Apex DML Patterns
