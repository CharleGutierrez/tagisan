---
name: ietf-rfc-6455-websocket-framing
description: "Full-duplex WebSocket connection handling for low-latency live browser terminal streaming"
version: 1.0.0
...
triggers:
  ...
  - "framing"
  - "ietf"
  - "ietf rfc 6455 websocket framing"
  - "ietf-rfc-6455-websocket-framing"
  - "ietf-rfc-6455-websocket-framing execute"
  - "ietf-rfc-6455-websocket-framing verify"
  - "opentelemetry"
---

# Ietf Rfc 6455 Websocket Framing Skill

The `ietf-rfc-6455-websocket-framing` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **IETF RFCs (ietf.org)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `TGS Web Daemon`.
...
- **Subsystem Binding**: `TGS Web Daemon`
...
```json
{
  "skill": "ietf-rfc-6455-websocket-framing",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "IETF RFCs (ietf.org)",
  "integration_target": "TGS Web Daemon",
