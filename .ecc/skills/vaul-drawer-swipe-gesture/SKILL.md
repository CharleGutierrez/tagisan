---
name: vaul-drawer-swipe-gesture
description: "Physics-based mobile drawer component with smooth gesture dismissal"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Emil Kowalski Vaul Docs"
tags:
  - bun
  - drawer
  - emil
...
triggers:
  ...
  - "frontend"
  - "full-stack"
  - "vaul drawer swipe gesture"
  - "vaul-drawer-swipe-gesture"
  - "vaul-drawer-swipe-gesture execute"
  - "vaul-drawer-swipe-gesture verify"
---

# Vaul Drawer Swipe Gesture Skill

The `vaul-drawer-swipe-gesture` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Emil Kowalski Vaul Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "vaul-drawer-swipe-gesture",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Emil Kowalski Vaul Docs",
