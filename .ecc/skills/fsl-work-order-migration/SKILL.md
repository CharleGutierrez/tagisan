...
description: "Use this skill when migrating Work Order, Work Order Line Item, Service Appointment,\
  \ AssignedResource, and ProductConsumed data into a Salesforce Field Service org.\
  \ Trigger keywords: FSL data migration, WorkOrder import, ServiceAppointment migration,\
  \ AssignedResource load, ProductConsumed migration, work order history data load.\
  \ NOT for loading the technicians, skills and certifications themselves \u2014 use\
  \ data/fsl-resource-and-skill-data. NOT for reporting on the work-order data once\
  \ it is loaded \u2014 use data/fsl-reporting-data-model."
---
