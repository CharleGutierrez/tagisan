---
name: sf-security-scan
description: "Use when scanning Salesforce org Claude Code configuration for security vulnerabilities,\
  \ deploy misconfigurations, and injection risks in CLAUDE.md, hooks, and MCP servers.\
  \ Do NOT use for Apex code review \u2014 use sf-security."
---
