...
description: "Use when practitioners need to understand system-managed fields (CreatedDate, LastModifiedDate,\
  \ SystemModstamp, CreatedById, LastModifiedById, IsDeleted) \u2014 their update\
  \ behavior, indexing, and queryability. Triggers: 'difference between SystemModstamp\
  \ and LastModifiedDate', 'how to query deleted records', 'set CreatedDate during\
  \ data migration', 'why does LastModifiedDate not match SystemModstamp', 'Create\
  \ Audit Fields permission'. NOT for a field's value-change history \u2014 use data/field-history-tracking.\
  \ NOT for Shield Field Audit Trail \u2014 use security/field-audit-trail."
---
