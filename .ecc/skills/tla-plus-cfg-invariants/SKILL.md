---
name: tla-plus-cfg-invariants
description: "Configuring TLC model checker CFG invariants (TypeOK, Safety, MutualExclusion)"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "invariants"
  - "tla plus cfg invariants"
  - "tla-plus-cfg-invariants"
  - "tla-plus-cfg-invariants execute"
  - "tla-plus-cfg-invariants verify"
---

# Tla Plus Cfg Invariants Skill

The `tla-plus-cfg-invariants` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **TLA+ Foundation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `TLA+ Consensus Checker`.
