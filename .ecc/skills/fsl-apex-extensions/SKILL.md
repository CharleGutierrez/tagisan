...
description: "Use when writing Apex that calls Field Service Lightning scheduling APIs \u2014 AppointmentBookingService,\
  \ ScheduleService, GradeSlotsService, or OAAS \u2014 to book, schedule, grade, or\
  \ optimize service appointments programmatically. Trigger keywords: FSL Apex namespace,\
  \ GetSlots, schedule service appointment via code, appointment booking API, FSL\
  \ optimization API. NOT for scheduling policy or work rule config \u2014 use admin/fsl-scheduling-policies.\
  \ NOT for optimization-mode and territory-sizing design \u2014 use architect/fsl-optimization-architecture."
---
# FSL Apex Extensions
