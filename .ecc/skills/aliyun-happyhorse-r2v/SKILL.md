...
description: Use when generating videos that fuse 1-9 reference images with DashScope HappyHorse
  1.0 reference-to-video model (happyhorse-1.0-r2v). Use when implementing multi-subject
  reference-to-video synthesis where prompts cite the input images as character1..N
  via the video-synthesis async API.
...
---
