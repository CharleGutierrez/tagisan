---
name: composio-servicenow-itsm
description: "ServiceNow incident lifecycle, change requests, and CMDB CI updates"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio servicenow itsm"
  - "composio-dev"
  - "composio-servicenow-itsm"
  - "composio-servicenow-itsm execute"
  - "composio-servicenow-itsm verify"
  - "enterprise"
  - "itsm"
---

# Composio Servicenow Itsm Skill

The `composio-servicenow-itsm` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-servicenow-itsm",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
