...
description: "Use when designing or managing Data Model Objects (DMOs) in Salesforce Data Cloud\
  \ \u2014 covers DMO schema design, subject area governance, data relationships between\
  \ DMOs, XMD (extended metadata) layer management, data transforms (streaming vs.\
  \ batch), and mandatory DMO requirements for identity resolution. NOT for configuring\
  \ source connectors or the DLO-to-DMO ingestion mapping \u2014 use data/data-cloud-data-streams.\
  \ NOT for overall Data Cloud architecture, activation targets or segmentation strategy\
  \ \u2014 use architect/data-cloud-architecture."
---
