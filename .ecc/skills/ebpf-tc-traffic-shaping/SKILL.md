---
name: ebpf-tc-traffic-shaping
description: "Traffic Control (cls_bpf) packet classification, rate limiting, and DSCP remarking"
version: 1.0.0
...
triggers:
  - "ebpf"
  - "ebpf tc traffic shaping"
  - "ebpf-io"
  - "ebpf-tc-traffic-shaping"
  - "ebpf-tc-traffic-shaping execute"
  - "ebpf-tc-traffic-shaping verify"
  - "hardware"
  - "kernel"
  - "low-level"
---

# Ebpf Tc Traffic Shaping Skill

The `ebpf-tc-traffic-shaping` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **eBPF.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / libbpf-rs / AgentShield`.
...
- **Subsystem Binding**: `Native Rust / libbpf-rs / AgentShield`
...
```json
{
  "skill": "ebpf-tc-traffic-shaping",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "eBPF.io",
  "integration_target": "Native Rust / libbpf-rs / AgentShield",
