---
name: colibri-semantic-invariant-guard
description: "Zero lossy schema truncation enforcing complete compiler diagnostic preservation"
version: 1.0.0
...
triggers:
  - "ai"
  - "colibri"
  - "colibri semantic invariant guard"
  - "colibri-semantic-invariant-guard"
  - "colibri-semantic-invariant-guard execute"
  - "colibri-semantic-invariant-guard verify"
  - "colibrì"
  - "cuda"
  - "gguf"
---

# Colibri Semantic Invariant Guard Skill

The `colibri-semantic-invariant-guard` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Colibrì MoE Architecture** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Semantic Invariant Guard`.
...
```json
{
  "skill": "colibri-semantic-invariant-guard",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Colibrì MoE Architecture",
