...
description: "Programmatic record access in Financial Services Cloud using Compliant Data Sharing\
  \ (CDS): inserting AccountParticipant/OpportunityParticipant records, working with\
  \ ParticipantRole and ParticipantGroup objects, verifying sharing coverage, and\
  \ CDS recalculation behavior. NOT for enabling CDS in Setup, OWDs, or Participant\
  \ Role setup \u2014 use admin/compliant-data-sharing-setup. NOT for standard Apex\
  \ managed sharing on non-FSC objects \u2014 use apex/apex-managed-sharing."
---
