...
description: "Use when creating, assigning, or checking custom permissions to control feature access\
  \ beyond CRUD and FLS. Trigger keywords: 'custom permission', 'FeatureManagement.checkPermission',\
  \ '$Permission global variable', 'feature gate', 'named access grant', 'beta feature\
  \ flag'. NOT for gating Apex service code and its tests \u2014 use apex/apex-custom-permissions-check.\
  \ NOT for permission set design \u2014 use admin/permission-set-architecture."
---
# Custom Permissions
