...
description: "Use this skill when creating, uploading, or rotating certificates in Salesforce,\
  \ configuring mutual TLS (mTLS) client authentication, managing the Java KeyStore\
  \ for CA-signed certificates, diagnosing certificate expiry. NOT for Shield Platform\
  \ Encryption key management or Named Credential setup \u2014 use integration/named-credentials-setup."
---
