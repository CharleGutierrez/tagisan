...
description: "Use when uploading, validating, or deploying a change set between Salesforce orgs\
  \ through Setup UI. Trigger keywords: 'change set upload', 'validate change set',\
  \ 'deploy inbound change set', 'change set stuck', 'missing dependency change set',\
  \ 'change set component error'. NOT for release planning or rollback strategy \u2014\
  \ use admin/change-management-and-deployment. NOT for DevOps Center pipelines \u2014\
  \ use devops/devops-center-pipeline. NOT for scripted or CI/CD deploys \u2014 use\
