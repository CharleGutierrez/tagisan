---
name: soql-security
description: "Use when writing, reviewing, or troubleshooting Apex queries that may expose SOQL\
  \ injection or CRUD/FLS issues. Triggers: 'Database.query', 'WITH USER_MODE', 'WITH\
  \ SECURITY_ENFORCED', 'stripInaccessible', 'security review finding'. NOT for enforcing\
  \ FLS on records before DML \u2014 use apex/apex-stripinaccessible-and-fls-enforcement.\
