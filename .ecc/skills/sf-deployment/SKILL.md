---
name: sf-deployment
description: Use when deploying to a Salesforce org. SF CLI source deploy, metadata API, package
  deployment, validation-then-quick-deploy, rollback planning, and production deployment
  best practices.
...
---
