---
name: drag-and-drop
description: Implement drag-and-drop in LWC using HTML5 Drag and Drop API, keyboard alternatives,
  accessible announcements, and file drop zones. NOT for handling a file the user
  dropped onto the component - use lwc/file-upload-patterns.
...
---
# LWC Drag and Drop
