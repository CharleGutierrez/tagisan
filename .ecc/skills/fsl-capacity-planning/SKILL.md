...
description: "Use this skill to configure and manage Field Service Lightning workforce capacity\
  \ \u2014 covering ServiceResourceCapacity for individual resource caps, WorkCapacityLimit\
  \ for territory-level demand throttling, and reporting strategies for capacity vs.\
  \ utilization analysis. NOT for resource skills, certifications, or preference setup\
  \ \u2014 use admin/fsl-resource-management. NOT for work rules and service objectives\
  \ \u2014 use admin/fsl-scheduling-policies. NOT for Omni-Channel agent capacity\
