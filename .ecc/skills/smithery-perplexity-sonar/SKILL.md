---
name: smithery-perplexity-sonar
description: "Online reasoning engine with citations and confidence metrics"
version: 1.0.0
...
triggers:
  ...
  - "perplexity"
  - "smithery"
  - "smithery perplexity sonar"
  - "smithery-ai"
  - "smithery-perplexity-sonar"
  - "smithery-perplexity-sonar execute"
  - "smithery-perplexity-sonar verify"
---

# Smithery Perplexity Sonar Skill

The `smithery-perplexity-sonar` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-perplexity-sonar",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
