---
name: linux-zfs-arc-cache-tuning
description: "ZFS Adaptive Replacement Cache tuning and persistent L2ARC cache management"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux zfs arc cache tuning"
  - "linux-zfs-arc-cache-tuning"
  - "linux-zfs-arc-cache-tuning execute"
  - "linux-zfs-arc-cache-tuning verify"
---

# Linux Zfs Arc Cache Tuning Skill

The `linux-zfs-arc-cache-tuning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OpenZFS Docs** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Colibrì Storage`.
...
```json
{
  "skill": "linux-zfs-arc-cache-tuning",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "OpenZFS Docs",
