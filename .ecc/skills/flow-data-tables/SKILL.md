...
description: "Use the Data Table screen component for selecting rows from collections in Screen\
  \ Flows, including single/multi-select and inline actions. NOT for displaying read-only\
  \ data outside flows \u2014 use flow/screen-flow-choice-component-selection."
---
# Flow Data Tables
