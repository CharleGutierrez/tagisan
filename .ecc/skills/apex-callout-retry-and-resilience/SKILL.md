...
description: "Strategy layer for resilient Apex HTTP callouts: bounded retry with backoff, queueable\
  \ async retry chains, circuit-breaker via Platform Cache, idempotency keys, dead-letter\
  \ pattern. NOT for callout authentication \u2014 use apex/apex-named-credentials-patterns.\
