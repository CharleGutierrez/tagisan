...
description: "Use when configuring, troubleshooting, or choosing between Remote Action types in\
  \ OmniScript or FlexCard. Triggers: 'remote action', 'OmniScript action', 'IP action',\
  \ 'Apex action element'. NOT for Integration Procedure internal design or generic\
  \ Apex callout patterns \u2014 use omnistudio/integration-procedures."
---
