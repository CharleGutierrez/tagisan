...
description: "Use when enabling Data Cloud (Data 360) in an org, creating data spaces, assigning\
  \ permission sets, registering ingestion API sources, or configuring activation\
  \ targets. Triggers: 'enable data cloud', 'data spaces setup', 'data cloud permission\
  \ sets', 'ingestion API connected app', 'activation target setup', 'data cloud licensing',\
  \ 'dedicated home org vs existing org'. NOT for data streams or DLO-to-DMO mapping\
  \ \u2014 use data/data-cloud-data-streams. NOT for identity resolution rulesets\
  \ \u2014 use admin/data-cloud-identity-resolution."
---
