...
description: "Audit Experience Cloud guest user access \u2014 object/field CRUD, sharing, login,\
  \ and hardening. Triggers: guest user audit, Experience Cloud guest security, site\
  \ guest profile. NOT for member/community user provisioning \u2014 use admin/experience-cloud-member-management.\
  \ NOT for profile/permset architecture \u2014 use admin/permission-sets-vs-profiles."
---
