...
description: "Lifecycle management for Prompt Builder templates: version, test, promote, roll back\
  \ via CMDT-backed bindings. NOT for source-control layout, model-version pinning,\
  \ or versioning agent topic prompts \u2014 use agentforce/agentforce-prompt-versioning.\
  \ NOT for authoring a template in Prompt Builder \u2014 use agentforce/prompt-builder-templates."
---
