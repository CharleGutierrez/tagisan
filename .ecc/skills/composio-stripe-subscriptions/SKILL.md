---
name: composio-stripe-subscriptions
description: "Stripe customer subscription billing, invoice generation, and refunds"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio stripe subscriptions"
  - "composio-dev"
  - "composio-stripe-subscriptions"
  - "composio-stripe-subscriptions execute"
  - "composio-stripe-subscriptions verify"
  - "enterprise"
  - "saas"
---

# Composio Stripe Subscriptions Skill

The `composio-stripe-subscriptions` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-stripe-subscriptions",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
