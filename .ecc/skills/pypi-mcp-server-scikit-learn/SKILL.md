---
name: pypi-mcp-server-scikit-learn
description: "Machine learning clustering, dimensionality reduction, and classification models"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server scikit learn"
  - "pypi-mcp-server-scikit-learn"
  - "pypi-mcp-server-scikit-learn execute"
  - "pypi-mcp-server-scikit-learn verify"
  - "scikit"
---

# Pypi Mcp Server Scikit Learn Skill

The `pypi-mcp-server-scikit-learn` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-scikit-learn",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
