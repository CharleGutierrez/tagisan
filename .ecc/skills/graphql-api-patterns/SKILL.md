...
description: "Use when designing or reviewing Salesforce GraphQL API usage, especially endpoint\
  \ selection, field shaping, connection-based pagination, LWC wire adapters, and\
  \ GraphQL vs REST tradeoffs. Triggers: 'GraphQL API'. NOT for building a custom\
  \ GraphQL server or for generic REST integration design with no  \u2014 use integration/rest-api-patterns."
---
