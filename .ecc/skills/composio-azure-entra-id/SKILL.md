---
name: composio-azure-entra-id
description: "Microsoft Entra ID (Azure AD) enterprise app consent and tenant audits"
version: 1.0.0
...
triggers:
  ...
  - "azure"
  - "composio"
  - "composio azure entra id"
  - "composio-azure-entra-id"
  - "composio-azure-entra-id execute"
  - "composio-azure-entra-id verify"
  - "composio-dev"
  - "enterprise"
---

# Composio Azure Entra Id Skill

The `composio-azure-entra-id` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / AgentShield`.
