...
description: "Use when building or reviewing Apex triggers on the Opportunity object \u2014 stage-change\
  \ detection, amount rollups to Account, OpportunityTeamMember sync, or OpportunitySplit\
  \ calculations. Trigger keywords: stage change automation, opportunity rollup, team\
  \ member sync, split percentage, Trigger.oldMap stage comparison. NOT for generic\
  \ trigger framework structure (use apex/trigger-framework) and NOT for Flow-based\
  \ opportunity automation (use admin/flow-for-admins)."
---
