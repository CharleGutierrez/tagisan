...
description: "Managing OAuth policies, IP relaxation, session security, PKCE, and credential rotation\
  \ for Salesforce Connected Apps. Use when hardening Connected App security, rotating\
  \ client secrets, configuring IP restrictions, or requiring high-assurance sessions.\
  \ NOT for basic Connected App setup or creation \u2014 use admin/connected-app-troubleshooting."
---
