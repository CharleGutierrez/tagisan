---
name: colibri-moe-expert-router
description: "Top-k sparse expert gating and dynamic routing across local Mixture-of-Experts"
version: 1.0.0
...
triggers:
  - "ai"
  - "colibri"
  - "colibri moe expert router"
  - "colibri-moe-expert-router"
  - "colibri-moe-expert-router execute"
  - "colibri-moe-expert-router verify"
  - "colibrì"
  - "cuda"
  - "expert"
---

# Colibri Moe Expert Router Skill

The `colibri-moe-expert-router` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Colibrì MoE Architecture** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Colibrì Superpowers`.
...
- **Subsystem Binding**: `Colibrì Superpowers`
...
```json
{
  "skill": "colibri-moe-expert-router",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Colibrì MoE Architecture",
  "integration_target": "Colibrì Superpowers",
