---
name: swarm-git-worktree-isolation
description: "Branching agent tasks into ephemeral git worktrees with diff validation before merge"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Git Internals / Tagisan"
tags:
  - consensus
  - debate
  - git
...
triggers:
  ...
  - "isolation"
  - "moa"
  - "swarm git worktree isolation"
  - "swarm-git-worktree-isolation"
  - "swarm-git-worktree-isolation execute"
  - "swarm-git-worktree-isolation verify"
---

# Swarm Git Worktree Isolation Skill

The `swarm-git-worktree-isolation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Git Internals / Tagisan** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `GitWorktreeMergeArbiter`.
...
- **Subsystem Binding**: `GitWorktreeMergeArbiter`
...
```json
{
  "skill": "swarm-git-worktree-isolation",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Git Internals / Tagisan",
  "integration_target": "GitWorktreeMergeArbiter",
