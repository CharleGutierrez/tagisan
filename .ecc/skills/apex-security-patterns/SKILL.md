...
description: "Use when designing, reviewing, or debugging Apex execution context, sharing keywords,\
  \ CRUD/FLS enforcement, system-vs-user mode behavior, or secure write patterns.\
  \ Triggers: 'with sharing', 'inherited sharing', 'AuraEnabled security', 'what execution\
  \ context does this class run in', 'system mode vs user mode'. NOT for remediating\
  \ a CRUD/FLS finding \u2014 use apex/apex-stripinaccessible-and-fls-enforcement\
  \ for stripInaccessible, AccessType, SObjectAccessDecision and WITH USER_MODE mechanics.\
  \ NOT for SOQL injection review alone \u2014 use apex/soql-security."
---
