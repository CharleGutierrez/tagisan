...
description: "Use this skill when designing data quality gates, auditing data quality posture,\
  \ troubleshooting validation failures, or implementing governance controls (field\
  \ history, GDPR erasure, data classification, duplicate strategy). Trigger keywords:\
  \ validation rules, field history, duplicate management, GDPR right to erasure,\
  \ data retention, data classification, Shield Field Audit Trail, Einstein Data Detect,\
  \ Matching Rules, PII anonymization. NOT for configuring matching and duplicate\
  \ rules in Setup \u2014 use admin/duplicate-management. NOT for executing a bulk\
  \ data migration \u2014 use data/data-migration-planning."
---
