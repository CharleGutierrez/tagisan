---
name: llvm-ir-inline-cost-heuristics
description: "Target-aware function inlining threshold tuning based on call site frequency"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "heuristics"
  - "llvm ir inline cost heuristics"
  - "llvm-ir-inline-cost-heuristics"
  - "llvm-ir-inline-cost-heuristics execute"
  - "llvm-ir-inline-cost-heuristics verify"
---

# Llvm Ir Inline Cost Heuristics Skill

The `llvm-ir-inline-cost-heuristics` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
```json
{
  "skill": "llvm-ir-inline-cost-heuristics",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
