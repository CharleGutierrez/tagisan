...
description: "Designing high availability and disaster recovery strategies for Salesforce: Trust\
  \ site monitoring, backup strategies, cross-region considerations, business continuity\
  \ planning, RTO/RPO target definition, and failover patterns for integrations. Use\
  \ when designing org resilience architecture, planning for outages, or defining\
  \ recovery objectives. NOT for picking a backup product or restore mechanics \u2014\
  \ use data/salesforce-backup-and-restore. NOT for a security posture review \u2014\
