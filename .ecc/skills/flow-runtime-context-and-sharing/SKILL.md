...
description: "Flow runtime sharing context \u2014 run in user vs system mode, record access in\
  \ Flow. Triggers: Flow sharing, run in system mode, Flow user context. NOT for Apex\
  \ sharing declarations \u2014 use apex/apex-with-without-sharing-decision."
---
