...
description: "Design IP-based access controls: profile login IP ranges, org-wide trusted IPs, IP\
  \ relaxation per profile, and the interaction with MFA and SSO. Trigger keywords:\
  \ login IP range, trusted IP, IP relaxation, restricted IP, IP allowlist, login\
  \ hours. NOT for CSP Trusted Sites, CORS allowlists, TLS requirements, or troubleshooting\
  \ a CSP violation \u2014 use security/network-security-and-trusted-ips."
---
