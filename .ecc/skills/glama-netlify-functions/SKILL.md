---
name: glama-netlify-functions
description: "Netlify serverless function trigger, build inspection, and preview deployment"
version: 1.0.0
...
triggers:
  - "functions"
  - "glama"
  - "glama netlify functions"
  - "glama-ai"
  - "glama-netlify-functions"
  - "glama-netlify-functions execute"
  - "glama-netlify-functions verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Netlify Functions Skill

The `glama-netlify-functions` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
