...
description: "Use this skill when writing acceptance criteria for Salesforce features, structuring\
  \ UAT test scripts from user stories, classifying defects found during UAT, or planning\
  \ regression testing before a Salesforce release. Trigger keywords: UAT, user acceptance\
  \ testing, test script, acceptance criteria, defect classification, regression testing,\
  \ test plan, test case. NOT for Given/When/Then AC syntax \u2014 use admin/acceptance-criteria-given-when-then.\
  \ NOT for automated Flow or Apex test coverage \u2014 use flow/flow-testing."
---
