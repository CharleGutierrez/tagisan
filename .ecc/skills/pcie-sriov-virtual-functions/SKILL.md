---
name: pcie-sriov-virtual-functions
description: "Single Root I/O Virtualization VF allocation for hardware-isolated network slices"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "pci-sig"
  - "pcie sriov virtual functions"
  - "pcie-sriov-virtual-functions"
  - "pcie-sriov-virtual-functions execute"
  - "pcie-sriov-virtual-functions verify"
---

# Pcie Sriov Virtual Functions Skill

The `pcie-sriov-virtual-functions` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PCI-SIG Specifications** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `HardwareEngine`.
...
```json
{
  "skill": "pcie-sriov-virtual-functions",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "PCI-SIG Specifications",
