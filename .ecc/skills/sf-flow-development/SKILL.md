...
description: "Salesforce Flow development \u2014 flow types, patterns, bulkification, error handling,\
  \ testing, subflows, Flow vs Apex. Use when building or reviewing Flows. Do NOT\
  \ use for pure Apex or Platform Event architecture."
---
