---
name: composio-dynamics-365
description: "Microsoft Dynamics 365 enterprise account sync and ERP data retrieval"
version: 1.0.0
...
triggers:
  ...
  - "api-orchestration"
  - "composio"
  - "composio dynamics 365"
  - "composio-dev"
  - "composio-dynamics-365"
  - "composio-dynamics-365 execute"
  - "composio-dynamics-365 verify"
  - "dynamics"
---

# Composio Dynamics 365 Skill

The `composio-dynamics-365` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
