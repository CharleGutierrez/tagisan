---
name: pypi-mcp-server-rag-docs
description: "Local document vectorization and retrieval with chunking and reranking"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server rag docs"
  - "pypi-mcp-server-rag-docs"
  - "pypi-mcp-server-rag-docs execute"
  - "pypi-mcp-server-rag-docs verify"
  - "rag"
---

# Pypi Mcp Server Rag Docs Skill

The `pypi-mcp-server-rag-docs` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-rag-docs",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
