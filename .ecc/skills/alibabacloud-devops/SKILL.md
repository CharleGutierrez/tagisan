...
description: "Automate Alibaba Cloud Yunxiao DevOps tasks \u2014 create and run pipelines, manage\
  \ code repositories and merge requests, track work items and sprints, create test\
  \ cases, manage artifacts, and drive application release workflows across 8 Yunxiao\
  \ products. Triggers: \"Yunxiao\", \"DevOps\", \"pipeline\", \"code repository\"\
  , \"merge request\", \"work item\", \"sprint\", \"test case\", \"application delivery\"\
  , \"artifact repository\", \"Codeup\", \"Flow\", \"Projex\", \"AppStack\", \"Packages\"\
  , \"Testhub\""
---
