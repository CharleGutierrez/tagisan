---
name: scoping-rules
description: 'Use when setting the default filtered set of records a user sees in list views, reports
  and SOQL without removing their access. Trigger keywords: scoping rule, Filter by
  scope, default record scope, RestrictionRule enforcementType Scoping, Object Manager
  scoping rule, recordFilter. NOT for the SOQL USING SCOPE clause - use apex/soql-using-scope-clause.
  NOT for blocking record access - use admin/restriction-rules.'
---
# Scoping Rules
