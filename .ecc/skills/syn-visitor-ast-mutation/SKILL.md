---
name: syn-visitor-ast-mutation
description: "In-place syntax tree visitor applying surgical span substitutions to Rust code"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "syn Docs (docs.rs)"
tags:
  - ast
  - compiler
  - formal-methods
...
triggers:
  ...
  - "mutation"
  - "symbolic"
  - "syn visitor ast mutation"
  - "syn-visitor-ast-mutation"
  - "syn-visitor-ast-mutation execute"
  - "syn-visitor-ast-mutation verify"
---

# Syn Visitor Ast Mutation Skill

The `syn-visitor-ast-mutation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **syn Docs (docs.rs)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Self-Healing Compiler`.
...
```json
{
  "skill": "syn-visitor-ast-mutation",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "syn Docs (docs.rs)",
