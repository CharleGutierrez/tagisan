...
description: "Use this skill when setting up or extending Salesforce Loyalty Management \u2014\
  \ including program and currency creation, tier group design, qualifying vs. non-qualifying\
  \ point currency separation, DPE batch job. NOT for Marketing Cloud engagement program\
  \ design or B2B loyalty via Sales Cloud \u2014 use architect/loyalty-program-architecture."
---
