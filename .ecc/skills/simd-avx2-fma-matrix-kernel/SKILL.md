---
name: simd-avx2-fma-matrix-kernel
description: "Fused Multiply-Add AVX2 8-wide float kernels for quantized tensor dequantization"
version: 1.0.0
...
triggers:
  ...
  - "intel"
  - "kernel"
  - "simd avx2 fma matrix kernel"
  - "simd-avx2-fma-matrix-kernel"
  - "simd-avx2-fma-matrix-kernel execute"
  - "simd-avx2-fma-matrix-kernel verify"
---

# Simd Avx2 Fma Matrix Kernel Skill

The `simd-avx2-fma-matrix-kernel` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Intel Architecture Manuals** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tensor Engine / SIMD`.
...
```json
{
  "skill": "simd-avx2-fma-matrix-kernel",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Intel Architecture Manuals",
