...
description: "Use this skill when mapping care coordination process requirements for Health Cloud:\
  \ designing care team workflows, transition of care handoffs, social determinants\
  \ of health (SDOH) barrier tracking, and care gap identification. NOT for building\
  \ care plan templates, problems, and goals \u2014 use admin/care-plan-configuration.\
  \ NOT for referral routing and provider networks \u2014 use admin/referral-management-health."
---
