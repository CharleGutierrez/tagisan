---
name: smt-z3-qf-arrays-extensionality
description: "Array theory reasoning with read-over-write axioms for buffer safety proofs"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "SMT-LIB / Z3 Project"
tags:
  - arrays
  - ast
  - compiler
...
triggers:
  ...
  - "extensionality"
  - "formal-methods"
  - "smt z3 qf arrays extensionality"
  - "smt-z3-qf-arrays-extensionality"
  - "smt-z3-qf-arrays-extensionality execute"
  - "smt-z3-qf-arrays-extensionality verify"
---

# Smt Z3 Qf Arrays Extensionality Skill

The `smt-z3-qf-arrays-extensionality` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / Z3 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Z3 SMT Solver Tool`.
...
- **Subsystem Binding**: `Z3 SMT Solver Tool`
...
```json
{
  "skill": "smt-z3-qf-arrays-extensionality",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "SMT-LIB / Z3 Project",
  "integration_target": "Z3 SMT Solver Tool",
