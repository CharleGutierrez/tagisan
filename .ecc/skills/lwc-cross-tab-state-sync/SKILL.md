...
description: "Use when an LWC needs to react to events that happen in another browser tab \u2014\
  \ record updates, login state, draft autosave, console-tab navigation. Triggers:\
  \ 'sync data across tabs', 'BroadcastChannel LWC', 'storage event fallback'. NOT\
  \ for state sync within the same Lightning page \u2014 use lwc/component-communication.\
  \ NOT for console tab and utility bar APIs \u2014 use lwc/lwc-console-workspace-api."
---
