---
name: quant-k-quants-q4-k-m-dequant
description: "Block-based K-quants (Q4_K_M, Q5_K_M) dot products using SIMD vectorized unrolling"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "GGML Library Reference"
tags:
  - ai
  - cuda
  - dequant
...
triggers:
  ...
  - "ggml"
  - "gguf"
  - "quant k quants q4 k m dequant"
  - "quant-k-quants-q4-k-m-dequant"
  - "quant-k-quants-q4-k-m-dequant execute"
  - "quant-k-quants-q4-k-m-dequant verify"
---

# Quant K Quants Q4 K M Dequant Skill

The `quant-k-quants-q4-k-m-dequant` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **GGML Library Reference** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Quant`.
...
- **Subsystem Binding**: `Tensor Engine / Quant`
...
```json
{
  "skill": "quant-k-quants-q4-k-m-dequant",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "GGML Library Reference",
  "integration_target": "Tensor Engine / Quant",
