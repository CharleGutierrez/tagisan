...
description: "Use when a Flow needs to do work that must survive the triggering transaction \u2014\
  \ post-commit notifications, callouts, audit rows, or compensating actions. Covers\
  \ Flow Transaction Control element, scheduled paths, Platform Event + finalizer.\
  \ NOT for general Flow async decisions (see async-selection) \u2014 use apex/apex-transaction-finalizers."
---
