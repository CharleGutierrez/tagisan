---
name: zapier-zoominfo-enterprise
description: "ZoomInfo enterprise corporate hierarchy, org charts, and intent signals"
version: 1.0.0
...
triggers:
  ...
  - "workflow"
  - "zapier"
  - "zapier zoominfo enterprise"
  - "zapier-zoominfo-enterprise"
  - "zapier-zoominfo-enterprise execute"
  - "zapier-zoominfo-enterprise verify"
---

# Zapier Zoominfo Enterprise Skill

The `zapier-zoominfo-enterprise` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-zoominfo-enterprise",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
