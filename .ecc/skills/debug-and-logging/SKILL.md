...
description: "Use when diagnosing Apex behavior with debug logs, choosing log levels, or replacing\
  \ `System.debug` habits with structured production logging and async job monitoring.\
  \ Triggers: 'debug log', 'System.debug', 'logging framework', 'AsyncApexJob monitoring',\
  \ 'production logs'. NOT for trace flag setup, reading a log, or the Developer Console\
  \ \u2014 use apex/debug-logs-and-developer-console. NOT for building a custom Log__c\
  \ framework \u2014 use apex/custom-logging-and-monitoring."
---
