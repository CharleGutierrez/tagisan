---
name: agent-chain-of-verification-cove
description: "Generating verification questions and checking factual grounding before emitting answers"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent chain of verification cove"
  - "agent-chain-of-verification-cove"
  - "agent-chain-of-verification-cove execute"
  - "agent-chain-of-verification-cove verify"
  - "arxiv"
  - "chain"
  - "consensus"
  - "cove"
...
# Agent Chain Of Verification Cove Skill

The `agent-chain-of-verification-cove` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Verification Loop`.
...
- **Subsystem Binding**: `Verification Loop`
...
```json
{
  "skill": "agent-chain-of-verification-cove",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
  "integration_target": "Verification Loop",
