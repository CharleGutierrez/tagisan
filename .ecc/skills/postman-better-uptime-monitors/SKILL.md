---
name: postman-better-uptime-monitors
description: "Better Uptime heartbeat monitor verification and incident notification"
version: 1.0.0
...
triggers:
  ...
  - "monitors"
  - "postman"
  - "postman better uptime monitors"
  - "postman-better-uptime-monitors"
  - "postman-better-uptime-monitors execute"
  - "postman-better-uptime-monitors verify"
---

# Postman Better Uptime Monitors Skill

The `postman-better-uptime-monitors` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-better-uptime-monitors",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
