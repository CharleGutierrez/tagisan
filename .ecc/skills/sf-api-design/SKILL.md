---
name: sf-api-design
description: "Salesforce API design \u2014 custom REST endpoints, batch operations, Composite API,\
  \ error envelopes, auth. Use when designing APIs exposed from Salesforce. Do NOT\
  \ use for outbound callouts or Platform Events."
---
