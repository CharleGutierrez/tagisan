...
description: "Use this skill when architecting Health Cloud orgs that must satisfy geographic data\
  \ residency, HIPAA, GDPR, or national health-data regulations on Hyperforce \u2014\
  \ scoping the HIPAA BAA, mapping transient processing exceptions, and the features\
  \ that require separate compliance addenda. NOT for choosing a Hyperforce region\
  \ or planning a Hyperforce migration outside healthcare \u2014 use architect/hyperforce-architecture.\
  \ NOT for Shield encryption and HIPAA technical safeguards \u2014 use architect/hipaa-compliance-architecture."
---
