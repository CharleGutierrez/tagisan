...
description: "Configure platform-level global search in a Salesforce org \u2014 per-object Search\
  \ Layouts (Search Results, Lookup Dialogs, Lookup Phone Dialogs, Tab columns), the\
  \ Setup \u2192 Search Settings page (Sidebar Search, Lookup Auto-Completion, Drop-Down\
  \ List size), and Synonym Groups (Setup \u2192 User Interface \u2192 Synonyms).\
  \ NOT for Einstein Search personalization signals or Natural Language Search (use\
  \ agentforce/einstein-search-personalization), NOT for Experience Cloud site Search\
  \ Manager (use lwc/experience-cloud-search-customization), NOT for SOSL query authoring\
  \ (use data/sosl-search-patterns), NOT for Commerce storefront search tuning."
---
