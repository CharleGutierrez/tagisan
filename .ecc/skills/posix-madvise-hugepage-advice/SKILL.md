---
name: posix-madvise-hugepage-advice
description: "MADV_HUGEPAGE and MADV_WILLNEED advice to OS kernel for large GGUF weights"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "low-level"
  - "posix madvise hugepage advice"
  - "posix-madvise-hugepage-advice"
  - "posix-madvise-hugepage-advice execute"
  - "posix-madvise-hugepage-advice verify"
---

# Posix Madvise Hugepage Advice Skill

The `posix-madvise-hugepage-advice` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **POSIX IEEE 1003.1** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `GGUF Engine / Mmap`.
...
- **Subsystem Binding**: `GGUF Engine / Mmap`
...
```json
{
  "skill": "posix-madvise-hugepage-advice",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "POSIX IEEE 1003.1",
  "integration_target": "GGUF Engine / Mmap",
