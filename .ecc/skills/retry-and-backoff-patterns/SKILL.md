...
description: "Implementing resilient integration retry logic in Salesforce: exponential backoff,\
  \ jitter, idempotency keys, dead-letter queues, and circuit breaker patterns for\
  \ Apex callouts. Use when designing callout retry behavior, preventing thundering-herd\
  \ issues, or handling persistent integration failures. NOT for how many callouts\
  \ fit in a transaction or CalloutException after DML \u2014 use integration/callout-limits-and-async-patterns.\
  \ NOT for chaining or debugging Queueable jobs that make no callout \u2014 use apex/apex-queueable-patterns."
---
