...
description: "@TestSetup method semantics: one-time creation per test class, isolation behavior,\
  \ @TestVisible, System.runAs, Test.startTest/stopTest governor reset, mixed-DML\
  \ boundaries. NOT for building a reusable test data factory class \u2014 use apex/test-data-factory-patterns.\
  \ NOT for HTTP callout mocks \u2014 use apex/apex-http-callout-mocking."
---
