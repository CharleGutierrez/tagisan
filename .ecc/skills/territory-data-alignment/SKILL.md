...
description: "Use this skill when querying, migrating, auditing, or maintaining account-to-territory\
  \ and user-to-territory data in a Salesforce Enterprise Territory Management (ETM)\
  \ org. Covers Territory2ModelHistory audit queries, the Track Territory Assignment\
  \ History feature (GA Spring '25), and coverage analysis SOQL with the AssociationCause\
  \ filter. Trigger keywords: ObjectTerritory2Association, UserTerritory2Association,\
  \ territory assignment data, territory coverage analysis, territory association\
  \ bulk load, ETM data migration, track territory assignment history. NOT for setting\
  \ up the territory model or its assignment rules \u2014 use admin/enterprise-territory-management.\
  \ NOT for writing Apex that assigns territories \u2014 use apex/territory-api-and-assignment."
---
