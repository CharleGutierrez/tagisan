...
description: "Use this skill when bulk loading FSL ServiceResource records, ServiceResourceSkill\
  \ data, skill certifications, capacity-based resource setup, and availability patterns.\
  \ Trigger keywords: FSL resource migration, ServiceResourceSkill bulk load, skill\
  \ certification tracking FSL, capacity-based resource, service resource availability.\
  \ NOT for configuring resources and skills in Setup rather than loading them \u2014\
  \ use admin/fsl-resource-management. NOT for ServiceTerritoryMember and territory\
  \ bulk load \u2014 use data/fsl-territory-data-setup."
---
