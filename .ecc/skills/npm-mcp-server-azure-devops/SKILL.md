---
name: npm-mcp-server-azure-devops
description: "Azure DevOps work items, build pipelines, and artifact feed automation"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server azure devops"
  - "npm-mcp-server-azure-devops"
  - "npm-mcp-server-azure-devops execute"
  - "npm-mcp-server-azure-devops verify"
---

# Npm Mcp Server Azure Devops Skill

The `npm-mcp-server-azure-devops` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "npm-mcp-server-azure-devops",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "NPM Registry",
