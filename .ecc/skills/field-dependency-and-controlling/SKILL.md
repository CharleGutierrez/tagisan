...
description: 'Dependent picklists in Salesforce: controlling field (picklist or checkbox), dependent
  picklist, valueSettings matrix in metadata, API behavior via SOAP/REST, LWC lightning-combobox
  with dependency. NOT for creating picklist fields or Global Value Sets and replacing
  retired values - use admin/picklist-and-value-sets. NOT for filtering picklist values
  per record type or layout - use admin/record-types-and-page-layouts.'
---
