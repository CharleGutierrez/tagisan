---
name: npm-mcp-server-todoist
description: "Task organization, project priority management, and deadline scheduling"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server todoist"
  - "npm-mcp-server-todoist"
  - "npm-mcp-server-todoist execute"
  - "npm-mcp-server-todoist verify"
  - "server"
  - "todoist"
---

# Npm Mcp Server Todoist Skill

The `npm-mcp-server-todoist` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
