...
description: "Manage the full lifecycle of Alibaba Cloud PAI DSW (Data Science Workshop) instances\
  \ \u2014 create, update, query, list, start, stop, and look up ECS specs. Triggers:\
  \ PAI DSW, DSW instance, create instance, start instance, stop instance, update\
  \ instance, query instance, instance list, ECS spec, CreateInstance, UpdateInstance,\
