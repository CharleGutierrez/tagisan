...
description: 'Create and configure Lightning apps in Salesforce Setup, add navigation items and
  tabs to apps, configure utility bar components, and control app visibility by profile
  or permission set. Trigger keywords: Lightning app, App Manager, custom tab, navigation
  bar, utility bar, app visibility. NOT for console navigation, workspace tabs and
  subtabs - use admin/service-console-configuration. NOT for the record page or app
  page inside the app - use admin/lightning-app-builder-advanced.'
---
