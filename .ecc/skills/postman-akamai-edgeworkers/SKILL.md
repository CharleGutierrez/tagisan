---
name: postman-akamai-edgeworkers
description: "Akamai EdgeWorkers JavaScript deployment and property manager rules"
version: 1.0.0
...
triggers:
  ...
  - "enterprise"
  - "postman"
  - "postman akamai edgeworkers"
  - "postman-akamai-edgeworkers"
  - "postman-akamai-edgeworkers execute"
  - "postman-akamai-edgeworkers verify"
---

# Postman Akamai Edgeworkers Skill

The `postman-akamai-edgeworkers` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-akamai-edgeworkers",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
