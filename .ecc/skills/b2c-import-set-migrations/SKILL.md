...
description: Create and apply ordered, idempotent B2C Commerce site import/export archives from
  discovered cartridge metadata and project migrations using `b2c job import-set`.
  Use this opt-in project workflow for migrations built from focused instance exports,
  repeatable setup, onboarding, and CI/CD imports that apply once per instance. Also
  covers source exclusions, post-import README notes, resetting history, and recovering
  an interrupted run.
...
---
