...
description: "Setup and configuration of Einstein for Sales AI features: Opportunity Scoring, Pipeline\
  \ Inspection AI insights, Einstein email insights and composition, and Forecasting\
  \ AI \u2014 prerequisites, license checks, feature sequencing, data readiness validation.\
  \ NOT for configuring or troubleshooting Einstein Activity Capture and Relationship\
  \ Insights in a live org \u2014 use agentforce/einstein-copilot-for-sales. NOT for\
  \ building an Agentforce agent \u2014 use agentforce/agentforce-agent-creation.\
