...
**[CTX] Session Memory Backfill** (not displayed to user): Record the identified system partition drive letter as `<SystemLetter>`. In subsequent scripts, `<SystemLetter>` refers to this drive letter.
