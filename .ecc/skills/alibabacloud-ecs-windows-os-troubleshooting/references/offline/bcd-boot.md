...
Diagnostic steps are divided into three categories: first execute "BCD File Existence and Integrity" check (Step 1), then enter "BCD Detail Check" (Step 2–4) after passing; if `<BootMode>` = `BIOS`, enter "BIOS Boot Code Check" (Step 5).
