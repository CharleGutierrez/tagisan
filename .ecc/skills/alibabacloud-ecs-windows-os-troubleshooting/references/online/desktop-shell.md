...
Diagnoses Windows logon Shell configuration, Explorer.exe process status, taskbar/start menu responsiveness, Console session status, DWM and DPI scaling. Covers 7 known issues.
...
- PowerShell script: [desktop-shell.ps1](references/online/scripts/desktop-shell.ps1) §Step 1
...
- PowerShell script: [desktop-shell.ps1](references/online/scripts/desktop-shell.ps1) §Step 2
...
- PowerShell script: [desktop-shell.ps1](references/online/scripts/desktop-shell.ps1) §Step 3
...
- PowerShell script: [desktop-shell.ps1](references/online/scripts/desktop-shell.ps1) §Step 4
...
- PowerShell script: [desktop-shell.ps1](references/online/scripts/desktop-shell.ps1) §Step 5
...
- PowerShell script: [desktop-shell.ps1](references/online/scripts/desktop-shell.ps1) §Step 6
