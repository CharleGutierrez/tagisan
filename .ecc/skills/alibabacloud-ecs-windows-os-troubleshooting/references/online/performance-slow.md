...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 1
...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 2
- PowerShell auxiliary collection:
...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 3
...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 5
...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 6
...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 7
...
- PowerShell script: [performance-slow.ps1](references/online/scripts/performance-slow.ps1) §Step 8
