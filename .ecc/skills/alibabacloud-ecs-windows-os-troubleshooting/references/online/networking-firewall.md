...
| Ping reports "General failure / 一般故障" (any localized equivalent) | Step 7 FIRST (highest priority) — this error text means the packet never left the local stack → local filtering; run after at most a quick adapter/IP sanity glance |
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 1
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 2
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 3
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 4
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 5
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 6
...
- PowerShell script: [networking-firewall.ps1](references/online/scripts/networking-firewall.ps1) §Step 7
...
Fix plans for root causes confirmed in this file are in [networking-firewall.md](references/online/fixes/networking-firewall.md).
