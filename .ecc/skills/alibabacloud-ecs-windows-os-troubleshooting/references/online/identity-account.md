...
- PowerShell script: [identity-account.ps1](references/online/scripts/identity-account.ps1) §Step 1
...
- PowerShell script: [identity-account.ps1](references/online/scripts/identity-account.ps1) §Step 2
...
- PowerShell script: [identity-account.ps1](references/online/scripts/identity-account.ps1) §Step 3
...
- PowerShell script: [identity-account.ps1](references/online/scripts/identity-account.ps1) §Step 4
