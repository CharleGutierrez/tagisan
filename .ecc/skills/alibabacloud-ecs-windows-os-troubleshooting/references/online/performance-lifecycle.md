...
- PowerShell script: [performance-lifecycle.ps1](references/online/scripts/performance-lifecycle.ps1) §Step 1
...
- PowerShell script: [performance-lifecycle.ps1](references/online/scripts/performance-lifecycle.ps1) §Step 2
...
- PowerShell script: [performance-lifecycle.ps1](references/online/scripts/performance-lifecycle.ps1) §Step 3
...
- PowerShell script: [performance-lifecycle.ps1](references/online/scripts/performance-lifecycle.ps1) §Step 4
...
- PowerShell script: [performance-lifecycle.ps1](references/online/scripts/performance-lifecycle.ps1) §Step 5
...
- PowerShell script: [performance-lifecycle.ps1](references/online/scripts/performance-lifecycle.ps1) §Step 6
