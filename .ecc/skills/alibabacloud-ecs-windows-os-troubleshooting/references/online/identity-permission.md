...
- PowerShell script: [identity-permission.ps1](references/online/scripts/identity-permission.ps1) §Step 1
...
- PowerShell script: [identity-permission.ps1](references/online/scripts/identity-permission.ps1) §Step 2
...
- PowerShell script: [identity-permission.ps1](references/online/scripts/identity-permission.ps1) §Step 3
...
- PowerShell script: [identity-permission.ps1](references/online/scripts/identity-permission.ps1) §Step 4
...
- PowerShell script: [identity-permission.ps1](references/online/scripts/identity-permission.ps1) §Step 5
...
- PowerShell script: [identity-permission.ps1](references/online/scripts/identity-permission.ps1) §Step 6
