...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 1
...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 2
...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 3
...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 4
...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 5
...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 6
...
- PowerShell script: [system-health-check.ps1](references/online/scripts/system-health-check.ps1) §Step 7

**Analysis Approach**:

1. Check security baseline configuration:
   - Normal: Firewall has at least one Profile enabled, BitLocker and Defender status as expected
   - Abnormal: Firewall all disabled or protection measures abnormal → **Anomaly item**: Security baseline anomaly (record specific items), **Severity**: Warning; route to security-bitlocker / security-malware corresponding files for review
