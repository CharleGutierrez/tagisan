...
- PowerShell script: [rdp-certificate.ps1](references/online/scripts/rdp-certificate.ps1) §Step 1
...
- PowerShell script: [rdp-certificate.ps1](references/online/scripts/rdp-certificate.ps1) §Step 2
...
- PowerShell script: [rdp-certificate.ps1](references/online/scripts/rdp-certificate.ps1) §Step 3
