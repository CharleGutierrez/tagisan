...
- PowerShell script: [security-bitlocker.ps1](references/online/scripts/security-bitlocker.ps1) §Step 1
...
- PowerShell script: [security-bitlocker.ps1](references/online/scripts/security-bitlocker.ps1) §Step 2
