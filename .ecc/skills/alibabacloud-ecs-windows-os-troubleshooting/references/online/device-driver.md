...
- PowerShell script: [device-driver.ps1](references/online/scripts/device-driver.ps1) §Step 1
...
- PowerShell script: [device-driver.ps1](references/online/scripts/device-driver.ps1) §Step 2
...
- PowerShell script: [device-driver.ps1](references/online/scripts/device-driver.ps1) §Step 3
