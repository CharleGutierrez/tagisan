...
- PowerShell script: [cloud-metaserver.ps1](references/online/scripts/cloud-metaserver.ps1) §Step 1
...
- PowerShell script: [cloud-metaserver.ps1](references/online/scripts/cloud-metaserver.ps1) §Step 2
...
- PowerShell script: [cloud-metaserver.ps1](references/online/scripts/cloud-metaserver.ps1) §Step 3
...
- PowerShell script: [cloud-metaserver.ps1](references/online/scripts/cloud-metaserver.ps1) §Step 4
...
- PowerShell script: [cloud-metaserver.ps1](references/online/scripts/cloud-metaserver.ps1) §Step 5
...
- PowerShell script: [cloud-metaserver.ps1](references/online/scripts/cloud-metaserver.ps1) §Step 6
