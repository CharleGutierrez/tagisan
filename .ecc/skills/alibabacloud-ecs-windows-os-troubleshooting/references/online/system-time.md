...
- PowerShell script: [system-time.ps1](references/online/scripts/system-time.ps1) §Step 1
...
- PowerShell script: [system-time.ps1](references/online/scripts/system-time.ps1) §Step 2
...
- PowerShell script: [system-time.ps1](references/online/scripts/system-time.ps1) §Step 3
...
- PowerShell script: [system-time.ps1](references/online/scripts/system-time.ps1) §Step 4
...
- PowerShell script: [system-time.ps1](references/online/scripts/system-time.ps1) §Step 5
...
- PowerShell script: [system-time.ps1](references/online/scripts/system-time.ps1) §Step 7
