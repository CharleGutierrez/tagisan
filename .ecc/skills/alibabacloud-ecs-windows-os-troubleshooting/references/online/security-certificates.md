...
- PowerShell script: [security-certificates.ps1](references/online/scripts/security-certificates.ps1) §Step 1
...
- PowerShell script: [security-certificates.ps1](references/online/scripts/security-certificates.ps1) §Step 2
...
- PowerShell script: [security-certificates.ps1](references/online/scripts/security-certificates.ps1) §Step 3
...
- PowerShell script: [security-certificates.ps1](references/online/scripts/security-certificates.ps1) §Step 4
