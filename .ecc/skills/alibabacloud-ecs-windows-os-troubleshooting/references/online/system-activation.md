...
- PowerShell script: [system-activation.ps1](references/online/scripts/system-activation.ps1) §Step 1
...
- PowerShell script: [system-activation.ps1](references/online/scripts/system-activation.ps1) §Step 2
...
- PowerShell script: [system-activation.ps1](references/online/scripts/system-activation.ps1) §Step 3
...
- PowerShell script: [system-activation.ps1](references/online/scripts/system-activation.ps1) §Step 4
