...
- PowerShell script: [storage-disk.ps1](references/online/scripts/storage-disk.ps1) §Step 1
...
- PowerShell script: [storage-disk.ps1](references/online/scripts/storage-disk.ps1) §Step 2
...
> **Localization note**: diskpart output language depends on the OS language environment. Chinese systems output "已启用"/"已禁用"; English systems output "Enabled"/"Disabled". Interpret the output based on the actual system language during analysis.

- PowerShell script: [storage-disk.ps1](references/online/scripts/storage-disk.ps1) §Step 3
...
- PowerShell script: [storage-disk.ps1](references/online/scripts/storage-disk.ps1) §Step 4

**Analysis Approach**:

1. Check whether the NTFS volume is approaching the maximum capacity limit corresponding to its Cluster Size:
   - NTFS maximum volume capacity = Cluster Size × 2³² (i.e., Cluster Size × 4,294,967,296). For example, the default 4KB Cluster Size corresponds to a maximum volume capacity of 16TB
...
- PowerShell script: [storage-disk.ps1](references/online/scripts/storage-disk.ps1) §Step 5
...
- PowerShell script: [storage-disk.ps1](references/online/scripts/storage-disk.ps1) §Step 6
