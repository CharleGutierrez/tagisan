...
- PowerShell script: [cloud-driver.ps1](references/online/scripts/cloud-driver.ps1) §Step 1
...
- PowerShell script: [cloud-driver.ps1](references/online/scripts/cloud-driver.ps1) §Step 2
...
- PowerShell script: [cloud-driver.ps1](references/online/scripts/cloud-driver.ps1) §Step 3
...
- PowerShell script: [cloud-driver.ps1](references/online/scripts/cloud-driver.ps1) §Step 4
