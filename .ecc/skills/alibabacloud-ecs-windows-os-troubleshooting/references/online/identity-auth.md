...
- PowerShell script: [identity-auth.ps1](references/online/scripts/identity-auth.ps1) §Step 1
...
- PowerShell script: [identity-auth.ps1](references/online/scripts/identity-auth.ps1) §Step 2
...
- PowerShell script: [identity-auth.ps1](references/online/scripts/identity-auth.ps1) §Step 3
