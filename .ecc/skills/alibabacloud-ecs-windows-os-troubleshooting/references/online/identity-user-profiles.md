...
- PowerShell script: [identity-user-profiles.ps1](references/online/scripts/identity-user-profiles.ps1) §Step 1
...
- PowerShell script: [identity-user-profiles.ps1](references/online/scripts/identity-user-profiles.ps1) §Step 2
...
- PowerShell script: [identity-user-profiles.ps1](references/online/scripts/identity-user-profiles.ps1) §Step 3
