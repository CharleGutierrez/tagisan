...
- PowerShell script: [rdp-service.ps1](references/online/scripts/rdp-service.ps1) §Step 1
...
- PowerShell script: [rdp-service.ps1](references/online/scripts/rdp-service.ps1) §Step 2
...
- PowerShell script: [rdp-service.ps1](references/online/scripts/rdp-service.ps1) §Step 3
...
- PowerShell script: [rdp-service.ps1](references/online/scripts/rdp-service.ps1) §Step 4
