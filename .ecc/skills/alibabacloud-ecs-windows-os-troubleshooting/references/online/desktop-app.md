...
- PowerShell script: [desktop-app.ps1](references/online/scripts/desktop-app.ps1) §Step 1
...
- PowerShell script: [desktop-app.ps1](references/online/scripts/desktop-app.ps1) §Step 2
...
- PowerShell script: [desktop-app.ps1](references/online/scripts/desktop-app.ps1) §Step 3
