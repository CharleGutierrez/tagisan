...
- PowerShell script: [rdp-auth.ps1](references/online/scripts/rdp-auth.ps1) §Step 1
...
- PowerShell script: [rdp-auth.ps1](references/online/scripts/rdp-auth.ps1) §Step 2
...
- PowerShell script: [rdp-auth.ps1](references/online/scripts/rdp-auth.ps1) §Step 3
...
- PowerShell script: [rdp-auth.ps1](references/online/scripts/rdp-auth.ps1) §Step 4
...
- PowerShell script: [rdp-auth.ps1](references/online/scripts/rdp-auth.ps1) §Step 5
...
- PowerShell script: [rdp-auth.ps1](references/online/scripts/rdp-auth.ps1) §Step 6
