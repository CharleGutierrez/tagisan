...
- PowerShell script: [storage-smb.ps1](references/online/scripts/storage-smb.ps1) §Step 1
...
- PowerShell script: [storage-smb.ps1](references/online/scripts/storage-smb.ps1) §Step 2
...
- PowerShell script: [storage-smb.ps1](references/online/scripts/storage-smb.ps1) §Step 3
...
- PowerShell script: [storage-smb.ps1](references/online/scripts/storage-smb.ps1) §Step 4
