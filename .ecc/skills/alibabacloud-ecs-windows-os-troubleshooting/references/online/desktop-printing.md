...
- PowerShell script: [desktop-printing.ps1](references/online/scripts/desktop-printing.ps1) §Step 1
...
- PowerShell script: [desktop-printing.ps1](references/online/scripts/desktop-printing.ps1) §Step 2
...
- PowerShell script: [desktop-printing.ps1](references/online/scripts/desktop-printing.ps1) §Step 3
