...
description: "Use when designing or reviewing permission-set-group architecture, especially profile\
  \ minimization, group composition, muting strategy, and migration away from profile-heavy\
  \ security models. Triggers: 'permission set group', 'muting permission. NOT for\
  \ record-sharing design or CRUD/FLS review in Apex code \u2014 use admin/permission-set-architecture."
---
