---
name: npm-mcp-server-obsidian
description: "Local Obsidian markdown vault searching, link graph analysis, and note writing"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server obsidian"
  - "npm-mcp-server-obsidian"
  - "npm-mcp-server-obsidian execute"
  - "npm-mcp-server-obsidian verify"
  - "obsidian"
  - "server"
---

# Npm Mcp Server Obsidian Skill

The `npm-mcp-server-obsidian` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
