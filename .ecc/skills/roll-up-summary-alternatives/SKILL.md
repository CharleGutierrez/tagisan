...
description: "Use when native Roll-Up Summary fields are not enough and the design needs Flow,\
  \ Apex aggregate, or DLRS-style alternatives for lookup or advanced summary scenarios.\
  \ Triggers: 'roll up summary on lookup'. NOT for ordinary master-detail roll-ups\
  \ that fit native limits \u2014 use apex/cross-object-formula-and-rollup-performance."
---
