...
description: "Designing and configuring MuleSoft Anypoint Salesforce Connector flows: API selection\
  \ (SOAP/REST/Bulk/Streaming), OAuth 2.0 JWT Bearer auth, watermark-based incremental\
  \ sync with Object Store, batch processing with record-level error isolation. NOT\
  \ for native Salesforce-to-Salesforce integration without MuleSoft \u2014 use integration/platform-events-integration\
  \ or integration/change-data-capture-integration. NOT for generic REST callouts\
  \ from Apex \u2014 use integration/rest-api-patterns."
---
