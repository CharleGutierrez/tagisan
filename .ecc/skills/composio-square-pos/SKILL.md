---
name: composio-square-pos
description: "Square point-of-sale inventory adjustments, orders, and payment capture"
version: 1.0.0
...
triggers:
  ...
  - "composio-dev"
  - "composio-square-pos"
  - "composio-square-pos execute"
  - "composio-square-pos verify"
  - "enterprise"
  - "pos"
---

# Composio Square Pos Skill

The `composio-square-pos` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
