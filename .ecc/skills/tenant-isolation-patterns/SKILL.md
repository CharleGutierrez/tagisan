...
description: "Multi-tenant isolation patterns on Salesforce: custom metadata per-tenant, permission-based\
  \ feature gating, data partitioning, namespace isolation, ISV managed-package patterns.\
  \ NOT for deciding whether each tenant should get its own org \u2014 use architect/multi-org-strategy.\
  \ NOT for the managed vs unlocked package-type decision \u2014 use devops/package-development-strategy.\
  \ NOT for data sharing design \u2014 use the sharing-selection decision tree."
---
