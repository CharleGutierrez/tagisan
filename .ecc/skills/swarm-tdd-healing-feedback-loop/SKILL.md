---
name: swarm-tdd-healing-feedback-loop
description: "Autonomous diagnosis, surgical patch application, and re-compilation up to max attempts"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Extreme Programming / Tagisan"
tags:
  - consensus
  - debate
  - extreme
...
triggers:
  ...
  - "feedback"
  - "healing"
  - "swarm tdd healing feedback loop"
  - "swarm-tdd-healing-feedback-loop"
  - "swarm-tdd-healing-feedback-loop execute"
  - "swarm-tdd-healing-feedback-loop verify"
---

# Swarm Tdd Healing Feedback Loop Skill

The `swarm-tdd-healing-feedback-loop` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Extreme Programming / Tagisan** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `tgs autofix`.
...
```json
{
  "skill": "swarm-tdd-healing-feedback-loop",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Extreme Programming / Tagisan",
  "integration_target": "tgs autofix",
