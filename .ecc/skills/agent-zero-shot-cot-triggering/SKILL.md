---
name: agent-zero-shot-cot-triggering
description: "Synthesizing step-by-step thinking tokens to unlock deep reasoning in base models"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent zero shot cot triggering"
  - "agent-zero-shot-cot-triggering"
  - "agent-zero-shot-cot-triggering execute"
  - "agent-zero-shot-cot-triggering verify"
  - "arxiv"
  - "consensus"
  - "cot"
  - "debate"
...
# Agent Zero Shot Cot Triggering Skill

The `agent-zero-shot-cot-triggering` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Prompt Engine`.
...
```json
{
  "skill": "agent-zero-shot-cot-triggering",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
