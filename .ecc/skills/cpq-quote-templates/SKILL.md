...
description: "Use when designing or troubleshooting Salesforce CPQ (SBQQ) quote templates: building\
  \ template sections, configuring line columns, conditionally showing sections, generating\
  \ branded PDFs, or handling multi-language output. Triggers: 'CPQ quote template',\
  \ 'SBQQ template', 'CPQ PDF', 'line columns', 'quote template sections', 'conditional\
  \ section', 'CPQ quote document'. NOT for standard non-CPQ quote templates in Setup\
  \ \u2014 use admin/quotes-and-quote-templates. NOT for a Visualforce-built quote\
  \ PDF \u2014 use apex/quote-pdf-customization."
---
# CPQ Quote Templates
