...
description: "Use when monitoring Agentforce agent sessions, analyzing conversation logs, measuring\
  \ deflection rates, or diagnosing agent performance issues. Triggers: 'agentforce\
  \ session analytics', 'how to query agent conversation data', 'monitor agentforce\
  \ agent effectiveness', 'agent deflection rate', 'utterance analysis agentforce'.\
  \ NOT for Trust Layer audit logging \u2014 use agentforce/einstein-trust-layer.\
  \ NOT for designing the topic boundaries and guardrails that cause the misrouting\
  \ you are seeing in the data \u2014 use agentforce/agentforce-guardrails."
---
