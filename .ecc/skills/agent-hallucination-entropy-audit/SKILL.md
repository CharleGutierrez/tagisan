---
name: agent-hallucination-entropy-audit
description: "Monitoring token generation entropy to detect and halt speculative hallucination loops"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent hallucination entropy audit"
  - "agent-hallucination-entropy-audit"
  - "agent-hallucination-entropy-audit execute"
  - "agent-hallucination-entropy-audit verify"
  - "arxiv"
  - "audit"
  - "consensus"
  - "debate"
...
# Agent Hallucination Entropy Audit Skill

The `agent-hallucination-entropy-audit` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Hallucination Detector`.
...
- **Subsystem Binding**: `Hallucination Detector`
...
```json
{
  "skill": "agent-hallucination-entropy-audit",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
  "integration_target": "Hallucination Detector",
