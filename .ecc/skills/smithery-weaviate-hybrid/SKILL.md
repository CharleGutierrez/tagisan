---
name: smithery-weaviate-hybrid
description: "Hybrid BM25 keyword and dense vector retrieval with schema introspection"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery weaviate hybrid"
  - "smithery-ai"
  - "smithery-weaviate-hybrid"
  - "smithery-weaviate-hybrid execute"
  - "smithery-weaviate-hybrid verify"
---

# Smithery Weaviate Hybrid Skill

The `smithery-weaviate-hybrid` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / VectorStoreBackend`.
...
```json
{
  "skill": "smithery-weaviate-hybrid",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
