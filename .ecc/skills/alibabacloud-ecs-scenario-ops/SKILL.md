...
description: 'Alibaba Cloud ECS scenario-based operations. Use for end-to-end operational scenarios
  ...
  data disks with formatting, instance migration, and batch operations. Triggers:
  "create full instance", "provision ecs", "expand disk and resize partition", "add
  data disk", "format disk", "ecs migration", "batch ecs operations", "ecs scenario",
  "full stack ecs", "instance with network".'
---
