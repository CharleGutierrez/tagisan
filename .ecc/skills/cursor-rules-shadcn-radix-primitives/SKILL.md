---
name: cursor-rules-shadcn-radix-primitives
description: "Accessible UI components built on Radix primitives with Tailwind variant classes"
version: 1.0.0
...
triggers:
  - "bun"
  - "cursor"
  - "cursor rules shadcn radix primitives"
  - "cursor-rules-shadcn-radix-primitives"
  - "cursor-rules-shadcn-radix-primitives execute"
  - "cursor-rules-shadcn-radix-primitives verify"
  - "frontend"
  - "full-stack"
  - "primitives"
---

# Cursor Rules Shadcn Radix Primitives Skill

The `cursor-rules-shadcn-radix-primitives` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-shadcn-radix-primitives",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
