...
description: "Polymorphic SOQL with TYPEOF: querying Task.WhatId, Task.WhoId, ContentDocumentLink.LinkedEntityId,\
  \ FeedItem.ParentId; fallback to Type filters; indexing and selectivity. NOT for\
  \ subqueries or dot-notation traversal \u2014 use apex/apex-soql-relationship-queries.\
  \ NOT for the Activity data model \u2014 use admin/activity-and-task-patterns."
---
