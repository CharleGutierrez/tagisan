...
description: "Use when planning, reviewing, or troubleshooting a Salesforce data migration \u2014\
  \ covering tool selection (Data Loader, Bulk API 2.0, MuleSoft, Informatica, Jitterbit),\
  \ migration sequencing for parent-child objects, external ID strategy for upsert\
  \ idempotency, validation rule bypass, trigger and flow suppression, rollback planning,\
  \ and post-migration reconciliation. NOT for Data Loader step-by-step mechanics\
  \ \u2014 use admin/data-import-and-management. NOT for schema or data model design\
  \ \u2014 use data/data-model-design-patterns."
---
