---
name: linux-splice-zero-copy-pipe
description: "Kernel-space data pipe splicing between file descriptors with zero userspace copies"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux splice zero copy pipe"
  - "linux-splice-zero-copy-pipe"
  - "linux-splice-zero-copy-pipe execute"
  - "linux-splice-zero-copy-pipe verify"
  - "low-level"
---

# Linux Splice Zero Copy Pipe Skill

The `linux-splice-zero-copy-pipe` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `FileCRUD / Engine`.
...
- **Subsystem Binding**: `FileCRUD / Engine`
...
```json
{
  "skill": "linux-splice-zero-copy-pipe",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "FileCRUD / Engine",
