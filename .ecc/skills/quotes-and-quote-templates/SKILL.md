...
description: "Use when configuring standard Salesforce Quotes, building quote templates for PDF\
  \ generation, emailing quotes, syncing quotes to opportunity products, or setting\
  \ up discount approvals on quotes. Triggers: 'create quote', 'quote template', 'quote\
  \ PDF', 'email quote', 'quote sync', 'synced quote', 'discount approval', 'quote\
  \ line items'. NOT for CPQ (SBQQ) quote templates \u2014 use admin/cpq-quote-templates.\
  \ NOT for the end-to-end quote-to-cash process \u2014 use admin/quote-to-cash-requirements."
---
