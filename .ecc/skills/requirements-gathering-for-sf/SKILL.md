...
description: 'Eliciting, documenting and structuring requirements for a Salesforce implementation:
  stakeholder discovery interviews, As-Is and To-Be process mapping, and gap analysis
  against standard Salesforce capability. Trigger keywords: requirements gathering,
  user story, As-Is To-Be, gap analysis, stakeholder interview, process mapping, business
  requirements, fit gap. NOT for authoring the user stories themselves - use admin/user-story-writing-for-salesforce.
  NOT for scoring requirements against a specific org - use admin/fit-gap-analysis-against-org.
  NOT for technical design decisions - use architect/solution-design-patterns.'
---
