...
description: "Canonical naming conventions for Flow elements (Get_/Update_/Decision_/Loop_/Assignment_),\
  \ resource variables (var/coll/map/formula/choice/constant/stage/screen), Decision\
  \ branch outcomes, Stage/Step labels in Orchestrations, Subflow input/output contracts,\
  \ and fault-path target names. NOT for object or field API naming (use admin/object-creation-and-design)\
  \ or flow portfolio retirement \u2014 use flow/flow-governance."
---
