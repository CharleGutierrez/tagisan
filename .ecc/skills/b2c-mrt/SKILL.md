---
name: b2c-mrt
description: "Deploy and manage Managed Runtime (MRT) storefronts using the b2c CLI. Use this skill\
  \ whenever the user needs to deploy a PWA Kit bundle, manage MRT environments and\
  \ projects, set environment variables, configure URL redirects, or manage organization\
  \ connections \u2014 even if they just say \"deploy my PWA\" or \"set up a staging\
  \ environment\"."
---
# B2C MRT Skill
