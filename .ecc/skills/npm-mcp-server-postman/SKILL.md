---
name: npm-mcp-server-postman
description: "Postman API collection execution, mock testing, and schema validation"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server postman"
  - "npm-mcp-server-postman"
  - "npm-mcp-server-postman execute"
  - "npm-mcp-server-postman verify"
  - "postman"
  - "server"
---

# Npm Mcp Server Postman Skill

The `npm-mcp-server-postman` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
