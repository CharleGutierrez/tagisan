...
description: "Use when auditing a Salesforce org for technical debt: dead code, unused automations,\
  \ overlapping Flow and Apex triggers, deprecated features, configuration complexity,\
  \ and legacy patterns. Triggers: technical debt review, org health check, dead code\
  \ analysis, automation overlap, deprecated features, complexity audit. NOT for actually\
  \ deleting the unused fields, inactive Flow versions and old workflow rules \u2014\
  \ use admin/org-cleanup-and-technical-debt. NOT for a security-specific review \u2014\
  \ use architect/security-architecture-review."
---
