---
name: glama-duckdb-olap
description: "Fast in-process columnar SQL analysis on Parquet, Arrow, and CSV files"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-duckdb-olap"
  - "glama-duckdb-olap execute"
  - "glama-duckdb-olap verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Duckdb Olap Skill

The `glama-duckdb-olap` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
