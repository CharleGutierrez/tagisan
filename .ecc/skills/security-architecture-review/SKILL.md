...
description: "Use when conducting a dedicated security architecture review of a Salesforce org\
  \ \u2014 assessing sharing model completeness, FLS/CRUD enforcement, Apex security\
  \ patterns, exposed API surface, Connected App policies, and Shield readiness. Produces\
  \ a structured findings report with severity ratings (Critical/High/Medium/Low)\
  \ and a 20+ point review checklist. Triggers: security architecture review, org\
  \ security posture, sharing model audit, FLS coverage review, Connected App security,\
  \ Shield assessment, org security health deep-dive, HIPAA or PCI security controls\
  \ Salesforce. NOT for auditing Apex or LWC code line-by-line for CRUD/FLS, SOQL\
  \ injection and XSS \u2014 use security/secure-coding-review-checklist. NOT for\
  \ a full Well-Architected review across all three pillars \u2014 use architect/well-architected-review."
---
