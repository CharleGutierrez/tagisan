---
name: smithery-slack-collaboration
description: "Workspace channel messaging, thread summarization, and bot alerts"
version: 1.0.0
...
triggers:
  ...
  - "slack"
  - "smithery"
  - "smithery slack collaboration"
  - "smithery-slack-collaboration"
  - "smithery-slack-collaboration execute"
  - "smithery-slack-collaboration verify"
---

# Smithery Slack Collaboration Skill

The `smithery-slack-collaboration` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-slack-collaboration",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
