...
description: "Use when designing or refactoring Salesforce access architecture around minimal profiles,\
  \ permission sets, permission set groups, muting, and assignment governance. Triggers:\
  \ 'profile sprawl', 'permission set strategy', 'PSG architecture', 'access bundle\
  \ design', 'least privilege'. NOT for PSG muting mechanics and recalculation order\
  \ \u2014 use admin/permission-set-group-composition. NOT for record-sharing model\
  \ design \u2014 use admin/sharing-and-visibility."
---
