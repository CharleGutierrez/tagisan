...
description: "Execute Anonymous Apex: Developer Console, VS Code SFDX, `sf apex run`, variable\
  \ scope, transaction semantics, governor limits, debugging output, common errors.\
  \ NOT for trace flags or reading the log output \u2014 use apex/debug-logs-and-developer-console.\
  \ NOT for async job design \u2014 use apex/async-apex."
---
