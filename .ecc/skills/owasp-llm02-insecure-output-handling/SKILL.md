...
description: "Sanitizing LLM outputs before passing to system shells, browser DOM, or compilers"
version: 1.0.0
...
triggers:
  ...
  - "owasp-llm02-insecure-output-handling"
  - "owasp-llm02-insecure-output-handling execute"
  - "owasp-llm02-insecure-output-handling verify"
---

# Owasp Llm02 Insecure Output Handling Skill

The `owasp-llm02-insecure-output-handling` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OWASP GenAI Top 10 (owasp.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Semantic Invariant Guard`.
...
```json
{
  "skill": "owasp-llm02-insecure-output-handling",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "OWASP GenAI Top 10 (owasp.org)",
