...
description: "Process images, audio, and video files stored in Alibaba Cloud OSS. Supports 14+\
  \ image operations (resize, crop, rotate, watermark, blur, format conversion, etc.),\
  \ image-intelligent features via IMM (blind watermark, face/body/car detection,\
  \ QR recognition, labeling, scoring), and audio/video processing (transcoding, screenshot,\
  \ animation, sprite sheet, concatenation, metadata extraction, HLS streaming). Results\
  \ can be returned as signed URL, downloaded locally, or saved as new OSS object.\
  \ Also supports plain file upload/download. Use when the user needs to process or\
  \ transform media files in OSS, such as generating thumbnails, transcoding video,\
  \ extracting audio, adding watermarks, detecting faces, compressing images, or converting\
  \ formats. Triggers on media processing requests in English or Chinese (resize,\
  \ crop, thumbnail, transcode, video convert, audio convert, watermark, face detection,\
  \ \u7F29\u7565\u56FE, \u88C1\u526A, \u538B\u7F29, \u8F6C\u7801, \u89C6\u9891\u8F6C\
  \u6362, \u97F3\u9891\u5904\u7406, \u6C34\u5370, \u76F2\u6C34\u5370, \u4EBA\u8138\
  \u68C0\u6D4B, \u622A\u5E27, \u62FC\u63A5)."
---
