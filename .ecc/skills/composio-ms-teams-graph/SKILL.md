---
name: composio-ms-teams-graph
description: "Microsoft Graph API Teams message dispatch and meeting transcription fetch"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio ms teams graph"
  - "composio-dev"
  - "composio-ms-teams-graph"
  - "composio-ms-teams-graph execute"
  - "composio-ms-teams-graph verify"
  - "enterprise"
  - "graph"
---

# Composio Ms Teams Graph Skill

The `composio-ms-teams-graph` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
