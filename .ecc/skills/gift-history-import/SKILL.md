...
description: "Use when migrating donation or gift history into Salesforce NPSP using the NPSP Data\
  \ Importer (BDI) \u2014 covers DataImport__c staging, payment mapping, soft credit\
  \ creation via Opportunity Contact Roles, GAU allocation, and campaign attribution.\
  \ NOT for loading the constituents, households and addresses themselves \u2014 use\
  \ data/constituent-data-migration. NOT for configuring soft credit and matching\
  \ gift rules \u2014 use admin/soft-credits-and-matching."
---
# Gift History Import
