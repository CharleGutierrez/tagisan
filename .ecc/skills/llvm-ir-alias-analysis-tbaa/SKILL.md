---
name: llvm-ir-alias-analysis-tbaa
description: "Type-Based Alias Analysis (TBAA) metadata generation to disambiguate raw pointers"
version: 1.0.0
...
triggers:
  ...
  - "compiler"
  - "formal-methods"
  - "llvm ir alias analysis tbaa"
  - "llvm-ir-alias-analysis-tbaa"
  - "llvm-ir-alias-analysis-tbaa execute"
  - "llvm-ir-alias-analysis-tbaa verify"
---

# Llvm Ir Alias Analysis Tbaa Skill

The `llvm-ir-alias-analysis-tbaa` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
```json
{
  "skill": "llvm-ir-alias-analysis-tbaa",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
