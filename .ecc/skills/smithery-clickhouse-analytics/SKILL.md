---
name: smithery-clickhouse-analytics
description: "Columnar OLAP SQL queries and log aggregation at petabyte scale"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery clickhouse analytics"
  - "smithery-clickhouse-analytics"
  - "smithery-clickhouse-analytics execute"
  - "smithery-clickhouse-analytics verify"
---

# Smithery Clickhouse Analytics Skill

The `smithery-clickhouse-analytics` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-clickhouse-analytics",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
