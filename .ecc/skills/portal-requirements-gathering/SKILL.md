...
description: "Use when gathering requirements for a customer portal, partner community, or self-service\
  \ Experience Cloud site. Triggers: 'gathering requirements for customer portal',\
  \ 'planning Experience Cloud site', 'what license for community portal', 'portal\
  \ user journey mapping', 'self-service requirements'. NOT for building the site\
  \ in Experience Builder \u2014 use admin/experience-cloud-site-setup. NOT for designing\
  \ the deal-registration and MDF processes themselves \u2014 use admin/partner-community-requirements."
---
