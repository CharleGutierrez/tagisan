---
name: agent-rag-multi-query-fusion
description: "Generating multiple semantic query variations and fusing reciprocal rank results"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent rag multi query fusion"
  - "agent-rag-multi-query-fusion"
  - "agent-rag-multi-query-fusion execute"
  - "agent-rag-multi-query-fusion verify"
  - "consensus"
  - "debate"
  - "fusion"
  - "langchain"
...
# Agent Rag Multi Query Fusion Skill

The `agent-rag-multi-query-fusion` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LangChain Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `RAG Pipeline`.
...
```json
{
  "skill": "agent-rag-multi-query-fusion",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "LangChain Research",
