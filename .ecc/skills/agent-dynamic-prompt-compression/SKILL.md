---
name: agent-dynamic-prompt-compression
description: "Selective summarization of prior conversational turns preserving invariant symbols"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent dynamic prompt compression"
  - "agent-dynamic-prompt-compression"
  - "agent-dynamic-prompt-compression execute"
  - "agent-dynamic-prompt-compression verify"
  - "arxiv"
  - "compression"
  - "consensus"
  - "debate"
...
# Agent Dynamic Prompt Compression Skill

The `agent-dynamic-prompt-compression` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Context Compressor`.
...
- **Subsystem Binding**: `Context Compressor`
...
```json
{
  "skill": "agent-dynamic-prompt-compression",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
  "integration_target": "Context Compressor",
