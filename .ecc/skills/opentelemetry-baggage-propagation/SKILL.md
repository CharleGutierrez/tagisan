---
name: opentelemetry-baggage-propagation
description: "Propagating contextual correlation metadata across asynchronous agent swarms"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "W3C / OpenTelemetry"
tags:
  - baggage
  - distributed
  - opentelemetry
...
triggers:
  ...
  - "opentelemetry-baggage-propagation"
  - "opentelemetry-baggage-propagation execute"
  - "opentelemetry-baggage-propagation verify"
  - "propagation"
  - "resilience"
---

# Opentelemetry Baggage Propagation Skill

The `opentelemetry-baggage-propagation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **W3C / OpenTelemetry** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Telemetry Module`.
...
```json
{
  "skill": "opentelemetry-baggage-propagation",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "W3C / OpenTelemetry",
