...
description: "Use when building, debugging, or architecting a custom activity, custom split activity,\
  \ or custom entry source for Marketing Cloud Journey Builder. Trigger keywords:\
  \ custom activity, Postmonger, config.json, Journey Builder execute endpoint, customActivity.js,\
  \ custom split outcome, installed package app extension, Journey Builder REST API.\
  \ NOT for Journey Builder canvas setup \u2014 use admin/journey-builder-administration.\
  \ NOT for MC REST/SOAP API calls \u2014 use apex/marketing-cloud-api."
---
