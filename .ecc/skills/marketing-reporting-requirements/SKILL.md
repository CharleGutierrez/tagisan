...
description: 'Gathering and documenting Salesforce marketing reporting requirements: defining KPIs,
  choosing an attribution model (First Touch / Last Touch / Even Distribution / Multi-Touch),
  selecting the right Campaign Influence configuration, and mapping business questions
  to report types and dashboard features. NOT for actually building the Campaign Hierarchy
  and CCI models - use admin/campaign-planning-and-attribution. NOT for CRM Analytics
  dataset and dashboard requirements - use admin/analytics-requirements-gathering.'
---
