...
description: "Alicloud Service Scenario-Based Skill. Use for diagnosing local-to-OSS network state,\
  \ upload/download bandwidth, download time, and local symlink issues with `aliyun\
  \ ossutil probe`. Triggers: \"aliyun ossutil probe\", \"OSS \u7F51\u7EDC\u63A2\u6D4B\
  \", \"OSS \u5E26\u5BBD\u63A2\u6D4B\", \"OSS \u4E0B\u8F7D\u65F6\u95F4\u63A2\u6D4B\
  \", \"OSS \u8F6F\u94FE\u63A5\u63A2\u6D4B\"."
---
