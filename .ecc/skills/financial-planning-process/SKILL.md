...
description: "Use this skill when configuring FSC financial planning objects, designing periodic\
  \ review cycles, modeling risk assessment workflows, or tracking goal progress in\
  \ Financial Services Cloud. Trigger keywords: FinancialGoal, FinancialPlan, goal\
  \ tracking, risk tolerance, review cycle, financial planning workflow, Discovery\
  \ Framework, Revenue Insights. NOT for wealth management process discovery \u2014\
  \ use admin/wealth-management-requirements. NOT for Action Plan template mechanics\
  \ \u2014 use admin/fsc-action-plans."
---
