---
name: postman-datadog-synthetics
description: "Datadog synthetic API test execution, uptime verification, and alert rules"
version: 1.0.0
...
triggers:
  ...
  - "enterprise"
  - "postman"
  - "postman datadog synthetics"
  - "postman-datadog-synthetics"
  - "postman-datadog-synthetics execute"
  - "postman-datadog-synthetics verify"
  - "saas"
---

# Postman Datadog Synthetics Skill

The `postman-datadog-synthetics` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-datadog-synthetics",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
