---
name: swarm-condorcet-pairwise-arbiter
description: "Pairwise Condorcet matrix comparison selecting the universally preferred architecture plan"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Voting Theory / Social Choice"
tags:
  - arbiter
  - condorcet
  - consensus
...
triggers:
  ...
  - "debate"
  - "moa"
  - "swarm condorcet pairwise arbiter"
  - "swarm-condorcet-pairwise-arbiter"
  - "swarm-condorcet-pairwise-arbiter execute"
  - "swarm-condorcet-pairwise-arbiter verify"
---

# Swarm Condorcet Pairwise Arbiter Skill

The `swarm-condorcet-pairwise-arbiter` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Voting Theory / Social Choice** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Consensus Voting Engine`.
...
- **Subsystem Binding**: `Consensus Voting Engine`
...
```json
{
  "skill": "swarm-condorcet-pairwise-arbiter",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Voting Theory / Social Choice",
  "integration_target": "Consensus Voting Engine",
