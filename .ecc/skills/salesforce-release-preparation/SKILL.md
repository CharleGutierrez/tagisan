...
description: "Use when preparing for a Salesforce seasonal release \u2014 triaging release notes,\
  ...
  \ triage', 'Release Updates', 'sandbox preview opt-in', 'release readiness checklist',\
  \ 'production upgrade date', 'feature impact', 'critical update', 'roll out the\
  \ Spring release safely', 'is our org ready for the Spring release'. NOT for planning\
  \ your own release train \u2014 use devops/release-management. NOT for user training\
  \ and go-live comms \u2014 use admin/change-management-and-training."
---
