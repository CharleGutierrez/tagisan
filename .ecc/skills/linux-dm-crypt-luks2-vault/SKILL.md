---
name: linux-dm-crypt-luks2-vault
description: "LUKS2 authenticated disk encryption volume mounting with argon2id key derivation"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux dm crypt luks2 vault"
  - "linux-dm-crypt-luks2-vault"
  - "linux-dm-crypt-luks2-vault execute"
  - "linux-dm-crypt-luks2-vault verify"
  - "low-level"
---

# Linux Dm Crypt Luks2 Vault Skill

The `linux-dm-crypt-luks2-vault` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `AgentShield / Vault`.
...
- **Subsystem Binding**: `AgentShield / Vault`
...
```json
{
  "skill": "linux-dm-crypt-luks2-vault",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "AgentShield / Vault",
