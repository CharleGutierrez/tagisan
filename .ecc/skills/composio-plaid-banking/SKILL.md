---
name: composio-plaid-banking
description: "Plaid bank account authentication, balance checking, and transaction sync"
version: 1.0.0
...
triggers:
  ...
  - "banking"
  - "composio"
  - "composio plaid banking"
  - "composio-dev"
  - "composio-plaid-banking"
  - "composio-plaid-banking execute"
  - "composio-plaid-banking verify"
  - "enterprise"
---

# Composio Plaid Banking Skill

The `composio-plaid-banking` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
