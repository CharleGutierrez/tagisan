...
description: "Async/await and Promise patterns in LWC: imperative Apex, loading states, error handling,\
  \ concurrent wire + imperative, AbortController for in-flight cancellation, Promise.all\
  \ for parallel calls. NOT for the basic imperative Apex import-and-call pattern\
  \ or cacheable=true rules \u2014 use lwc/lwc-imperative-apex. NOT for @wire provisioning\
  \ basics \u2014 use lwc/wire-service-patterns."
---
# LWC Async Patterns
