---
name: npm-mcp-server-postgres
description: "PostgreSQL database connection, schema introspection, and parameterized queries"
version: 1.0.0
...
triggers:
  ...
  - "npm-mcp-server-postgres"
  - "npm-mcp-server-postgres execute"
  - "npm-mcp-server-postgres verify"
  - "postgres"
  - "server"
---

# Npm Mcp Server Postgres Skill

The `npm-mcp-server-postgres` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
