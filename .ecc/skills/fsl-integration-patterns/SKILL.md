...
description: "Use this skill when designing FSL integrations: ERP parts/inventory sync, GPS/fleet\
  \ management integration, IoT-triggered work order creation, and customer notification\
  \ workflows. Trigger keywords: FSL ERP integration, ProductConsumed ERP sync, GPS\
  \ fleet integration FSL, IoT work order trigger, customer notification FSL integration.\
  \ NOT for Financial Services Cloud integration design \u2014 use architect/fsc-architecture-patterns.\
  \ NOT for bulk-loading Work Order and Service Appointment history \u2014 use data/fsl-work-order-migration."
---
