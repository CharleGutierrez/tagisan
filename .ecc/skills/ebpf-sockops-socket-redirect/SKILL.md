---
name: ebpf-sockops-socket-redirect
description: "Kernel TCP socket splice and localhost acceleration bypassing network stack"
version: 1.0.0
...
triggers:
  - "ebpf"
  - "ebpf sockops socket redirect"
  - "ebpf-io"
  - "ebpf-sockops-socket-redirect"
  - "ebpf-sockops-socket-redirect execute"
  - "ebpf-sockops-socket-redirect verify"
  - "hardware"
  - "kernel"
  - "low-level"
---

# Ebpf Sockops Socket Redirect Skill

The `ebpf-sockops-socket-redirect` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **eBPF.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / Tokio / Net`.
...
- **Subsystem Binding**: `Native Rust / Tokio / Net`
...
```json
{
  "skill": "ebpf-sockops-socket-redirect",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "eBPF.io",
  "integration_target": "Native Rust / Tokio / Net",
