...
description: "Runtime mechanisms to disable Apex triggers without commenting out code: Custom Metadata\
  \ kill switches via Trigger_Setting__mdt, Custom Permission gates via FeatureManagement.checkPermission,\
  \ Hierarchy Custom Settings, and TriggerControl static-state bypass for nested operations.\
  \ NOT for a handler re-entering itself \u2014 use apex/recursive-trigger-prevention.\
  \ NOT for gating a business feature \u2014 use apex/feature-flags-and-kill-switches."
---
