---
name: ggml-metal-mps-apple-silicon
description: "Metal Performance Shaders graph execution on unified Apple Silicon memory"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "Apple Metal Framework Docs"
tags:
  - ai
  - apple
  - cuda
...
triggers:
  ...
  - "cuda"
  - "ggml"
  - "ggml metal mps apple silicon"
  - "ggml-metal-mps-apple-silicon"
  - "ggml-metal-mps-apple-silicon execute"
  - "ggml-metal-mps-apple-silicon verify"
  - "gguf"
---

# Ggml Metal Mps Apple Silicon Skill

The `ggml-metal-mps-apple-silicon` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Apple Metal Framework Docs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Mac`.
...
- **Subsystem Binding**: `Tensor Engine / Mac`
...
```json
{
  "skill": "ggml-metal-mps-apple-silicon",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Apple Metal Framework Docs",
  "integration_target": "Tensor Engine / Mac",
