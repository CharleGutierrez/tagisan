...
description: "Use this skill to design orchestration-layer error handling for Salesforce integrations\
  \ \u2014 covering Platform Event replay recovery, dead-letter queue routing, cross-channel\
  \ error notification patterns, circuit breaker design, and trigger suspension recovery.\
  \ Triggers: integration error handling, Platform Event retry, integration dead letter\
  \ queue, circuit breaker. NOT for Apex exception handling \u2014 use apex/exception-handling.\
  \ NOT for HTTP error response contracts \u2014 use integration/api-error-handling-design.\
  \ NOT for retry backoff patterns \u2014 use integration/retry-and-backoff-patterns."
---
