---
name: glama-terraform-plan
description: "Terraform HCL infrastructure plan generation, state inspection, and validation"
version: 1.0.0
...
triggers:
  - "glama"
  - "glama terraform plan"
  - "glama-ai"
  - "glama-terraform-plan"
  - "glama-terraform-plan execute"
  - "glama-terraform-plan verify"
  - "mcp"
  - "model-context-protocol"
  - "plan"
---

# Glama Terraform Plan Skill

The `glama-terraform-plan` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
