---
name: tree-sitter-rust-cst-extraction
description: "Incremental concrete syntax tree querying for Rust functions, structs, and traits"
version: 1.0.0
...
triggers:
  ...
  - "extraction"
  - "formal-methods"
  - "tree sitter rust cst extraction"
  - "tree-sitter-rust-cst-extraction"
  - "tree-sitter-rust-cst-extraction execute"
  - "tree-sitter-rust-cst-extraction verify"
---

# Tree Sitter Rust Cst Extraction Skill

The `tree-sitter-rust-cst-extraction` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tree-sitter Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
```json
{
  "skill": "tree-sitter-rust-cst-extraction",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Tree-sitter Docs",
