...
description: "Use this skill when designing or reviewing a Salesforce Financial Services Cloud\
  \ (FSC) wealth management platform \u2014 covering advisor workspace configuration,\
  \ client portal setup, portfolio data integration, Compliant Data Sharing, and FSC\
  \ feature enablement decisions. NOT for the org-wide FSC data-model choice (managed-package\
  \ vs platform-native) \u2014 use architect/fsc-architecture-patterns. NOT for gathering\
  \ wealth management requirements before design \u2014 use admin/wealth-management-requirements."
---
