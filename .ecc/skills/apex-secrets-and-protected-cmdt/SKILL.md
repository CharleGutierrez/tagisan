...
description: "Storing API keys, signing secrets, and third-party tokens that Apex must consume\
  \ \u2014 Protected Custom Metadata in a managed package, Protected Custom Settings,\
  \ Encrypted Custom Fields, Apex Crypto, and what to NEVER do (hardcode, unprotected\
  \ CMDT, System.debug). NOT for callout authentication \u2014 use apex/apex-named-credentials-patterns.\
  \ NOT for computing the HMAC or signature itself \u2014 use apex/apex-encoding-and-crypto.\
  \ NOT for record-level Shield data encryption \u2014 use security/platform-encryption."
---
