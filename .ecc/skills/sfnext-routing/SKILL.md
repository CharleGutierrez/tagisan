---
name: sfnext-routing
description: Implement file-based routing in Storefront Next with React Router 7. Use when adding
  new pages, creating layout routes, defining route parameters, or understanding route
  module exports (loader, action, component, meta). Covers flat-routes conventions,
  nested layouts, and the _app prefix.
...
---
# Routing Skill
