---
name: smithery-pinecone-indexer
description: "Managed vector index search with namespace isolation and metadata filtering"
version: 1.0.0
...
triggers:
  ...
  - "pinecone"
  - "smithery"
  - "smithery pinecone indexer"
  - "smithery-pinecone-indexer"
  - "smithery-pinecone-indexer execute"
  - "smithery-pinecone-indexer verify"
---

# Smithery Pinecone Indexer Skill

The `smithery-pinecone-indexer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / VectorStoreBackend`.
...
```json
{
  "skill": "smithery-pinecone-indexer",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
