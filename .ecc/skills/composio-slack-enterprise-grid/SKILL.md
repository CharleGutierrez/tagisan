---
name: composio-slack-enterprise-grid
description: "Enterprise Grid cross-workspace channel administration and compliance export"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio slack enterprise grid"
  - "composio-dev"
  - "composio-slack-enterprise-grid"
  - "composio-slack-enterprise-grid execute"
  - "composio-slack-enterprise-grid verify"
  - "enterprise"
  - "grid"
---

# Composio Slack Enterprise Grid Skill

The `composio-slack-enterprise-grid` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-slack-enterprise-grid",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
