...
description: "Implement server-side data fetching in Storefront Next using loaders, actions, and\
  \ useScapiFetcher. Use when writing loader functions, making SCAPI calls, handling\
  \ form submissions, or implementing interactive data fetching. Covers synchronous\
  \ loaders, streaming patterns, createApiClients, and parallel requests. NOT for\
  \ client-side Zustand state \u2014 see sfnext-state-management."
---
# Data Fetching Skill
