...
description: "Tune Flow runtime performance: pick Before-Save over After-Save, consolidate Get\
  \ Records, eliminate loop-DML, cache lookups, split with Scheduled Paths, and measure\
  \ actual runtime. Covers benchmarking methodology, profiling tools, and the 80/20\
  \ wins. NOT for governor-limit math \u2014 use flow/flow-governor-limits-deep-dive.\
  \ NOT for LDV strategy \u2014 use flow/flow-large-data-volume-patterns."
---
