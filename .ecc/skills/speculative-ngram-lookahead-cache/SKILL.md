---
name: speculative-ngram-lookahead-cache
description: "Self-speculative n-gram matching for deterministic syntax token lookahead acceleration"
version: 1.0.0
...
triggers:
  ...
  - "cuda"
  - "gguf"
  - "speculative ngram lookahead cache"
  - "speculative-ngram-lookahead-cache"
  - "speculative-ngram-lookahead-cache execute"
  - "speculative-ngram-lookahead-cache verify"
---

# Speculative Ngram Lookahead Cache Skill

The `speculative-ngram-lookahead-cache` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Decoder`.
...
- **Subsystem Binding**: `Tensor Engine / Decoder`
...
```json
{
  "skill": "speculative-ngram-lookahead-cache",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "ArXiv AI Research",
  "integration_target": "Tensor Engine / Decoder",
