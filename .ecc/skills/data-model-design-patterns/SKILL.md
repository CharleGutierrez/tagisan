...
description: "Use when designing, reviewing, or troubleshooting Salesforce object relationships\
  \ and field type choices \u2014 lookup vs master-detail, junction object modeling,\
  \ indexing strategy, and data model anti-patterns. NOT for drawing or diagramming\
  \ the model \u2014 use architect/salesforce-erd-and-diagramming. NOT for the Setup\
  \ steps to create the object itself \u2014 use admin/object-creation-and-design.\
  \ NOT for hierarchical or external relationship types, polymorphic lookups, or the\
