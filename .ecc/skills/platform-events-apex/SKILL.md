...
description: "Use when publishing or subscribing to Salesforce Platform Events from Apex, comparing\
  \ Platform Events with Change Data Capture, or designing event-triggered error handling\
  \ and monitoring. Triggers: 'EventBus.publish', 'platform event trigger', 'CDC vs\
  \ Platform Events', 'replay ID', 'high-volume event'. NOT for external publishers\
  \ or subscribers \u2014 use integration/platform-events-integration. NOT for subscriber\
  \ batch size and retries \u2014 use apex/apex-event-bus-subscriber."
---
