...
description: "Composable commerce on Salesforce: headless API layer, micro-frontends, BFF pattern,\
  \ CDN strategy, third-party composability over B2C/B2B Commerce. NOT for the supported\
  \ PWA Kit on Managed Runtime composable storefront \u2014 use architect/headless-commerce-architecture.\
  \ NOT for standard B2C storefront setup \u2014 use admin/b2c-commerce-store-setup."
---
