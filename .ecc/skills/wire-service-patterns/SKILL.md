...
description: "Use when designing or reviewing Lightning Web Components that use `@wire`, Lightning\
  \ Data Service, UI API, or the GraphQL wire adapter, especially for reactive parameters,\
  \ cache behavior, and refresh strategy. Triggers: 'wire service', 'refreshApex',\
  \ 'reactive parameter', 'getRecord', 'wire vs imperative Apex'. NOT for forcing\
  \ a refresh after DML \u2014 use lwc/lwc-wire-refresh-patterns. NOT for imperative\
  \ Apex on a click \u2014 use lwc/lwc-imperative-apex."
---
