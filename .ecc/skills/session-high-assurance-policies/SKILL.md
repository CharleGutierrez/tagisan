...
description: "Enforce step-up authentication for sensitive pages/objects using High Assurance session\
  \ level and login flow policies. NOT for initial MFA enrollment UX \u2014 use admin/org-setup-and-configuration."
---
