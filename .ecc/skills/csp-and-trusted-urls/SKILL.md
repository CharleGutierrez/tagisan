...
description: "Configure Content Security Policy via Trusted URLs and CSP Trusted Sites so Lightning,\
  \ LWR, and LWC can call third-party scripts, APIs, and frame sources. NOT for clickjack\
  \ configuration \u2014 use lwc/static-resources-in-lwc."
---
