...
description: "Apex Trigger.new / Trigger.old / Trigger.newMap / Trigger.oldMap / Trigger.isInsert\
  \ etc.: when each is populated, null-safety, recursion depth, trigger event matrix.\
  \ NOT for trigger framework / handler architecture and one-trigger-per-object design\
  \ \u2014 use apex/trigger-framework. NOT for bulk patterns and Map<Id, SObject>\
  \ collection handling \u2014 use apex/apex-collections-patterns."
---
