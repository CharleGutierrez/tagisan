---
name: lean4-tactic-metaprogramming
description: "Writing custom Lean 4 syntax tactics for automated equivalence reduction"
version: 1.0.0
...
triggers:
  ...
  - "lean"
  - "lean4"
  - "lean4 tactic metaprogramming"
  - "lean4-tactic-metaprogramming"
  - "lean4-tactic-metaprogramming execute"
  - "lean4-tactic-metaprogramming verify"
---

# Lean4 Tactic Metaprogramming Skill

The `lean4-tactic-metaprogramming` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Lean 4 Documentation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "lean4-tactic-metaprogramming",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Lean 4 Documentation",
