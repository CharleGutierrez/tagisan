...
description: "Use this skill when extending Salesforce B2B/B2C Commerce Cloud behavior through\
  \ Apex: building custom cart calculators, implementing pricing hooks, integrating\
  \ inventory checks, or registering custom checkout extensions via the CartExtension\
  \ Apex namespace and RegisteredExternalService metadata. NOT for standard LWC Commerce\
  \ components, declarative store configuration, or Experience Builder page layouts\
  \ \u2014 use admin/commerce-checkout-configuration for those."
---
