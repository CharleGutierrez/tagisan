...
description: "Use when reading or writing Hierarchy Custom Settings from Apex to resolve per-user/per-profile/org\
  \ configuration. Covers `getInstance()` resolution order, DML cost, cache semantics,\
  \ and when to prefer Custom Metadata Types instead. NOT for Custom Metadata Types\
  \ in Apex \u2014 use apex/custom-metadata-in-apex. NOT for the CMT vs Custom Settings\
  \ choice \u2014 use admin/custom-metadata-types-and-settings."
---
