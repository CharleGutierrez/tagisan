---
name: glama-aws-s3-storage
description: "Amazon S3 bucket listing, object download/upload, and presigned URL generation"
version: 1.0.0
...
triggers:
  - "aws"
  - "glama"
  - "glama aws s3 storage"
  - "glama-ai"
  - "glama-aws-s3-storage"
  - "glama-aws-s3-storage execute"
  - "glama-aws-s3-storage verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Aws S3 Storage Skill

The `glama-aws-s3-storage` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
