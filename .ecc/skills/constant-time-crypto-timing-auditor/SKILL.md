---
name: constant-time-crypto-timing-auditor
description: "Auditing cryptographic code for branch-dependent execution time and cache side-channels"
version: 1.0.0
...
triggers:
  ...
  - "auditor"
  - "constant"
  - "constant time crypto timing auditor"
  - "constant-time-crypto-timing-auditor"
  - "constant-time-crypto-timing-auditor execute"
  - "constant-time-crypto-timing-auditor verify"
  - "crypto"
  - "cryptography"
---

# Constant Time Crypto Timing Auditor Skill

The `constant-time-crypto-timing-auditor` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cryptography Engineering** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Post-Quantum Auditor`.
...
```json
{
  "skill": "constant-time-crypto-timing-auditor",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Cryptography Engineering",
