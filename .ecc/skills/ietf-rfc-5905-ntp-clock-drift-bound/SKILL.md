---
name: ietf-rfc-5905-ntp-clock-drift-bound
description: "Verifying NTP clock skew bounds across cluster nodes before consensus voting"
version: 1.0.0
...
triggers:
  ...
  - "distributed"
  - "drift"
  - "ietf rfc 5905 ntp clock drift bound"
  - "ietf-rfc-5905-ntp-clock-drift-bound"
  - "ietf-rfc-5905-ntp-clock-drift-bound execute"
  - "ietf-rfc-5905-ntp-clock-drift-bound verify"
---

# Ietf Rfc 5905 Ntp Clock Drift Bound Skill

The `ietf-rfc-5905-ntp-clock-drift-bound` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **IETF RFCs (ietf.org)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Consensus Engine`.
...
- **Subsystem Binding**: `Consensus Engine`
...
```json
{
  "skill": "ietf-rfc-5905-ntp-clock-drift-bound",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "IETF RFCs (ietf.org)",
  "integration_target": "Consensus Engine",
