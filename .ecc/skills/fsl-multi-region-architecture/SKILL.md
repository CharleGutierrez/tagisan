...
description: "Use this skill when designing FSL for multiple geographic regions or timezones: territory\
  \ timezone configuration, cross-territory resource assignment, and concurrent optimization\
  \ serialization. Trigger keywords: multi-region FSL, FSL timezone territories, cross-territory\
  \ resource scheduling, concurrent optimization territories, international FSL deployment.\
  \ NOT for choosing an optimization mode or fixing Global optimization timeouts \u2014\
  \ use architect/fsl-optimization-architecture. NOT for creating a territory, its\
  \ operating hours or polygon in Setup \u2014 use admin/fsl-service-territory-setup."
---
