---
name: llvm-ir-polly-polyhedral-loops
description: "Polyhedral model loop tiling and affine dependency transformations for SIMD/GPU"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "llvm"
  - "llvm ir polly polyhedral loops"
  - "llvm-ir-polly-polyhedral-loops"
  - "llvm-ir-polly-polyhedral-loops execute"
  - "llvm-ir-polly-polyhedral-loops verify"
  - "loops"
---

# Llvm Ir Polly Polyhedral Loops Skill

The `llvm-ir-polly-polyhedral-loops` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
```json
{
  "skill": "llvm-ir-polly-polyhedral-loops",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
