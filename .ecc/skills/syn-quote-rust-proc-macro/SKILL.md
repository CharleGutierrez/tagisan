---
name: syn-quote-rust-proc-macro
description: "Derive procedural macro token stream parsing and AST code synthesis"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "syn/quote Docs (docs.rs)"
tags:
  - ast
  - compiler
  - formal-methods
...
triggers:
  ...
  - "macro"
  - "proc"
  - "syn quote rust proc macro"
  - "syn-quote-rust-proc-macro"
  - "syn-quote-rust-proc-macro execute"
  - "syn-quote-rust-proc-macro verify"
---

# Syn Quote Rust Proc Macro Skill

The `syn-quote-rust-proc-macro` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **syn/quote Docs (docs.rs)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Self-Healing Compiler`.
...
```json
{
  "skill": "syn-quote-rust-proc-macro",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "syn/quote Docs (docs.rs)",
