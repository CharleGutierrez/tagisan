---
name: composio-basecamp-hq
description: "Basecamp project message boards, to-do lists, and campfire chat ping"
version: 1.0.0
...
triggers:
  ...
  - "basecamp"
  - "composio"
  - "composio basecamp hq"
  - "composio-basecamp-hq"
  - "composio-basecamp-hq execute"
  - "composio-basecamp-hq verify"
  - "composio-dev"
  - "enterprise"
---

# Composio Basecamp Hq Skill

The `composio-basecamp-hq` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
