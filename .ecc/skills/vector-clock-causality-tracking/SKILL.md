---
name: vector-clock-causality-tracking
description: "Vector clocks capturing happens-before causality relationships across distributed agents"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "Distributed Systems Research"
tags:
  - causality
  - clock
  - distributed
...
triggers:
  ...
  - "vector-clock-causality-tracking"
  - "vector-clock-causality-tracking execute"
  - "vector-clock-causality-tracking verify"
---

# Vector Clock Causality Tracking Skill

The `vector-clock-causality-tracking` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Distributed Systems Research** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `P2P Cluster Mesh`.
...
```json
{
  "skill": "vector-clock-causality-tracking",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Distributed Systems Research",
