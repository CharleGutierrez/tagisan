...
description: Implement authentication in Storefront Next using split-cookie architecture, SLAS
  tokens, and auth middleware. Use when accessing user identity in loaders, detecting
  guest vs registered users, using getAuth or useAuth, or understanding session management
  and token refresh.
...
---
