---
name: jotai-atomic-dependency-graph
description: "Bottom-up atomic state architecture optimizing selective component re-renders"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Jotai Docs (jotai.org)"
tags:
  - atomic
  - bun
  - dependency
...
triggers:
  ...
  - "frontend"
  - "full-stack"
  - "jotai atomic dependency graph"
  - "jotai-atomic-dependency-graph"
  - "jotai-atomic-dependency-graph execute"
  - "jotai-atomic-dependency-graph verify"
---

# Jotai Atomic Dependency Graph Skill

The `jotai-atomic-dependency-graph` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Jotai Docs (jotai.org)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "jotai-atomic-dependency-graph",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Jotai Docs (jotai.org)",
