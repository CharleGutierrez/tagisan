---
name: clickhouse-merge-tree-partitioning
description: "Designing efficient MergeTree partition keys and primary indices for multi-terabyte traces"
version: 1.0.0
...
triggers:
  - "clickhouse"
  - "clickhouse merge tree partitioning"
  - "clickhouse-merge-tree-partitioning"
  - "clickhouse-merge-tree-partitioning execute"
  - "clickhouse-merge-tree-partitioning verify"
  - "distributed"
  - "merge"
  - "opentelemetry"
  - "partitioning"
...
# Clickhouse Merge Tree Partitioning Skill

The `clickhouse-merge-tree-partitioning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ClickHouse Documentation** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Telemetry / Logs`.
...
- **Subsystem Binding**: `Telemetry / Logs`
...
```json
{
  "skill": "clickhouse-merge-tree-partitioning",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "ClickHouse Documentation",
  "integration_target": "Telemetry / Logs",
