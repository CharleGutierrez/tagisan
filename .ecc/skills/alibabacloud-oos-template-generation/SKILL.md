...
description: 'OOS template intelligent generation skill. Use when users need to create, write,
  or generate Alibaba Cloud OOS (Operation Orchestration Service) automation templates.
  Applicable for: generating OOS templates based on O&M requirements, querying available
  Actions and OpenAPIs, validating template syntax, iteratively fixing template errors.
  Triggers: "generate template", "create template", "write a template", "OOS template",
  "operation orchestration", "automation template", "help me orchestrate"'
---
