---
name: mitre-t1041-exfiltration-over-c2-clamp
description: "Clamping outbound socket byte buffers to prevent mass data exfiltration of source code"
version: 1.0.0
...
triggers:
  ...
  - "edr"
  - "exfiltration"
  - "mitre t1041 exfiltration over c2 clamp"
  - "mitre-t1041-exfiltration-over-c2-clamp"
  - "mitre-t1041-exfiltration-over-c2-clamp execute"
  - "mitre-t1041-exfiltration-over-c2-clamp verify"
---

# Mitre T1041 Exfiltration Over C2 Clamp Skill

The `mitre-t1041-exfiltration-over-c2-clamp` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / EDR`.
...
```json
{
  "skill": "mitre-t1041-exfiltration-over-c2-clamp",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
