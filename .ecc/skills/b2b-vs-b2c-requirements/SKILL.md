...
description: "Use this skill to determine whether a Salesforce Commerce project should use B2B\
  \ Commerce (account-gated, BuyerGroup-based, contract pricing) or D2C Commerce (consumer\
  \ storefront, guest checkout, individual-based). Trigger keywords: B2B vs B2C, commerce\
  \ platform selection, buyer journey, account-based purchasing, consumer storefront,\
  \ licensing decision. NOT for implementation mechanics \u2014 use admin/b2b-commerce-store-setup\
  \ or admin/b2c-commerce-store-setup for configuration work. NOT for Salesforce B2C\
  \ Commerce (SFCC/Business Manager) setup."
---
