...
description: "Use when adopting or working with the fflib (Apex Enterprise Patterns) open-source\
  \ library \u2014 UnitOfWork, SObjectDomain, SObjectSelector, and Service layer classes\
  \ \u2014 in a Salesforce Apex codebase. Triggers: 'fflib', 'UnitOfWork', 'SObjectDomain',\
  \ 'enterprise patterns apex'. NOT for Apex layering without the fflib library \u2014\
  \ use apex/apex-design-patterns. NOT for splitting a class with this repo's lightweight\
  \ base classes \u2014 use apex/apex-class-decomposition-pattern."
---
