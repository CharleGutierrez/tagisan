...
description: "Reference guide for Salesforce Industries cloud data models: Insurance Cloud (InsurancePolicy\
  \ hierarchy), Communications Cloud (Account record types, BillingAccount), Energy\
  \ & Utilities (ServicePoint, ServiceContract), and Health Cloud (CarePlan, FHIR-aligned\
  \ patient objects). NOT for Health Cloud clinical objects in depth, HC24 vs FHIR\
  \ R4 \u2014 use data/health-cloud-data-model. NOT for insurance module licensing,\
  \ claims and underwriting design \u2014 use architect/insurance-cloud-architecture."
---
