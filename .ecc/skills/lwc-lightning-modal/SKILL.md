...
description: "LightningModal base class (Winter '23+): extending LightningModal, open() static\
  \ method, modal headers/bodies/footers, close() with result, size variants, accessibility.\
  \ NOT for lightning-dialog legacy patterns (deprecated) \u2014 use lwc/lwc-modal-and-overlay."
---
# LWC Lightning Modal
