---
name: simd-vnni-int8-acceleration
description: "Vector Neural Network Instructions for INT8 low-precision tensor dot products"
version: 1.0.0
...
triggers:
  ...
  - "intel"
  - "kernel"
  - "simd vnni int8 acceleration"
  - "simd-vnni-int8-acceleration"
  - "simd-vnni-int8-acceleration execute"
  - "simd-vnni-int8-acceleration verify"
---

# Simd Vnni Int8 Acceleration Skill

The `simd-vnni-int8-acceleration` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Intel Architecture Manuals** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tensor Engine / Quant`.
...
```json
{
  "skill": "simd-vnni-int8-acceleration",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Intel Architecture Manuals",
