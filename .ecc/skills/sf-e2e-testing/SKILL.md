---
name: sf-e2e-testing
description: Use when writing Salesforce Apex end-to-end integration tests, deployment verification,
  or bulk scenario validation. Do NOT use for unit tests or TDD.
...
---
