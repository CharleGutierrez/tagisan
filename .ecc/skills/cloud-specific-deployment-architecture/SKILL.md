...
description: "Deployment architecture quirks per Salesforce cloud: Industries (OmniStudio), Marketing\
  \ Cloud (MC packages), Commerce Cloud, Data Cloud, Agentforce. What ships via metadata\
  \ API, what ships via cloud-specific tools, ordering, dependencies. NOT for building\
  \ the OmniStudio DataPack pipeline itself \u2014 use omnistudio/omnistudio-ci-cd-patterns.\
  \ NOT for the generic CI/CD pipeline, branch strategy or Copado-vs-Gearset choice\
  \ \u2014 use architect/deployment-automation-architecture."
---
