---
name: gossip-swim-membership-protocol
description: "SWIM weakly-consistent infection-style process group membership protocol with failure detection"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "IEEE Infocom Research"
tags:
  - distributed
  - gossip
  - ieee
...
triggers:
  ...
  - "gossip-swim-membership-protocol"
  - "gossip-swim-membership-protocol execute"
  - "gossip-swim-membership-protocol verify"
  - "ieee"
  - "membership"
  - "opentelemetry"
---

# Gossip Swim Membership Protocol Skill

The `gossip-swim-membership-protocol` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **IEEE Infocom Research** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `P2P Cluster Mesh`.
...
```json
{
  "skill": "gossip-swim-membership-protocol",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "IEEE Infocom Research",
