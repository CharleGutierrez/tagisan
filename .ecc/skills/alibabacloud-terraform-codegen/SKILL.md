...
description: "Use when the user wants Terraform HCL for Alibaba Cloud (Alicloud) infrastructure\
  ...
  \ via the provider's own documentation fetched at generation time. For AWS \u2192\
  \ Alicloud migration or importing existing resources into state, use a different\
  \ skill. Triggers: \"write terraform for alicloud\", \"generate alibaba cloud terraform\"\
  , \"alicloud HCL\", \"create alibaba cloud vpc/ecs/rds\", \"\u751F\u6210\u963F\u91CC\
  \u4E91 Terraform\", \"\u963F\u91CC\u4E91 HCL\", \"\u7528 Terraform \u90E8\u7F72\u963F\
  \u91CC\u4E91\", \"alicloud provider\", \"aliyun/alicloud\", \"terraform-provider-alicloud\"\
  ."
---
