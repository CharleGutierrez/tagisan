---
name: linux-epoll-edge-triggered
description: "High-performance edge-triggered (EPOLLET) multiplexing for massive TCP connections"
version: 1.0.0
...
triggers:
  ...
  - "linux-epoll-edge-triggered"
  - "linux-epoll-edge-triggered execute"
  - "linux-epoll-edge-triggered verify"
---

# Linux Epoll Edge Triggered Skill

The `linux-epoll-edge-triggered` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tokio / tgs serve`.
...
- **Subsystem Binding**: `Tokio / tgs serve`
...
```json
{
  "skill": "linux-epoll-edge-triggered",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Tokio / tgs serve",
