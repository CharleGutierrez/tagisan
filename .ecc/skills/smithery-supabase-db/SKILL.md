---
name: smithery-supabase-db
description: "PostgreSQL schema introspection, RLS policy audit, and SQL runner"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery supabase db"
  - "smithery-ai"
  - "smithery-supabase-db"
  - "smithery-supabase-db execute"
  - "smithery-supabase-db verify"
  - "supabase"
---

# Smithery Supabase Db Skill

The `smithery-supabase-db` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
