...
description: "Migrate classic Visualforce-based OmniScripts to LWC-based runtime with feature parity\
  \ and regression testing. NOT for new OmniScript design \u2014 use omnistudio/omnistudio-lwc-integration."
---
