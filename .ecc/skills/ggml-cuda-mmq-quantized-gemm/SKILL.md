---
name: ggml-cuda-mmq-quantized-gemm
description: "CUDA-accelerated matrix-vector operations directly on quantized integer tensors"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "llama.cpp Technical Docs"
tags:
  - ai
  - cuda
  - gemm
...
triggers:
  ...
  - "gemm"
  - "ggml"
  - "ggml cuda mmq quantized gemm"
  - "ggml-cuda-mmq-quantized-gemm"
  - "ggml-cuda-mmq-quantized-gemm execute"
  - "ggml-cuda-mmq-quantized-gemm verify"
  - "gguf"
---

# Ggml Cuda Mmq Quantized Gemm Skill

The `ggml-cuda-mmq-quantized-gemm` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **llama.cpp Technical Docs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / GPU`.
...
```json
{
  "skill": "ggml-cuda-mmq-quantized-gemm",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "llama.cpp Technical Docs",
