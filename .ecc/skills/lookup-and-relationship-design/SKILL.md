...
description: "Designing Lookup vs Master-Detail vs Hierarchical vs External relationships: cascade\
  \ delete, roll-up summaries, ownership, sharing implications, polymorphic lookups,\
  \ junction objects, relationship depth limits. NOT for restricting which records\
  \ a lookup can pick \u2014 use admin/lookup-filter-cross-object-patterns. NOT for\
  \ a roll-up across a plain lookup \u2014 use data/roll-up-summary-alternatives."
---
