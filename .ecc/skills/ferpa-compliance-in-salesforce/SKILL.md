...
description: "Use this skill when implementing FERPA (Family Educational Rights and Privacy Act)\
  \ compliance controls in Salesforce Education Cloud or Education Data Architecture\
  \ (EDA): LearnerProfile FERPA boolean fields. NOT for GDPR/CCPA data privacy, platform\
  \ encryption at rest, or HIPAA health-data compliance \u2014 use architect/health-cloud-data-residency."
---
