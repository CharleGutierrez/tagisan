---
name: threejs-r3f-3d-scene-builder
description: "Declarative 3D scene graph rendering with PBR materials and camera controls"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Three.js / React Three Fiber Docs"
tags:
  - builder
  - bun
  - frontend
...
triggers:
  ...
  - "full-stack"
  - "r3f"
  - "threejs r3f 3d scene builder"
  - "threejs-r3f-3d-scene-builder"
  - "threejs-r3f-3d-scene-builder execute"
  - "threejs-r3f-3d-scene-builder verify"
---

# Threejs R3f 3d Scene Builder Skill

The `threejs-r3f-3d-scene-builder` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Three.js / React Three Fiber Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web 3D Graphics`.
...
- **Subsystem Binding**: `Web 3D Graphics`
...
```json
{
  "skill": "threejs-r3f-3d-scene-builder",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Three.js / React Three Fiber Docs",
  "integration_target": "Web 3D Graphics",
