...
description: "Add, remove, and list typed SCAPI clients in a Storefront Next project using `b2c\
  \ sfnext scapi` commands, and browse API schemas to discover endpoints before writing\
  \ loaders. Use this skill whenever the user says 'sfnext scapi', 'add an API to\
  \ my storefront next project', 'what SCAPI clients does my sfnext project have',\
  \ 'remove an API client', 'list available APIs for sfnext', 'browse schema before\
  \ writing a loader', or asks how to integrate a specific SCAPI (shopper-baskets,\
  \ shopper-search, etc.) into their Storefront Next project as a typed client. Also\
  \ use when they want to check what parameters an endpoint accepts before coding.\
  \ NOT for making actual SCAPI calls from loaders \u2014 see sfnext-data-fetching.\
  \ NOT for standalone schema browsing outside a Storefront Next project \u2014 see\
  \ b2c-cli:b2c-scapi-schemas."
---
