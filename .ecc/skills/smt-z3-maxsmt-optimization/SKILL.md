---
name: smt-z3-maxsmt-optimization
description: "Weighted soft constraint optimization for optimal code refactoring decisions"
version: 1.0.0
...
triggers:
  ...
  - "maxsmt"
  - "optimization"
  - "smt z3 maxsmt optimization"
  - "smt-z3-maxsmt-optimization"
  - "smt-z3-maxsmt-optimization execute"
  - "smt-z3-maxsmt-optimization verify"
---

# Smt Z3 Maxsmt Optimization Skill

The `smt-z3-maxsmt-optimization` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / Z3 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Blast Radius Engine`.
...
```json
{
  "skill": "smt-z3-maxsmt-optimization",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "SMT-LIB / Z3 Project",
