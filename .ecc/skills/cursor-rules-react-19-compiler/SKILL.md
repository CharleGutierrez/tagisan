---
name: cursor-rules-react-19-compiler
description: "React 19 useActionState, useOptimistic, and automated compiler memoization rules"
version: 1.0.0
...
triggers:
  ...
  - "compiler"
  - "cursor"
  - "cursor rules react 19 compiler"
  - "cursor-rules-react-19-compiler"
  - "cursor-rules-react-19-compiler execute"
  - "cursor-rules-react-19-compiler verify"
  - "frontend"
  - "full-stack"
---

# Cursor Rules React 19 Compiler Skill

The `cursor-rules-react-19-compiler` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-react-19-compiler",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
