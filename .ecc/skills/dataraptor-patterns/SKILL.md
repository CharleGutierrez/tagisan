...
description: "Design DataRaptors \u2014 Extract vs Turbo Extract vs Transform vs Load, mapping,\
  \ performance. Triggers: DataRaptor Extract, Turbo Extract, DataRaptor Load, DataRaptor\
  \ Transform, OmniStudio data mapping. NOT for Extract/Load debugging \u2014 use\
  \ omnistudio/dataraptor-load-and-extract. NOT for transform optimization \u2014\
  \ use omnistudio/dataraptor-transform-optimization."
---
# DataRaptor Patterns
