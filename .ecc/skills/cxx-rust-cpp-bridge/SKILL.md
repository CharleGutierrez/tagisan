---
name: cxx-rust-cpp-bridge
description: "Safe bidirectional C++ and Rust type interop with compile-time type validation"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "CXX Project Docs"
tags:
  - ast
  - bridge
  - compiler
...
triggers:
  ...
  - "cxx rust cpp bridge"
  - "cxx-rust-cpp-bridge"
  - "cxx-rust-cpp-bridge execute"
  - "cxx-rust-cpp-bridge verify"
---

# Cxx Rust Cpp Bridge Skill

The `cxx-rust-cpp-bridge` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **CXX Project Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Plugin Tier D (Native)`.
