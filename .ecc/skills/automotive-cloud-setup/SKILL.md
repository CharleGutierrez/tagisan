...
description: "Use this skill when setting up or extending Salesforce Automotive Cloud \u2014 including\
  \ the Vehicle / VehicleDefinition data model, dealer-OEM relationship modeling via\
  \ AccountAccountRelation, ActionableEvent orchestration. NOT for general Sales Cloud\
  \ opportunity work on a vehicle product (use admin/opportunity-management) \u2014\
  \ use architect/industries-data-model."
---
