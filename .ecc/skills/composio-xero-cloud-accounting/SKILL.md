---
name: composio-xero-cloud-accounting
description: "Xero bank reconciliation, expense tracking, and purchase order sync"
version: 1.0.0
...
triggers:
  ...
  - "cloud"
  - "composio"
  - "composio xero cloud accounting"
  - "composio-dev"
  - "composio-xero-cloud-accounting"
  - "composio-xero-cloud-accounting execute"
  - "composio-xero-cloud-accounting verify"
---

# Composio Xero Cloud Accounting Skill

The `composio-xero-cloud-accounting` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-xero-cloud-accounting",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
