...
description: "Create and query Alibaba Cloud alert rules via CLI. Supports CMS 1.0 cloud resource\
  \  monitoring (ECS, RDS, SLB, etc.) and CMS 2.0 advanced monitoring (Prometheus,\
  \ APM, UModel). Intent routing automatically selects the correct workflow based\
  \ on alert type. Use this skill when users mention: create alert, setup monitoring,\
  \ configure alarm,  ECS/RDS/SLB alert, Prometheus alert, PromQL, K8s monitoring,\
  \ APM alert, UModel alert, list alerts, query rules, \u544A\u8B66\u89C4\u5219, \u521B\
  \u5EFA\u544A\u8B66, \u76D1\u63A7\u62A5\u8B66, Prometheus\u544A\u8B66, \u5E94\u7528\
  \u76D1\u63A7, \u67E5\u770B\u544A\u8B66."
---
