---
name: aliyun-wan-i2v
description: Use when generating videos from images with DashScope Wan 2.7 image-to-video model
  (wan2.7-i2v). Use when implementing first-frame video generation, first+last frame
  interpolation, video continuation, or audio-driven video synthesis via the video-synthesis
  async API.
...
---
