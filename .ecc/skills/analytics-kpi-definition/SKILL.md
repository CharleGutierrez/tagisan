...
description: "Use this skill to define, document, and validate KPI metrics for CRM Analytics \u2014\
  \ covering metric formula design, dimension selection, target-dataset modeling,\
  \ benchmark setting, and the KPI register that must exist before any dashboard or\
  \ lens is built. Trigger keywords: KPI definition CRM Analytics, analytics metric\
  \ design, analytics target attainment, CRM Analytics measures vs dimensions, analytics\
  \ benchmark. NOT for laying out the dashboard or lens itself \u2014 use admin/analytics-dashboard-design.\
  \ NOT for scoping data sources, audiences, and drill-down paths \u2014 use admin/analytics-requirements-gathering."
---
