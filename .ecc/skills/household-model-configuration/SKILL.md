...
description: "Use this skill when configuring the Financial Services Cloud (FSC) household data\
  \ model \u2014 including Household record type setup, Primary Group assignment,\
  \ ACR-based membership, rollup field inclusion, and batch rollup scheduling. NOT\
  \ for NPSP household account configuration (use admin/npsp-household-accounts),\
  \ non-FSC Account hierarchies, or standard Contact-Account relationships outside\
  \ of FSC."
---
