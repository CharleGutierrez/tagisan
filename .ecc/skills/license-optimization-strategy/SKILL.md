...
description: "Auditing, right-sizing, and reclaiming Salesforce licenses to reduce cost and ensure\
  \ compliant allocation. Trigger keywords: license audit, license cost reduction,\
  \ unused licenses, permission set license, login-based license, inactive users,\
  \ license reclamation, right-size licenses. NOT for whether a feature needs an edition\
  \ upgrade or add-on license \u2014 use architect/org-edition-and-feature-licensing.\
  \ NOT for choosing an Experience Cloud external user license type \u2014 use architect/experience-cloud-licensing-model."
---
