---
name: composio-gorgias-ecommerce-support
description: "Gorgias Shopify customer ticket triage and order refund handling"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio gorgias ecommerce support"
  - "composio-dev"
  - "composio-gorgias-ecommerce-support"
  - "composio-gorgias-ecommerce-support execute"
  - "composio-gorgias-ecommerce-support verify"
  - "ecommerce"
  - "enterprise"
---

# Composio Gorgias Ecommerce Support Skill

The `composio-gorgias-ecommerce-support` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-gorgias-ecommerce-support",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
