...
description: "MCP Server actions for Agentforce \u2014 registry, auth, prebuilt servers, Apex integration.\
  \ Use when configuring MCP as an Agentforce action type. Do NOT use for building\
  \ MCP servers."
---
