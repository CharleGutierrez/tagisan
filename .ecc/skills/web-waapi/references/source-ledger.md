...
- `references/docs-mdn-web-animations-api.md`

## Tailored Reference Files

- `references/waapi-lifecycle.md` - Animation object lifecycle
- `references/keyframe-effect-options.md` - Keyframes and timing options
- `references/playback-testing.md` - Playback and interruption validation
- `references/promise-events-and-cancellation.md` - Animation promises, events, and cancellation
- `references/testing-with-getanimations.md` - Testing with getAnimations and deterministic fixtures
