---
name: postman-statuspage-incident
description: "Atlassian Statuspage component status updates and public incident notices"
version: 1.0.0
...
triggers:
  ...
  - "incident"
  - "postman"
  - "postman statuspage incident"
  - "postman-statuspage-incident"
  - "postman-statuspage-incident execute"
  - "postman-statuspage-incident verify"
  - "saas"
---

# Postman Statuspage Incident Skill

The `postman-statuspage-incident` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-statuspage-incident",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
