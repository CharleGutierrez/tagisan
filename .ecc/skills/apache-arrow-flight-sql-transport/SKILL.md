---
name: apache-arrow-flight-sql-transport
description: "High-performance streaming columnar data transport over gRPC between agent nodes"
version: 1.0.0
...
triggers:
  - "apache"
  - "apache arrow flight sql transport"
  - "apache-arrow-flight-sql-transport"
  - "apache-arrow-flight-sql-transport execute"
  - "apache-arrow-flight-sql-transport verify"
  - "arrow"
  - "distributed"
  - "flight"
  - "opentelemetry"
...
# Apache Arrow Flight Sql Transport Skill

The `apache-arrow-flight-sql-transport` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Apache Arrow Documentation** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Data Processing`.
...
- **Subsystem Binding**: `Data Processing`
...
```json
{
  "skill": "apache-arrow-flight-sql-transport",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Apache Arrow Documentation",
  "integration_target": "Data Processing",
