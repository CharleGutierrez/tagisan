---
name: smithery-elasticsearch-log
description: "Lucene full-text cluster search, index mapping, and log aggregation"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery elasticsearch log"
  - "smithery-elasticsearch-log"
  - "smithery-elasticsearch-log execute"
  - "smithery-elasticsearch-log verify"
---

# Smithery Elasticsearch Log Skill

The `smithery-elasticsearch-log` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-elasticsearch-log",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
