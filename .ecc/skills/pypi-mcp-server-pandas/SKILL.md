---
name: pypi-mcp-server-pandas
description: "DataFrame data manipulation, aggregation, and statistical profiling"
version: 1.0.0
...
triggers:
  ...
  - "pandas"
  - "pypi"
  - "pypi mcp server pandas"
  - "pypi-mcp-server-pandas"
  - "pypi-mcp-server-pandas execute"
  - "pypi-mcp-server-pandas verify"
  - "server"
---

# Pypi Mcp Server Pandas Skill

The `pypi-mcp-server-pandas` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
