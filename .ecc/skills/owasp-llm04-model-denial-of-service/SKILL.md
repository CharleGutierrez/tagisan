...
description: "Limiting prompt token count and recursive generation depth to prevent compute exhaustion"
version: 1.0.0
...
triggers:
  ...
  - "owasp-llm04-model-denial-of-service"
  - "owasp-llm04-model-denial-of-service execute"
  - "owasp-llm04-model-denial-of-service verify"
---

# Owasp Llm04 Model Denial Of Service Skill

The `owasp-llm04-model-denial-of-service` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OWASP GenAI Top 10 (owasp.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Concurrency Manager`.
...
```json
{
  "skill": "owasp-llm04-model-denial-of-service",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "OWASP GenAI Top 10 (owasp.org)",
