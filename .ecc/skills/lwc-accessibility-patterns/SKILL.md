...
description: "Use when implementing ARIA attributes, keyboard navigation, live regions, WCAG 2.1,\
  \ focus traps, or accessible datatables in LWCs. Triggers: aria-live, role=grid,\
  \ focus trap, WCAG AA. NOT for a general accessibility review \u2014 use lwc/lwc-accessibility.\
