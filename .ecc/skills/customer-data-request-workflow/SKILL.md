...
description: "Implement GDPR/CCPA data subject rights (access, deletion, rectification) using Salesforce\
  \ Privacy Center and/or custom workflow. NOT for the underlying erasure mechanics\
  \ (Individual sObject, ShouldForget, ContactPointConsent) \u2014 use security/gdpr-data-privacy.\
  \ NOT for general backup or org-level data retention policy."
---
