---
name: seccomp-custom-bpf-generator
description: "Synthesizing custom seccomp BPF bytecodes tailor-made for each agent execution tier"
version: 1.0.0
...
triggers:
  ...
  - "defense"
  - "edr"
  - "seccomp custom bpf generator"
  - "seccomp-custom-bpf-generator"
  - "seccomp-custom-bpf-generator execute"
  - "seccomp-custom-bpf-generator verify"
---

# Seccomp Custom Bpf Generator Skill

The `seccomp-custom-bpf-generator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Security** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Sandbox`.
...
- **Subsystem Binding**: `AgentShield / Sandbox`
...
```json
{
  "skill": "seccomp-custom-bpf-generator",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Linux Kernel Security",
  "integration_target": "AgentShield / Sandbox",
