...
description: 'Alibaba Cloud DataHub full-lifecycle resource management skill. Use for creating,
  querying, updating, and deleting DataHub Projects, Topics, and Subscriptions via
  Aliyun CLI. Triggers: "datahub", "datahub project", "datahub topic", "datahub subscription",
  "datahub resource management", "streaming data management".'
---
