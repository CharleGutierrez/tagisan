---
name: tree-sitter-go-interface-resolver
description: "Go interface method set extraction and structural implementation edge building"
version: 1.0.0
...
triggers:
  ...
  - "interface"
  - "resolver"
  - "tree sitter go interface resolver"
  - "tree-sitter-go-interface-resolver"
  - "tree-sitter-go-interface-resolver execute"
  - "tree-sitter-go-interface-resolver verify"
---

# Tree Sitter Go Interface Resolver Skill

The `tree-sitter-go-interface-resolver` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tree-sitter Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
```json
{
  "skill": "tree-sitter-go-interface-resolver",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Tree-sitter Docs",
