---
name: smt-z3-qf-bv-bitvector
description: "Quantifier-Free Bit-Vector theory constraint solving for integer overflow detection"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "smt"
  - "smt z3 qf bv bitvector"
  - "smt-z3-qf-bv-bitvector"
  - "smt-z3-qf-bv-bitvector execute"
  - "smt-z3-qf-bv-bitvector verify"
---

# Smt Z3 Qf Bv Bitvector Skill

The `smt-z3-qf-bv-bitvector` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / Z3 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Z3 SMT Solver Tool`.
