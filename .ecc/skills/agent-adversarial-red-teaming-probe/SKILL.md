---
name: agent-adversarial-red-teaming-probe
description: "Simulating jailbreaks, prompt injection, and extraction attacks against system prompts"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Cybersecurity AI Specs"
tags:
  - adversarial
  - agent
  - consensus
...
triggers:
  - "adversarial"
  - "agent"
  - "agent adversarial red teaming probe"
  - "agent-adversarial-red-teaming-probe"
  - "agent-adversarial-red-teaming-probe execute"
  - "agent-adversarial-red-teaming-probe verify"
  - "consensus"
  - "cybersecurity"
  - "debate"
---

# Agent Adversarial Red Teaming Probe Skill

The `agent-adversarial-red-teaming-probe` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cybersecurity AI Specs** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `AgentShield`.
...
```json
{
  "skill": "agent-adversarial-red-teaming-probe",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Cybersecurity AI Specs",
  "integration_target": "AgentShield",
