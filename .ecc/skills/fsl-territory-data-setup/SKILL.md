...
description: "Use this skill when bulk loading Service Territory data: boundary polygons, ServiceTerritoryMember\
  \ assignments, OperatingHours, TimeSlots, and territory hierarchy setup. Trigger\
  \ keywords: service territory bulk load, KML polygon import FSL, ServiceTerritoryMember\
  \ migration, OperatingHours data setup, PolygonUtils Apex. NOT for ETM territory\
  \ data \u2014 use data/territory-data-alignment. NOT for territory config in Setup\
  \ \u2014 use admin/fsl-service-territory-setup."
---
