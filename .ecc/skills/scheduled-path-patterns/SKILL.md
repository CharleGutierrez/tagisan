...
description: "Scheduled Paths in record-triggered Flow: delayed execution, time-offset from field,\
  \ batch size tuning, monitoring Paused Flow Interviews, async limits. NOT for picking\
  \ between Scheduled Path, Wait and Scheduled Flow, or migrating time-based workflow\
  \ rules \u2014 use flow/flow-time-based-patterns. NOT for a flow that runs on a\
  \ recurring schedule \u2014 use flow/scheduled-flows."
---
