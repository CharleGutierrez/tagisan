...
description: "Use when designing or reviewing LWCs for keyboard access, semantic labeling, focus.\
  \ Triggers: LWC accessibility, keyboard nav, aria-label, focus order, screen reader.\
  \ NOT for specific ARIA/datatable implementation patterns \u2014 use lwc/lwc-accessibility-patterns.\
  \ NOT for SLDS styling with no assistive-tech impact \u2014 use lwc/lwc-css-and-styling."
---
