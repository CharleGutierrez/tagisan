---
name: zapier-klaviyo-flows
description: "Klaviyo e-commerce SMS and email flow event triggers and list segmentation"
version: 1.0.0
...
triggers:
  ...
  - "klaviyo"
  - "saas"
  - "zapier klaviyo flows"
  - "zapier-klaviyo-flows"
  - "zapier-klaviyo-flows execute"
  - "zapier-klaviyo-flows verify"
---

# Zapier Klaviyo Flows Skill

The `zapier-klaviyo-flows` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
