...
description: "Sales-specific AI features in Sales Cloud: Einstein Opportunity Scoring setup and\
  \ optimization, Einstein Activity Capture configuration, AI email generation, Pipeline\
  \ Inspection AI insights, and Einstein Relationship Insights. NOT for the license\
  \ check and enablement sequence before any of these are turned on \u2014 use agentforce/agentforce-sales-ai-setup.\
  \ NOT for the Service Cloud equivalents such as Case Classification and Work Summaries\
  \ \u2014 use agentforce/einstein-copilot-for-service."
---
