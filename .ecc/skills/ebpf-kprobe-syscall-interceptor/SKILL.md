---
name: ebpf-kprobe-syscall-interceptor
description: "Dynamic kernel function entry/exit probing for non-invasive audit logs"
version: 1.0.0
...
triggers:
  - "ebpf"
  - "ebpf kprobe syscall interceptor"
  - "ebpf-io"
  - "ebpf-kprobe-syscall-interceptor"
  - "ebpf-kprobe-syscall-interceptor execute"
  - "ebpf-kprobe-syscall-interceptor verify"
  - "hardware"
  - "interceptor"
  - "kernel"
---

# Ebpf Kprobe Syscall Interceptor Skill

The `ebpf-kprobe-syscall-interceptor` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **eBPF.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / aya-rs / AgentShield`.
...
- **Subsystem Binding**: `Native Rust / aya-rs / AgentShield`
...
```json
{
  "skill": "ebpf-kprobe-syscall-interceptor",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "eBPF.io",
  "integration_target": "Native Rust / aya-rs / AgentShield",
