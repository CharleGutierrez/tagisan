...
description: "Use when planning or executing load tests, stress tests, or performance benchmarks\
  \ against a Salesforce org. Covers Salesforce Scale Test, third-party tools (JMeter,\
  \ BlazeMeter, k6), API throughput testing, Experience Page Time. NOT for Apex unit\
  \ test performance assertions, LWC Jest tests, or query tuning \u2014 use data/soql-query-optimization."
---
