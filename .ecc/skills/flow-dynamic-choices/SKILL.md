...
description: "Build Flow choice sets from records, picklist fields, or collections, including dependent\
  \ choices. Triggers: dynamic choices Flow, record choice set, dependent picklist\
  \ Flow. NOT for static hard-coded choices \u2014 use flow/screen-flow-choice-component-selection."
---
