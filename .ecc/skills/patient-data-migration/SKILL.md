...
description: "Use this skill when migrating patient records into Salesforce Health Cloud, including\
  \ Person Account (Patient record type) setup, clinical history objects, and care\
  \ plan data. Trigger keywords: patient migration, EMR import, EHR to Health Cloud,\
  \ clinical data load, care plan history migration, HIPAA-compliant data import.\
  \ NOT for generic multi-object migration sequencing and rollback planning \u2014\
  \ use data/data-migration-planning. NOT for Insurance, Energy or Communications\
  \ industry-cloud objects \u2014 use data/industries-data-migration."
---
