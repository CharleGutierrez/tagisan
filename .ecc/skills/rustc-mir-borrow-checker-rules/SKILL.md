---
name: rustc-mir-borrow-checker-rules
description: "MIR Non-Lexical Lifetimes (NLL) analysis and borrow region constraint debugging"
version: 1.0.0
...
triggers:
  ...
  - "compiler"
  - "formal-methods"
  - "rustc mir borrow checker rules"
  - "rustc-mir-borrow-checker-rules"
  - "rustc-mir-borrow-checker-rules execute"
  - "rustc-mir-borrow-checker-rules verify"
---

# Rustc Mir Borrow Checker Rules Skill

The `rustc-mir-borrow-checker-rules` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **rustc dev guide (doc.rust-lang.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Self-Healing Compiler (autofix)`.
...
```json
{
  "skill": "rustc-mir-borrow-checker-rules",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "rustc dev guide (doc.rust-lang.org)",
