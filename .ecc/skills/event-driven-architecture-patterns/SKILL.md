...
description: "Use when choosing between Salesforce event-driven mechanisms \u2014 Platform Events,\
  \ Change Data Capture (CDC), Streaming API (PushTopic), and Outbound Messages \u2014\
  \ to determine which pattern fits a given integration requirement. Triggers: platform\
  \ events vs CDC, choose event pattern, streaming API vs platform events. NOT for\
  \ implementing a single pattern \u2014 use integration/platform-events-integration,\
  \ integration/change-data-capture-integration, or integration/streaming-api-and-pushtopic."
---
