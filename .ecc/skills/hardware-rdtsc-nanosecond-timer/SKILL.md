---
name: hardware-rdtsc-nanosecond-timer
description: "High-precision invariant CPU cycle counter reading for sub-microsecond latency benchmarks"
version: 1.0.0
tier: "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration"
source: "x86-64 Software Developer's Manual"
tags:
  - hardware
  - kernel
  - low-level
...
triggers:
  - "hardware"
  - "hardware rdtsc nanosecond timer"
  - "hardware-rdtsc-nanosecond-timer"
  - "hardware-rdtsc-nanosecond-timer execute"
  - "hardware-rdtsc-nanosecond-timer verify"
  - "kernel"
  - "low-level"
  - "nanosecond"
  - "performance"
...
# Hardware Rdtsc Nanosecond Timer Skill

The `hardware-rdtsc-nanosecond-timer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **x86-64 Software Developer's Manual** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Criterion / Metrics`.
...
- **Subsystem Binding**: `Criterion / Metrics`
...
```json
{
  "skill": "hardware-rdtsc-nanosecond-timer",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "x86-64 Software Developer's Manual",
  "integration_target": "Criterion / Metrics",
