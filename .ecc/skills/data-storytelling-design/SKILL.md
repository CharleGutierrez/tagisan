...
description: 'Designing data stories and narrative-driven analytics in Salesforce: structuring
  CRM Analytics dashboards for executive communication, text widgets and conditional
  highlights for annotation, sequential narrative in Tableau Story sheets, and Einstein
  Discovery narrative REST endpoints. Trigger keywords: data storytelling dashboard,
  executive analytics narrative, CRM Analytics text widget annotation, Tableau story
  sheet, smart data discovery narrative API. NOT for building the Einstein Discovery
  story or prediction definition - use admin/einstein-discovery-setup. NOT for choosing
  between Reports, CRM Analytics and Tableau - use admin/einstein-analytics-basics.'
---
