---
name: rustc-trait-solver-chalk
description: "First-order logic trait solver resolution for higher-ranked trait bounds (HRTB)"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "rustc"
  - "rustc trait solver chalk"
  - "rustc-trait-solver-chalk"
  - "rustc-trait-solver-chalk execute"
  - "rustc-trait-solver-chalk verify"
---

# Rustc Trait Solver Chalk Skill

The `rustc-trait-solver-chalk` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **rustc dev guide (doc.rust-lang.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Self-Healing Compiler (autofix)`.
...
```json
{
  "skill": "rustc-trait-solver-chalk",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "rustc dev guide (doc.rust-lang.org)",
