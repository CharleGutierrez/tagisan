---
name: composio-zoho-crm
description: "Zoho CRM customer record updates, deal pipelines, and invoice linking"
version: 1.0.0
...
triggers:
  ...
  - "composio-dev"
  - "composio-zoho-crm"
  - "composio-zoho-crm execute"
  - "composio-zoho-crm verify"
  - "crm"
  - "enterprise"
---

# Composio Zoho Crm Skill

The `composio-zoho-crm` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
