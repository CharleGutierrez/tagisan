---
name: oxc-ast-typescript-transformer
description: "High-performance Rust-native AST visitor for TypeScript AST transformations"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "Oxc Project Docs"
tags:
  - ast
  - compiler
  - formal-methods
...
triggers:
  ...
  - "formal-methods"
  - "oxc"
  - "oxc ast typescript transformer"
  - "oxc-ast-typescript-transformer"
  - "oxc-ast-typescript-transformer execute"
  - "oxc-ast-typescript-transformer verify"
  - "symbolic"
---

# Oxc Ast Typescript Transformer Skill

The `oxc-ast-typescript-transformer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Oxc Project Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Polyglot Runtimes / Bun`.
...
- **Subsystem Binding**: `Polyglot Runtimes / Bun`
...
```json
{
  "skill": "oxc-ast-typescript-transformer",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Oxc Project Docs",
  "integration_target": "Polyglot Runtimes / Bun",
