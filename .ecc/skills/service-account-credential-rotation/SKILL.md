...
description: "Use when designing credential rotation for integration users, connected apps, named\
  \ credentials, and OAuth client secrets in Salesforce. Covers rotation cadence,\
  \ zero-downtime handover, secret storage, and detection of stale credentials. Triggers:\
  \ 'rotate integration user. NOT for end-user password policies \u2014 use admin/connected-apps-and-auth."
---
