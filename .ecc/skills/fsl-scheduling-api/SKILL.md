...
description: "Use this skill when implementing Apex code that calls the FSL scheduling Apex API:\
  \ GetSlots, schedule(), GradeSlotsService, or OAAS optimization classes. Trigger\
  \ keywords: AppointmentBookingService, ScheduleService.schedule, GetSlots, GradeSlotsService,\
  \ OAAS, bulk scheduling, FSL optimization callout. NOT for scheduling policy config\
  \ \u2014 use admin/fsl-scheduling-policies. NOT for optimization-mode and territory\
  \ design \u2014 use architect/fsl-optimization-architecture."
---
# FSL Scheduling API
