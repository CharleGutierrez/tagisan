---
name: linux-netlink-route-monitor
description: "Netlink socket subscription for routing table changes and link state transitions"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux netlink route monitor"
  - "linux-netlink-route-monitor"
  - "linux-netlink-route-monitor execute"
  - "linux-netlink-route-monitor verify"
  - "low-level"
  - "monitor"
---

# Linux Netlink Route Monitor Skill

The `linux-netlink-route-monitor` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Distributed P2P / Mesh`.
...
```json
{
  "skill": "linux-netlink-route-monitor",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
