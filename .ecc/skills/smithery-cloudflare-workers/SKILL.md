---
name: smithery-cloudflare-workers
description: "Edge worker script deployment, route binding, and execution tail logs"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery cloudflare workers"
  - "smithery-ai"
  - "smithery-cloudflare-workers"
  - "smithery-cloudflare-workers execute"
  - "smithery-cloudflare-workers verify"
---

# Smithery Cloudflare Workers Skill

The `smithery-cloudflare-workers` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-cloudflare-workers",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
