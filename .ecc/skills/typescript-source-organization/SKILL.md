...
description: Apply, review, and explain TypeScript source organization conventions. Use automatically
  for tasks involving feature-based organization, code colocation, import paths, import
  sorting, monorepos, or frontend and backend project structure.
...
---
# Source Organization
