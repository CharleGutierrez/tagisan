---
name: composio-trello-boards
description: "Trello board list cards moving, checklist updates, and webhook callbacks"
version: 1.0.0
...
triggers:
  ...
  - "boards"
  - "composio"
  - "composio trello boards"
  - "composio-dev"
  - "composio-trello-boards"
  - "composio-trello-boards execute"
  - "composio-trello-boards verify"
  - "enterprise"
---

# Composio Trello Boards Skill

The `composio-trello-boards` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
