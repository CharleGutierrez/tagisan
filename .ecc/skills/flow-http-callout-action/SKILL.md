...
description: "Call external HTTP APIs directly from Flow using HTTP Callout actions (no Apex),\
  \ handling auth, schema, and errors. NOT for registering an OpenAPI spec as an External\
  \ Service \u2014 use flow/flow-external-services. NOT for Apex callout logic and\
  \ mock tests \u2014 use apex/callouts-and-http-integrations."
---
