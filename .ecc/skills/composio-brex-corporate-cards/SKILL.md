---
name: composio-brex-corporate-cards
description: "Brex corporate credit card transaction categorization and receipt match"
version: 1.0.0
...
triggers:
  ...
  - "cards"
  - "composio"
  - "composio brex corporate cards"
  - "composio-brex-corporate-cards"
  - "composio-brex-corporate-cards execute"
  - "composio-brex-corporate-cards verify"
  - "composio-dev"
---

# Composio Brex Corporate Cards Skill

The `composio-brex-corporate-cards` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-brex-corporate-cards",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
