---
name: llvm-ir-gvn-redundancy-elimination
description: "Global Value Numbering to eliminate redundant computations and sub-expressions"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "LLVM Language Reference (llvm.org)"
tags:
  - ast
  - compiler
  - elimination
...
triggers:
  ...
  - "formal-methods"
  - "gvn"
  - "llvm ir gvn redundancy elimination"
  - "llvm-ir-gvn-redundancy-elimination"
  - "llvm-ir-gvn-redundancy-elimination execute"
  - "llvm-ir-gvn-redundancy-elimination verify"
---

# Llvm Ir Gvn Redundancy Elimination Skill

The `llvm-ir-gvn-redundancy-elimination` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
- **Subsystem Binding**: `Compiler IR Optimizer`
...
```json
{
  "skill": "llvm-ir-gvn-redundancy-elimination",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
  "integration_target": "Compiler IR Optimizer",
