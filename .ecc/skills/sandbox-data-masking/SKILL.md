...
description: "Use this skill when configuring or reviewing Salesforce Data Mask to protect PII/PHI\
  \ in partial or full copy sandboxes after a refresh. Trigger keywords: data mask,\
  \ sandbox masking, PII in sandbox, GDPR sandbox, HIPAA. NOT for sandbox refresh\
  \ mechanics (use devops/sandbox-refresh-and-templates) or production data anonymization\
  \ \u2014 use admin/sandbox-strategy."
---
