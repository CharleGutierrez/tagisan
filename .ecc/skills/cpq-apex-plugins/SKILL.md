...
description: "Implementing Salesforce CPQ plugin interfaces in Apex or JavaScript (JS QCP) to customize\
  \ quote calculation, product search, order creation, contracting, or configuration\
  \ screens. Trigger keywords: SBQQ plugin, QuoteCalculatorPlugin, ProductSearchPlugin,\
  \ OrderPlugin, ContractingPlugin, ConfigurationInitializerPlugin, SBQQ__CustomScript__c,\
  \ JS QCP, calculate callback, CPQ plugin registration. NOT for driving CPQ yourself\
  \ via SBQQ.ServiceRouter \u2014 use apex/cpq-api-and-automation. NOT for declarative\
  \ price rules and discount schedules \u2014 use admin/cpq-pricing-rules; for product\
  \ rules and bundle options \u2014 use admin/cpq-product-catalog-setup."
---
# CPQ Apex Plugins
