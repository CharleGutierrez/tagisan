---
name: zod-v4-schema-validation-transforms
description: "Type inference, recursive schema parsing, and transformation pipelines"
version: 1.0.0
...
triggers:
  ...
  - "schema"
  - "transforms"
  - "zod v4 schema validation transforms"
  - "zod-v4-schema-validation-transforms"
  - "zod-v4-schema-validation-transforms execute"
  - "zod-v4-schema-validation-transforms verify"
---

# Zod V4 Schema Validation Transforms Skill

The `zod-v4-schema-validation-transforms` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zod Documentation (zod.dev)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Structured Output`.
...
```json
{
  "skill": "zod-v4-schema-validation-transforms",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Zod Documentation (zod.dev)",
