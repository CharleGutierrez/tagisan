---
name: swarm-petgraph-dag-pipeline
description: "5-stage parallel directed acyclic graph workflow execution with failure propagation"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Tagisan Architecture Blueprint"
tags:
  - consensus
  - dag
  - debate
...
triggers:
  ...
  - "moa"
  - "multi-agent"
  - "swarm petgraph dag pipeline"
  - "swarm-petgraph-dag-pipeline"
  - "swarm-petgraph-dag-pipeline execute"
  - "swarm-petgraph-dag-pipeline verify"
---

# Swarm Petgraph Dag Pipeline Skill

The `swarm-petgraph-dag-pipeline` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tagisan Architecture Blueprint** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `ECC 5-Stage Pipeline`.
...
- **Subsystem Binding**: `ECC 5-Stage Pipeline`
...
```json
{
  "skill": "swarm-petgraph-dag-pipeline",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Tagisan Architecture Blueprint",
  "integration_target": "ECC 5-Stage Pipeline",
