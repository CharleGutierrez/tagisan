...
description: "Use when designing or troubleshooting CRM Analytics dashboards \u2014 chart types,\
  \ bindings, faceting, dashboard interactions, mobile layout, and filters. NOT for\
  \ standard Salesforce reports and dashboards \u2014 use admin/reports-and-dashboards-fundamentals.\
  \ NOT for hand-editing dashboard JSON or a SAQL step \u2014 use admin/analytics-dashboard-json."
---
