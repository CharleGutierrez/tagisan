---
name: mitre-t1552-unsecured-credentials-scanner
description: "Scanning code diffs and environment for private keys, AWS tokens, and hardcoded secrets"
version: 1.0.0
...
triggers:
  ...
  - "edr"
  - "mitre"
  - "mitre t1552 unsecured credentials scanner"
  - "mitre-t1552-unsecured-credentials-scanner"
  - "mitre-t1552-unsecured-credentials-scanner execute"
  - "mitre-t1552-unsecured-credentials-scanner verify"
---

# Mitre T1552 Unsecured Credentials Scanner Skill

The `mitre-t1552-unsecured-credentials-scanner` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Secret Entropy Scanner`.
...
- **Subsystem Binding**: `Secret Entropy Scanner`
...
```json
{
  "skill": "mitre-t1552-unsecured-credentials-scanner",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "Secret Entropy Scanner",
