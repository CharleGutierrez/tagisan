---
name: chaos-process-kill-monkey
description: "Randomly terminating non-critical worker subagents to verify automatic session healing"
version: 1.0.0
...
triggers:
  - "chaos"
  - "chaos process kill monkey"
  - "chaos-process-kill-monkey"
  - "chaos-process-kill-monkey execute"
  - "chaos-process-kill-monkey verify"
  - "distributed"
  - "kill"
  - "monkey"
  - "opentelemetry"
...
# Chaos Process Kill Monkey Skill

The `chaos-process-kill-monkey` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Principles of Chaos Engineering** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Chaos Fault Injector`.
...
```json
{
  "skill": "chaos-process-kill-monkey",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Principles of Chaos Engineering",
