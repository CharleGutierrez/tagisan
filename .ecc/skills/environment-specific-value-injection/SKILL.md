...
description: "Use this skill when configuring, reviewing, or troubleshooting how environment-specific\
  \ values \u2014 endpoint URLs, client IDs, thresholds, feature flags \u2014 are\
  \ managed across Salesforce orgs without hardcoding. Triggers:. NOT for sandbox\
  \ refresh automation (use sandbox-refresh-and-templates), NOT for general  \u2014\
  \ use data/deployment-data-dependencies."
---
