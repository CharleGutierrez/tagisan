...
description: 'Design, implement, or audit a Change Advisory Board (CAB) process for Salesforce
  deployments: change classification (standard, normal, emergency), required approvals,
  deployment gate sequencing, and integration with external ITSM tooling. NOT for
  scoring how risky one release is - use admin/deployment-risk-assessment. NOT for
  executing or troubleshooting the deployment itself - use admin/change-management-and-deployment.'
---
