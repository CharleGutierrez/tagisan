...
description: "Use when you need to diagnose live Lightning Web Component behavior in the browser\
  \ \u2014 setting breakpoints, stepping through @wire emits, inspecting component\
  \ state with the Lightning Component Inspector, reading. NOT for Jest test failures\
  \ \u2014 use `lwc-testing` \u2014 and NOT for Apex debug logs, which are  \u2014\
  \ use lwc/common-lwc-runtime-errors."
---
