---
name: postman-split-io-experiments
description: "Split.io feature experiment tracking, targeting rules, and metric variance"
version: 1.0.0
...
triggers:
  ...
  - "experiments"
  - "postman"
  - "postman split io experiments"
  - "postman-split-io-experiments"
  - "postman-split-io-experiments execute"
  - "postman-split-io-experiments verify"
  - "saas"
---

# Postman Split Io Experiments Skill

The `postman-split-io-experiments` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-split-io-experiments",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
