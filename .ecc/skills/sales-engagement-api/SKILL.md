...
description: "Use when enrolling records in Sales Engagement cadences from Apex, logging call outcomes\
  \ on cadence steps, customizing cadence step actions via Apex, or consuming cadence\
  \ lifecycle events through Change Data Capture. Triggers: 'enroll lead in cadence',\
  \ 'assignTargetToSalesCadence', 'ActionCadenceTracker', 'log call result cadence',\
  \ 'Sales Engagement Apex'. NOT for building or administering cadences, steps, or\
  \ rep permissions in Setup \u2014 use admin/sales-engagement-cadences."
---
