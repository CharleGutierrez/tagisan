---
name: gsap-utils
description: "Official GSAP skill for gsap.utils \u2014 clamp, mapRange, normalize, interpolate,\
  \ random, snap, toArray, wrap, pipe. Use when the user asks about gsap.utils, clamp,\
  \ mapRange, random, snap, toArray, wrap, or helper utilities in GSAP."
---
# gsap.utils
