...
description: "Troubleshoot SAML SSO failures \u2014 assertion errors, certificate mismatch, JIT\
  \ provisioning. Triggers: SAML error, SSO login failure, assertion invalid. NOT\
  \ for initial SSO configuration - use security/sso-configuration."
---
