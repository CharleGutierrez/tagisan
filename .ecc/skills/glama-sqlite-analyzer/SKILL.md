---
name: glama-sqlite-analyzer
description: "In-process SQLite database introspection, schema validation, and SQL execution"
version: 1.0.0
...
triggers:
  - "analyzer"
  - "glama"
  - "glama sqlite analyzer"
  - "glama-ai"
  - "glama-sqlite-analyzer"
  - "glama-sqlite-analyzer execute"
  - "glama-sqlite-analyzer verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Sqlite Analyzer Skill

The `glama-sqlite-analyzer` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
