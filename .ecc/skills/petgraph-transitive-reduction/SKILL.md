---
name: petgraph-transitive-reduction
description: "Pruning redundant transitive dependency edges in multi-crate workspace graphs"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "petgraph"
  - "petgraph transitive reduction"
  - "petgraph-transitive-reduction"
  - "petgraph-transitive-reduction execute"
  - "petgraph-transitive-reduction verify"
  - "reduction"
---

# Petgraph Transitive Reduction Skill

The `petgraph-transitive-reduction` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Petgraph Docs (docs.rs)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Blast Radius Engine`.
...
- **Subsystem Binding**: `Blast Radius Engine`
...
```json
{
  "skill": "petgraph-transitive-reduction",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Petgraph Docs (docs.rs)",
  "integration_target": "Blast Radius Engine",
