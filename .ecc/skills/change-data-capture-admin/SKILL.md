...
description: "Use when enabling, configuring, or monitoring Change Data Capture (CDC) entity selection,\
  \ channel enrichment, and delivery usage limits from an admin perspective. NOT for\
  \ writing an Apex change-event trigger \u2014 use apex/change-data-capture-apex.\
  \ NOT for subscribing an external system over Pub/Sub or CometD \u2014 use integration/change-data-capture-integration."
---
