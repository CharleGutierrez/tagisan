---
name: owasp-llm06-sensitive-information-leak
description: "Automatic PII, credit card, and API key scrubbing before prompt persistence to memory"
version: 1.0.0
...
triggers:
  ...
  - "owasp-llm06-sensitive-information-leak"
  - "owasp-llm06-sensitive-information-leak execute"
  - "owasp-llm06-sensitive-information-leak verify"
---

# Owasp Llm06 Sensitive Information Leak Skill

The `owasp-llm06-sensitive-information-leak` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OWASP GenAI Top 10 (owasp.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `MemoryBackend / Redact`.
...
- **Subsystem Binding**: `MemoryBackend / Redact`
...
```json
{
  "skill": "owasp-llm06-sensitive-information-leak",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "OWASP GenAI Top 10 (owasp.org)",
  "integration_target": "MemoryBackend / Redact",
