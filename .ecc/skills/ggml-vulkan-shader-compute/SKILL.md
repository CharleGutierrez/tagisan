---
name: ggml-vulkan-shader-compute
description: "Cross-platform Vulkan compute SPIR-V shaders for AMD and Intel GPU acceleration"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "Khronos Group Vulkan Spec"
tags:
  - ai
  - compute
  - cuda
...
triggers:
  ...
  - "cuda"
  - "ggml"
  - "ggml vulkan shader compute"
  - "ggml-vulkan-shader-compute"
  - "ggml-vulkan-shader-compute execute"
  - "ggml-vulkan-shader-compute verify"
  - "gguf"
---

# Ggml Vulkan Shader Compute Skill

The `ggml-vulkan-shader-compute` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Khronos Group Vulkan Spec** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / GPU`.
...
```json
{
  "skill": "ggml-vulkan-shader-compute",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Khronos Group Vulkan Spec",
