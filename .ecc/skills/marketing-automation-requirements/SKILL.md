...
description: "Use this skill when gathering, documenting, or validating requirements for a Salesforce\
  \ marketing automation program \u2014 covering MCAE (Account Engagement / Pardot)\
  \ lifecycle stages, MQL/SQL threshold definitions, scoring model specifications\
  \ (sources, weights, decay, ceiling), handoff notification design, CRM field updates\
  \ on status change, and sales SLA. Trigger keywords: MQL criteria, marketing-to-sales\
  \ handoff, lead lifecycle, scoring requirements, automation program requirements,\
  \ Marketing Cloud Automation Studio scope. NOT for building the scoring and grading\
  \ rules in MCAE \u2014 use admin/mcae-lead-scoring-and-grading. NOT for a Sales-Cloud\
  \ composite score built from formula fields \u2014 use admin/lead-scoring-requirements."
---
