...
description: "Use this skill when setting up or troubleshooting the Salesforce for Slack managed\
  \ app \u2014 including connecting a Salesforce org to a Slack workspace, configuring\
  \ the three-party admin handshake, linking Slack channels. NOT for building custom\
  \ Slack apps or Slack bots (separate development platform), not fo \u2014 use integration/slack-workflow-builder."
---
