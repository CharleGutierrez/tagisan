...
description: "Use this skill when you need guaranteed post-Queueable cleanup, retry, or failure-logging\
  \ logic that must run even when the parent Queueable throws an unhandled exception.\
  \ Trigger keywords: FinalizerContext, System.attachFinalizer, Queueable cleanup\
  \ on failure, post-job compensation, guaranteed async cleanup. NOT for Queueable\
  \ design or chaining \u2014 use apex/apex-queueable-patterns. NOT for the same need\
  \ in Flow \u2014 use flow/flow-transaction-finalizer-patterns."
---
