...
description: "Use this skill when configuring Salesforce B2B or D2C Commerce checkout: payment\
  \ methods, shipping/tax integration, guest checkout, order summary setup, and CartCheckoutSession\
  \ state orchestration. Trigger keywords: checkout flow, payment adapter, shipping\
  \ tax integration, guest checkout, order summary, CartCheckoutSession, Managed Checkout,\
  \ Commerce checkout flow. NOT for deciding the checkout design before build (LWR\
  \ vs Aura) \u2014 use admin/commerce-checkout-flow-design. NOT for writing the CommercePayments\
  \ adapter class \u2014 use apex/commerce-payment-integration."
---
