...
description: Use when the user wants to run SQL against Alibaba Cloud MaxCompute (ODPS), inspect
  MaxCompute schemas, build or maintain a semantic package, enrich package semantics,
  manage MaxCompute UDFs, or record verified/failed SQL memory through the `mcs` CLI.
...
---
# maxcompute-semantic
