---
name: pypi-mcp-server-scipy
description: "Scientific computing, optimization, interpolation, and signal processing"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server scipy"
  - "pypi-mcp-server-scipy"
  - "pypi-mcp-server-scipy execute"
  - "pypi-mcp-server-scipy verify"
  - "scipy"
  - "server"
---

# Pypi Mcp Server Scipy Skill

The `pypi-mcp-server-scipy` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
