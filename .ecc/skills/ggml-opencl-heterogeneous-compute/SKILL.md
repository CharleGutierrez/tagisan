---
name: ggml-opencl-heterogeneous-compute
description: "OpenCL kernel compilation for legacy and integrated GPUs"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "Khronos Group OpenCL Spec"
tags:
  - ai
  - compute
  - cuda
...
triggers:
  ...
  - "cuda"
  - "ggml"
  - "ggml opencl heterogeneous compute"
  - "ggml-opencl-heterogeneous-compute"
  - "ggml-opencl-heterogeneous-compute execute"
  - "ggml-opencl-heterogeneous-compute verify"
  - "gguf"
---

# Ggml Opencl Heterogeneous Compute Skill

The `ggml-opencl-heterogeneous-compute` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Khronos Group OpenCL Spec** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / GPU`.
...
- **Subsystem Binding**: `Tensor Engine / GPU`
...
```json
{
  "skill": "ggml-opencl-heterogeneous-compute",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Khronos Group OpenCL Spec",
  "integration_target": "Tensor Engine / GPU",
