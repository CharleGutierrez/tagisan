...
description: "When and how to split an Apex class into Domain / Service / Selector layers using\
  \ this repo's lightweight base classes (BaseDomain, BaseService, BaseSelector).\
  \ Covers splitting signals, ordering of extraction, and naming conventions. NOT\
  \ for a full fflib migration \u2014 use apex/fflib-enterprise-patterns. NOT for\
  \ choosing a trigger handler framework \u2014 use apex/trigger-framework."
---
