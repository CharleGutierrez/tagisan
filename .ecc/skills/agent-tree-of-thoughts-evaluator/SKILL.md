---
name: agent-tree-of-thoughts-evaluator
description: "Exploring multiple reasoning branches simultaneously with heuristic evaluation scoring"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent tree of thoughts evaluator"
  - "agent-tree-of-thoughts-evaluator"
  - "agent-tree-of-thoughts-evaluator execute"
  - "agent-tree-of-thoughts-evaluator verify"
  - "arxiv"
  - "consensus"
  - "debate"
  - "evaluator"
...
# Agent Tree Of Thoughts Evaluator Skill

The `agent-tree-of-thoughts-evaluator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Cognitive Engine`.
...
```json
{
  "skill": "agent-tree-of-thoughts-evaluator",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
