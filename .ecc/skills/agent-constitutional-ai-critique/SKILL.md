---
name: agent-constitutional-ai-critique
description: "Automated critique and revision loops against a set of explicit behavioral rules"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent constitutional ai critique"
  - "agent-constitutional-ai-critique"
  - "agent-constitutional-ai-critique execute"
  - "agent-constitutional-ai-critique verify"
  - "anthropic"
  - "consensus"
  - "constitutional"
  - "critique"
...
# Agent Constitutional Ai Critique Skill

The `agent-constitutional-ai-critique` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Anthropic Research Papers** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `AgentShield`.
...
```json
{
  "skill": "agent-constitutional-ai-critique",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Anthropic Research Papers",
