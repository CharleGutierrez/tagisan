---
name: lean4-theorem-formalization
description: "Formalizing software architectural invariants as interactive machine-checked theorems"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "Lean 4 Documentation"
tags:
  - ast
  - compiler
  - formal-methods
...
triggers:
  ...
  - "formalization"
  - "lean"
  - "lean4 theorem formalization"
  - "lean4-theorem-formalization"
  - "lean4-theorem-formalization execute"
  - "lean4-theorem-formalization verify"
---

# Lean4 Theorem Formalization Skill

The `lean4-theorem-formalization` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Lean 4 Documentation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "lean4-theorem-formalization",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Lean 4 Documentation",
