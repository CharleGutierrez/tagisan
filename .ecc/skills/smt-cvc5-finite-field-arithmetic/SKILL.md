---
name: smt-cvc5-finite-field-arithmetic
description: "Finite field constraint solving for cryptographic circuit correctness validation"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "SMT-LIB / cvc5 Project"
tags:
  - arithmetic
  - ast
  - compiler
...
triggers:
  ...
  - "cvc5"
  - "field"
  - "smt cvc5 finite field arithmetic"
  - "smt-cvc5-finite-field-arithmetic"
  - "smt-cvc5-finite-field-arithmetic execute"
  - "smt-cvc5-finite-field-arithmetic verify"
---

# Smt Cvc5 Finite Field Arithmetic Skill

The `smt-cvc5-finite-field-arithmetic` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / cvc5 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Post-Quantum Auditor`.
...
- **Subsystem Binding**: `Post-Quantum Auditor`
...
```json
{
  "skill": "smt-cvc5-finite-field-arithmetic",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "SMT-LIB / cvc5 Project",
  "integration_target": "Post-Quantum Auditor",
