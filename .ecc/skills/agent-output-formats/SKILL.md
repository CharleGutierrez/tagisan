...
description: "Convert the canonical markdown+JSON deliverable of any SfSkills runtime agent into\
  \ Excel, PDF, CSV, Notion card, ServiceNow ticket, or similar downstream format\
  \ without adding dependencies to the consumer's project. NOT for an Agentforce action's\
  \ output \u2014 use agentforce/agent-actions. NOT for exporting Salesforce data\
  \ \u2014 use integration/bulk-api-2-patterns."
---
