---
name: agent-self-consistency-sampling
description: "Sampling multiple independent reasoning paths and selecting majority consensus verdict"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent self consistency sampling"
  - "agent-self-consistency-sampling"
  - "agent-self-consistency-sampling execute"
  - "agent-self-consistency-sampling verify"
  - "arxiv"
  - "consensus"
  - "consistency"
  - "debate"
...
# Agent Self Consistency Sampling Skill

The `agent-self-consistency-sampling` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Consensus Engine`.
...
```json
{
  "skill": "agent-self-consistency-sampling",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
