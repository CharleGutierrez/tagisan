...
description: 'Use to enable or verify the Omni-Channel sidebar on a Lightning console app. Triggers:
  enable the Omni sidebar, pin Omni-Channel in a console app, configure the Omni sidebar,
  turn on the Omni-Channel utility region, verify the pinned Omni widget. Do not use
  for Aura apps, standard apps, utility-bar-only Omni widgets, or to create a console
  app.'
---
