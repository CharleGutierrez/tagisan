---
name: zero-knowledge-proof-snark-verifier
description: "Verifying zero-knowledge proofs of execution without revealing proprietary inputs"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "ZK-Proof Specifications"
tags:
  - agentshield
  - defense
  - edr
...
triggers:
  ...
  - "knowledge"
  - "mitre"
  - "zero knowledge proof snark verifier"
  - "zero-knowledge-proof-snark-verifier"
  - "zero-knowledge-proof-snark-verifier execute"
  - "zero-knowledge-proof-snark-verifier verify"
---

# Zero Knowledge Proof Snark Verifier Skill

The `zero-knowledge-proof-snark-verifier` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ZK-Proof Specifications** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Formal Invariant Prover`.
...
- **Subsystem Binding**: `Formal Invariant Prover`
...
```json
{
  "skill": "zero-knowledge-proof-snark-verifier",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "ZK-Proof Specifications",
  "integration_target": "Formal Invariant Prover",
