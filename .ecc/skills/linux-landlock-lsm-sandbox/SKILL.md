---
name: linux-landlock-lsm-sandbox
description: "Landlock LSM filesystem hierarchy restriction without root privileges"
version: 1.0.0
...
triggers:
  ...
  - "linux-landlock-lsm-sandbox"
  - "linux-landlock-lsm-sandbox execute"
  - "linux-landlock-lsm-sandbox verify"
  - "low-level"
---

# Linux Landlock Lsm Sandbox Skill

The `linux-landlock-lsm-sandbox` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `AgentShield / Sandbox`.
...
```json
{
  "skill": "linux-landlock-lsm-sandbox",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
