---
name: mitre-t1098-account-manipulation-guard
description: "Detecting unauthorized additions to /etc/sudoers, authorized_keys, and local admin groups"
version: 1.0.0
...
triggers:
  ...
  - "edr"
  - "guard"
  - "mitre t1098 account manipulation guard"
  - "mitre-t1098-account-manipulation-guard"
  - "mitre-t1098-account-manipulation-guard execute"
  - "mitre-t1098-account-manipulation-guard verify"
---

# Mitre T1098 Account Manipulation Guard Skill

The `mitre-t1098-account-manipulation-guard` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Audit`.
...
- **Subsystem Binding**: `AgentShield / Audit`
...
```json
{
  "skill": "mitre-t1098-account-manipulation-guard",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "AgentShield / Audit",
