...
description: "Designing, querying, or troubleshooting the Health Cloud consent data model \u2014\
  \ the five-object HIPAA authorization hierarchy (DataUsePurpose \u2192 AuthorizationForm\
  \ \u2192 AuthorizationFormText \u2192 AuthorizationFormDataUse \u2192 AuthorizationFormConsent).\
  \ Trigger keywords: authorization form consent, ConsentGiverId, AuthorizationFormConsent\
  \ SOQL, CareProgramEnrollee consent gate, PHI consent trail, consent hierarchy setup.\
  \ NOT for the Setup configuration of authorization forms, consent templates, and\
  \ withdrawal handling \u2014 use admin/health-cloud-consent-management. NOT for\
  \ marketing or GDPR opt-out on ContactPointTypeConsent \u2014 use security/gdpr-data-privacy."
---
