---
name: tree-sitter-python-grammar-traversal
description: "Surgical CST traversal extracting Python decorators, async defs, and type hints"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "Tree-sitter Docs"
tags:
  - ast
  - compiler
  - formal-methods
...
triggers:
  ...
  - "grammar"
  - "python"
  - "tree sitter python grammar traversal"
  - "tree-sitter-python-grammar-traversal"
  - "tree-sitter-python-grammar-traversal execute"
  - "tree-sitter-python-grammar-traversal verify"
---

# Tree Sitter Python Grammar Traversal Skill

The `tree-sitter-python-grammar-traversal` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tree-sitter Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
- **Subsystem Binding**: `AST Codebase Graph`
...
```json
{
  "skill": "tree-sitter-python-grammar-traversal",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Tree-sitter Docs",
  "integration_target": "AST Codebase Graph",
