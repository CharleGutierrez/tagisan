...
description: "Use when designing or reviewing Lightning Web Components for the Salesforce mobile\
  \ app, mobile device capabilities, or offline-aware behavior. Triggers: 'lightning/mobileCapabilities',\
  \ 'mobile lwc', 'offline lwc'. NOT for Mobile SDK or fully native app architecture\
  \ unless the decision is whether LWC i \u2014 use apex/fsl-mobile-app-extensions."
---
