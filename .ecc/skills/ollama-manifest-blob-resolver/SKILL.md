---
name: ollama-manifest-blob-resolver
description: "Mapping friendly model tags to sha256 blob weights in ~/.ollama/models/manifests/"
version: 1.0.0
...
triggers:
  ...
  - "gguf"
  - "manifest"
  - "ollama manifest blob resolver"
  - "ollama-manifest-blob-resolver"
  - "ollama-manifest-blob-resolver execute"
  - "ollama-manifest-blob-resolver verify"
---

# Ollama Manifest Blob Resolver Skill

The `ollama-manifest-blob-resolver` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Ollama.com Library** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `OllamaBlobResolver`.
...
- **Subsystem Binding**: `OllamaBlobResolver`
...
```json
{
  "skill": "ollama-manifest-blob-resolver",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Ollama.com Library",
  "integration_target": "OllamaBlobResolver",
