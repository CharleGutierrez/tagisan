---
name: pypi-mcp-server-chromadb
description: "Chroma vector database client with native Python embedding pipelines"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server chromadb"
  - "pypi-mcp-server-chromadb"
  - "pypi-mcp-server-chromadb execute"
  - "pypi-mcp-server-chromadb verify"
  - "server"
---

# Pypi Mcp Server Chromadb Skill

The `pypi-mcp-server-chromadb` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / VectorStoreBackend`.
...
```json
{
  "skill": "pypi-mcp-server-chromadb",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
