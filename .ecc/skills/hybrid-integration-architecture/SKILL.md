...
description: "Use this skill when designing hybrid on-premises-to-Salesforce integration architectures:\
  \ DMZ relay patterns, reverse proxy configuration, VPN connectivity, and Salesforce\
  \ Private Connect (AWS PrivateLink) topology. Trigger keywords: on-premises to Salesforce\
  \ integration network topology, DMZ relay Salesforce, hybrid integration VPN, Private\
  \ Connect architecture, data residency Salesforce hybrid. NOT for choosing the authentication\
  \ mechanism \u2014 mTLS, OAuth flow, API gateway placement \u2014 use architect/integration-security-architecture.\
  \ NOT for the Setup steps that configure Private Connect peering \u2014 use integration/private-connect-setup."
---
