...
description: "Use this skill when designing, building, or troubleshooting FSC Action Plan templates\
  \ for client-facing task sequences such as client onboarding, account opening, annual\
  \ review preparation, and compliance tasks. Trigger keywords: Action Plan template,\
  \ ActionPlanTemplate, ActionPlan object, FSC task sequence, onboarding checklist,\
  \ review prep tasks. NOT for designing the onboarding process itself \u2014 use\
  \ admin/client-onboarding-design. NOT for Health Cloud care plan templates \u2014\
  \ use admin/care-plan-configuration."
---
# FSC Action Plans
