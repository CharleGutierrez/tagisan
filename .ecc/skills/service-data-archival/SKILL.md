...
description: "Use this skill when Service Cloud orgs are consuming excessive data or file storage\
  \ due to Case-related records, or when compliance requirements demand structured\
  \ retention and deletion of case history. Trigger keywords: EmailMessage bloat,\
  \ Email-to-Case storage, ContentDocument archival, case attachment cleanup, compliance\
  \ retention policy, service storage optimization. NOT for generic archival across\
  \ non-Service objects (CPQ, Sales Cloud, FSL) \u2014 use data/data-archival-strategies.\
  \ NOT for loading legacy case history into the org rather than purging it \u2014\
  \ use data/case-history-migration."
---
