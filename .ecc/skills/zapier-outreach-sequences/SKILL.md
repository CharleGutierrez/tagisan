---
name: zapier-outreach-sequences
description: "Outreach.io sales prospect sequencing, call logging, and reply sentiment"
version: 1.0.0
...
triggers:
  ...
  - "saas"
  - "sequences"
  - "zapier outreach sequences"
  - "zapier-outreach-sequences"
  - "zapier-outreach-sequences execute"
  - "zapier-outreach-sequences verify"
---

# Zapier Outreach Sequences Skill

The `zapier-outreach-sequences` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-outreach-sequences",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
