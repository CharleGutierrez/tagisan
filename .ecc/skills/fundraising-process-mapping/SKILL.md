...
description: "Use when designing nonprofit fundraising lifecycle stages, donor pipeline workflows,\
  \ cultivation-to-stewardship cycles, or Salesforce Opportunity sales process configuration\
  \ for NPSP or Nonprofit Cloud. Trigger keywords: fundraising lifecycle, donor pipeline,\
  \ cultivation stage, solicitation workflow, major gift process, moves management,\
  \ NPSP Opportunity stages, stewardship cycle, NPC fundraising stages. NOT for lapsed\
  \ donor re-engagement or portfolio segmentation \u2014 use admin/donor-lifecycle-requirements.\
  \ NOT for Engagement Plan setup \u2014 use admin/npsp-engagement-plans."
---
