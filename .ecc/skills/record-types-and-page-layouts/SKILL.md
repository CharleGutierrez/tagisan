...
description: "Use when designing, auditing, or simplifying Record Types and Page Layouts. Triggers:\
  \ 'record type', 'page layout', 'different picklist values', 'different fields per\
  \ team', 'dynamic forms'. NOT for layout explosion across many profiles \u2014 use\
  \ admin/record-type-strategy-at-scale. NOT for sharing rules \u2014 use admin/sharing-and-visibility.\
