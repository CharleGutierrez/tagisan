...
description: "Use this skill when building, debugging, or optimizing CRM Analytics dataflows \u2014\
  \ defining node types (sfdcDigest, Append, Augment, computeExpression, computeRelative,\
  \ Flatten, dim2mea, sfdcRegister), scheduling runs, handling run failures, and tuning\
  \ performance. NOT for doing the same transformation in a Data Prep recipe \u2014\
  \ use admin/analytics-recipe-design. NOT for dataset field types, refresh schedules,\
  \ or row limits \u2014 use admin/analytics-dataset-management."
---
