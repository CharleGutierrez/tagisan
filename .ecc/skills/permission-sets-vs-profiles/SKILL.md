...
description: "Use when designing or auditing Salesforce access control \u2014 deciding between\
  \ Profiles, Permission Sets, and Permission Set Groups. Triggers: 'user can't see\
  \ field', 'too many profiles', 'permission model', 'least privilege', 'profile migration'.\
  \ NOT for sharing rules or record-level access \u2014 use admin/sharing-and-visibility\
  \ for that."
---
