...
description: "Use when creating test data for scratch orgs, sandboxes, or CI pipelines: Apex @testSetup\
  \ factories, sf data import tree plans, CumulusCI datasets, Snowfakery. NOT for\
  \ production data migration or ETL pipelines \u2014 use data/data-migration-planning."
---
