...
description: "Use this skill when bulk-migrating data into Salesforce Industries clouds \u2014\
  \ including InsurancePolicy and its child objects for Insurance, ServicePoint/Premise\
  \ for Energy and Utilities, or subscriber/account hierarchies for Communications.\
  \ Trigger keywords: insurance policy migration, InsurancePolicyCoverage load order,\
  \ ServicePoint bulk load, Premise hierarchy, E&U data migration, telco subscriber\
  \ migration, utility account import, industries object dependency. NOT for generic\
  \ migration planning \u2014 use data/data-migration-planning. NOT for Health Cloud\
  \ patient data \u2014 use data/patient-data-migration."
---
