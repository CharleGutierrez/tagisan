...
class BailianClient(LLMClient):
    """Bailian API client for Qwen models."""

    DEFAULT_BASE_URL = "https://bailian.aliyuncs.com/v1"
    ...
    def _make_request(
        ...
        """Make HTTP request to Bailian API."""
        ...
        try:
            ...
            raise RuntimeError(f"Bailian API error: {e.code} - {error_body}")
        except urllib.error.URLError as e:
            raise RuntimeError(f"Bailian API connection error: {e.reason}")
