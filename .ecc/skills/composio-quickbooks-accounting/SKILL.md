---
name: composio-quickbooks-accounting
description: "QuickBooks general ledger entry, invoice creation, and balance sheets"
version: 1.0.0
...
triggers:
  ...
  - "api-orchestration"
  - "composio"
  - "composio quickbooks accounting"
  - "composio-dev"
  - "composio-quickbooks-accounting"
  - "composio-quickbooks-accounting execute"
  - "composio-quickbooks-accounting verify"
  - "enterprise"
---

# Composio Quickbooks Accounting Skill

The `composio-quickbooks-accounting` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-quickbooks-accounting",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
