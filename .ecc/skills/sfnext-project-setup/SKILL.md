...
description: Create and configure Storefront Next projects. Use when creating a new storefront,
  understanding project structure, setting up environment variables, or running the
  sfnext CLI for the first time. Covers project creation, directory layout, .env configuration,
  and sfnext CLI basics.
...
---
# Project Setup Skill
