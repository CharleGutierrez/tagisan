---
name: composio-keycloak-admin
description: "Keycloak realm role management, client secret refresh, and token claims"
version: 1.0.0
...
triggers:
  ...
  - "api-orchestration"
  - "composio"
  - "composio keycloak admin"
  - "composio-dev"
  - "composio-keycloak-admin"
  - "composio-keycloak-admin execute"
  - "composio-keycloak-admin verify"
  - "enterprise"
---

# Composio Keycloak Admin Skill

The `composio-keycloak-admin` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
