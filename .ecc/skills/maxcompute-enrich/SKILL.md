---
name: maxcompute-enrich
description: Review and apply semantic-package proposals generated from build evidence. Use when
  maintaining package semantics through an agent rather than writing direct annotations.
...
---
# mcs enrich workflow
