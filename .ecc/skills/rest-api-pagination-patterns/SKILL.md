...
description: "REST API pagination for inbound and outbound integrations: Salesforce QueryMore,\
  \ cursor-based, offset-based, Link header, page-size tuning, rate limit interaction.\
  \ NOT for REST CRUD or Composite \u2014 use integration/rest-api-patterns. NOT for\
  \ GraphQL pagination \u2014 use integration/graphql-api-patterns."
---
