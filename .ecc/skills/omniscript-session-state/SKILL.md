...
description: "Use when an OmniScript must persist mid-flow state across refresh, navigation, multi-device\
  \ resume, or abandonment recovery. Covers session objects, staging data, OmniScript\
  \ tracking, and resume URLs. NOT for OmniScript UI step layout \u2014 use omnistudio/omniscript-design-patterns.\
  \ NOT for general Flow pause/resume \u2014 use flow/pause-elements-and-wait-events."
---
