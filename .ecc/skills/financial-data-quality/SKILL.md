...
description: "Use when validating FinancialAccount record integrity in Financial Services Cloud,\
  \ detecting duplicate financial records, or reconciling FSC data against core banking\
  \ and custodial source systems. Trigger keywords: FinancialAccount validation, FSC\
  \ duplicate detection, financial record reconciliation, stale household KPIs, FinancialHolding\
  \ data quality, FSC data integrity. NOT for the one-time bulk load of FSC accounts\
  \ and holdings \u2014 use data/financial-account-migration. NOT for generic org-wide\
  \ data quality gates and governance \u2014 use data/data-quality-and-governance.\
