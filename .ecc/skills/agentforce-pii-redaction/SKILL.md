...
description: "Redact PII in your own code before it reaches Agentforce prompts, models, and logs.\
  \ Trigger keywords: agentforce pii, pii redaction, data masking llm, prompt pii\
  \ filter, audit pii leakage. NOT for turning on the platform's own masking, zero-retention\
  \ and audit-trail controls \u2014 use agentforce/einstein-trust-layer. NOT for masking\
  \ PII in a refreshed sandbox \u2014 use security/sandbox-data-masking."
---
