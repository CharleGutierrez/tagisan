---
name: composio-gmail-inbox-automation
description: "Gmail search filters, draft creation, and label classification"
version: 1.0.0
...
triggers:
  ...
  - "automation"
  - "composio"
  - "composio gmail inbox automation"
  - "composio-dev"
  - "composio-gmail-inbox-automation"
  - "composio-gmail-inbox-automation execute"
  - "composio-gmail-inbox-automation verify"
  - "enterprise"
---

# Composio Gmail Inbox Automation Skill

The `composio-gmail-inbox-automation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-gmail-inbox-automation",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
