---
name: spdk-nvmf-rdma-initiator
description: "NVMe over Fabrics RDMA initiator for remote low-latency tensor access"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "nvmf"
  - "spdk nvmf rdma initiator"
  - "spdk-nvmf-rdma-initiator"
  - "spdk-nvmf-rdma-initiator execute"
  - "spdk-nvmf-rdma-initiator verify"
---

# Spdk Nvmf Rdma Initiator Skill

The `spdk-nvmf-rdma-initiator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SPDK.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Distributed P2P / Mesh`.
...
```json
{
  "skill": "spdk-nvmf-rdma-initiator",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "SPDK.io",
