...
description: "Deploy and manage projects on Vercel using token-based authentication. Use when working\
  \ with Vercel CLI using access tokens rather than interactive login \u2014 e.g.\
