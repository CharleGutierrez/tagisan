---
name: sigma-rule-shadow-copy-deletion
description: "Intercepting vssadmin delete shadows or wmic shadowcopy delete ransomware behavior"
version: 1.0.0
...
triggers:
  ...
  - "sigma-rule-shadow-copy-deletion"
  - "sigma-rule-shadow-copy-deletion execute"
  - "sigma-rule-shadow-copy-deletion verify"
---

# Sigma Rule Shadow Copy Deletion Skill

The `sigma-rule-shadow-copy-deletion` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Sigma Rules Project** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Windows`.
...
```json
{
  "skill": "sigma-rule-shadow-copy-deletion",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Sigma Rules Project",
