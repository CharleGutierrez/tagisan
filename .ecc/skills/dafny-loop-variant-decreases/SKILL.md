---
name: dafny-loop-variant-decreases
description: "Specifying 'decreases' termination metrics ensuring loop and recursion termination"
version: 1.0.0
...
triggers:
  ...
  - "compiler"
  - "dafny"
  - "dafny loop variant decreases"
  - "dafny-loop-variant-decreases"
  - "dafny-loop-variant-decreases execute"
  - "dafny-loop-variant-decreases verify"
  - "decreases"
  - "formal-methods"
---

# Dafny Loop Variant Decreases Skill

The `dafny-loop-variant-decreases` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Dafny Language Reference** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "dafny-loop-variant-decreases",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Dafny Language Reference",
