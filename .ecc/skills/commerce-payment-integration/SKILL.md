...
description: "Use this skill when building or debugging a custom Salesforce Commerce payment gateway\
  \ adapter using the CommercePayments Apex namespace \u2014 covering adapter implementation,\
  \ RequestType handling, PCI tokenization patterns, and integration path selection.\
  \ NOT for Salesforce Billing invoices and the blng namespace \u2014 use apex/billing-integration-apex.\
  \ NOT for the legacy sfdc_checkout.CartPaymentAuthorize interface \u2014 use admin/commerce-checkout-configuration."
---
