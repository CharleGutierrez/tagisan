...
description: "Use when sending Custom Notifications (bell icon / mobile push) from Apex via `Messaging.CustomNotification`.\
  \ Covers target resolution, Notification Type discovery, recipient limits, and async-safe\
  \ sending. NOT for creating the Notification Type in Setup \u2014 use admin/custom-notification-types.\
  \ NOT for sending it from Flow \u2014 use flow/flow-email-and-notifications."
---
