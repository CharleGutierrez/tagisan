---
name: model-context-window-rope-scaling
description: "Linear and YaRN (Yet another RoPE extensioN) frequency scaling for 128k+ tokens"
version: 1.0.0
...
triggers:
  ...
  - "cuda"
  - "gguf"
  - "model context window rope scaling"
  - "model-context-window-rope-scaling"
  - "model-context-window-rope-scaling execute"
  - "model-context-window-rope-scaling verify"
---

# Model Context Window Rope Scaling Skill

The `model-context-window-rope-scaling` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Context Window Engine`.
...
- **Subsystem Binding**: `Context Window Engine`
...
```json
{
  "skill": "model-context-window-rope-scaling",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "ArXiv AI Research",
  "integration_target": "Context Window Engine",
