...
description: "Process images for web development \u2014 resize, crop, trim whitespace, convert\
  \ formats (PNG/WebP/JPG), optimise file size, generate thumbnails, create OG card\
  \ images. Uses Pillow (Python) \u2014 no ImageMagick needed. Trigger with 'resize\
  \ image', 'convert to webp', 'trim logo', 'optimise images', 'make thumbnail', 'create\
  \ OG image', 'crop whitespace', 'process image', or 'image too large'."
---
# Image Processing
