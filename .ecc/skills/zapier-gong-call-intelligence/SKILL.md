---
name: zapier-gong-call-intelligence
description: "Gong.io sales call audio transcription, tracker keywords, and deal insights"
version: 1.0.0
...
triggers:
  ...
  - "gong"
  - "intelligence"
  - "zapier gong call intelligence"
  - "zapier-gong-call-intelligence"
  - "zapier-gong-call-intelligence execute"
  - "zapier-gong-call-intelligence verify"
---

# Zapier Gong Call Intelligence Skill

The `zapier-gong-call-intelligence` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-gong-call-intelligence",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
