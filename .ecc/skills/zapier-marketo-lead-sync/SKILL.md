---
name: zapier-marketo-lead-sync
description: "Marketo marketing automation lead scoring and campaign membership sync"
version: 1.0.0
...
triggers:
  ...
  - "marketo"
  - "saas"
  - "zapier marketo lead sync"
  - "zapier-marketo-lead-sync"
  - "zapier-marketo-lead-sync execute"
  - "zapier-marketo-lead-sync verify"
---

# Zapier Marketo Lead Sync Skill

The `zapier-marketo-lead-sync` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-marketo-lead-sync",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
