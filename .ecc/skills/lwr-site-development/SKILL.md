...
description: "Use this skill when building or customizing sites on the Lightning Web Runtime (LWR)\
  \ in Experience Cloud \u2014 including component authoring, custom theming with\
  \ --dxp hooks, layout components, and publish lifecycle management. Trigger keywords:\
  \ build LWR site Experience Cloud, Lightning Web Runtime custom theme, LWR component\
  \ development community, Build Your Own LWR template, Microsite LWR, lightningCommunity__Theme_Layout,\
  \ --dxp styling hooks. NOT for Aura-based communities or no-code Experience Builder\
  \ setup \u2014 use admin/experience-cloud-site-setup. NOT for one component's guest\
  \ access \u2014 use lwc/experience-cloud-lwc-components."
---
