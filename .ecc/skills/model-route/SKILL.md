---
name: model-route
description: Use when selecting Claude model tier for Salesforce development tasks. Recommend haiku,
  sonnet, or opus based on Apex complexity, deploy risk, and budget.
...
---
