...
description: "Use this skill when configuring Salesforce Manufacturing Cloud \u2014 including Sales\
  \ Agreement setup, Account-Based Forecasting (ABF) recalc jobs, run-rate management,\
  \ Rebate Management programs, channel inventory tracking. NOT for general Sales\
  \ Cloud opportunity-to-order flow (use standard Opportunity / Order) \u2014 use\
