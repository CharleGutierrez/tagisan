...
description: "Configure and operate NPSP Gift Entry: gift entry templates, batch gift entry, payment\
  \ processing, donation allocation, and receipting workflows. NOT for a one-time\
  \ migration of historical gift data \u2014 use data/gift-history-import. NOT for\
  \ soft credits or matching gifts \u2014 use admin/soft-credits-and-matching."
---
