---
name: post-quantum-kyber-kem-handshake
description: "Quantum-resistant ML-KEM (Kyber) key encapsulation for inter-agent cluster links"
version: 1.0.0
...
triggers:
  ...
  - "handshake"
  - "kem"
  - "post quantum kyber kem handshake"
  - "post-quantum-kyber-kem-handshake"
  - "post-quantum-kyber-kem-handshake execute"
  - "post-quantum-kyber-kem-handshake verify"
---

# Post Quantum Kyber Kem Handshake Skill

The `post-quantum-kyber-kem-handshake` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NIST PQC Standards** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `P2P Cluster Mesh`.
...
```json
{
  "skill": "post-quantum-kyber-kem-handshake",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "NIST PQC Standards",
