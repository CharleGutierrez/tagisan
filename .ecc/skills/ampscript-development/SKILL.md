...
description: "Use this skill when writing, debugging, or reviewing AMPscript in Marketing Cloud\
  \ email bodies, subject lines, preheaders, SMS, push notifications, or Cloud Pages\
  \ \u2014 including Lookup/LookupRows data retrieval, IF/ELSEIF conditional blocks,\
  \ FOR loops over rowsets, and inline personalization. NOT for Journey Builder configuration.\
  \ NOT for Server-Side JavaScript (SSJS), WSProxy, or REST API calls from content\
  \ \u2014 use apex/ssjs-server-side-javascript. NOT for SQL Query Activities in Automation\
  \ Studio \u2014 use data/marketing-cloud-sql-queries."
---
