...
description: "Async Apex patterns \u2014 @future, Queueable, Batch, Schedulable, Platform Events,\
  \ chaining. Use when choosing or implementing async processing. Do NOT use for synchronous\
  \ Apex or constraint enforcement."
---
# Apex Async Patterns
