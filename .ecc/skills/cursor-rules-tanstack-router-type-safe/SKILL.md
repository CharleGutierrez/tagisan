---
name: cursor-rules-tanstack-router-type-safe
description: "100% type-safe file-based routing, loader prefetching, and search params validation"
version: 1.0.0
...
triggers:
  - "bun"
  - "cursor"
  - "cursor rules tanstack router type safe"
  - "cursor-rules-tanstack-router-type-safe"
  - "cursor-rules-tanstack-router-type-safe execute"
  - "cursor-rules-tanstack-router-type-safe verify"
  - "frontend"
  - "full-stack"
  - "router"
---

# Cursor Rules Tanstack Router Type Safe Skill

The `cursor-rules-tanstack-router-type-safe` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-tanstack-router-type-safe",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
