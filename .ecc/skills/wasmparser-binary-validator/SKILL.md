---
name: wasmparser-binary-validator
description: "Validating WebAssembly binary section headers, function signatures, and limits"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "WebAssembly Wasmparser Docs"
tags:
  - ast
  - binary
  - compiler
...
triggers:
  ...
  - "formal-methods"
  - "symbolic"
  - "wasmparser binary validator"
  - "wasmparser-binary-validator"
  - "wasmparser-binary-validator execute"
  - "wasmparser-binary-validator verify"
---

# Wasmparser Binary Validator Skill

The `wasmparser-binary-validator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **WebAssembly Wasmparser Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Plugin Tier A (WASM)`.
...
```json
{
  "skill": "wasmparser-binary-validator",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "WebAssembly Wasmparser Docs",
