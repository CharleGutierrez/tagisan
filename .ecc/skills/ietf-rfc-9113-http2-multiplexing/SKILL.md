---
name: ietf-rfc-9113-http2-multiplexing
description: "HTTP/2 binary framing and concurrent stream multiplexing over a single TCP connection"
version: 1.0.0
...
triggers:
  ...
  - "http2"
  - "ietf"
  - "ietf rfc 9113 http2 multiplexing"
  - "ietf-rfc-9113-http2-multiplexing"
  - "ietf-rfc-9113-http2-multiplexing execute"
  - "ietf-rfc-9113-http2-multiplexing verify"
  - "multiplexing"
---

# Ietf Rfc 9113 Http2 Multiplexing Skill

The `ietf-rfc-9113-http2-multiplexing` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **IETF RFCs (ietf.org)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Tokio HTTP Daemon`.
...
- **Subsystem Binding**: `Tokio HTTP Daemon`
...
```json
{
  "skill": "ietf-rfc-9113-http2-multiplexing",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "IETF RFCs (ietf.org)",
  "integration_target": "Tokio HTTP Daemon",
