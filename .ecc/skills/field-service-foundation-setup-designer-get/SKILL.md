...
description: "Creates Field Service foundation data \u2014 Work Types, Skills, Service Territories,\
  \ and Operating Hours. Accepts existing data in any format or designs from scratch,\
  \ and confirms the design with the user. Use this skill when a user wants to create,\
  \ design, or set up Field Service foundation data."
---
