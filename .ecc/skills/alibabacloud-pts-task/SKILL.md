...
description: "Alibaba Cloud PTS task CRUD worker skill \u2014 executes concrete PTS scenario operations\
  \ (create / query / start / stop / report / delete) for both PTS native HTTP/HTTPS\
  \ and JMeter-based stress testing. This is a WORKER skill, typically delegated from\
  \ the `alibabacloud-pts-pilot` router. Do NOT use this skill for tuning advice or\
  \ general PTS Q&A. Triggers: \"\u521B\u5EFA\u538B\u6D4B\u573A\u666F\", \"\u542F\u52A8\
  \u538B\u6D4B\", \"\u505C\u6B62\u538B\u6D4B\", \"\u67E5\u770B\u538B\u6D4B\u62A5\u544A\
  \", \"\u5220\u9664\u538B\u6D4B\u573A\u666F\", \"\u4E0A\u4F20JMeter\u811A\u672C\"\
  , \"\u6267\u884CJMeter\u538B\u6D4B\", \"list PTS scenes\", \"start PTS scene\","
---
