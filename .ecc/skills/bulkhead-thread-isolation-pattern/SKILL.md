---
name: bulkhead-thread-isolation-pattern
description: "Partitioning thread pools and CPU quotas so a stuck tool call never freezes the core"
version: 1.0.0
...
triggers:
  - "bulkhead"
  - "bulkhead thread isolation pattern"
  - "bulkhead-thread-isolation-pattern"
  - "bulkhead-thread-isolation-pattern execute"
  - "bulkhead-thread-isolation-pattern verify"
  - "distributed"
  - "isolation"
  - "michael"
  - "opentelemetry"
...
# Bulkhead Thread Isolation Pattern Skill

The `bulkhead-thread-isolation-pattern` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Michael Nygard (Release It!)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Tokio Swarm`.
...
```json
{
  "skill": "bulkhead-thread-isolation-pattern",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Michael Nygard (Release It!)",
  "integration_target": "Tokio Swarm",
