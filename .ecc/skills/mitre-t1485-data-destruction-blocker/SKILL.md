---
name: mitre-t1485-data-destruction-blocker
description: "Intercepting destructive commands (rm -rf /, mkfs, dd of=/dev/sd*) and routing to atomic trash"
version: 1.0.0
...
triggers:
  ...
  - "defense"
  - "destruction"
  - "mitre t1485 data destruction blocker"
  - "mitre-t1485-data-destruction-blocker"
  - "mitre-t1485-data-destruction-blocker execute"
  - "mitre-t1485-data-destruction-blocker verify"
---

# Mitre T1485 Data Destruction Blocker Skill

The `mitre-t1485-data-destruction-blocker` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `FileCRUD / SafeRecycler`.
...
- **Subsystem Binding**: `FileCRUD / SafeRecycler`
...
```json
{
  "skill": "mitre-t1485-data-destruction-blocker",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "FileCRUD / SafeRecycler",
