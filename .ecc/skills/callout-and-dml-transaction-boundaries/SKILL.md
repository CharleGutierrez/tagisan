...
description: "Use when diagnosing, preventing, or refactoring the 'You have uncommitted work pending'\
  \ CalloutException caused by mixing DML and callouts in the same Apex transaction.\
  \ Triggers: 'uncommitted work pending', 'callout after DML', 'DML between callouts'.\
  \ NOT for the callout itself \u2014 use apex/callouts-and-http-integrations. NOT\
  \ for rollback semantics \u2014 use apex/apex-savepoint-and-rollback."
---
