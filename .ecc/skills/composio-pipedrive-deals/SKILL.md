---
name: composio-pipedrive-deals
description: "Pipedrive deal pipeline stage advancement and activity scheduling"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio pipedrive deals"
  - "composio-dev"
  - "composio-pipedrive-deals"
  - "composio-pipedrive-deals execute"
  - "composio-pipedrive-deals verify"
  - "deals"
  - "enterprise"
---

# Composio Pipedrive Deals Skill

The `composio-pipedrive-deals` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-pipedrive-deals",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
