---
name: agent-rag-hyde-query-expansion
description: "Generating Hypothetical Document Embeddings (HyDE) to improve vector retrieval accuracy"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent rag hyde query expansion"
  - "agent-rag-hyde-query-expansion"
  - "agent-rag-hyde-query-expansion execute"
  - "agent-rag-hyde-query-expansion verify"
  - "arxiv"
  - "consensus"
  - "debate"
  - "expansion"
...
# Agent Rag Hyde Query Expansion Skill

The `agent-rag-hyde-query-expansion` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `RAG Pipeline`.
...
```json
{
  "skill": "agent-rag-hyde-query-expansion",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
