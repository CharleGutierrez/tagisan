---
name: glama-grafana-loki
description: "LogQL log stream querying, metric extraction, and dashboard alert checks"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-grafana-loki"
  - "glama-grafana-loki execute"
  - "glama-grafana-loki verify"
  - "grafana"
  - "loki"
  - "mcp"
---

# Glama Grafana Loki Skill

The `glama-grafana-loki` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
