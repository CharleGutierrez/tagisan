---
name: pypi-mcp-server-networkx
description: "Graph theory algorithms, centrality metrics, and shortest path traversal"
version: 1.0.0
...
triggers:
  ...
  - "networkx"
  - "pypi"
  - "pypi mcp server networkx"
  - "pypi-mcp-server-networkx"
  - "pypi-mcp-server-networkx execute"
  - "pypi-mcp-server-networkx verify"
  - "server"
---

# Pypi Mcp Server Networkx Skill

The `pypi-mcp-server-networkx` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-networkx",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
