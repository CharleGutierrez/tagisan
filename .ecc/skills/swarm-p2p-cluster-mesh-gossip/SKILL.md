---
name: swarm-p2p-cluster-mesh-gossip
description: "Tokio TCP coordinator and worker mesh on port 8765 distributing tool tasks"
version: 1.0.0
...
triggers:
  ...
  - "distributed"
  - "gossip"
  - "swarm p2p cluster mesh gossip"
  - "swarm-p2p-cluster-mesh-gossip"
  - "swarm-p2p-cluster-mesh-gossip execute"
  - "swarm-p2p-cluster-mesh-gossip verify"
---

# Swarm P2p Cluster Mesh Gossip Skill

The `swarm-p2p-cluster-mesh-gossip` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Distributed Systems / Tokio** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `tgs swarm cluster`.
...
- **Subsystem Binding**: `tgs swarm cluster`
...
```json
{
  "skill": "swarm-p2p-cluster-mesh-gossip",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Distributed Systems / Tokio",
  "integration_target": "tgs swarm cluster",
