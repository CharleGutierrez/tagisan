---
name: npm-mcp-server-slack
description: "Slack API connector for workspace communications and bot interactions"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server slack"
  - "npm-mcp-server-slack"
  - "npm-mcp-server-slack execute"
  - "npm-mcp-server-slack verify"
  - "server"
  - "slack"
---

# Npm Mcp Server Slack Skill

The `npm-mcp-server-slack` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
