---
name: smithery-neo4j-graph
description: "Cypher property graph querying, node traversal, and relationship modeling"
version: 1.0.0
...
triggers:
  ...
  - "neo4j"
  - "smithery"
  - "smithery neo4j graph"
  - "smithery-neo4j-graph"
  - "smithery-neo4j-graph execute"
  - "smithery-neo4j-graph verify"
---

# Smithery Neo4j Graph Skill

The `smithery-neo4j-graph` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
