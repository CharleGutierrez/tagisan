...
description: "Guidance on non-obvious runtime behaviors of Salesforce standard objects \u2014 polymorphic\
  \ lookups, lead conversion field loss, PersonAccount dual-nature, CaseComment trigger\
  \ isolation, and Activity date fields. NOT for the Activity object model \u2014\
  \ use admin/activity-and-task-patterns. NOT for writing TYPEOF queries \u2014 use\
