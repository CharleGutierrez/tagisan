---
name: zapier-mixpanel-cohorts
description: "Mixpanel product event tracking, behavioral cohort sync, and retention graphs"
version: 1.0.0
...
triggers:
  ...
  - "mixpanel"
  - "saas"
  - "zapier mixpanel cohorts"
  - "zapier-mixpanel-cohorts"
  - "zapier-mixpanel-cohorts execute"
  - "zapier-mixpanel-cohorts verify"
---

# Zapier Mixpanel Cohorts Skill

The `zapier-mixpanel-cohorts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
