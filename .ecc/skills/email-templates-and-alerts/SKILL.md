...
description: "Use when designing, reviewing, or troubleshooting Salesforce email templates, email\
  \ alerts, and declarative notification design. Triggers: 'Lightning Email Template',\
  \ 'email alert', 'merge field', 'org-wide email', 'too many emails', 'mass email\
  \ limit'. NOT for migrating Classic templates to Lightning \u2014 use admin/classic-email-template-migration.\
  \ NOT for sending email from Apex \u2014 use apex/apex-outbound-email-patterns."
---
