---
name: llvm-ir-tail-call-elimination
description: "Converting recursive tail calls into iterative loops to prevent stack overflows"
version: 1.0.0
...
triggers:
  ...
  - "elimination"
  - "formal-methods"
  - "llvm ir tail call elimination"
  - "llvm-ir-tail-call-elimination"
  - "llvm-ir-tail-call-elimination execute"
  - "llvm-ir-tail-call-elimination verify"
---

# Llvm Ir Tail Call Elimination Skill

The `llvm-ir-tail-call-elimination` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Compiler IR Optimizer`.
...
```json
{
  "skill": "llvm-ir-tail-call-elimination",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
