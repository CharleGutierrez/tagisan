...
description: "Omni-Channel analytics data: agent work records, queue metrics, capacity, wait times.\
  \ Triggers: Omni-Channel reporting, agent work metrics, queue wait time. NOT for\
  \ routing/capacity admin setup \u2014 use admin/omni-channel-routing-setup. NOT\
  \ for capacity modeling architecture \u2014 use architect/omni-channel-capacity-model."
---
