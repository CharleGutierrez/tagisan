---
name: tla-plus-tlapm-proof-assistant
description: "Mechanized formal proof derivation using TLA+ Proof Manager (TLAPM)"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "TLA+ Foundation"
tags:
  - assistant
  - ast
  - compiler
...
triggers:
  ...
  - "formal-methods"
  - "plus"
  - "tla plus tlapm proof assistant"
  - "tla-plus-tlapm-proof-assistant"
  - "tla-plus-tlapm-proof-assistant execute"
  - "tla-plus-tlapm-proof-assistant verify"
---

# Tla Plus Tlapm Proof Assistant Skill

The `tla-plus-tlapm-proof-assistant` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **TLA+ Foundation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "tla-plus-tlapm-proof-assistant",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "TLA+ Foundation",
