...
description: "Use when migrating historical order records into Salesforce Order Management \u2014\
  \ covers the required object creation sequence (Order > OrderDeliveryGroup > OrderItem\
  \ > OrderSummary), LifeCycleType=Unmanaged for historical orders, and OrderSummary\
  \ creation via ConnectAPI. NOT for CPQ legacy order, contract and asset upload using\
  \ SBQQ objects \u2014 use data/historical-order-migration. NOT for live order processing,\
  \ fulfilment, returns or cancellations \u2014 use admin/commerce-order-management."
---
