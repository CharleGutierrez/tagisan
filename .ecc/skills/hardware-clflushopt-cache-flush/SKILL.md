---
name: hardware-clflushopt-cache-flush
description: "Optimized CPU cache line flushing for non-volatile memory (NVDIMM) persistence"
version: 1.0.0
...
triggers:
  ...
  - "flush"
  - "hardware"
  - "hardware clflushopt cache flush"
  - "hardware-clflushopt-cache-flush"
  - "hardware-clflushopt-cache-flush execute"
  - "hardware-clflushopt-cache-flush verify"
  - "kernel"
---

# Hardware Clflushopt Cache Flush Skill

The `hardware-clflushopt-cache-flush` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **x86-64 Software Developer's Manual** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Storage / Persistence`.
...
- **Subsystem Binding**: `Storage / Persistence`
...
```json
{
  "skill": "hardware-clflushopt-cache-flush",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "x86-64 Software Developer's Manual",
  "integration_target": "Storage / Persistence",
