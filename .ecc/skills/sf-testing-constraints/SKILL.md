...
description: "Enforce Apex testing standards \u2014 75% coverage minimum, test isolation, assertions,\
  \ TestDataFactory. Use when writing or reviewing ANY Apex test class or method.\
  \ Do NOT use for LWC Jest or Flow tests."
---
