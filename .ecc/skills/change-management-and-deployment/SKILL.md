...
description: "Use when planning, reviewing, or troubleshooting Salesforce metadata releases and\
  \ admin deployment processes. Triggers: 'change set', 'deployment plan', 'rollback',\
  \ 'DevOps Center', 'SFDX deploy', 'release checklist', 'production deployment'.\
  \ NOT for change set upload mechanics \u2014 use devops/change-set-deployment. NOT\
  \ for scoring release risk up front \u2014 use admin/deployment-risk-assessment."
---
