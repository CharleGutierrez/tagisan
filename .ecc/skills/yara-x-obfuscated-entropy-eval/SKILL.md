---
name: yara-x-obfuscated-entropy-eval
description: "Flagging high-Shannon-entropy strings indicative of packed payloads or keys"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "YARA-X Project Reference"
tags:
  - agentshield
  - defense
  - edr
...
triggers:
  ...
  - "entropy"
  - "eval"
  - "yara x obfuscated entropy eval"
  - "yara-x-obfuscated-entropy-eval"
  - "yara-x-obfuscated-entropy-eval execute"
  - "yara-x-obfuscated-entropy-eval verify"
---

# Yara X Obfuscated Entropy Eval Skill

The `yara-x-obfuscated-entropy-eval` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **YARA-X Project Reference** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Secret Entropy Scanner`.
...
```json
{
  "skill": "yara-x-obfuscated-entropy-eval",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "YARA-X Project Reference",
