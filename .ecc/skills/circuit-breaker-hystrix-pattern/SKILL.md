...
description: "Trip-and-recover circuit breaker preventing cascade failures when APIs go down"
version: 1.0.0
...
triggers:
  ...
  - "circuit-breaker-hystrix-pattern"
  - "circuit-breaker-hystrix-pattern execute"
  - "circuit-breaker-hystrix-pattern verify"
  - "distributed"
  - "hystrix"
  - "michael"
---

# Circuit Breaker Hystrix Pattern Skill

The `circuit-breaker-hystrix-pattern` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Michael Nygard (Release It!)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `ToolRegistry`.
...
```json
{
  "skill": "circuit-breaker-hystrix-pattern",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Michael Nygard (Release It!)",
