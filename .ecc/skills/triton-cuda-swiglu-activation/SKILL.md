---
name: triton-cuda-swiglu-activation
description: "Fused SwiGLU activation and gate projection kernel optimizing feed-forward layers"
version: 1.0.0
...
triggers:
  ...
  - "gguf"
  - "quantization"
  - "triton cuda swiglu activation"
  - "triton-cuda-swiglu-activation"
  - "triton-cuda-swiglu-activation execute"
  - "triton-cuda-swiglu-activation verify"
---

# Triton Cuda Swiglu Activation Skill

The `triton-cuda-swiglu-activation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Triton-lang.org Docs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Triton CUDA Fuser Tool`.
...
```json
{
  "skill": "triton-cuda-swiglu-activation",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "Triton-lang.org Docs",
