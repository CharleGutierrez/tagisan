...
description: "Generating documents (PDF, DOCX, PPTX) from OmniStudio using Document Templates,\
  \ OmniDataTransform token mapping, and OmniScript or Integration Procedure orchestration.\
  \ Use when building client-side interactive or server-side batch document generation\
  \ flows. NOT for Salesforce CPQ document generation \u2014 use apex/fsc-document-generation."
---
