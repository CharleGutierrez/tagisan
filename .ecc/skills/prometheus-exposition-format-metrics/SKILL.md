---
name: prometheus-exposition-format-metrics
description: "Exposing /metrics in Prometheus text format for cluster-wide scraping"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "Prometheus Docs (prometheus.io)"
tags:
  - distributed
  - exposition
  - format
...
triggers:
  ...
  - "prometheus-exposition-format-metrics"
  - "prometheus-exposition-format-metrics execute"
  - "prometheus-exposition-format-metrics verify"
---

# Prometheus Exposition Format Metrics Skill

The `prometheus-exposition-format-metrics` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Prometheus Docs (prometheus.io)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `tgs serve Daemon`.
...
```json
{
  "skill": "prometheus-exposition-format-metrics",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Prometheus Docs (prometheus.io)",
