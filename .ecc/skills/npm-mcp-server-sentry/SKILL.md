---
name: npm-mcp-server-sentry
description: "Production crash analysis, breadcrumb tracing, and regression detection"
version: 1.0.0
...
triggers:
  ...
  - "npm-mcp-server-sentry"
  - "npm-mcp-server-sentry execute"
  - "npm-mcp-server-sentry verify"
  - "sentry"
  - "server"
---

# Npm Mcp Server Sentry Skill

The `npm-mcp-server-sentry` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
