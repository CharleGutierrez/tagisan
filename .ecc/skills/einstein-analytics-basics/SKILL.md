...
description: "Use when deciding whether Salesforce Reports, CRM Analytics, or Tableau is the right\
  \ level of analytics tooling, and when reviewing or troubleshooting basic CRM Analytics\
  \ designs. Triggers: 'CRM Analytics', 'Einstein Analytics', 'Tableau CRM', 'lens',\
  \ 'dataset', 'dataflow', 'analytics dashboard', 'license requirement'. NOT for a\
  \ detailed CRM Analytics vs Tableau licensing and platform comparison \u2014 use\
  \ architect/crm-analytics-vs-tableau-decision. NOT for building the app, lenses\
  \ and datasets \u2014 use admin/crm-analytics-app-creation."
---
