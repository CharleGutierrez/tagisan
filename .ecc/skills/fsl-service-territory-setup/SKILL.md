...
description: "Use this skill to configure Field Service Lightning service territories \u2014 including\
  \ territory types, operating hours, time slots, territory hierarchy, member types,\
  \ and polygon boundaries. NOT for Enterprise Territory Management (Territory2) in\
  \ Sales Cloud \u2014 use admin/enterprise-territory-management. NOT for bulk-loading\
  \ territory polygons or members \u2014 use data/fsl-territory-data-setup."
---
