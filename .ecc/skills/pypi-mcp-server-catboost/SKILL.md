---
name: pypi-mcp-server-catboost
description: "Categorical feature boosting model evaluation and cross-validation"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server catboost"
  - "pypi-mcp-server-catboost"
  - "pypi-mcp-server-catboost execute"
  - "pypi-mcp-server-catboost verify"
  - "server"
---

# Pypi Mcp Server Catboost Skill

The `pypi-mcp-server-catboost` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-catboost",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
