...
description: "Building custom Apex-based actions for Agentforce agents: designing @InvocableMethod\
  \ classes for Atlas Reasoning Engine invocation, defining input/output schema, handling\
  \ errors, and managing security context. NOT for choosing between Apex, Flow, External\
  \ Service and prompt-template tool shapes \u2014 use agentforce/agentforce-tool-use-patterns.\
  \ NOT for the Apex test class that covers each action branch \u2014 use agentforce/agent-action-unit-tests."
---
