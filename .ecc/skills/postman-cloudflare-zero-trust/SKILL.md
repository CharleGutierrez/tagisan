---
name: postman-cloudflare-zero-trust
description: "Cloudflare Access application policies and Gateway DNS firewall rules"
version: 1.0.0
...
triggers:
  ...
  - "enterprise"
  - "postman"
  - "postman cloudflare zero trust"
  - "postman-cloudflare-zero-trust"
  - "postman-cloudflare-zero-trust execute"
  - "postman-cloudflare-zero-trust verify"
  - "saas"
---

# Postman Cloudflare Zero Trust Skill

The `postman-cloudflare-zero-trust` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / AgentShield`.
...
```json
{
  "skill": "postman-cloudflare-zero-trust",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
