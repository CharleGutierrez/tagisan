...
description: Update Salesforce platform reference docs with latest release features and deprecation
  announcements. Use when SessionStart hook warns docs are outdated or a new Salesforce
  release has shipped. Do NOT use for Apex or LWC development.
...
---
