---
name: oxc-semantic-scope-hoisting
description: "Lexical scope and symbol declaration binding analysis across ES modules"
version: 1.0.0
...
triggers:
  ...
  - "hoisting"
  - "oxc"
  - "oxc semantic scope hoisting"
  - "oxc-semantic-scope-hoisting"
  - "oxc-semantic-scope-hoisting execute"
  - "oxc-semantic-scope-hoisting verify"
---

# Oxc Semantic Scope Hoisting Skill

The `oxc-semantic-scope-hoisting` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Oxc Project Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Polyglot Runtimes / Bun`.
...
```json
{
  "skill": "oxc-semantic-scope-hoisting",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Oxc Project Docs",
