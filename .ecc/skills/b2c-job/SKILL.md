...
description: "Run and monitor jobs on B2C Commerce instances using the b2c CLI, including individual\
  \ site archive imports and exports and search indexing. Use this skill whenever\
  \ the user needs to trigger an existing job, import a single site archive, export\
  \ site data, rebuild search indexes, check job status, or troubleshoot a failed\
  \ job execution \u2014 even if they just say \"run this job\", \"import this archive\"\
  , or \"rebuild the search index\"."
---
# B2C Job Skill
