...
description: 'Use when choosing between Salesforce record-access mechanisms or reviewing the access
  model end to end. Trigger keywords: OWD, org-wide defaults, record access model,
  sharing architecture, why can user see too much. NOT for sharing rules - use admin/sharing-rules.
  NOT for role hierarchy - use admin/role-hierarchy-design.'
---
