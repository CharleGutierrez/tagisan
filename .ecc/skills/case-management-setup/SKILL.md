...
description: "Configuring Salesforce case management: case queues, assignment rules, escalation\
  \ rules, auto-response rules, Email-to-Case, Web-to-Case, case teams, entitlements,\
  \ and milestones. Use when setting up or troubleshooting the Service Cloud case\
  \ handling layer. Trigger keywords: email-to-case, web-to-case, escalation rules,\
  \ case teams, entitlements, milestones, auto-response, case queue. NOT for Standard\
  \ vs On-Demand Email-to-Case and routing-address setup \u2014 use admin/email-to-case-configuration.\
  \ NOT for routing case work items to agents \u2014 use admin/omni-channel-routing-setup."
---
