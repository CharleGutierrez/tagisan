---
name: agent-rag-contextual-compression
description: "Extracting only query-relevant sentences from retrieved documents before prompt injection"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent rag contextual compression"
  - "agent-rag-contextual-compression"
  - "agent-rag-contextual-compression execute"
  - "agent-rag-contextual-compression verify"
  - "compression"
  - "consensus"
  - "contextual"
  - "debate"
...
# Agent Rag Contextual Compression Skill

The `agent-rag-contextual-compression` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LangChain Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `RAG Pipeline`.
...
```json
{
  "skill": "agent-rag-contextual-compression",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "LangChain Research",
