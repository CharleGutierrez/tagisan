---
name: hardware-sfence-memory-barrier
description: "Store fence memory barrier ensuring out-of-order write synchronization"
version: 1.0.0
...
triggers:
  - "barrier"
  - "hardware"
  - "hardware sfence memory barrier"
  - "hardware-sfence-memory-barrier"
  - "hardware-sfence-memory-barrier execute"
  - "hardware-sfence-memory-barrier verify"
  - "kernel"
  - "low-level"
  - "memory"
---

# Hardware Sfence Memory Barrier Skill

The `hardware-sfence-memory-barrier` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **x86-64 Software Developer's Manual** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Lockless Channels`.
...
- **Subsystem Binding**: `Lockless Channels`
...
```json
{
  "skill": "hardware-sfence-memory-barrier",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "x86-64 Software Developer's Manual",
  "integration_target": "Lockless Channels",
