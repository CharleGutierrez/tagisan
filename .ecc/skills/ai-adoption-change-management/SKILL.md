...
description: "Use this skill when planning or executing the human side of an Agentforce or Einstein\
  \ AI feature rollout \u2014 user trust-building, AI-specific training, structured\
  \ feedback collection via the Feedback API, and adoption measurement via Agentforce\
  \ Analytics. NOT for turning the Einstein for Sales features on \u2014 use agentforce/agentforce-sales-ai-setup.\
  \ NOT for rollout training with no AI in scope \u2014 use admin/change-management-and-training."
---
