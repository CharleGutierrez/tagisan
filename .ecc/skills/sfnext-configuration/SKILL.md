...
description: "Manage Storefront Next application configuration using config.server.ts, schema types,\
  \ environment variables, and multi-site setup. Use when editing config.server.ts,\
  \ adding PUBLIC__ environment variables, using useConfig or getConfig, or configuring\
  \ multiple sites. NOT for initial project creation \u2014 see sfnext-project-setup."
---
# Configuration Skill
