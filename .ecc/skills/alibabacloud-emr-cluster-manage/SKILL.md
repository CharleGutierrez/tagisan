...
description: "Manage the full lifecycle of Alibaba Cloud E-MapReduce (EMR) ECS clusters\u2014creation,\
  \ scaling, renewal, and status queries. Use this Skill when users want to set up\
  \ big data clusters, view cluster status, add nodes, release nodes, configure auto-scaling,\
  \ check cluster and node states, or diagnose creation failures. Also applicable\
  \ for scenarios like \"create a Hadoop cluster\", \"data lake cluster\", \"running\
  \ out of resources\", \"check my cluster\", \"renew\", etc. NOTE: This Skill does\
  \ NOT support cluster deletion, release, or termination under any circumstances.\
  \ Any request to delete or terminate a cluster will be refused and redirected to\
  \ the EMR console."
---
