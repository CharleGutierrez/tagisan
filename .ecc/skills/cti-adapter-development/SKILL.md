...
description: "Use when building or debugging a browser-based CTI softphone adapter using the Salesforce\
  \ Open CTI JavaScript API \u2014 covers callcenter.xml definition, Lightning utility\
  \ item registration, core API methods (enableClickToDial, onClickToDial, screenPop,\
  \ setSoftphonePanelHeight, saveLog), call logging as Task, and the lightning-click-to-dial\
  \ LWC component. NOT for Service Cloud Voice / Amazon Connect setup \u2014 use admin/service-cloud-voice-setup.\
  \ NOT for Omni-Channel routing \u2014 use admin/omni-channel-routing-setup."
---
