...
description: "Use when designing or refactoring record types across objects with many profiles,\
  \ business processes, or picklist variations. Covers layout assignment explosion,\
  \ Dynamic Forms migration, and record type ID portability. NOT for basic record\
  \ type setup or page layout assignment \u2014 use admin/record-types-and-page-layouts.\
  \ NOT for converting one page layout to Dynamic Forms \u2014 use admin/dynamic-forms-migration."
---
