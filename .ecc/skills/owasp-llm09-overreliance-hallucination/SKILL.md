---
name: owasp-llm09-overreliance-hallucination
description: "Automated compiler verification pass ensuring generated code compiles before acceptance"
version: 1.0.0
...
triggers:
  ...
  - "owasp-llm09-overreliance-hallucination"
  - "owasp-llm09-overreliance-hallucination execute"
  - "owasp-llm09-overreliance-hallucination verify"
---

# Owasp Llm09 Overreliance Hallucination Skill

The `owasp-llm09-overreliance-hallucination` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OWASP GenAI Top 10 (owasp.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `tgs autofix`.
...
```json
{
  "skill": "owasp-llm09-overreliance-hallucination",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "OWASP GenAI Top 10 (owasp.org)",
