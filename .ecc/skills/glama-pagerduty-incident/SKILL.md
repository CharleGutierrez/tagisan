---
name: glama-pagerduty-incident
description: "On-call schedule querying, incident acknowledgement, and escalation triggers"
version: 1.0.0
...
triggers:
  - "glama"
  - "glama pagerduty incident"
  - "glama-ai"
  - "glama-pagerduty-incident"
  - "glama-pagerduty-incident execute"
  - "glama-pagerduty-incident verify"
  - "incident"
  - "mcp"
  - "model-context-protocol"
---

# Glama Pagerduty Incident Skill

The `glama-pagerduty-incident` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "glama-pagerduty-incident",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Glama.ai",
