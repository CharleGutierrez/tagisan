---
name: postman-launchdarkly-flags
description: "LaunchDarkly feature flag toggling, targeted percentage rollouts, and audit"
version: 1.0.0
...
triggers:
  ...
  - "launchdarkly"
  - "postman"
  - "postman launchdarkly flags"
  - "postman-launchdarkly-flags"
  - "postman-launchdarkly-flags execute"
  - "postman-launchdarkly-flags verify"
---

# Postman Launchdarkly Flags Skill

The `postman-launchdarkly-flags` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "postman-launchdarkly-flags",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Postman API Network",
