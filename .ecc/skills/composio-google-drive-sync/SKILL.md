---
name: composio-google-drive-sync
description: "Google Drive corporate file indexing, OCR parsing, and permission sync"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio google drive sync"
  - "composio-dev"
  - "composio-google-drive-sync"
  - "composio-google-drive-sync execute"
  - "composio-google-drive-sync verify"
  - "drive"
  - "enterprise"
---

# Composio Google Drive Sync Skill

The `composio-google-drive-sync` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-google-drive-sync",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
