---
name: cursor-rules-vue-pinia-composition
description: "Vue 3 Composition API with script setup and Pinia type-safe stores"
version: 1.0.0
...
triggers:
  ...
  - "composition"
  - "cursor"
  - "cursor rules vue pinia composition"
  - "cursor-rules-vue-pinia-composition"
  - "cursor-rules-vue-pinia-composition execute"
  - "cursor-rules-vue-pinia-composition verify"
  - "frontend"
  - "full-stack"
---

# Cursor Rules Vue Pinia Composition Skill

The `cursor-rules-vue-pinia-composition` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-vue-pinia-composition",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
