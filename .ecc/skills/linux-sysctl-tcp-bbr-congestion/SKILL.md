---
name: linux-sysctl-tcp-bbr-congestion
description: "TCP BBR v2/v3 congestion control socket option tuning for WAN cluster links"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux sysctl tcp bbr congestion"
  - "linux-sysctl-tcp-bbr-congestion"
  - "linux-sysctl-tcp-bbr-congestion execute"
  - "linux-sysctl-tcp-bbr-congestion verify"
---

# Linux Sysctl Tcp Bbr Congestion Skill

The `linux-sysctl-tcp-bbr-congestion` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Distributed P2P / Mesh`.
...
```json
{
  "skill": "linux-sysctl-tcp-bbr-congestion",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
