...
description: "Use when hitting Salesforce governor limits in Apex \u2014 SOQL, DML, heap, CPU optimization,\
  \ async offloading, bulk processing strategies. Do NOT use for general Apex or LWC\
  \ patterns."
---
