...
description: "Use this skill to configure Field Service Lightning service resources \u2014 including\
  \ ServiceResource types, skill assignments via ServiceResourceSkill, capacity-based\
  \ resource setup, and ResourcePreference rules. NOT for territory-level WorkCapacityLimit\
  \ throttling or capacity-vs-utilization reporting \u2014 use admin/fsl-capacity-planning.\
  \ NOT for service territory setup \u2014 use admin/fsl-service-territory-setup.\
  \ NOT for work rules and service objectives \u2014 use admin/fsl-scheduling-policies."
---
