...
description: "Use when configuring or troubleshooting email deliverability for Marketing Cloud\
  \ or Salesforce orgs: sender authentication (SPF, DKIM, DMARC), private sending\
  \ domain setup, dedicated IP warm-up, list hygiene practices, and sender reputation\
  \ monitoring. NOT for building a Marketing Cloud email \u2014 use admin/email-studio-administration.\
  \ NOT for unsubscribe and consent \u2014 use admin/consent-management-marketing."
---
