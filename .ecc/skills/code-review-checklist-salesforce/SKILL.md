...
description: "Structured Salesforce code review for Apex, triggers, async, and tests before merge\
  \ or deployment \u2014 governor limits, bulk-safe triggers, CRUD/FLS and sharing\
  \ posture, meaningful tests, and naming consistency. NOT for AppExchange security-review-only\
  \ deep dives \u2014 use security/secure-coding-review-checklist."
---
