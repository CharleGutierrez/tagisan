...
description: Use when working with Salesforce metadata types, package.xml, or .forceignore. Source
  vs metadata format, retrieval, deployment, and org comparison.
...
---
