...
description: "Use when designing or restructuring a Salesforce Knowledge taxonomy: Data Category\
  \ Group structure, hierarchy depth, article type selection, article lifecycle governance\
  \ (Draft/Published/Archived), Validation Status gating, and content gap analysis\
  \ via KCS methodology and Search Activity Gaps. Triggers: knowledge taxonomy design,\
  \ data category hierarchy, knowledge article lifecycle, knowledge governance model,\
  \ KCS content gap analysis, search activity gaps, knowledge category structure.\
  \ NOT for enabling Lightning Knowledge, Knowledge__kav record types or Data Category\
  \ visibility setup \u2014 use admin/knowledge-base-administration. NOT for choosing\
  \ Salesforce Knowledge vs an external CMS \u2014 use architect/knowledge-vs-external-cms."
---
