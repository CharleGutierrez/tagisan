---
name: composio-wise-crossborder
description: "Wise international money transfer rate quote and batch payment trigger"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio wise crossborder"
  - "composio-dev"
  - "composio-wise-crossborder"
  - "composio-wise-crossborder execute"
  - "composio-wise-crossborder verify"
  - "crossborder"
  - "enterprise"
---

# Composio Wise Crossborder Skill

The `composio-wise-crossborder` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-wise-crossborder",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
