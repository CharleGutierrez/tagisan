...
description: "Create, track, and manage QianWen support tickets from the conversation: submit a\
  \ new ticket, check ticket status and engineer replies, follow up, close, and rate\
  \ \u2014 so platform issues get resolved without leaving the chat. Triggers: \"\
  submit ticket\", \"create ticket\", \"list tickets\", \"view ticket\", \"reply ticket\"\
  , \"close ticket\", \"rate ticket\", \"transfer to human\", \"work order\", \"customer\
  \ service\", \"human support\", \"open ticket\", \"check ticket\", \"cancel ticket\"\
  , \"evaluate ticket\", \"ticket list\", \"support request\", \"escalate to agent\"\
  . Do NOT use for general model usage questions, API Key management, or billing inquiries\
  \ \u2014 only when the user explicitly needs ticket operations."
---
