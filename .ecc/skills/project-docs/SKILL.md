---
name: project-docs
description: "Generate project documentation from codebase analysis \u2014 ARCHITECTURE.md, API_ENDPOINTS.md,\
  \ DATABASE_SCHEMA.md. Reads source code, schema files, routes, and config to produce\
  \ accurate, structured docs. Use when starting a project, onboarding contributors,\
  \ or when docs are missing or stale. Triggers: 'generate docs', 'document architecture',\
  \ 'create api docs', 'document schema', 'project documentation', 'write architecture\
  \ doc'."
---
