...
description: "Use when writing production-ready Salesforce Apex classes \u2014 organization, error\
  \ handling, collection patterns. Do NOT use for test classes or triggers."
---
# Apex Best Practices
