...
description: "Metadata API concepts, package.xml manifest structure, retrieve and deploy workflows,\
  \ what metadata types can and cannot be retrieved, deployment order dependencies,\
  \ and destructiveChanges.xml for deletions. NOT for scripting retrieve/deploy in\
  \ a CI pipeline \u2014 use devops/metadata-api-retrieve-deploy. NOT for sf CLI command\
  \ syntax or DX source format \u2014 use apex/sf-cli-and-sfdx-essentials."
---
