---
name: smithery-mongodb-atlas
description: "BSON document queries, aggregation pipeline execution, and index verification"
version: 1.0.0
...
triggers:
  ...
  - "mongodb"
  - "smithery"
  - "smithery mongodb atlas"
  - "smithery-mongodb-atlas"
  - "smithery-mongodb-atlas execute"
  - "smithery-mongodb-atlas verify"
---

# Smithery Mongodb Atlas Skill

The `smithery-mongodb-atlas` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
