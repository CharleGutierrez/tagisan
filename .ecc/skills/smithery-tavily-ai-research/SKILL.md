---
name: smithery-tavily-ai-research
description: "Autonomous agent research engine aggregating verified web sources"
version: 1.0.0
...
triggers:
  ...
  - "research"
  - "smithery"
  - "smithery tavily ai research"
  - "smithery-ai"
  - "smithery-tavily-ai-research"
  - "smithery-tavily-ai-research execute"
  - "smithery-tavily-ai-research verify"
---

# Smithery Tavily Ai Research Skill

The `smithery-tavily-ai-research` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-tavily-ai-research",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
