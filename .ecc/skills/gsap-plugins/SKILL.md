---
name: gsap-plugins
description: "Official GSAP skill for GSAP plugins \u2014 registration, ScrollToPlugin, ScrollSmoother,\
  \ Flip, Draggable, Inertia, Observer, SplitText, ScrambleText, SVG and physics plugins,\
  \ CustomEase, EasePack, CustomWiggle, CustomBounce, GSDevTools. Use when the user\
  \ asks about a GSAP plugin, scroll-to, flip animations, draggable, SVG drawing,\
