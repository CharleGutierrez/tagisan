...
description: "Use this skill when comparing Industries CPQ (formerly Vlocity CPQ) with Salesforce\
  \ CPQ (Revenue Cloud managed package) \u2014 covering feature parity, decision criteria,\
  \ migration paths, and coexistence patterns. Trigger keywords: Vlocity. NOT for\
  \ implementing, configuring, or debugging either CPQ product \u2014 use architect/industries-cloud-selection."
---
