...
description: "Use this skill to configure and tune search in B2B Commerce or D2C Commerce storefronts:\
  \ searchable attributes, facetable attributes, sort rules, search index rebuilds,\
  \ Einstein product recommendations, and BuyerGroup entitlement visibility. Trigger\
  \ keywords: commerce search ranking, faceted navigation commerce, search index rebuild,\
  \ Einstein recommendations storefront, product not appearing in search. NOT for\
  \ catalog taxonomy and attribute strategy \u2014 use admin/commerce-catalog-strategy.\
  \ NOT for Einstein Search in Lightning Experience \u2014 use agentforce/einstein-search-personalization."
---
