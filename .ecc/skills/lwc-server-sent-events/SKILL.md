...
description: "Use when building LWCs that must react to live server pushes \u2014 Platform Events,\
  \ Change Data Capture, or streaming updates \u2014 via the lightning/empApi (CometD)\
  \ subscription model. Covers lifecycle, replayId, error handling. NOT for publishing\
  \ events (see platform-events or apex-platform-events) \u2014 use integration/platform-events-integration."
---
