---
name: zapier-mailchimp-campaigns
description: "Mailchimp subscriber tags, audience campaigns, and open-rate webhooks"
version: 1.0.0
...
triggers:
  ...
  - "mailchimp"
  - "saas"
  - "zapier mailchimp campaigns"
  - "zapier-mailchimp-campaigns"
  - "zapier-mailchimp-campaigns execute"
  - "zapier-mailchimp-campaigns verify"
---

# Zapier Mailchimp Campaigns Skill

The `zapier-mailchimp-campaigns` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "zapier-mailchimp-campaigns",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Zapier Platform",
