...
description: "Use when diagnosing or resolving slow CPQ quote calculation, QLEx timeouts, or governor\
  \ limit errors on large quotes. Trigger keywords: Large Quote Mode, QCP field declaration,\
  \ quote calculation performance, SBQQ calculation timeout, async pricing. NOT for\
  \ designing bundles and a pricing model that scales before the problem exists \u2014\
  \ use architect/cpq-architecture-patterns. NOT for writing the QCP or other SBQQ\
  \ plugin interfaces themselves \u2014 use apex/cpq-apex-plugins."
---
