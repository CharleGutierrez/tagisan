---
name: tls-certificate-pinning-validator
description: "Strict SPKI public key pinning for outbound HTTPS connections to critical AI providers"
version: 1.0.0
tier: "Tier 7: Cybersecurity, EDR & Nation-State APT Defense"
source: "IETF RFC 7469"
tags:
  - agentshield
  - certificate
  - defense
...
triggers:
  ...
  - "edr"
  - "ietf"
  - "tls certificate pinning validator"
  - "tls-certificate-pinning-validator"
  - "tls-certificate-pinning-validator execute"
  - "tls-certificate-pinning-validator verify"
---

# Tls Certificate Pinning Validator Skill

The `tls-certificate-pinning-validator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **IETF RFC 7469** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Network / TLS`.
...
```json
{
  "skill": "tls-certificate-pinning-validator",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "IETF RFC 7469",
  "integration_target": "Network / TLS",
