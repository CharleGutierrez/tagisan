...
description: "When to use: active or suspected Salesforce org compromise, unauthorized access investigation,\
  \ attacker containment, forensic evidence collection from EventLogFile/LoginHistory,\
  \ session revocation, OAuth token cleanup. NOT for general security setup, permission\
  \ set design, or field-level security configuration \u2014 use admin/permission-sets-vs-profiles."
---
