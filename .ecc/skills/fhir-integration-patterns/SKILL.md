...
description: "Use this skill when implementing FHIR R4 integration for Health Cloud in code: inbound\
  \ and outbound FHIR REST API patterns, CDS Hooks via MuleSoft middleware, SMART\
  \ on FHIR setup, and HL7 v2 to FHIR R4 conversion. NOT for mapping a FHIR resource\
  \ to Health Cloud objects field by field \u2014 use data/fhir-data-mapping. NOT\
  \ for choosing the EHR sync topology or MuleSoft Accelerator design \u2014 use architect/fhir-integration-architecture."
---
