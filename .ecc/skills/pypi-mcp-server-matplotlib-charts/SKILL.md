---
name: pypi-mcp-server-matplotlib-charts
description: "Data visualization chart generation, SVG export, and metric plotting"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server matplotlib charts"
  - "pypi-mcp-server-matplotlib-charts"
  - "pypi-mcp-server-matplotlib-charts execute"
  - "pypi-mcp-server-matplotlib-charts verify"
---

# Pypi Mcp Server Matplotlib Charts Skill

The `pypi-mcp-server-matplotlib-charts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-matplotlib-charts",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
