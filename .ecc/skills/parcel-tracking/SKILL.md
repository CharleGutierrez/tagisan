...
description: 'Track parcels and check delivery status for Australian and international couriers.
  Searches Gmail for dispatch/shipping emails and provides tracking links for all
  major Australian couriers including AusPost, StarTrack, Aramex, CouriersPlease,
  Sendle, Toll, Team Global Express, DHL, FedEx, TNT, Hunter Express, Border Express,
  Direct Freight Express, and UPS. Triggers: ''where is my parcel'', ''track my order'',
  ''has my package arrived'', ''tracking status'', ''check tracking'', ''where is
  my delivery''.'
---
# Parcel Tracking
