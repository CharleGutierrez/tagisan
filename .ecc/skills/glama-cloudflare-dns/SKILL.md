---
name: glama-cloudflare-dns
description: "Cloudflare DNS record querying, zone updating, and propagation checks"
version: 1.0.0
...
triggers:
  ...
  - "dns"
  - "glama"
  - "glama cloudflare dns"
  - "glama-ai"
  - "glama-cloudflare-dns"
  - "glama-cloudflare-dns execute"
  - "glama-cloudflare-dns verify"
  - "mcp"
---

# Glama Cloudflare Dns Skill

The `glama-cloudflare-dns` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
