...
description: "Salesforce Functions is retired (EOL Jan 2025). This skill maps Functions workloads\
  \ to replacements: Heroku (with Hyperforce), external containers, Apex (where viable),\
  \ Agentforce Actions, external compute via Named Credentials. NOT for Lambda / Azure\
  \ Functions tutorials \u2014 use agentforce/einstein-bots-to-agentforce-migration."
---
