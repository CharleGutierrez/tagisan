---
name: mitre-t1562-impair-defenses-alerter
description: "Immediate panic if a tool attempts to disable AgentShield, iptables, or audit logs"
version: 1.0.0
...
triggers:
  ...
  - "defenses"
  - "edr"
  - "mitre t1562 impair defenses alerter"
  - "mitre-t1562-impair-defenses-alerter"
  - "mitre-t1562-impair-defenses-alerter execute"
  - "mitre-t1562-impair-defenses-alerter verify"
---

# Mitre T1562 Impair Defenses Alerter Skill

The `mitre-t1562-impair-defenses-alerter` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Sentinel`.
...
- **Subsystem Binding**: `AgentShield / Sentinel`
...
```json
{
  "skill": "mitre-t1562-impair-defenses-alerter",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "AgentShield / Sentinel",
