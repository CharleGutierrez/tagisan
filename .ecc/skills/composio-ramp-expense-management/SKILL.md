---
name: composio-ramp-expense-management
description: "Ramp corporate expense policy verification and spend limit checks"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio ramp expense management"
  - "composio-dev"
  - "composio-ramp-expense-management"
  - "composio-ramp-expense-management execute"
  - "composio-ramp-expense-management verify"
  - "enterprise"
  - "expense"
---

# Composio Ramp Expense Management Skill

The `composio-ramp-expense-management` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-ramp-expense-management",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
