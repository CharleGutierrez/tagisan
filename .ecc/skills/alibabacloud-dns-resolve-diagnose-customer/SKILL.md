...
description: "Alicloud DNS Diagnostic Skill (Read-Only). Diagnostic tool for domain unreachable,\
  \ DNS resolution failure, DNS record not taking effect, NXDOMAIN, unknownhost, and\
  \ other DNS-layer issues. Automatically performs WHOIS lookup, recursive tracing,\
  \ OpenAPI config verification, and nationwide probing via boce to generate diagnostic\
  \ reports. Covers Alibaba Cloud DNS, GTM, PrivateZone, and third-party DNS. This\
  \ skill is read-only and will NOT execute any Create, Update, Delete, or other write\
  \ operations. Triggers: \"DNS resolution failed\", \"domain unreachable\", \"DNS\
  \ not working\", \"NXDOMAIN\", \"domain ping failed\", \"DNS diagnose\", \"quick\
  \ check\", \"\u5FEB\u901F\u68C0\u67E5\", \"DNS record check\", \"\u8BB0\u5F55\u89E3\
  \u6790\", \"DNS resolution status\", \"\u89E3\u6790\u72B6\u6001\", \"check A/CNAME/MX/TXT\
  \ record\""
---
