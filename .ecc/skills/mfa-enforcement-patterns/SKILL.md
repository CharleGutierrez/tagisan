...
description: "Design MFA enforcement: auto-enablement, Authenticator rollout, exceptions, API-only\
  \ users, SSO interop. Triggers: MFA enforcement, MFA exception, api-only MFA, MFA\
  \ SSO. NOT for org-wide MFA policy sequencing \u2014 use security/mfa-enforcement-strategy."
---
