...
description: "Set up, configure or troubleshoot Salesforce Collaborative Forecasts: forecast types,\
  \ forecast categories, rollup methods, quota management, forecast hierarchy, manager\
  \ adjustments, pipeline inspection integration. Trigger keywords: forecast type,\
  \ forecast category, cumulative rollup, individual rollup, quota, forecast adjustment,\
  \ forecast hierarchy, opportunity splits forecasting, pipeline forecast. NOT for\
  \ configuring the opportunity stages, sales processes or split types themselves\
  \ \u2014 use admin/opportunity-management. NOT for territory-based forecasting setup\
  \ \u2014 use admin/enterprise-territory-management. NOT for Classic/Customizable\
  \ Forecasting."
---
