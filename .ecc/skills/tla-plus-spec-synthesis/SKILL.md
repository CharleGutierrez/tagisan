---
name: tla-plus-spec-synthesis
description: "Synthesizing TLA+ state-machine specifications from Rust/Go distributed code"
version: 1.0.0
...
triggers:
  ...
  - "plus"
  - "spec"
  - "tla plus spec synthesis"
  - "tla-plus-spec-synthesis"
  - "tla-plus-spec-synthesis execute"
  - "tla-plus-spec-synthesis verify"
---

# Tla Plus Spec Synthesis Skill

The `tla-plus-spec-synthesis` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **TLA+ Foundation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `TLA+ Consensus Checker`.
