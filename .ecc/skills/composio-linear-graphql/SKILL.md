---
name: composio-linear-graphql
description: "Linear GraphQL API client for engineering team cycles and triage filters"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio linear graphql"
  - "composio-dev"
  - "composio-linear-graphql"
  - "composio-linear-graphql execute"
  - "composio-linear-graphql verify"
  - "enterprise"
  - "graphql"
---

# Composio Linear Graphql Skill

The `composio-linear-graphql` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
