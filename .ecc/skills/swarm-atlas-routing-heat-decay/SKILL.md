---
name: swarm-atlas-routing-heat-decay
description: "Empirical agent invocation frequency tracking with exponential heat decay routing"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Colibrì Cortex Atlas"
tags:
  - atlas
  - colibrì
  - consensus
...
triggers:
  ...
  - "debate"
  - "decay"
  - "swarm atlas routing heat decay"
  - "swarm-atlas-routing-heat-decay"
  - "swarm-atlas-routing-heat-decay execute"
  - "swarm-atlas-routing-heat-decay verify"
---

# Swarm Atlas Routing Heat Decay Skill

The `swarm-atlas-routing-heat-decay` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Colibrì Cortex Atlas** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Swarm Atlas Dashboard`.
...
- **Subsystem Binding**: `Swarm Atlas Dashboard`
...
```json
{
  "skill": "swarm-atlas-routing-heat-decay",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Colibrì Cortex Atlas",
  "integration_target": "Swarm Atlas Dashboard",
