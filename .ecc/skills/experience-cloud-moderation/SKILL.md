...
description: "Set up or tune Experience Cloud content moderation: keyword/criteria rules, member\
  \ reputation system, moderation queue. Triggers: 'set up community content moderation',\
  \ 'configure reputation levels', 'flagging rules Experience Cloud', 'moderation\
  \ queue setup', 'keyword blocking community', 'approve community posts before publishing'.\
  \ NOT for publishing or scheduling CMS articles on the site \u2014 use admin/experience-cloud-cms-content.\
  \ NOT for deciding which behaviours to reward or how to name reputation tiers \u2014\
  \ use admin/community-engagement-strategy."
---
