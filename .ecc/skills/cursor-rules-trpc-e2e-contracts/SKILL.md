---
name: cursor-rules-trpc-e2e-contracts
description: "End-to-end type safety between backend router and frontend client with zero codegen"
version: 1.0.0
...
triggers:
  ...
  - "contracts"
  - "cursor"
  - "cursor rules trpc e2e contracts"
  - "cursor-rules-trpc-e2e-contracts"
  - "cursor-rules-trpc-e2e-contracts execute"
  - "cursor-rules-trpc-e2e-contracts verify"
  - "e2e"
  - "frontend"
---

# Cursor Rules Trpc E2e Contracts Skill

The `cursor-rules-trpc-e2e-contracts` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-trpc-e2e-contracts",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
