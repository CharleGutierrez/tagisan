...
description: "2GP managed package development: creating managed packages with Dev Hub and Salesforce\
  \ CLI, semantic versioning, patch versions, namespace linking, ISV AppExchange listing,\
  \ and subscriber upgrade management. NOT for unlocked packages \u2014 use devops/unlocked-package-development.\
  \ NOT for 1GP packaging orgs and namespace registration \u2014 use devops/managed-package-development."
---
