---
name: spdk-bdev-striped-raid0
description: "Block device striping across dual NVMe SSDs achieving 14.8 GB/s tensor throughput"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "performance"
  - "spdk bdev striped raid0"
  - "spdk-bdev-striped-raid0"
  - "spdk-bdev-striped-raid0 execute"
  - "spdk-bdev-striped-raid0 verify"
---

# Spdk Bdev Striped Raid0 Skill

The `spdk-bdev-striped-raid0` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SPDK.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Colibrì Engine / Storage`.
...
- **Subsystem Binding**: `Colibrì Engine / Storage`
...
```json
{
  "skill": "spdk-bdev-striped-raid0",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "SPDK.io",
  "integration_target": "Colibrì Engine / Storage",
