...
description: "Use when building or reviewing Lightning Web Components \u2014 specifically lifecycle.\
  \ Triggers: 'LWC', 'connectedCallback', 'renderedCallback', 'memory leak', 'NavigationMixin',\
  \ 'wire'. Triggers: 'LWC', 'connectedCallback', 'renderedCallback', 'memory leak',\
  \ 'NavigationMixin', 'wire'. NOT for Aura components \u2014 use lwc/navigation-and-routing."
---
