...
description: "Deploy the deterministic half of Einstein Pre-Work Brief on Field Service Mobile\
  \ to a target org \u2014 prompt template, Lightning Data Service, licenses and permission\
  \ sets, the Work Order layout field, and a scheduled test Work Order. Use this skill\
  \ when a user asks to deploy, set up, enable, or configure Einstein Pre-Work Brief\
