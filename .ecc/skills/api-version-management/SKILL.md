...
description: "Use this skill when auditing, upgrading, or standardizing Salesforce API versions\
  \ across metadata components, sfdx-project.json sourceApiVersion, Apex classes,\
  \ LWC bundles, Aura bundles, and integration endpoints. NOT for REST/SOAP API design\
  \ patterns, OAuth configuration, or Metadata API deployment mechanics \u2014 use\
