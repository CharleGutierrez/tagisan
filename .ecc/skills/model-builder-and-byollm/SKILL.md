...
description: "Use when configuring Model Builder in Salesforce to register external LLMs or select\
  \ standard models for Agentforce and Einstein features. Covers model registration,\
  \ API key configuration, model aliases, and cost/performance tradeoffs. NOT for\
  \ deciding the model-tier or multi-agent platform strategy before you register anything\
  \ \u2014 use architect/ai-platform-architecture. NOT for Trust Layer configuration\
