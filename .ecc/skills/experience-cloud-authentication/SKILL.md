...
description: "Experience Cloud authentication customization \u2014 login pages, self-registration,\
  \ social sign-on. Triggers: Experience Cloud login, community auth, self-registration.\
  \ NOT for multi-IdP enterprise SSO \u2014 use lwc/experience-cloud-multi-idp-sso."
---
