...
description: "URL routing, deep links, and page-reference patterns beyond basic NavigationMixin\
  \ calls. Triggers: deep link LWC, page reference, URL state. NOT for simple in-app\
  \ navigation \u2014 use lwc/lwc-navigation-mixin."
---
