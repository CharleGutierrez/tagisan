...
description: "Use this skill when designing or documenting a lead scoring model in Salesforce Sales\
  \ Cloud or Account Engagement: qualifying criteria, MQL/SQL threshold definitions,\
  \ scoring dimensions (demographic, firmographic, behavioral), and sales handoff\
  \ SLA. NOT for configuring the scoring, grading, and automation rules in Account\
  \ Engagement \u2014 use admin/mcae-lead-scoring-and-grading. NOT for the whole marketing\
  \ program's lifecycle stages and platform scope \u2014 use admin/marketing-automation-requirements."
---
