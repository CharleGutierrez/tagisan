...
description: "Hand-built virtual/windowed list rendering in LWC for datasets above datatable limits\
  \ \u2014 IntersectionObserver sentinels. Triggers: virtual list LWC, windowed rendering,\
  \ infinite scroll custom. NOT for built-in lightning-datatable infinite loading\
  \ \u2014 use lwc/lwc-datatable-advanced. NOT for simple lists under ~100 rows \u2014\
  \ use lwc/virtualized-lists."
---
