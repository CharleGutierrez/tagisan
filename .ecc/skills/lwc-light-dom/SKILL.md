---
name: lwc-light-dom
description: "Use Light DOM in LWC when third-party libraries or global CSS require document-level\
  \ access. Triggers: light DOM LWC, renderMode light, shadow DOM escape. NOT for\
  \ choosing Shadow vs Light DOM \u2014 use lwc/lwc-shadow-vs-light-dom-decision.\
  \ NOT for managed-package distribution constraints \u2014 use architect/omnistudio-vs-standard-decision."
---
# LWC Light DOM
