...
description: "Custom Labels for i18n, configuration strings, and UI text: translation workbench,\
  \ Apex System.Label, LWC @salesforce/label imports, 1,000-char limit. NOT for translating\
  \ picklist values, field labels or layouts \u2014 use admin/multi-language-and-translation.\
  \ NOT for config values in custom metadata or custom settings \u2014 use admin/custom-metadata-types."
---
