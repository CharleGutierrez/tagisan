---
name: swarm-dialectical-debate-engine
description: "3-round adversarial debate: Thesis (Proponent) -> Antithesis (Adversary) -> Synthesis (Lakandiwa)"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Tagisan ng Talino / Lakandiwa"
tags:
  - consensus
  - debate
  - dialectical
...
triggers:
  ...
  - "engine"
  - "moa"
  - "swarm dialectical debate engine"
  - "swarm-dialectical-debate-engine"
  - "swarm-dialectical-debate-engine execute"
  - "swarm-dialectical-debate-engine verify"
---

# Swarm Dialectical Debate Engine Skill

The `swarm-dialectical-debate-engine` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Tagisan ng Talino / Lakandiwa** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Dialectical Debate Engine`.
...
- **Subsystem Binding**: `Dialectical Debate Engine`
...
```json
{
  "skill": "swarm-dialectical-debate-engine",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Tagisan ng Talino / Lakandiwa",
  "integration_target": "Dialectical Debate Engine",
