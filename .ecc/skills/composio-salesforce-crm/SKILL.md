---
name: composio-salesforce-crm
description: "Salesforce CRM lead creation, opportunity tracking, and SOQL record sync"
version: 1.0.0
...
triggers:
  ...
  - "composio-dev"
  - "composio-salesforce-crm"
  - "composio-salesforce-crm execute"
  - "composio-salesforce-crm verify"
  - "crm"
  - "enterprise"
---

# Composio Salesforce Crm Skill

The `composio-salesforce-crm` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
