---
name: npm-mcp-server-fetch
description: "HTTP fetching with Markdown conversion and content sanitization"
version: 1.0.0
...
triggers:
  ...
  - "npm-mcp-server-fetch"
  - "npm-mcp-server-fetch execute"
  - "npm-mcp-server-fetch verify"
  - "server"
---

# Npm Mcp Server Fetch Skill

The `npm-mcp-server-fetch` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
