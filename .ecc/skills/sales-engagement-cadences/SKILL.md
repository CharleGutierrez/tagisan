...
description: "Use when setting up, configuring, or troubleshooting Salesforce Sales Engagement\
  \ (formerly High Velocity Sales) cadences, call scripts, email templates, work queue,\
  \ or rep assignment. Triggers: 'cadence builder', 'HVS cadence', 'work queue steps',\
  \ 'sales engagement setup', 'sequence steps not appearing', 'cadence not sending\
  \ email', 'Sales Engagement permission set'. NOT for cadence enrollment from Apex\
  \ \u2014 use apex/sales-engagement-api. NOT for MCAE/Pardot nurture \u2014 use admin/lead-nurture-journey-design."
---
