...
description: "Apex unit testing \u2014 test structure, TestDataFactory, governor limit testing,\
  \ async testing, mocks, coverage. Use when writing tests or improving coverage.\
  \ Do NOT use for TDD workflow or LWC Jest tests."
---
# Apex Testing
