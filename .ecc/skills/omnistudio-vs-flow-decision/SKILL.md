...
description: "Use when choosing between OmniStudio (OmniScript / Integration Procedure / FlexCard\
  \ / DataRaptor) and Flow / Screen Flow / Apex for a given capability. Triggers:\
  \ 'omnistudio or flow', 'omniscript vs screen flow'. NOT for general automation\
  \ selection (use admin/process-automation-selection) \u2014 use architect/omnistudio-vs-standard-decision."
---
