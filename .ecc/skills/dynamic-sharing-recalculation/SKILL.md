...
description: "Force or orchestrate sharing recalculation after bulk data loads, rule changes, or\
  \ user/role reorgs so row access catches up with policy. NOT for designing new sharing\
  \ rules \u2014 use sharing-selection tree \u2014 use data/sharing-recalculation-performance."
---
