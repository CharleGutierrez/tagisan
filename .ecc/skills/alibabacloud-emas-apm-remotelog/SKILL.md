...
description: 'EMAS APM Remote Log (TLog) CLI Skill. Use for remote log retrieval, task management,
  and log query operations via Alibaba Cloud CLI. Triggers: "EMAS APM", "remote log",
  "tlog", "log retrieval", "log collection", "get-tlog-device-list", "create-tlog-task",
  "search-tlog", "mobile app log".'
---
