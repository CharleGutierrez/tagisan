...
description: "Use when setting up or auditing a dedicated Salesforce integration user \u2014 Salesforce\
  \ Integration user license, API-only profile, permission set layering, MFA waiver,\
  \ and login monitoring. NOT for creating human users, roles, or login hours \u2014\
  \ use admin/user-management. NOT for login IP ranges, session lifetime, or OAuth\
  \ client-credential hardening \u2014 use security/api-only-user-hardening."
---
