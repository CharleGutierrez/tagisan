---
name: sglang-radix-attention-prefix-tree
description: "Radix tree caching of prompt prefix key-value states for sub-millisecond reuse"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "SGLang Documentation"
tags:
  - ai
  - attention
  - cuda
...
triggers:
  ...
  - "gguf"
  - "prefix"
  - "sglang radix attention prefix tree"
  - "sglang-radix-attention-prefix-tree"
  - "sglang-radix-attention-prefix-tree execute"
  - "sglang-radix-attention-prefix-tree verify"
---

# Sglang Radix Attention Prefix Tree Skill

The `sglang-radix-attention-prefix-tree` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SGLang Documentation** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `In-Process KV Cache`.
...
- **Subsystem Binding**: `In-Process KV Cache`
...
```json
{
  "skill": "sglang-radix-attention-prefix-tree",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "SGLang Documentation",
  "integration_target": "In-Process KV Cache",
