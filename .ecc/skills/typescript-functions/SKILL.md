...
description: Apply, review, and explain TypeScript function conventions. Use automatically for
  tasks involving function responsibility, statelessness, purity, side effects, function
  arguments, function API design, or return types.
...
---
# Functions
