...
description: "Deep library, dependency, framework, and API documentation research using Context7\
  \ MCP tools only. Use when you need up-to-date docs, version-specific API reference,\
  \ migration guidance, or to verify code against official documentation. Triggers\
  \ on requests like \u201Clook up docs\u201D, \u201CAPI reference\u201D, \u201Chow\
  \ do I use X\u201D, \u201Clatest/current\u201D, \u201Cdeprecated\u201D, \u201Cbreaking\
  \ changes\u201D, \u201Cbest practices\u201D, or whenever correctness depends on\
