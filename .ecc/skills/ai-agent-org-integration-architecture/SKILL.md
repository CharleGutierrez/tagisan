...
description: "Use this skill to design and review the architecture for integrating external AI\
  \ agents (Claude, ChatGPT, LangChain, custom LLM pipelines) with a Salesforce org\
  \ \u2014 covering integration pattern selection (MCP vs. REST vs. Platform Events),\
  \ auth model design, data exposure scope, org governor limit planning, and Well-Architected\
  \ tradeoffs. Trigger keywords: AI agent Salesforce integration, agent-to-org architecture,\
  \ LLM Salesforce access pattern, external AI org connectivity, agentic system org\
  \ design. NOT for building an Agentforce agent in-org \u2014 use agentforce/agentforce-agent-creation.\
  \ NOT for implementation-level Apex tool code \u2014 use agentforce/mcp-tool-definition-apex.\
  \ NOT for ETL or data pipeline design \u2014 use agentforce/sf-to-llm-data-pipelines."
---
