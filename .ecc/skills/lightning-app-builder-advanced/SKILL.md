...
description: "Advanced Lightning App Builder usage: component visibility filters, custom page templates,\
  \ Dynamic Forms, Dynamic Actions, page performance optimization, LWC targetConfig\
  \ constraints on record pages. Use when building complex record pages or custom\
  \ app templates. NOT for Dynamic Forms basics \u2014 use admin/dynamic-forms-and-actions.\
  \ NOT for exposing an LWC via js-meta.xml targets \u2014 use lwc/lwc-app-builder-config."
---
