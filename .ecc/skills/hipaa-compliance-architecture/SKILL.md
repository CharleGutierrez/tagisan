...
description: "Use this skill to design HIPAA-compliant Salesforce org architectures for healthcare\
  \ organizations storing or processing Protected Health Information (PHI). Trigger\
  \ keywords: HIPAA BAA, PHI storage, Shield encryption, Health Cloud compliance,\
  \ HIPAA technical safeguards, covered entity Salesforce architecture. NOT for minimum-necessary\
  \ access design \u2014 use admin/hipaa-workflow-design. NOT for non-healthcare org\
  \ security review \u2014 use architect/security-architecture-review."
---
