...
description: "Structure Decision elements in Flow: default outcome placement, outcome ordering,\
  \ compound criteria, null-safe checks, Boolean vs Pick-list comparisons, and avoiding\
  \ deep nested branching. Trigger keywords: decision element, flow branching. NOT\
  \ for loop or fault path design, or Screen Flow navigation \u2014 use flow/flow-element-naming-conventions."
---
