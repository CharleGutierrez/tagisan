---
name: composio-discord-bot-ops
description: "Discord bot interaction handling, guild role checking, and webhook alerts"
version: 1.0.0
...
triggers:
  ...
  - "bot"
  - "composio"
  - "composio discord bot ops"
  - "composio-dev"
  - "composio-discord-bot-ops"
  - "composio-discord-bot-ops execute"
  - "composio-discord-bot-ops verify"
  - "discord"
---

# Composio Discord Bot Ops Skill

The `composio-discord-bot-ops` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-discord-bot-ops",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
