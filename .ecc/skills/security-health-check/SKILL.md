...
description: "Use when running, interpreting, or acting on Salesforce Security Health Check results\
  \ \u2014 reading the score, understanding risk categories, evaluating specific settings,\
  \ creating or importing a custom baseline. NOT for org hardening implementation,\
  \ permission model design, or broad baseline config  \u2014 use security/org-hardening-and-baseline-config."
---
