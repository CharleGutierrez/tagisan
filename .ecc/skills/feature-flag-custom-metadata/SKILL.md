...
description: "Implement environment-safe feature flags using Custom Metadata Types for Apex, LWC,\
  \ and Flow. NOT for user-level entitlements or permission sets \u2014 use admin/custom-metadata-types."
---
