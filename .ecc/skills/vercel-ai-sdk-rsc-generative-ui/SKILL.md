---
name: vercel-ai-sdk-rsc-generative-ui
description: "Streaming React components and dynamic generative UI directly from agent tools"
version: 1.0.0
...
triggers:
  ...
  - "generative"
  - "rsc"
  - "vercel ai sdk rsc generative ui"
  - "vercel-ai-sdk-rsc-generative-ui"
  - "vercel-ai-sdk-rsc-generative-ui execute"
  - "vercel-ai-sdk-rsc-generative-ui verify"
---

# Vercel Ai Sdk Rsc Generative Ui Skill

The `vercel-ai-sdk-rsc-generative-ui` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Vercel AI SDK Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Interface`.
...
- **Subsystem Binding**: `Web Interface`
...
```json
{
  "skill": "vercel-ai-sdk-rsc-generative-ui",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Vercel AI SDK Docs",
  "integration_target": "Web Interface",
