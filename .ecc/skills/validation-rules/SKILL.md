...
description: "Use when writing, auditing, or troubleshooting Salesforce Validation Rules. Triggers:\
  \ 'validation rule', 'required field formula', 'rule fires unexpectedly', 'integration\
  \ failing validation', 'data quality'. NOT for Flow-based validation \u2014 use\
  \ admin/flow-for-admins for that."
---
