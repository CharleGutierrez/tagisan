---
name: smithery-jira-cloud
description: "Enterprise issue tracking, backlog grooming, and workflow state transitions"
version: 1.0.0
...
triggers:
  ...
  - "smithery jira cloud"
  - "smithery-jira-cloud"
  - "smithery-jira-cloud execute"
  - "smithery-jira-cloud verify"
---

# Smithery Jira Cloud Skill

The `smithery-jira-cloud` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
