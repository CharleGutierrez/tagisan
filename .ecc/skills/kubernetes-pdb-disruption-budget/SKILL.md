---
name: kubernetes-pdb-disruption-budget
description: "Pod Disruption Budget verification preventing accidental drain of active coordinator nodes"
version: 1.0.0
...
triggers:
  ...
  - "distributed"
  - "kubernetes"
  - "kubernetes pdb disruption budget"
  - "kubernetes-pdb-disruption-budget"
  - "kubernetes-pdb-disruption-budget execute"
  - "kubernetes-pdb-disruption-budget verify"
  - "opentelemetry"
---

# Kubernetes Pdb Disruption Budget Skill

The `kubernetes-pdb-disruption-budget` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Kubernetes Documentation** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `K8s Operator`.
...
- **Subsystem Binding**: `K8s Operator`
...
```json
{
  "skill": "kubernetes-pdb-disruption-budget",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "Kubernetes Documentation",
  "integration_target": "K8s Operator",
