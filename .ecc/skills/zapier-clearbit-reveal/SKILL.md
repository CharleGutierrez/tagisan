---
name: zapier-clearbit-reveal
description: "Clearbit IP-to-company Deanonymization and firmographic data enrichment"
version: 1.0.0
...
triggers:
  ...
  - "reveal"
  - "saas"
  - "zapier clearbit reveal"
  - "zapier-clearbit-reveal"
  - "zapier-clearbit-reveal execute"
  - "zapier-clearbit-reveal verify"
---

# Zapier Clearbit Reveal Skill

The `zapier-clearbit-reveal` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zapier Platform** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
