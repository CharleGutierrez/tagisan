---
name: linux-btrfs-subvolume-snapshots
description: "Btrfs subvolume snapshot creation for instant sub-millisecond repository sandboxing"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux btrfs subvolume snapshots"
  - "linux-btrfs-subvolume-snapshots"
  - "linux-btrfs-subvolume-snapshots execute"
  - "linux-btrfs-subvolume-snapshots verify"
  - "low-level"
---

# Linux Btrfs Subvolume Snapshots Skill

The `linux-btrfs-subvolume-snapshots` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `FileCRUD / GitWorktree`.
...
- **Subsystem Binding**: `FileCRUD / GitWorktree`
...
```json
{
  "skill": "linux-btrfs-subvolume-snapshots",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "FileCRUD / GitWorktree",
