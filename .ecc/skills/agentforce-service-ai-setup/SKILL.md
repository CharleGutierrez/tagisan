...
description: "Verify prerequisites, license entitlements, and org readiness before enabling Einstein\
  \ for Service AI features: Case Classification, Article Recommendations, Reply Recommendations,\
  \ and Work Summaries. Trigger keywords: Einstein for Service setup, enable Case\
  \ Classification, enable Article Recommendations, enable Reply Recommendations,\
  \ enable Work Summaries, Einstein generative AI prerequisites, Data Cloud for Work\
  \ Summaries. NOT for tuning or troubleshooting a feature that is already live \u2014\
  \ classification accuracy, recommendations not appearing \u2014 use agentforce/einstein-copilot-for-service.\
  \ NOT for building the agent itself \u2014 use agentforce/agentforce-agent-creation.\
  \ NOT for its topic boundary design \u2014 use agentforce/agent-topic-design."
---
