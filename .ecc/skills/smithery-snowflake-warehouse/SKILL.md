---
name: smithery-snowflake-warehouse
description: "Data warehouse SQL query orchestration and virtual warehouse management"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery snowflake warehouse"
  - "smithery-ai"
  - "smithery-snowflake-warehouse"
  - "smithery-snowflake-warehouse execute"
  - "smithery-snowflake-warehouse verify"
  - "snowflake"
---

# Smithery Snowflake Warehouse Skill

The `smithery-snowflake-warehouse` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-snowflake-warehouse",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
