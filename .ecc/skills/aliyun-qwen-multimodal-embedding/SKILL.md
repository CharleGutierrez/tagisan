...
description: Use when multimodal embeddings are needed from Alibaba Cloud Model Studio models such
  as `qwen3-vl-embedding` for image, video, and text retrieval, cross-modal search,
  clustering, or offline vectorization pipelines.
...
---
Category: provider
