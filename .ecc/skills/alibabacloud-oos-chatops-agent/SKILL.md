...
description: "Alibaba Cloud OOS ChatOps Agent for natural-language cloud resource management and\
  \ O&M operations. Supports querying ECS/RDS/VPC/SLB resources, executing operations\
  \ (start/stop/restart), viewing monitoring and billing data, and batch O&M via OOS.\
  \ Use when users ask about Alibaba Cloud resources, instance management, cloud operations,\
  \ or O&M automation. Triggers: \"\u67E5\u770B\u5B9E\u4F8B\", \"ECS\", \"RDS\", \"\
  \u7BA1\u7406\u8D44\u6E90\", \"\u8FD0\u7EF4\", \"OOS\", \"ChatOps\", \"\u963F\u91CC\
  \u4E91\u8D44\u6E90\", \"\u5B9E\u4F8B\u5217\u8868\", \"\u5E2E\u6211\u64CD\u4F5C\"\
  , \"\u91CD\u542F\", \"\u505C\u6B62\u5B9E\u4F8B\", \"resource management\", \"cloud\
  \ operations\", \"list instances\", \"batch ops\"."
---
