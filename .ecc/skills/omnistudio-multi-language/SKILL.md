...
description: "Localize OmniScripts, FlexCards, and DataRaptors using Label-based translation, multi-language\
  \ JSON, and locale-aware number/date formatting. NOT for Salesforce Translation\
  \ Workbench alone \u2014 use admin/multi-language-and-translation."
---
