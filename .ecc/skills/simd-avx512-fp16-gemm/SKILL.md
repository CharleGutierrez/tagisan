---
name: simd-avx512-fp16-gemm
description: "AVX-512 FP16 vector instructions for high-throughput matrix multiplication on CPU"
version: 1.0.0
...
triggers:
  ...
  - "hardware"
  - "intel"
  - "simd avx512 fp16 gemm"
  - "simd-avx512-fp16-gemm"
  - "simd-avx512-fp16-gemm execute"
  - "simd-avx512-fp16-gemm verify"
---

# Simd Avx512 Fp16 Gemm Skill

The `simd-avx512-fp16-gemm` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Intel Architecture Manuals** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tensor Engine / SIMD`.
