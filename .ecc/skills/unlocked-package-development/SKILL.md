...
description: "Use this skill when designing, creating, versioning, or installing unlocked packages:\
  \ package directory configuration in sfdx-project.json, namespace management, package\
  \ dependencies, version lifecycle (beta to released), and subscriber installation.\
  \ NOT for 2GP managed packages (ISV namespaces, push upgrades, AppExchange distribution)\
  \ \u2014 use devops/second-generation-managed-packages."
---
