---
name: llvm-ir-coroutine-elision
description: "CoroElide pass to convert dynamic heap frame allocations into static stack frames"
version: 1.0.0
...
triggers:
  ...
  - "elision"
  - "formal-methods"
  - "llvm ir coroutine elision"
  - "llvm-ir-coroutine-elision"
  - "llvm-ir-coroutine-elision execute"
  - "llvm-ir-coroutine-elision verify"
---

# Llvm Ir Coroutine Elision Skill

The `llvm-ir-coroutine-elision` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLVM Language Reference (llvm.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Tokio Async Tuning`.
...
- **Subsystem Binding**: `Tokio Async Tuning`
...
```json
{
  "skill": "llvm-ir-coroutine-elision",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "LLVM Language Reference (llvm.org)",
  "integration_target": "Tokio Async Tuning",
