---
name: mitre-t1059-command-shell-interceptor
description: "Interception and AST token analysis of /bin/sh, bash, and cmd.exe commands before execution"
version: 1.0.0
...
triggers:
  ...
  - "edr"
  - "interceptor"
  - "mitre t1059 command shell interceptor"
  - "mitre-t1059-command-shell-interceptor"
  - "mitre-t1059-command-shell-interceptor execute"
  - "mitre-t1059-command-shell-interceptor verify"
---

# Mitre T1059 Command Shell Interceptor Skill

The `mitre-t1059-command-shell-interceptor` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **MITRE ATT&CK (attack.mitre.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / tgs shield`.
...
- **Subsystem Binding**: `AgentShield / tgs shield`
...
```json
{
  "skill": "mitre-t1059-command-shell-interceptor",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "MITRE ATT&CK (attack.mitre.org)",
  "integration_target": "AgentShield / tgs shield",
