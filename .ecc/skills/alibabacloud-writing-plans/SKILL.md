...
description: 'Convert approved infrastructure designs into Terraform HCL code and CLI scripts.
  Requires alibabacloud:planning to be completed first. WHEN: generate terraform,
  write HCL, create infrastructure code, convert design to code, write IaC, generate
  alicloud terraform.'
---
