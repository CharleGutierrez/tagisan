...
description: "Design and use Apex-Defined Types as Flow variables for structured non-sObject data\
  \ (HTTP callout payloads, External Service responses, complex configuration). Trigger\
  \ keywords: apex-defined type, flow variable. NOT for building HTTP Callout Actions\
  \ themselves, External Services schema, or raw Apex  \u2014 use flow/flow-external-services."
---
