---
name: ggml-blas-openblas-tuning
description: "Thread affinity and SGEMM optimization for multi-socket enterprise CPU servers"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "OpenBLAS Project Reference"
tags:
  - ai
  - blas
  - cuda
...
triggers:
  ...
  - "cuda"
  - "ggml"
  - "ggml blas openblas tuning"
  - "ggml-blas-openblas-tuning"
  - "ggml-blas-openblas-tuning execute"
  - "ggml-blas-openblas-tuning verify"
  - "gguf"
---

# Ggml Blas Openblas Tuning Skill

The `ggml-blas-openblas-tuning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OpenBLAS Project Reference** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / CPU`.
...
- **Subsystem Binding**: `Tensor Engine / CPU`
...
```json
{
  "skill": "ggml-blas-openblas-tuning",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "OpenBLAS Project Reference",
  "integration_target": "Tensor Engine / CPU",
