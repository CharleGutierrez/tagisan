---
name: valibot-modular-schema-validator
description: "Tree-shakable sub-kilobyte schema validation for high-speed edge validation"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Valibot Documentation"
tags:
  - bun
  - frontend
  - full-stack
...
triggers:
  ...
  - "modular"
  - "schema"
  - "valibot modular schema validator"
  - "valibot-modular-schema-validator"
  - "valibot-modular-schema-validator execute"
  - "valibot-modular-schema-validator verify"
---

# Valibot Modular Schema Validator Skill

The `valibot-modular-schema-validator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Valibot Documentation** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Structured Output`.
...
```json
{
  "skill": "valibot-modular-schema-validator",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Valibot Documentation",
