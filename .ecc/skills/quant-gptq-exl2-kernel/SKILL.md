---
name: quant-gptq-exl2-kernel
description: "Variable-bitrate quantization (2-6 bits) for sub-4GB VRAM execution of 8B models"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "ExLlamaV2 Specs"
tags:
  - ai
  - cuda
  - exl2
...
triggers:
  ...
  - "exllamav2"
  - "gguf"
  - "quant gptq exl2 kernel"
  - "quant-gptq-exl2-kernel"
  - "quant-gptq-exl2-kernel execute"
  - "quant-gptq-exl2-kernel verify"
---

# Quant Gptq Exl2 Kernel Skill

The `quant-gptq-exl2-kernel` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ExLlamaV2 Specs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Quant`.
