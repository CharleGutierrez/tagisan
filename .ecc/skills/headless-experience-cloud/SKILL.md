...
description: "Use when building custom frontends (React, Vue, mobile, static sites) that consume\
  \ Salesforce CMS content via the Connect REST API headless delivery endpoint. Triggers:\
  \ 'headless Salesforce CMS', 'deliver CMS content to external frontend', 'React\
