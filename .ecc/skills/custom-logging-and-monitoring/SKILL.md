...
description: "Use when designing or implementing a custom logging framework in Apex: log sObject\
  \ schema, log level gating, retention policies, batch purge jobs, and forwarding\
  \ logs to external monitoring systems (Splunk, Datadog, etc.). NOT for System.debug\
  \ vs durable logging \u2014 use apex/debug-and-logging. NOT for exception capture\
  \ \u2014 use apex/error-handling-framework."
---
