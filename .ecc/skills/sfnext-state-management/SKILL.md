...
description: "Manage client-side state in Storefront Next using React context providers and feature-level\
  \ Zustand stores. Use when handling basket/auth UI state, creating extension stores\
  \ (for example store locator), or syncing client-visible state after server mutations.\
  \ NOT for server-side data loading \u2014 see sfnext-data-fetching for loader patterns."
---
