---
name: gguf-chat-template-jinja-eval
description: "Rendering ChatML, Llama-3, and DeepSeek chat templates directly from metadata"
version: 1.0.0
...
triggers:
  ...
  - "eval"
  - "ggml/gguf"
  - "gguf chat template jinja eval"
  - "gguf-chat-template-jinja-eval"
  - "gguf-chat-template-jinja-eval execute"
  - "gguf-chat-template-jinja-eval verify"
---

# Gguf Chat Template Jinja Eval Skill

The `gguf-chat-template-jinja-eval` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **GGML/GGUF Spec** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Ollama Server Daemon`.
...
- **Subsystem Binding**: `Ollama Server Daemon`
...
```json
{
  "skill": "gguf-chat-template-jinja-eval",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "GGML/GGUF Spec",
  "integration_target": "Ollama Server Daemon",
