---
name: composio-bill-com-ap-ar
description: "Bill.com accounts payable approval workflow and vendor payment status"
version: 1.0.0
...
triggers:
  ...
  - "com"
  - "composio"
  - "composio bill com ap ar"
  - "composio-bill-com-ap-ar"
  - "composio-bill-com-ap-ar execute"
  - "composio-bill-com-ap-ar verify"
  - "composio-dev"
---

# Composio Bill Com Ap Ar Skill

The `composio-bill-com-ap-ar` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
