---
name: postman-pagerduty-v2
description: "PagerDuty incident triggers, service maintenance windows, and roster shifts"
version: 1.0.0
...
triggers:
  ...
  - "pagerduty"
  - "postman"
  - "postman pagerduty v2"
  - "postman-pagerduty-v2"
  - "postman-pagerduty-v2 execute"
  - "postman-pagerduty-v2 verify"
  - "saas"
---

# Postman Pagerduty V2 Skill

The `postman-pagerduty-v2` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
