...
description: "Email consent management in Marketing Cloud: configuring Subscription Centers, building\
  \ Preference Centers on CloudPages, enforcing CAN-SPAM and GDPR requirements, and\
  \ handling opt-out propagation. Trigger keywords: unsubscribe handling, CAN-SPAM\
  \ compliance, GDPR consent tracking, publication lists, subscription center, preference\
  \ center, opt-out, double opt-in, Privacy Center, MC consent. NOT for subscriber\
  \ key and suppression lists \u2014 use data/subscriber-data-management. NOT for\
  \ the CRM consent data model or MC-to-CRM sync \u2014 use architect/marketing-consent-architecture."
---
