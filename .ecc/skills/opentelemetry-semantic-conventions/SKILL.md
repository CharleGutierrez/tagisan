...
description: "Instrumenting gen_ai.system, gen_ai.request.model, and token count attributes"
version: 1.0.0
...
triggers:
  ...
  - "opentelemetry-semantic-conventions"
  - "opentelemetry-semantic-conventions execute"
  - "opentelemetry-semantic-conventions verify"
  - "resilience"
  - "semantic"
---

# Opentelemetry Semantic Conventions Skill

The `opentelemetry-semantic-conventions` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OpenTelemetry (opentelemetry.io)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Telemetry Module`.
