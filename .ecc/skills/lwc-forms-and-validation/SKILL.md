...
description: "Use when building or reviewing Lightning Web Component form UX, especially the choice\
  \ between `lightning-record-edit-form` and custom inputs, client-side validation\
  \ with `reportValidity()`, server-side validation feedback, and file upload flows.\
  \ NOT for Flow screen design or Apex-only validation logic \u2014 use lwc/lwc-lightning-record-forms."
---
