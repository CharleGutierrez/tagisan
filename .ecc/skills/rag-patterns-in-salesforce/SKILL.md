...
description: "Grounding Agentforce agents with retrieved knowledge using Data Cloud vector search:\
  \ RAG pipeline design, vector search index configuration, chunking and embedding\
  \ strategy, and how retrieved context flows through the Einstein Trust Layer into\
  \ prompts. NOT for the Query API, Data Cloud access tokens, or Easy vs Advanced\
  \ index mechanics \u2014 use agentforce/data-cloud-vector-search-dev. NOT for structured\
  \ DMO retrievers, sharing enforcement at retrieval time and citations \u2014 use\
