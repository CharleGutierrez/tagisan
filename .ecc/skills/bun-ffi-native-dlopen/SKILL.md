---
name: bun-ffi-native-dlopen
description: "Calling C-ABI shared libraries directly from TypeScript with zero-overhead FFI"
version: 1.0.0
...
triggers:
  - "bun"
  - "bun ffi native dlopen"
  - "bun-ffi-native-dlopen"
  - "bun-ffi-native-dlopen execute"
  - "bun-ffi-native-dlopen verify"
  - "dlopen"
  - "ffi"
  - "frontend"
  - "full-stack"
...
# Bun Ffi Native Dlopen Skill

The `bun-ffi-native-dlopen` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Bun Documentation (bun.sh)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Bun Runtime / Polyglot`.
