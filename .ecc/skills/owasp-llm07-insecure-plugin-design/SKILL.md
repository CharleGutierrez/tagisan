...
description: "Capability-based access control restricting plugins to explicit network and file scopes"
version: 1.0.0
...
triggers:
  ...
  - "owasp-llm07-insecure-plugin-design"
  - "owasp-llm07-insecure-plugin-design execute"
  - "owasp-llm07-insecure-plugin-design verify"
---

# Owasp Llm07 Insecure Plugin Design Skill

The `owasp-llm07-insecure-plugin-design` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **OWASP GenAI Top 10 (owasp.org)** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `Plugin Manifest / tgs-plugin`.
...
- **Subsystem Binding**: `Plugin Manifest / tgs-plugin`
...
```json
{
  "skill": "owasp-llm07-insecure-plugin-design",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "OWASP GenAI Top 10 (owasp.org)",
  "integration_target": "Plugin Manifest / tgs-plugin",
