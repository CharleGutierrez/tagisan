---
name: composio-google-workspace-admin
description: "Google Workspace user directory management and domain audit reporting"
version: 1.0.0
...
triggers:
  ...
  - "api-orchestration"
  - "composio"
  - "composio google workspace admin"
  - "composio-dev"
  - "composio-google-workspace-admin"
  - "composio-google-workspace-admin execute"
  - "composio-google-workspace-admin verify"
  - "enterprise"
---

# Composio Google Workspace Admin Skill

The `composio-google-workspace-admin` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-google-workspace-admin",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
