...
description: "Use when generating customer- or stakeholder-facing release notes from git history,\
  \ Jira/ADO ticket links, and Salesforce metadata diffs at deploy time. Triggers:\
  \ 'auto-generate release notes', 'changelog from commits', 'release. NOT for managed-package\
  \ version creation, push upgrades, or org assessment \u2014 use admin/salesforce-release-preparation."
---
