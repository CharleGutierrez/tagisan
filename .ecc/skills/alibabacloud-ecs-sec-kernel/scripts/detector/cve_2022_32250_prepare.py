"""
CVE-2022-32250 Prepare phase handler

Record system state snapshot, create temp test directory.
nf_tables isCoreKernelSuccesscan，noneedLoadAdditionalModule。
"""
import logging
import os
import subprocess
...
class CVE202232250PrepareHandler(BasePrepareHandler):
    """CVE-2022-32250 Prepare phase: record system state and create test environment"""
