"""
CVE-2018-14634 Prepare phase handler

Record system state snapshot, create temp test directory.
binfmt_elf isCoreKernelSuccesscan，noneedLoadAdditionalModule。
"""
import logging
import os
import subprocess
...
class CVE201814634PrepareHandler(BasePrepareHandler):
    """CVE-2018-14634 Prepare phase: record system state and create test environment"""
