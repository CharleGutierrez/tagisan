"""
CVE-2020-14386 Prepare phase handler
...
class CVE202014386PrepareHandler(BasePrepareHandler):
    """CVE-2020-14386 Prepare phase: record system state and create test environment"""
