"""
CVE-2023-2163 Post phase handler
...
class CVE20232163PostHandler(BasePostHandler):
    """CVE-2023-2163 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（eBPF isCoreSuccesscan，noneedSpecialRestore）
