"""
CVE-2015-1328 Post phase handler
...
class CVE20151328PostHandler(BasePostHandler):
    """CVE-2015-1328 Post phase: Clean up environment and verify system state"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. System already restored (overlayfs is core feature, no special restore)
