"""
CVE-2024-0193 Prepare phase handler
...
class CVE20240193PrepareHandler(BasePrepareHandler):
    """CVE-2024-0193 Prepare phase: record system state and create test environment"""
