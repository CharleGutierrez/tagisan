"""
CVE-2018-18955 Post phase handler
...
class CVE201818955PostHandler(BasePostHandler):
    """CVE-2018-18955 Post phase: Clean up environment and verify system state"""
    ...
    def self_check(self, run_user: str) -> SelfCheckResult:
        ...
        # 2. CheckisWhetherhasResidual user namespace RelatedProcess
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（user namespace isCoreSuccesscan，noneedSpecialRestore）
        system_restored = True

        # 3. Check dmesg isWhetherhas user namespace RelatedAnomaly
        kernel_warnings = self._check_userns_kernel_log()
    ...
    def _check_userns_kernel_log(self) -> List[str]:
        """Check dmesg inisWhetherhas user namespace RelatedAnomaly"""
        warnings: List[str] = []
        ...
        try:
            ...
            for line in tail_lines:
                # Checkwith user namespace RelatedAnomaly
