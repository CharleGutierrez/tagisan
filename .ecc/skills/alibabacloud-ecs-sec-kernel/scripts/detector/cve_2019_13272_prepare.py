"""
CVE-2019-13272 Prepare phase handler

Record system state snapshot, create temp test directory.
ptrace isCoreKernelSuccesscan，noneedLoadAdditionalModule。
"""
import logging
import os
import subprocess
...
class CVE201913272PrepareHandler(BasePrepareHandler):
    """CVE-2019-13272 Prepare phase: record system state and create test environment"""
