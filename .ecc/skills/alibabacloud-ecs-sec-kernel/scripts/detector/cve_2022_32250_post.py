"""
CVE-2022-32250 Post phase handler
...
class CVE202232250PostHandler(BasePostHandler):
    """CVE-2022-32250 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（nf_tables isCoreSuccesscan，noneedSpecialRestore）
