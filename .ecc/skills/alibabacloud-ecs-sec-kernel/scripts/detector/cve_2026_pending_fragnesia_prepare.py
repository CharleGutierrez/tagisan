"""
CVE-2026-PENDING-FRAGNESIA Prepare phase handler
...
If the PoC manages to overwrite the canary via ESP-in-TCP page cache
corruption (splice + ULP), it proves the vulnerability is exploitable.
"""
import logging
import os
import secrets
...
class CVE2026PendingFragnesiaPrepareHandler(BasePrepareHandler):
    """CVE-2026-PENDING-FRAGNESIA Prepare phase: load ESP modules + create CTF target"""
    ...
    def get_operations(self, kernel_info: dict) -> List[PrepareOperation]:
        ...
        self._target_file = os.path.join(self._tmp_dir, "poc_target_fragnesia")
        operations.append(PrepareOperation(
    ...
    def _create_target_file(self, op: PrepareOperation) -> PrepareOperation:
        ...
        try:
            ...
            if self._test_mode == "read_root_file":
                ...
                # via page cache corruption (ESP-in-TCP splice + ULP path)
