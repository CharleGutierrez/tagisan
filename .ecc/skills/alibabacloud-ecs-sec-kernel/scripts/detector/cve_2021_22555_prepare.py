"""
CVE-2021-22555 Prepare phase handler

Record system state snapshot, create temp test directory.
x_tables isCoreKernelSuccesscan，noneedLoadAdditionalModule。
"""
import logging
import os
import subprocess
...
class CVE202122555PrepareHandler(BasePrepareHandler):
    """CVE-2021-22555 Prepare phase: record system state and create test environment"""
