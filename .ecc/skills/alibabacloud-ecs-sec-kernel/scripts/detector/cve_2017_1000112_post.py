"""
CVE-2017-1000112 Post phase handler
...
class CVE20171000112PostHandler(BasePostHandler):
    """CVE-2017-1000112 Post phase: Clean up environment and verify system state"""
    ...
    def verify_ctf(self, context, poc_output) -> bool:
        ...
        For write_root_file: verify file content was changed to the write_value.
        For read_root_file: unsupported, check PoC output flag.
        """
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. System already restored (UDP is core subsystem, no special restore)
