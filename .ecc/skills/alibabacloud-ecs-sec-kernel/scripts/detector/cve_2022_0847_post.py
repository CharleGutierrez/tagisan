"""
CVE-2022-0847 Post phase handler
...
class CVE20220847PostHandler(BasePostHandler):
    """CVE-2022-0847 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（pipe isCoreSuccesscan，noneedSpecialRestore）
