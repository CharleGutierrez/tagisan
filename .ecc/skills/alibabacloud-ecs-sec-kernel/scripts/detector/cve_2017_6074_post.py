"""
CVE-2017-6074 Post phase handler
...
class CVE20176074PostHandler(BasePostHandler):
    """CVE-2017-6074 Post phase: Clean up environment and verify system state"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. System already restored (DCCP is core subsystem, no special restore)
