"""
CVE-2023-0386 Post phase handler
...
class CVE20230386PostHandler(BasePostHandler):
    """CVE-2023-0386 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（OverlayFS isCoreSuccesscan，noneedSpecialRestore）
