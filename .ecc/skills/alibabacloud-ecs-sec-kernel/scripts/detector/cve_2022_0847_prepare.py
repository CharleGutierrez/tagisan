"""
CVE-2022-0847 Prepare phase handler

Record system state snapshot, create temp test directory.
pipe isCoreKernelSuccesscan，noneedLoadAdditionalModule。
"""
import logging
import os
import subprocess
...
class CVE20220847PrepareHandler(BasePrepareHandler):
    """CVE-2022-0847 Prepare phase: record system state and create test environment"""
