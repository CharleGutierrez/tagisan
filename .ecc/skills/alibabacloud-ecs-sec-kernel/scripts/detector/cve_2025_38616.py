"""Detector for CVE-2025-38616 - TLS data disappearing under ULP context. Race condition in Upper Layer
Protocol handling causes TLS data loss and potential memory corruption,
...
class CVE202538616Detector(BaseDetector):
    cve_id = "CVE-2025-38616"
    severity = "CRITICAL"
    cvss_score = 7.8
    has_poc = True
    poc_mode = "uaf"
    description = "TLS data disappearing under ULP context. Race condition in Upper Layer Protocol handling causes TLS data loss and potential memory corruption, enabling local privilege escalation."
    ...
    def get_remediation(self):
        """Return remediation guidance for CVE-2025-38616."""
        from ..core.result import Remediation
        return Remediation(
            priority="IMMEDIATE",
            steps=[
                "Upgrade kernel to version >= 6.15 (net/tls splice recv UAF fix).",
    ...
    def _get_poc_verifier(self):
        from ..poc.cve_2025_38616_poc import CVECve202538616PoCVerifier
        return CVECve202538616PoCVerifier()
