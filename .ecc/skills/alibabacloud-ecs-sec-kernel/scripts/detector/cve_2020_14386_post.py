"""
CVE-2020-14386 Post phase handler
...
class CVE202014386PostHandler(BasePostHandler):
    """CVE-2020-14386 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（AF_PACKET isCoreSuccesscan，noneedSpecialRestore）
