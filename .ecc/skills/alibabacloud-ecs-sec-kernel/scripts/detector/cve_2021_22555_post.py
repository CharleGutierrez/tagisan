"""
CVE-2021-22555 Post phase handler
...
class CVE202122555PostHandler(BasePostHandler):
    """CVE-2021-22555 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（x_tables isCoreSuccesscan，noneedSpecialRestore）
