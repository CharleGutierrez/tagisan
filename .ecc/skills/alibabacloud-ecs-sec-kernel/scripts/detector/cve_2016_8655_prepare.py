"""
CVE-2016-8655 Prepare phase handler
...
class CVE20168655PrepareHandler(BasePrepareHandler):
    """CVE-2016-8655 Prepare phase: record system state and create test environment"""
