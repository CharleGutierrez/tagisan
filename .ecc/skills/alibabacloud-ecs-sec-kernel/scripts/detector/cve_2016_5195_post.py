"""
CVE-2016-5195 Post phase handler
...
class CVE20165195PostHandler(BasePostHandler):
    """CVE-2016-5195 Post phase: Clean up environment and verify system state"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. System already restored (mm is core subsystem, no need special restore)
