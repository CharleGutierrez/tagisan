"""
CVE-2018-14634 Post phase handler
...
class CVE201814634PostHandler(BasePostHandler):
    """CVE-2018-14634 Post phase：Clean up environment并VerifySystemState"""
    ...
    def global_verify(self, prepare_result: PrepareResult) -> GlobalVerifyResult:
        ...
        # 2. SystemalreadyRestore（binfmt_elf isCoreSuccesscan，noneedSpecialRestore）
