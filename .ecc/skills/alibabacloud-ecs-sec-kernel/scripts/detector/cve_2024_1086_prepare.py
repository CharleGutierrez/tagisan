"""
CVE-2024-1086 Prepare phase handler
...
class CVE20241086PrepareHandler(BasePrepareHandler):
    """CVE-2024-1086 Prepare phase: record system state and create test environment"""
