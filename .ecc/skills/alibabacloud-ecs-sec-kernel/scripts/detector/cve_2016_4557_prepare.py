"""
CVE-2016-4557 Prepare phase handler
...
class CVE20164557PrepareHandler(BasePrepareHandler):
    """CVE-2016-4557 Prepare phase: record system state and create test environment"""
