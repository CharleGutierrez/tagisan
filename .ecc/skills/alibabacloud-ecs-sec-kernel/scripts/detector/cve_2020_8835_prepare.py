"""
CVE-2020-8835 Prepare phase handler
...
class CVE20208835PrepareHandler(BasePrepareHandler):
    """CVE-2020-8835 Prepare phase: record system state and create test environment"""
