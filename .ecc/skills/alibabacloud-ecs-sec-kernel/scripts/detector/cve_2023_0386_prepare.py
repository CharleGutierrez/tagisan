"""
CVE-2023-0386 Prepare phase handler

Record system state snapshot, create temp test directory.
OverlayFS isCoreKernelSuccesscan，noneedLoadAdditionalModule。
"""
import logging
import os
import subprocess
...
class CVE20230386PrepareHandler(BasePrepareHandler):
    """CVE-2023-0386 Prepare phase: record system state and create test environment"""
