"""
CVE-2016-9793 PoC orchestration
...
class CVE20169793PoCVerifier(BasePoCVerifier):
    """CVE-2016-9793 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2016-9793 dedicated Prepare handler"""
        from ..detector.cve_2016_9793_prepare import CVE20169793PrepareHandler
        return CVE20169793PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2016-9793 dedicated Post handler"""
        from ..detector.cve_2016_9793_post import CVE20169793PostHandler
        return CVE20169793PostHandler()
        ...
        if not config_enabled and kernel_info.config is not None:
            return PoCResult(
                ...
                error_message=(
                    ...
                    f"socket subsystem not available"
                )
            )
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2016-9793 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
