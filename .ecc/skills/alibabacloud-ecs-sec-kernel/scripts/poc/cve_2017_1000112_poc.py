"""
CVE-2017-1000112 PoC orchestration
...
class CVE20171000112PoCVerifier(BasePoCVerifier):
    """CVE-2017-1000112 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2017-1000112 dedicated Prepare handler"""
        from ..detector.cve_2017_1000112_prepare import CVE20171000112PrepareHandler
        return CVE20171000112PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2017-1000112 dedicated Post handler"""
        from ..detector.cve_2017_1000112_post import CVE20171000112PostHandler
        return CVE20171000112PostHandler()

    def pre_check(self, kernel_info: KernelInfo) -> Optional[PoCResult]:
        """
        Pre-check:
        1. Kernel version in affected range
        2. CONFIG_NET Configuration enabled
        """
        # Version check
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2017-1000112 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
