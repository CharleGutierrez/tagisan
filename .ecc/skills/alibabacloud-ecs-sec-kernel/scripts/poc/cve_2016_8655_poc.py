"""
CVE-2016-8655 PoC orchestration
...
class CVE20168655PoCVerifier(BasePoCVerifier):
    """CVE-2016-8655 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2016-8655 dedicated Prepare handler"""
        from ..detector.cve_2016_8655_prepare import CVE20168655PrepareHandler
        return CVE20168655PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2016-8655 dedicated Post handler"""
        from ..detector.cve_2016_8655_post import CVE20168655PostHandler
        return CVE20168655PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2016-8655 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
