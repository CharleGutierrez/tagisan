"""
CVE-2017-7308 PoC orchestration
...
class CVE20177308PoCVerifier(BasePoCVerifier):
    """CVE-2017-7308 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2017-7308 dedicated Prepare handler"""
        from ..detector.cve_2017_7308_prepare import CVE20177308PrepareHandler
        return CVE20177308PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2017-7308 dedicated Post handler"""
        from ..detector.cve_2017_7308_post import CVE20177308PostHandler
        return CVE20177308PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2017-7308 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
