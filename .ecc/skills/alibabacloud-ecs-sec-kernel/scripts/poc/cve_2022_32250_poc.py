"""
CVE-2022-32250 PoC orchestration
...
class CVE202232250PoCVerifier(BasePoCVerifier):
    """CVE-2022-32250 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2022-32250 dedicated Prepare handler"""
        from ..detector.cve_2022_32250_prepare import CVE202232250PrepareHandler
        return CVE202232250PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2022-32250 dedicated Post handler"""
        from ..detector.cve_2022_32250_post import CVE202232250PostHandler
        return CVE202232250PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2022-32250 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
