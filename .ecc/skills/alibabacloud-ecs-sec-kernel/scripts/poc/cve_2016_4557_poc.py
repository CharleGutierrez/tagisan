"""
CVE-2016-4557 PoC orchestration
...
class CVE20164557PoCVerifier(BasePoCVerifier):
    """CVE-2016-4557 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2016-4557 dedicated Prepare handler"""
        from ..detector.cve_2016_4557_prepare import CVE20164557PrepareHandler
        return CVE20164557PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2016-4557 dedicated Post handler"""
        from ..detector.cve_2016_4557_post import CVE20164557PostHandler
        return CVE20164557PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2016-4557 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
