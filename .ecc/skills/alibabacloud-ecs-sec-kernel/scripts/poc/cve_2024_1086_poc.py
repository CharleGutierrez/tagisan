"""
CVE-2024-1086 PoC orchestration
...
class CVE20241086PoCVerifier(BasePoCVerifier):
    """CVE-2024-1086 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2024-1086 dedicated Prepare handler"""
        from ..detector.cve_2024_1086_prepare import CVE20241086PrepareHandler
        return CVE20241086PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2024-1086 dedicated Post handler"""
        from ..detector.cve_2024_1086_post import CVE20241086PostHandler
        return CVE20241086PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2024-1086 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
