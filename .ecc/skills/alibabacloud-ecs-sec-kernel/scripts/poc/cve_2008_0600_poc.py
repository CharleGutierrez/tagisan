"""
CVE-2008-0600 PoC orchestrator

Custom pre-check and post-processing.
CTF challenge mode for vmsplice page cache pollution.
"""
import logging
import time
...
class CVE20080600PoCVerifier(BasePoCVerifier):
    """CVE-2008-0600 PoC orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2008-0600 specific Prepare handler"""
        from ..detector.cve_2008_0600_prepare import CVE20080600PrepareHandler
        return CVE20080600PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2008-0600 specific Post handler"""
        from ..detector.cve_2008_0600_post import CVE20080600PostHandler
        return CVE20080600PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2008-0600 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
