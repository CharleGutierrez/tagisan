"""
CVE-2020-8835 PoC orchestration
...
class CVE20208835PoCVerifier(BasePoCVerifier):
    """CVE-2020-8835 PoC Orchestrator"""
    ...
    def get_prepare_handler(self):
        """Return CVE-2020-8835 dedicated Prepare handler"""
        from ..detector.cve_2020_8835_prepare import CVE20208835PrepareHandler
        return CVE20208835PrepareHandler()

    def get_post_handler(self):
        """Return CVE-2020-8835 dedicated Post handler"""
        from ..detector.cve_2020_8835_post import CVE20208835PostHandler
        return CVE20208835PostHandler()
    ...
    def post_process(self, result: PoCResult,
        ...
        if result.status == "EXPLOITABLE":
            logger.info(
                "CVE-2020-8835 EXPLOITABLE on kernel %s",
                kernel_info.version
            )
        return result
