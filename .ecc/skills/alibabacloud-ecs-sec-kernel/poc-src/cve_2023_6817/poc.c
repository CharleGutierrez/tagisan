/*
 * CVE-2023-6817 PoC - CTF Challenge Mode
 *
 * Vulnerability: netfilter nft_set use-after-free on flag update
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2023-6817 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2023-6817 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2023-6817 CTF PoC ===");
    poc_log("Vuln: netfilter nft_set use-after-free on flag update");
