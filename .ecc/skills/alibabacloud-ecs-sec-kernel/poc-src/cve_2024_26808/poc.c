/*
 * CVE-2024-26808 PoC - CTF Challenge Mode
 *
 * Vulnerability: Netfilter stale reference in NETDEV_UNREGISTER
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2024-26808 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-26808 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-26808 CTF PoC ===");
    poc_log("Vuln: Netfilter stale reference in NETDEV_UNREGISTER");
