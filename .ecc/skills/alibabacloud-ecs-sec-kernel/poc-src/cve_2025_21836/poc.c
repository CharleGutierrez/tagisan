/*
 * CVE-2025-21836 PoC - CTF Challenge Mode
 *
 * Vulnerability: io_uring provided buffer list reallocation error
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2025-21836 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2025-21836 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2025-21836 CTF PoC ===");
    poc_log("Vuln: io_uring provided buffer list reallocation error");
