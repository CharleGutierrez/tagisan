/*
 * CVE-2024-26824 PoC - CTF Challenge Mode
 *
 * Vulnerability: Crypto algif_hash bogus SGL free
 *
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-26824 vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-26824 CTF PoC ===");
    poc_log("Vuln: Crypto algif_hash bogus SGL free");
