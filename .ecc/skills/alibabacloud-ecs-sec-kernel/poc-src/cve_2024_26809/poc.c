/*
 * CVE-2024-26809 PoC - CTF Challenge Mode
 *
 * Vulnerability: Netfilter nft_pipato improper element cleanup
 *
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-26809 vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-26809 CTF PoC ===");
    poc_log("Vuln: Netfilter nft_pipato improper element cleanup");
