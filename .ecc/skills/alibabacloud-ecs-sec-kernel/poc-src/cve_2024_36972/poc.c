/*
 * CVE-2024-36972 PoC - CTF Challenge Mode
 *
 * Vulnerability: AF_UNIX race condition updating oob_skb
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2024-36972 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-36972 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-36972 CTF PoC ===");
    poc_log("Vuln: AF_UNIX race condition updating oob_skb");
