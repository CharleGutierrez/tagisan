/*
 * CVE-2024-26585 PoC - CTF Challenge Mode
 *
 * Vulnerability: TLS race condition between tx work and socket close
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2024-26585 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-26585 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-26585 CTF PoC ===");
    poc_log("Vuln: TLS race condition between tx work and socket close");
