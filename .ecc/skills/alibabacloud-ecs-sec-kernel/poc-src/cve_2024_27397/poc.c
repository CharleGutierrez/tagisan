/*
 * CVE-2024-27397 PoC - CTF Challenge Mode
 *
 * Vulnerability: netfilter nft_set timer race condition use-after-free
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2024-27397 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-27397 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-27397 CTF PoC ===");
    poc_log("Vuln: netfilter nft_set timer race condition use-after-free");
