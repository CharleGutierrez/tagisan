/*
 * CVE-2024-39503 PoC - CTF Challenge Mode
 *
 * Vulnerability: Netfilter ipset race between namespace cleanup and GC
 *
...
static int mode_uaf(poc_args_t *args) {
    poc_log("Triggering CVE-2024-39503 UAF + spray corruption check...");
...
static int mode_write_root_file(const poc_args_t *args) {
    ...
    poc_log("Triggering CVE-2024-39503 UAF vulnerability...");
...
int main(int argc, char *argv[]) {
    ...
    poc_log("=== CVE-2024-39503 CTF PoC ===");
    poc_log("Vuln: Netfilter ipset race between namespace cleanup and GC");
