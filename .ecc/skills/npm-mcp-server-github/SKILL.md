---
name: npm-mcp-server-github
description: "Standalone npm distribution of GitHub REST and GraphQL API client"
version: 1.0.0
tier: "Tier 1: Model Context Protocol (MCP) & Web Registries"
source: "NPM Registry (Binary)"
tags:
  - github
  - mcp
...
triggers:
  ...
  - "npm-mcp-server-github"
  - "npm-mcp-server-github execute"
  - "npm-mcp-server-github verify"
  - "server"
---

# Npm Mcp Server Github Skill

The `npm-mcp-server-github` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry (Binary)** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
