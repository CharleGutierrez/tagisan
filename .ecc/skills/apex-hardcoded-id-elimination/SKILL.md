...
description: "Remove hardcoded Salesforce record IDs (Profile, RecordType, User, Queue, custom)\
  \ from Apex and replace with describe-API, name-based SOQL, or Custom Metadata-driven\
  \ lookups. NOT for record type IDs in Flow, formulas or LWC \u2014 use admin/record-type-id-management.\
  \ NOT for storing the config values themselves \u2014 use apex/custom-metadata-in-apex."
---
