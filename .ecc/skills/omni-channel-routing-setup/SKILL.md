...
description: "Configuring Salesforce Omni-Channel routing from scratch or updating existing routing:\
  \ enabling Omni-Channel, creating Service Channels, configuring Routing Configurations\
  \ (queue-based and skills-based), setting up Presence Statuses and Presence Configurations,\
  \ assigning skills to Service Resources, and defining Skills-Based Routing Rules.\
  \ Trigger keywords: Omni-Channel setup, routing configuration, queue-based routing,\
  \ skills-based routing, presence status, service channel, routing rules. NOT for\
  \ agent capacity units and channel weighting \u2014 use architect/omni-channel-capacity-model.\
  \ NOT for Apex routing via PendingServiceRouting \u2014 use apex/omni-channel-custom-routing."
---
