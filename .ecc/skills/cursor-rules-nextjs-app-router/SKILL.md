---
name: cursor-rules-nextjs-app-router
description: "Next.js 15 App Router conventions, React Server Components, and server actions"
version: 1.0.0
...
triggers:
  ...
  - "bun"
  - "cursor"
  - "cursor rules nextjs app router"
  - "cursor-rules-nextjs-app-router"
  - "cursor-rules-nextjs-app-router execute"
  - "cursor-rules-nextjs-app-router verify"
  - "frontend"
  - "full-stack"
---

# Cursor Rules Nextjs App Router Skill

The `cursor-rules-nextjs-app-router` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cursor Directory (cursor.directory)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev Vibe Coder`.
...
```json
{
  "skill": "cursor-rules-nextjs-app-router",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Cursor Directory (cursor.directory)",
