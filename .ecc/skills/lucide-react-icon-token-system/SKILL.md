---
name: lucide-react-icon-token-system
description: "Consistent vector icon sets with customizable stroke width and color inheritance"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Lucide Project Docs"
tags:
  - bun
  - frontend
  - full-stack
...
triggers:
  ...
  - "icon"
  - "lucide"
  - "lucide react icon token system"
  - "lucide-react-icon-token-system"
  - "lucide-react-icon-token-system execute"
  - "lucide-react-icon-token-system verify"
---

# Lucide React Icon Token System Skill

The `lucide-react-icon-token-system` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Lucide Project Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
- **Subsystem Binding**: `Web Design & Dev`
...
```json
{
  "skill": "lucide-react-icon-token-system",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Lucide Project Docs",
  "integration_target": "Web Design & Dev",
