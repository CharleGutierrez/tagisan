---
name: linux-audit-framework-kaudit
description: "Kernel audit subsystem rule injection for real-time security incident detection"
version: 1.0.0
...
triggers:
  ...
  - "kaudit"
  - "kernel"
  - "linux audit framework kaudit"
  - "linux-audit-framework-kaudit"
  - "linux-audit-framework-kaudit execute"
  - "linux-audit-framework-kaudit verify"
---

# Linux Audit Framework Kaudit Skill

The `linux-audit-framework-kaudit` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `AgentShield / EDR`.
...
```json
{
  "skill": "linux-audit-framework-kaudit",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
