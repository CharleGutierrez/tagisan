...
description: "Architecture guidance for Salesforce Insurance Cloud on FSC: module licensing strategy,\
  \ policy administration object model, claims processing workflow design, underwriting\
  \ rule integration, and channel routing. NOT for enabling insurance objects, coverage\
  \ types or claim config in Setup \u2014 use admin/industries-insurance-setup. NOT\
  \ for FSC retail banking and lending architecture \u2014 use architect/banking-lending-architecture."
---
