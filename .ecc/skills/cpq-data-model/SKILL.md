---
name: cpq-data-model
description: "Use when querying, mapping, or building against Salesforce CPQ managed-package objects\
  \ (SBQQ__ namespace): Quote, QuoteLine, QuoteLineGroup, DiscountSchedule, PriceRule,\
  \ Subscription. Trigger keywords: SBQQ__Quote__c, QuoteLineModel, CPQ object graph,\
  \ CPQ subscription, CPQ price rule. NOT for driving quote calculation, amend or\
  \ renew from code \u2014 use apex/cpq-api-and-automation. NOT for bulk-loading the\
  \ CPQ product catalog \u2014 use data/product-catalog-migration-cpq."
---
# CPQ Data Model
