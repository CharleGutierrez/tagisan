---
name: postman-dynatrace-davis
description: "Dynatrace Davis AI problem root cause analysis and host metrics"
version: 1.0.0
...
triggers:
  ...
  - "enterprise"
  - "postman"
  - "postman dynatrace davis"
  - "postman-dynatrace-davis"
  - "postman-dynatrace-davis execute"
  - "postman-dynatrace-davis verify"
---

# Postman Dynatrace Davis Skill

The `postman-dynatrace-davis` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
