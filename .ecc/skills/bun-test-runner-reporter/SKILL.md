---
name: bun-test-runner-reporter
description: "Running unit tests via native bun:test with snapshot diffing and coverage"
version: 1.0.0
...
triggers:
  - "bun"
  - "bun test runner reporter"
  - "bun-test-runner-reporter"
  - "bun-test-runner-reporter execute"
  - "bun-test-runner-reporter verify"
  - "frontend"
  - "full-stack"
  - "reporter"
  - "runner"
...
# Bun Test Runner Reporter Skill

The `bun-test-runner-reporter` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Bun Documentation (bun.sh)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Bun Runtime / Polyglot`.
...
```json
{
  "skill": "bun-test-runner-reporter",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Bun Documentation (bun.sh)",
