---
name: smt-z3-horn-clause-chc
description: "Constrained Horn Clauses solving for automated safety property reachability"
version: 1.0.0
...
triggers:
  ...
  - "compiler"
  - "formal-methods"
  - "smt z3 horn clause chc"
  - "smt-z3-horn-clause-chc"
  - "smt-z3-horn-clause-chc execute"
  - "smt-z3-horn-clause-chc verify"
---

# Smt Z3 Horn Clause Chc Skill

The `smt-z3-horn-clause-chc` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / Z3 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
