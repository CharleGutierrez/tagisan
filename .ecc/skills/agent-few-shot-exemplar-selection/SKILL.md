---
name: agent-few-shot-exemplar-selection
description: "Vector similarity search selecting the most relevant few-shot code examples"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent few shot exemplar selection"
  - "agent-few-shot-exemplar-selection"
  - "agent-few-shot-exemplar-selection execute"
  - "agent-few-shot-exemplar-selection verify"
  - "arxiv"
  - "consensus"
  - "debate"
  - "exemplar"
...
# Agent Few Shot Exemplar Selection Skill

The `agent-few-shot-exemplar-selection` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Prompt Engine`.
...
- **Subsystem Binding**: `Prompt Engine`
...
```json
{
  "skill": "agent-few-shot-exemplar-selection",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
  "integration_target": "Prompt Engine",
