...
description: "SObject.clone(preserveId, isDeepClone, preserveReadonly, preserveAutonumber): shallow\
  \ vs deep clone semantics, related-record replication, clone with parent repointing,\
  \ autonumber preservation. NOT for data migration \u2014 use data/bulk-api-and-large-data-loads.\
  \ NOT for record snapshots \u2014 use data/field-history-tracking."
---
