...
description: "Alibaba Cloud PTS (Performance Testing Service) scenario-based skill for creating\
  \ and managing stress testing scenarios. Supports both PTS native HTTP/HTTPS stress\
  \ testing and JMeter-based stress testing. Triggers: \"PTS\", \"\u538B\u6D4B\",\
  \ \"\u6027\u80FD\u6D4B\u8BD5\", \"stress testing\", \"performance testing\", \"\
  JMeter\", \"load testing\", \"\u521B\u5EFA\u538B\u6D4B\u573A\u666F\""
---
