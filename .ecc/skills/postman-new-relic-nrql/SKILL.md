---
name: postman-new-relic-nrql
description: "New Relic NRQL metric queries, error rate analysis, and entity health"
version: 1.0.0
...
triggers:
  ...
  - "nrql"
  - "postman"
  - "postman new relic nrql"
  - "postman-new-relic-nrql"
  - "postman-new-relic-nrql execute"
  - "postman-new-relic-nrql verify"
---

# Postman New Relic Nrql Skill

The `postman-new-relic-nrql` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Postman API Network** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
