---
name: smt-cvc5-string-theory
description: "Regular expressions and string constraint solving for parser vulnerability checks"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "smt"
  - "smt cvc5 string theory"
  - "smt-cvc5-string-theory"
  - "smt-cvc5-string-theory execute"
  - "smt-cvc5-string-theory verify"
---

# Smt Cvc5 String Theory Skill

The `smt-cvc5-string-theory` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / cvc5 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AgentShield / Interceptor`.
...
- **Subsystem Binding**: `AgentShield / Interceptor`
...
```json
{
  "skill": "smt-cvc5-string-theory",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "SMT-LIB / cvc5 Project",
  "integration_target": "AgentShield / Interceptor",
