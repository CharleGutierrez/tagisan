...
description: "Use this skill when configuring or troubleshooting API access for Experience Cloud\
  \ external users and guest users: guest user Apex data access, Customer Community\
  \ Plus or Partner Community REST/SOAP API access. NOT for internal Salesforce API\
  \ authentication, non-community OAuth flows, or internal u \u2014 use security/experience-cloud-security."
---
