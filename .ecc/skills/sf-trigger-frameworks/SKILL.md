...
description: "Salesforce Apex trigger framework patterns \u2014 TriggerHandler, FFLIB Domain, TDTM,\
  \ bypass and recursion control. Use when adopting or refactoring triggers."
---
# Trigger Frameworks
