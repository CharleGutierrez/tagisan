...
description: "Use when implementing runtime feature toggles, emergency kill switches, or gradual\
  \ rollout controls in Apex using Custom Metadata Types, Custom Permissions, or Hierarchical\
  \ Custom Settings. NOT for disabling a trigger during a data load \u2014 use apex/apex-trigger-bypass-and-killswitch-patterns.\
  \ NOT for CMDT basics \u2014 use admin/custom-metadata-types."
---
