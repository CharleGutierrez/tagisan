---
name: glama-twilio-messaging
description: "SMS notification dispatch, phone number verification, and WhatsApp webhook"
version: 1.0.0
...
triggers:
  - "glama"
  - "glama twilio messaging"
  - "glama-ai"
  - "glama-twilio-messaging"
  - "glama-twilio-messaging execute"
  - "glama-twilio-messaging verify"
  - "mcp"
  - "messaging"
  - "model-context-protocol"
---

# Glama Twilio Messaging Skill

The `glama-twilio-messaging` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
