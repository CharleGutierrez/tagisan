---
name: agent-cognitive-react-loop
description: "Interleaved Reasoning and Acting (ReAct) thought-action-observation cycle execution"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent cognitive react loop"
  - "agent-cognitive-react-loop"
  - "agent-cognitive-react-loop execute"
  - "agent-cognitive-react-loop verify"
  - "arxiv"
  - "cognitive"
  - "consensus"
  - "debate"
...
# Agent Cognitive React Loop Skill

The `agent-cognitive-react-loop` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Core Agent Loop`.
...
- **Subsystem Binding**: `Core Agent Loop`
...
```json
{
  "skill": "agent-cognitive-react-loop",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
  "integration_target": "Core Agent Loop",
