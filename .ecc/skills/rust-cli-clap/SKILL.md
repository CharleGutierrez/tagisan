---
name: rust-cli-clap
description: 'Rust command-line apps with clap: derive and builder APIs, subcommands, flags, config
  and env precedence, stdout, stderr and JSON contracts, exit codes, completions,
