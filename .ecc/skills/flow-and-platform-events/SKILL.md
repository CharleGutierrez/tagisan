...
description: "Publish and subscribe to Platform Events from Flow for async decoupling, high-volume\
  \ triggers, and cross-org signaling. NOT for publish-after-commit semantics, subscriber\
  \ idempotency, or fan-out failure design \u2014 use flow/flow-platform-events-integration.\
  \ NOT for a flow that just fires on record save \u2014 use flow/record-triggered-flow-patterns."
---
