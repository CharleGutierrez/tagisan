---
name: refactor-clean
description: Use when cleaning up Salesforce Apex or LWC code. Dead code removal and consolidation
  using PMD and Salesforce Code Analyzer for safe cleanup.
...
---
