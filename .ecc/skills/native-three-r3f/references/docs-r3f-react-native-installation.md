...
[**Vite.js**](https://r3f.docs.pmnd.rs/getting-started/installation#vite.js)
...
[**Next.js**](https://r3f.docs.pmnd.rs/getting-started/installation#next.js)
...
[**Without build tools**](https://r3f.docs.pmnd.rs/getting-started/installation#without-build-tools)
...
[**React Native**](https://r3f.docs.pmnd.rs/getting-started/installation#react-native)
...
iOS simulators often have incomplete or unreliable OpenGL ES support, which can cause EXC\_BAD\_ACCESS crashes when rendering 3D content. Always test on a physical iOS device (iPhone/iPad running iOS 16 or later) to ensure stable WebGL rendering.
