...
description: "Use this skill when creating, configuring, or troubleshooting FSC Relationship Groups\
  \ \u2014 including Household, Professional Group, and Trust group types; member\
  \ role assignment via AccountContactRelation FSC fields; Primary Group designation;\
  \ and group-level wealth aggregation rollups. NOT for standard account relationships,\
  \ Contact-Account relationships outside FSC, NPSP household configuration, or Financial\
  \ Account role setup (use admin/financial-account-setup)."
---
