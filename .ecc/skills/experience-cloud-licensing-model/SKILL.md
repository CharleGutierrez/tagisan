...
description: "Use this skill to select the correct Experience Cloud external user license type\
  \ for a portal or community. Trigger keywords: Customer Community vs Partner Community,\
  \ login-based vs member-based license, External Apps license, external user license\
  \ selection, Experience Cloud license tiers. NOT for adding members, self-registration\
  \ or login pages \u2014 use admin/experience-cloud-member-management. NOT for bulk-migrating\
  \ existing portal users between license types \u2014 use data/community-user-data-migration."
---
