---
name: linux-cgroups-v2-cpu-weight
description: "CFS scheduler CPU bandwidth quota and weight prioritization across agent threads"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux cgroups v2 cpu weight"
  - "linux-cgroups-v2-cpu-weight"
  - "linux-cgroups-v2-cpu-weight execute"
  - "linux-cgroups-v2-cpu-weight verify"
---

# Linux Cgroups V2 Cpu Weight Skill

The `linux-cgroups-v2-cpu-weight` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tokio Swarm / Scheduler`.
...
- **Subsystem Binding**: `Tokio Swarm / Scheduler`
...
```json
{
  "skill": "linux-cgroups-v2-cpu-weight",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Tokio Swarm / Scheduler",
