---
name: npm-mcp-server-atlassian-confluence
description: "Confluence enterprise documentation search, space hierarchy, and page creation"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server atlassian confluence"
  - "npm-mcp-server-atlassian-confluence"
  - "npm-mcp-server-atlassian-confluence execute"
  - "npm-mcp-server-atlassian-confluence verify"
---

# Npm Mcp Server Atlassian Confluence Skill

The `npm-mcp-server-atlassian-confluence` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "npm-mcp-server-atlassian-confluence",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "NPM Registry",
