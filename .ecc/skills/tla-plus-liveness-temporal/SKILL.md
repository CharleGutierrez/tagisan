---
name: tla-plus-liveness-temporal
description: "Fairness condition specifications and temporal liveness property verification"
version: 1.0.0
...
triggers:
  ...
  - "liveness"
  - "plus"
  - "tla plus liveness temporal"
  - "tla-plus-liveness-temporal"
  - "tla-plus-liveness-temporal execute"
  - "tla-plus-liveness-temporal verify"
---

# Tla Plus Liveness Temporal Skill

The `tla-plus-liveness-temporal` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **TLA+ Foundation** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `TLA+ Consensus Checker`.
...
```json
{
  "skill": "tla-plus-liveness-temporal",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "TLA+ Foundation",
