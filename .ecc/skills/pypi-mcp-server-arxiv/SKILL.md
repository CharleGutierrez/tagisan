---
name: pypi-mcp-server-arxiv
description: "ArXiv scientific paper search, abstract extraction, and PDF metadata parsing"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server arxiv"
  - "pypi-mcp-server-arxiv"
  - "pypi-mcp-server-arxiv execute"
  - "pypi-mcp-server-arxiv verify"
  - "server"
---

# Pypi Mcp Server Arxiv Skill

The `pypi-mcp-server-arxiv` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
