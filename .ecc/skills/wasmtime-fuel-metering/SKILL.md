---
name: wasmtime-fuel-metering
description: "Injecting execution fuel limits into WebAssembly instances to prevent infinite loops"
version: 1.0.0
tier: "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning"
source: "Wasmtime Docs"
tags:
  - ast
  - compiler
  - formal-methods
...
triggers:
  ...
  - "wasmtime-fuel-metering"
  - "wasmtime-fuel-metering execute"
  - "wasmtime-fuel-metering verify"
---

# Wasmtime Fuel Metering Skill

The `wasmtime-fuel-metering` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Wasmtime Docs** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Plugin Tier A (WASM)`.
