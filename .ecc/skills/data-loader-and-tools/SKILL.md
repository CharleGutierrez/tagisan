...
description: "Use this skill when selecting or configuring Salesforce data load tools: Data Loader,\
  \ Data Import Wizard, Workbench, Salesforce Inspector, or Salesforce CLI for import/export.\
  \ Trigger keywords: data loader configuration, import wizard, bulk data load, workbench\
  \ SOQL, salesforce inspector, data export, csv import salesforce, data migration\
  \ tool selection. NOT for mapping CSV columns to field API names \u2014 use data/data-loader-csv-column-mapping.\
  \ NOT for coding a Bulk API 2.0 job and retrieving its failed records \u2014 use\
