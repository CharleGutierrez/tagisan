---
name: "ratatui-layout"
description: "CRITICAL: Use for ratatui layout and positioning. Triggers on: Layout, Constraint, Rect, Flex, Direction, Margin, Alignment, horizontal, vertical, areas, split, Length, Percentage, Ratio, Fill, Min, Max, \"how to split screen\", \"ratatui layout\", \"divide terminal\", 布局, 约束, 分割屏幕, ratatui 布局, 水平布局, 垂直布局"
---
