---
name: npm-mcp-server-airtable
description: "Airtable base records querying, schema mapping, and relational syncing"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server airtable"
  - "npm-mcp-server-airtable"
  - "npm-mcp-server-airtable execute"
  - "npm-mcp-server-airtable verify"
  - "server"
---

# Npm Mcp Server Airtable Skill

The `npm-mcp-server-airtable` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
