...
description: "Use when invoking auto-launched Flows from Apex (Flow.Interview), from external systems\
  \ via REST API, from Platform Events, or from other Flows (subflow element). Covers\
  \ input/output variable mapping, bulkification patterns, and error/fault handling.\
  \ NOT for record-triggered flows \u2014 use flow/record-triggered-flow-patterns.\
  \ NOT for schedule-triggered flows \u2014 use flow/scheduled-flows."
---
