...
description: "Use when encountering or preventing MIXED_DML_OPERATION errors caused by DML on setup\
  \ objects (User, UserRole, PermissionSet, Group, GroupMember) in the same transaction\
  \ as non-setup objects. Triggers: 'MIXED_DML_OPERATION', 'setup object DML error',\
  \ 'cannot insert User and Account together', 'System.runAs mixed DML', '@future\
  \ setup object workaround'. NOT for general async Apex patterns \u2014 use apex/async-apex.\
  \ NOT for test data factory structure \u2014 use apex/test-data-factory-patterns."
---
