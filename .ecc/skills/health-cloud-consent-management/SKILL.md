...
description: "Use this skill when configuring Health Cloud patient consent management: setting\
  \ up HIPAA authorization forms, consent templates, consent tracking per patient,\
  \ and withdrawal handling. NOT for querying the AuthorizationFormConsent object\
  \ hierarchy or its required field values \u2014 use data/consent-data-model-health.\
  \ NOT for GDPR/CCPA marketing opt-out on ContactPointTypeConsent \u2014 use security/gdpr-data-privacy."
---
