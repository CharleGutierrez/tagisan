...
description: "Move a Flow from sandbox to production reliably \u2014 source format, version-on-deploy\
  \ semantics, deploy vs activate, dependency bundling, Change Set vs SFDX vs Unlocked\
  \ vs Managed, validate-then-quick-deploy, and rollback by activating a prior version.\
  \ NOT for paused interviews surviving a deploy or the two-active-versions race \u2014\
  \ use devops/flow-deployment-activation-ordering. NOT for source-tracking conflicts\
  \ between sandbox and repo \u2014 use devops/source-tracking-and-conflict-resolution.\
  \ NOT for branching strategy \u2014 use devops/git-branching-for-salesforce."
---
