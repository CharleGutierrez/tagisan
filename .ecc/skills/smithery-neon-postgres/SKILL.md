---
name: smithery-neon-postgres
description: "Serverless PostgreSQL branching and ephemeral database provisioning"
version: 1.0.0
...
triggers:
  ...
  - "postgres"
  - "smithery"
  - "smithery neon postgres"
  - "smithery-neon-postgres"
  - "smithery-neon-postgres execute"
  - "smithery-neon-postgres verify"
---

# Smithery Neon Postgres Skill

The `smithery-neon-postgres` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
