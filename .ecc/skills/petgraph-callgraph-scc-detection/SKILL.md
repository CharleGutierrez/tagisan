---
name: petgraph-callgraph-scc-detection
description: "Tarjan's strongly connected components algorithm detecting circular code dependencies"
version: 1.0.0
...
triggers:
  ...
  - "detection"
  - "formal-methods"
  - "petgraph callgraph scc detection"
  - "petgraph-callgraph-scc-detection"
  - "petgraph-callgraph-scc-detection execute"
  - "petgraph-callgraph-scc-detection verify"
---

# Petgraph Callgraph Scc Detection Skill

The `petgraph-callgraph-scc-detection` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Petgraph Docs (docs.rs)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
```json
{
  "skill": "petgraph-callgraph-scc-detection",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "Petgraph Docs (docs.rs)",
