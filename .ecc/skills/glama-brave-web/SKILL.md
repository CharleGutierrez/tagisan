---
name: glama-brave-web
description: "Web scraping and real-time news retrieval with Brave search index"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-brave-web"
  - "glama-brave-web execute"
  - "glama-brave-web verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Brave Web Skill

The `glama-brave-web` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP SSE client / ToolRegistry`.
...
- **Subsystem Binding**: `MCP SSE client / ToolRegistry`
...
```json
{
  "skill": "glama-brave-web",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Glama.ai",
  "integration_target": "MCP SSE client / ToolRegistry",
