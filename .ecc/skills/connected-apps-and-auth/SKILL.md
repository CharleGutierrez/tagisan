...
description: "Use when designing, reviewing, or troubleshooting Salesforce connected apps, External\
  \ Client Apps, Named Credentials, External Credentials, and OAuth-based integration\
  \ access. Triggers: 'connected app', 'OAuth flow', 'client credentials', 'JWT bearer',\
  \ 'Named Credential', 'External Credential', 'integration user', 'IP restrictions'.\
  \ NOT for OAuth error codes you are already seeing \u2014 use admin/connected-app-troubleshooting.\
  \ NOT for External Credential principal-type setup steps \u2014 use integration/named-credentials-setup."
---
