---
name: lazarus-malicious-npm-postinstall-audit
description: "Static analysis of package.json postinstall scripts for obfuscated base64 fetch payloads"
version: 1.0.0
...
triggers:
  ...
  - "defense"
  - "edr"
  - "lazarus malicious npm postinstall audit"
  - "lazarus-malicious-npm-postinstall-audit"
  - "lazarus-malicious-npm-postinstall-audit execute"
  - "lazarus-malicious-npm-postinstall-audit verify"
---

# Lazarus Malicious Npm Postinstall Audit Skill

The `lazarus-malicious-npm-postinstall-audit` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Cyber Threat Intelligence** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Polyglot`.
...
- **Subsystem Binding**: `AgentShield / Polyglot`
...
```json
{
  "skill": "lazarus-malicious-npm-postinstall-audit",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Cyber Threat Intelligence",
  "integration_target": "AgentShield / Polyglot",
