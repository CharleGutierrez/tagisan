---
name: linux-io-uring-sqpoll-tuning
description: "Submission Queue Polling kernel thread binding for zero-latency I/O loops"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "linux"
  - "linux io uring sqpoll tuning"
  - "linux-io-uring-sqpoll-tuning"
  - "linux-io-uring-sqpoll-tuning execute"
  - "linux-io-uring-sqpoll-tuning verify"
  - "low-level"
  - "performance"
---

# Linux Io Uring Sqpoll Tuning Skill

The `linux-io-uring-sqpoll-tuning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Linux Kernel Docs (kernel.org)** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tokio Core / Engine`.
...
- **Subsystem Binding**: `Tokio Core / Engine`
...
```json
{
  "skill": "linux-io-uring-sqpoll-tuning",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "Linux Kernel Docs (kernel.org)",
  "integration_target": "Tokio Core / Engine",
