...
description: "Use this skill when designing or evaluating a Health Cloud implementation to determine\
  \ whether the org serves a payer (health insurer), a provider (care delivery organization),\
  \ or both \u2014 and to derive the correct object model, PSL matrix, and feature\
  \ activation. Triggers: 'should we use MemberPlan or ClinicalEncounter', 'payer\
  \ vs provider Health Cloud', 'which Health Cloud objects does an insurer use', 'setting\
  \ up a Health Cloud org for a hospital vs a health plan', 'Provider Relationship\
  \ Management vs clinical provider'. NOT for an insurance carrier on FSC Insurance\
  \ Cloud \u2014 policy admin, claims, underwriting \u2014 use architect/insurance-cloud-architecture.\
  \ NOT for the Health Cloud object and field definitions themselves \u2014 use data/health-cloud-data-model."
---
