---
name: maxcompute-memory
description: Use when recording, recalling, listing, showing, removing, clearing, or running reindex
  for verified/failed SQL and domain notes.
...
---
# mcs memory workflow
