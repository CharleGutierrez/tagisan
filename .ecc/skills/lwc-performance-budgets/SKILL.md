...
description: "Set and enforce performance budgets for Lightning Web Components: bundle-size limits\
  \ per component, LCP/INP field targets, wire-adapter count caps, and CI-gate configuration\
  \ using Lighthouse or webpagetest. Trigger keywords: lwc performance budget, bundle\
  \ size limit, lcp budget, lighthouse ci, lwc size gate. NOT for runtime optimization\
  \ techniques, Lightning page tuning, or general LCP causes \u2014 use lwc/lwc-performance."
---
