---
name: swarm-pilot-lookahead-prefetcher
description: "1-step lookahead skill and AST context prefetching based on planned subagent steps"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "Colibrì MoE / PILOT Engine"
tags:
  - colibrì
  - consensus
  - debate
...
triggers:
  ...
  - "lookahead"
  - "moa"
  - "swarm pilot lookahead prefetcher"
  - "swarm-pilot-lookahead-prefetcher"
  - "swarm-pilot-lookahead-prefetcher execute"
  - "swarm-pilot-lookahead-prefetcher verify"
---

# Swarm Pilot Lookahead Prefetcher Skill

The `swarm-pilot-lookahead-prefetcher` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Colibrì MoE / PILOT Engine** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `PILOT JIT Engine`.
...
```json
{
  "skill": "swarm-pilot-lookahead-prefetcher",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Colibrì MoE / PILOT Engine",
