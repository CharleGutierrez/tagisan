---
name: glama-docker-daemon
description: "Docker container lifecycle management, image building, and isolated runs"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-docker-daemon"
  - "glama-docker-daemon execute"
  - "glama-docker-daemon verify"
  - "mcp"
---

# Glama Docker Daemon Skill

The `glama-docker-daemon` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
