...
description: "Use when uploading, downloading, managing, or integrating files and documents with\
  \ Salesforce \u2014 covering ContentVersion/ContentDocument, REST multipart uploads,\
  \ base64 inserts, Files Connect for external storage. NOT for Bulk API data loads,\
  \ Chatter feed post content, email attachment handling via Em \u2014 use security/file-upload-virus-scanning."
---
