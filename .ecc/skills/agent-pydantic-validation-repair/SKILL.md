---
name: agent-pydantic-validation-repair
description: "Automated re-prompting with validation error diagnostics when outputs violate schemas"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent pydantic validation repair"
  - "agent-pydantic-validation-repair"
  - "agent-pydantic-validation-repair execute"
  - "agent-pydantic-validation-repair verify"
  - "consensus"
  - "debate"
  - "moa"
  - "multi-agent"
...
# Agent Pydantic Validation Repair Skill

The `agent-pydantic-validation-repair` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Pydantic Documentation** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Self-Healing Output`.
...
- **Subsystem Binding**: `Self-Healing Output`
...
```json
{
  "skill": "agent-pydantic-validation-repair",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "Pydantic Documentation",
  "integration_target": "Self-Healing Output",
