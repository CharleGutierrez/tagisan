---
name: composio-zendesk-support
description: "Zendesk customer ticket creation, priority escalation, and macro replies"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio zendesk support"
  - "composio-dev"
  - "composio-zendesk-support"
  - "composio-zendesk-support execute"
  - "composio-zendesk-support verify"
  - "enterprise"
  - "saas"
---

# Composio Zendesk Support Skill

The `composio-zendesk-support` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-zendesk-support",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
