...
description: "Service-specific AI features in Service Cloud: Case Classification setup and optimization,\
  \ Article Recommendations configuration, Reply Recommendations, Work Summary (After-Visit\
  \ Summary), Service Replies with Einstein, Auto-Routing, and Einstein Conversation\
  \ Mining. NOT for the license, entitlement and data-threshold check before first\
  \ enablement \u2014 use agentforce/agentforce-service-ai-setup. NOT for building\
  \ an Agentforce agent \u2014 use agentforce/agentforce-agent-creation. NOT for its\
  \ topic boundary design \u2014 use agentforce/agent-topic-design."
---
