...
description: "Decide Shadow DOM vs Light DOM for an LWC \u2014 Salesforce distribution rules, Locker/LWS,\
  \ third-party library needs. Triggers: shadow vs light DOM, renderMode decision.\
  \ NOT for implementing Light DOM after the decision \u2014 use lwc/lwc-light-dom."
---
