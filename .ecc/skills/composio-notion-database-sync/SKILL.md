---
name: composio-notion-database-sync
description: "Notion database schema sync, property rollups, and linked relations"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio notion database sync"
  - "composio-dev"
  - "composio-notion-database-sync"
  - "composio-notion-database-sync execute"
  - "composio-notion-database-sync verify"
  - "database"
  - "enterprise"
---

# Composio Notion Database Sync Skill

The `composio-notion-database-sync` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-notion-database-sync",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
