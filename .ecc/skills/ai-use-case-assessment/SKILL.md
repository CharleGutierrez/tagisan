...
description: "Identify, score, and prioritize Salesforce AI use cases before any implementation\
  \ begins \u2014 opportunity identification, Impact-Effort matrix scoring, feasibility\
  \ evaluation across Technical/Operational/Data/Risk dimensions, and ROI framing.\
  \ NOT for the license checks and enablement steps once a use case is approved \u2014\
  \ use agentforce/agentforce-service-ai-setup or agentforce/agentforce-sales-ai-setup.\
  \ NOT for making the data model AI-ready \u2014 use architect/ai-ready-data-architecture."
---
