...
description: "Use when designing or validating the end-to-end quote-to-cash process on standard\
  \ Salesforce: Opportunity to Quote to Synced Quote to Approval Process to Quote\
  \ PDF to Order creation. Trigger keywords: quote approval, discount policy, quote\
  \ PDF limits, order from quote, quote sync, quote template. NOT for CPQ pricing\
  \ rules or discount schedules \u2014 use admin/cpq-pricing-rules. NOT for building\
  \ the quote template itself \u2014 use admin/quotes-and-quote-templates."
---
