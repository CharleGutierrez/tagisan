---
name: smt-z3-craig-interpolation
description: "Craig interpolant extraction from unsatisfiability proofs to synthesize loop invariants"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "interpolation"
  - "smt z3 craig interpolation"
  - "smt-z3-craig-interpolation"
  - "smt-z3-craig-interpolation execute"
  - "smt-z3-craig-interpolation verify"
---

# Smt Z3 Craig Interpolation Skill

The `smt-z3-craig-interpolation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SMT-LIB / Z3 Project** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `Formal Invariant Prover`.
...
```json
{
  "skill": "smt-z3-craig-interpolation",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "SMT-LIB / Z3 Project",
