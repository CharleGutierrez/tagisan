...
description: "FlexCard actions, conditional visibility, and state across navigation, refresh, and\
  \ parent/child transitions. Triggers: flexcard state, flexcard actions, flexcard\
  \ refresh. NOT for FlexCard layout/design \u2014 use omnistudio/flexcard-design-patterns.\
  \ NOT for admin requirements \u2014 use admin/flexcard-requirements."
---
