---
name: composio-hubspot-marketing
description: "HubSpot contact management, deal stages, and email campaign analytics"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio hubspot marketing"
  - "composio-dev"
  - "composio-hubspot-marketing"
  - "composio-hubspot-marketing execute"
  - "composio-hubspot-marketing verify"
  - "enterprise"
  - "hubspot"
---

# Composio Hubspot Marketing Skill

The `composio-hubspot-marketing` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-hubspot-marketing",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
