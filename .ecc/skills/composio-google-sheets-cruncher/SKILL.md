---
name: composio-google-sheets-cruncher
description: "Google Sheets formula recalculation, range appending, and CSV exports"
version: 1.0.0
...
triggers:
  - "api-orchestration"
  - "composio"
  - "composio google sheets cruncher"
  - "composio-dev"
  - "composio-google-sheets-cruncher"
  - "composio-google-sheets-cruncher execute"
  - "composio-google-sheets-cruncher verify"
  - "cruncher"
  - "enterprise"
---

# Composio Google Sheets Cruncher Skill

The `composio-google-sheets-cruncher` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / MCP Connector`.
...
```json
{
  "skill": "composio-google-sheets-cruncher",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
