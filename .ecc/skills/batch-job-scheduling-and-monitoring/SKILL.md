...
description: "Use when monitoring, diagnosing, or managing Batch Apex, Scheduled Apex, Queueable,\
  \ and Flow scheduled jobs: Setup > Apex Jobs, AsyncApexJob queries, concurrent limits,\
  \ failure detection, and notification patterns. NOT for writing the Batch or Schedulable\
  \ class itself \u2014 use apex/batch-apex-patterns or apex/apex-scheduled-jobs.\
  \ NOT for BatchApexErrorEvent alerting in code \u2014 use apex/scheduled-apex-failure-detection-and-monitoring."
---
