---
name: composio-hashicorp-vault-approle
description: "HashiCorp Vault AppRole authentication and dynamic DB credential lease"
version: 1.0.0
...
triggers:
  ...
  - "approle"
  - "composio"
  - "composio hashicorp vault approle"
  - "composio-dev"
  - "composio-hashicorp-vault-approle"
  - "composio-hashicorp-vault-approle execute"
  - "composio-hashicorp-vault-approle verify"
  - "enterprise"
---

# Composio Hashicorp Vault Approle Skill

The `composio-hashicorp-vault-approle` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / AgentShield`.
...
- **Subsystem Binding**: `ToolRegistry / AgentShield`
...
```json
{
  "skill": "composio-hashicorp-vault-approle",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
  "integration_target": "ToolRegistry / AgentShield",
