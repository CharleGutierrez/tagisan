...
description: "Use this skill when designing or troubleshooting the data pipeline strategy for connecting\
  \ source systems to Data Cloud \u2014 including ingestion API pattern selection\
  \ (streaming vs. batch), connector type decisions. NOT for standard Salesforce integration\
  \ patterns (use integration-patterns skill), not f \u2014 use data/data-cloud-data-streams."
---
