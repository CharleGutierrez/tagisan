---
name: smithery-cloudflare-kv
description: "Ultra-low-latency distributed key-value storage across global edge pops"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery cloudflare kv"
  - "smithery-ai"
  - "smithery-cloudflare-kv"
  - "smithery-cloudflare-kv execute"
  - "smithery-cloudflare-kv verify"
---

# Smithery Cloudflare Kv Skill

The `smithery-cloudflare-kv` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
