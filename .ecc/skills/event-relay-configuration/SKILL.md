...
description: "Use when forwarding Salesforce Platform Events or Change Data Capture to AWS EventBridge\
  \ via Event Relay. Covers Named Credential + Connection setup, channel selection,\
  \ event filter design, replay handling. NOT for consuming external events in Salesforce\
