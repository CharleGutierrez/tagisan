---
name: posix-pthread-affinity-pinning
description: "Real-time thread affinity setting to dedicated performance cores (P-cores)"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "performance"
  - "posix pthread affinity pinning"
  - "posix-pthread-affinity-pinning"
  - "posix-pthread-affinity-pinning execute"
  - "posix-pthread-affinity-pinning verify"
---

# Posix Pthread Affinity Pinning Skill

The `posix-pthread-affinity-pinning` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **POSIX IEEE 1003.1** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Tokio Swarm / Engine`.
...
- **Subsystem Binding**: `Tokio Swarm / Engine`
...
```json
{
  "skill": "posix-pthread-affinity-pinning",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "POSIX IEEE 1003.1",
  "integration_target": "Tokio Swarm / Engine",
