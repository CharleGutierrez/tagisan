...
description: "Use when setting up real-time data streaming from Salesforce to external systems\
  \ using the Streaming API (PushTopic, Generic Streaming), CometD client configuration,\
  \ replay, and channel management. NOT for Platform Events \u2014 use apex/platform-events-apex\
  \ or integration/platform-events-integration."
---
