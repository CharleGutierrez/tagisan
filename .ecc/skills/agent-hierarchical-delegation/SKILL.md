---
name: agent-hierarchical-delegation
description: "Supervisor agent coordinating specialist worker agents with role-scoped tools"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "CrewAI / AutoGen Specs"
tags:
  - agent
  - consensus
  - crewai
...
triggers:
  ...
  - "agent-hierarchical-delegation"
  - "agent-hierarchical-delegation execute"
  - "agent-hierarchical-delegation verify"
  - "consensus"
  - "crewai"
  - "debate"
  - "delegation"
...
# Agent Hierarchical Delegation Skill

The `agent-hierarchical-delegation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **CrewAI / AutoGen Specs** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Swarm Coordinator`.
...
- **Subsystem Binding**: `Swarm Coordinator`
...
```json
{
  "skill": "agent-hierarchical-delegation",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "CrewAI / AutoGen Specs",
  "integration_target": "Swarm Coordinator",
