---
name: bun-native-microservice-serve
description: "Bun.serve HTTP server implementation with WebSocket upgrades and TLS"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Bun Documentation (bun.sh)"
tags:
  - bun
  - frontend
  - full-stack
...
triggers:
  - "bun"
  - "bun native microservice serve"
  - "bun-native-microservice-serve"
  - "bun-native-microservice-serve execute"
  - "bun-native-microservice-serve verify"
  - "frontend"
  - "full-stack"
  - "microservice"
  - "native"
...
# Bun Native Microservice Serve Skill

The `bun-native-microservice-serve` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Bun Documentation (bun.sh)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Bun Runtime / Polyglot`.
...
- **Subsystem Binding**: `Bun Runtime / Polyglot`
...
```json
{
  "skill": "bun-native-microservice-serve",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Bun Documentation (bun.sh)",
  "integration_target": "Bun Runtime / Polyglot",
