...
description: "Use this skill when implementing clinical decision support in Health Cloud: creating\
  \ ClinicalAlert records via Apex or Flow, ingesting CareGap records from external\
  \ clinical rules engines, displaying CDS alerts in FlexCard UIs, and integrating\
  \ the Business Rules Engine for custom protocol checks. NOT for care plan lifecycle\
  \ Apex hooks \u2014 use apex/health-cloud-apex-extensions. NOT for FHIR ingestion\
  \ \u2014 use apex/fhir-integration-patterns."
---
