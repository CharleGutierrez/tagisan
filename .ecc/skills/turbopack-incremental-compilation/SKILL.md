---
name: turbopack-incremental-compilation
description: "Function-level caching and incremental compilation for lightning-fast HMR"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Next.js / Turbopack Docs"
tags:
  - bun
  - compilation
  - frontend
...
triggers:
  ...
  - "turbopack-incremental-compilation"
  - "turbopack-incremental-compilation execute"
  - "turbopack-incremental-compilation verify"
---

# Turbopack Incremental Compilation Skill

The `turbopack-incremental-compilation` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Next.js / Turbopack Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Developer Experience`.
...
```json
{
  "skill": "turbopack-incremental-compilation",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Next.js / Turbopack Docs",
