---
name: spdk-nvme-pcie-direct-io
description: "Userspace polled-mode NVMe driver over PCIe bypassing OS kernel overhead"
version: 1.0.0
...
triggers:
  ...
  - "low-level"
  - "nvme"
  - "spdk nvme pcie direct io"
  - "spdk-nvme-pcie-direct-io"
  - "spdk-nvme-pcie-direct-io execute"
  - "spdk-nvme-pcie-direct-io verify"
---

# Spdk Nvme Pcie Direct Io Skill

The `spdk-nvme-pcie-direct-io` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **SPDK.io** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Native Rust / Colibri Storage`.
...
- **Subsystem Binding**: `Native Rust / Colibri Storage`
...
```json
{
  "skill": "spdk-nvme-pcie-direct-io",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "SPDK.io",
  "integration_target": "Native Rust / Colibri Storage",
