---
name: composio-1password-secrets
description: "1Password service account secret retrieval and automated credential injection"
version: 1.0.0
...
triggers:
  ...
  - "api-orchestration"
  - "composio"
  - "composio 1password secrets"
  - "composio-1password-secrets"
  - "composio-1password-secrets execute"
  - "composio-1password-secrets verify"
  - "composio-dev"
  - "enterprise"
---

# Composio 1password Secrets Skill

The `composio-1password-secrets` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / AgentShield`.
...
```json
{
  "skill": "composio-1password-secrets",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
