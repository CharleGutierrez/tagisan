...
description: "Use when designing or reviewing SCIM-based user lifecycle provisioning into Salesforce\
  \ from Okta, Azure AD / Entra, or another IdP \u2014 create/update/deactivate, group-to-permission-set\
  \ mapping, attribute mapping, and deprovisioning semantics. NOT for SSO/authentication\
  \ setup (see single-sign-on skills) \u2014 use integration/manufacturing-cloud-setup."
---
