...
description: "Call Apex methods imperatively from LWC \u2014 on button click, lifecycle hooks,\
  \ or conditional logic. Covers import syntax, cacheable vs non-cacheable, async/await\
  \ patterns, error handling, loading states, and Promise.all. NOT for reactive @wire\
  \ reads \u2014 use lwc/wire-service-patterns. NOT for mocking the call in a Jest\
  \ test \u2014 use lwc/lwc-testing."
---
# LWC Imperative Apex
