...
description: "Use this skill when configuring Salesforce Net Zero Cloud \u2014 Scope 1/2/3 emission\
  \ source modeling via the StnryAssetCrbnFtprnt / VehicleAssetCrbnFtprnt / Scope3CrbnFtprnt\
  \ object families, emission factor library setup (EmssnFctr / EmssnFctrSet), DPE-driven\
  \ carbon calculation jobs, supplier engagement scoring, and CSRD / ESRS / TCFD disclosure\
  \ pack mapping. Triggers on: Net Zero Cloud setup, Sustainability Cloud carbon accounting,\
  \ Scope 1 2 3 emissions Salesforce, emission factor library, supplier engagement\
  \ Net Zero, ESG disclosure pack mapping. NOT for running the ESRS / CSRD / SASB\
  \ / GRI / CDP report builders or the double-materiality assessment that produces\
  \ the actual disclosure \u2014 use integration/sustainability-reporting."
---
