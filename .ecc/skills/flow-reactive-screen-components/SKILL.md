...
description: "Build reactive Flow screens where one component updates another without navigation\
  \ using reactive formulas and component outputs. NOT for Aura-based screens \u2014\
  \ use flow/flow-screen-input-validation-patterns."
---
