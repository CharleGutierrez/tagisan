---
name: sigma-rule-powershell-download-cradle
description: "Detecting Net.WebClient, Invoke-Expression (IEX), and encoded PowerShell execution"
version: 1.0.0
...
triggers:
  ...
  - "sigma-rule-powershell-download-cradle"
  - "sigma-rule-powershell-download-cradle execute"
  - "sigma-rule-powershell-download-cradle verify"
---

# Sigma Rule Powershell Download Cradle Skill

The `sigma-rule-powershell-download-cradle` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Sigma Rules Project** (Tier 7: Cybersecurity, EDR & Nation-State APT Defense). It integrates directly into `AgentShield / Windows`.
...
- **Subsystem Binding**: `AgentShield / Windows`
...
```json
{
  "skill": "sigma-rule-powershell-download-cradle",
  "tier": "Tier 7: Cybersecurity, EDR & Nation-State APT Defense",
  "source": "Sigma Rules Project",
  "integration_target": "AgentShield / Windows",
