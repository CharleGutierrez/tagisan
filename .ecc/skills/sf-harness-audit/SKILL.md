...
description: Use when auditing SCC harness for Salesforce development completeness. Check hooks,
  agents, skills, and rules health for Apex and LWC coverage, and score each category.
...
---
