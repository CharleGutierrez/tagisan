...
description: "Use this skill when configuring multiple identity providers (OIDC and/or SAML) on\
  \ a single Experience Cloud site or across tenant-specific portals in the same org\
  \ \u2014 covering auth provider registration, Start SSO URL routing, Federation.\
  \ NOT for internal Salesforce employee SSO configuration \u2014 use architect/experience-cloud-integration-patterns."
---
