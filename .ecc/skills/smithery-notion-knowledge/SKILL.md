---
name: smithery-notion-knowledge
description: "Workspace document querying, block extraction, and knowledge sync"
version: 1.0.0
...
triggers:
  ...
  - "notion"
  - "smithery"
  - "smithery notion knowledge"
  - "smithery-notion-knowledge"
  - "smithery-notion-knowledge execute"
  - "smithery-notion-knowledge verify"
---

# Smithery Notion Knowledge Skill

The `smithery-notion-knowledge` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-notion-knowledge",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
