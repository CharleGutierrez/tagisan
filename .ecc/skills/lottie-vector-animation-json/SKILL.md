---
name: lottie-vector-animation-json
description: "Lightweight vector animations rendered to SVG/Canvas based on operational status"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "LottieFiles Documentation"
tags:
  - animation
  - bun
  - frontend
...
triggers:
  ...
  - "full-stack"
  - "json"
  - "lottie vector animation json"
  - "lottie-vector-animation-json"
  - "lottie-vector-animation-json execute"
  - "lottie-vector-animation-json verify"
---

# Lottie Vector Animation Json Skill

The `lottie-vector-animation-json` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LottieFiles Documentation** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `NotificationHub`.
...
- **Subsystem Binding**: `NotificationHub`
...
```json
{
  "skill": "lottie-vector-animation-json",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "LottieFiles Documentation",
  "integration_target": "NotificationHub",
