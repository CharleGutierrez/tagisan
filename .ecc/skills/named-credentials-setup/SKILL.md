...
description: "Named Credentials and External Credentials configuration for secure outbound callouts:\
  \ per-user vs per-org authentication, legacy vs enhanced Named Credentials, external\
  \ credential principal types (Named Principal, Per User, Anonymous), OAuth 2.0 and\
  \ JWT flows, and credential deployment. NOT for the Apex callout code \u2014 use\
  \ apex/apex-named-credentials-patterns. NOT for connected app setup \u2014 use admin/connected-apps-and-auth."
---
