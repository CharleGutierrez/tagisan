...
description: "Use this skill for Salesforce Order Management (OMS) tasks: order lifecycle, OrderSummary\
  \ creation and status, FulfillmentOrder creation and routing, returns, exchanges,\
  \ cancellations, and platform event subscriptions. Trigger keywords: order management,\
  \ OrderSummary, FulfillmentOrder, ReturnOrder, ensure-funds, ensure-refunds, submit-cancel,\
  \ submit-return, adjust-item-submit. NOT for split-order routing or Omnichannel\
  \ Inventory design \u2014 use architect/order-management-architecture. NOT for loading\
  \ historical orders \u2014 use data/commerce-order-history-migration."
---
