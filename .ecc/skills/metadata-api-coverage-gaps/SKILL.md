...
description: "Use this skill when a deployment, source push, or package version fails because a\
  \ metadata type is unsupported, partially supported, or behaves differently across\
  \ Metadata API, source tracking, unlocked packages, and 2GP managed packages. NOT\
  \ for deployment error troubleshooting, Metadata API tutorials, or dependency mapping\
  \ \u2014 use devops/deployment-error-diagnosis."
---
