...
description: "Use when DataRaptor Transform operations are slow, hit governor limits, or use Apex\
  \ where formula fields would suffice. Covers formula vs Apex expressions, bulk transform\
  \ sizing, and chained transform composition. Triggers: 'dataraptor transform slow'.\
  \ NOT for DataRaptor Extract or Load performance \u2014 use omnistudio/dataraptor-patterns."
---
