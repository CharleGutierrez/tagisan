---
name: cmdk-command-palette-interface
description: "Fast, composable, unstyled command palette primitive with keyboard navigation"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Paco Coursey cmdk Docs"
tags:
  - bun
  - cmdk
  - command
...
triggers:
  ...
  - "cmdk-command-palette-interface"
  - "cmdk-command-palette-interface execute"
  - "cmdk-command-palette-interface verify"
  - "command"
  - "frontend"
  - "full-stack"
---

# Cmdk Command Palette Interface Skill

The `cmdk-command-palette-interface` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Paco Coursey cmdk Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `TGS CLI / TUI`.
...
```json
{
  "skill": "cmdk-command-palette-interface",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Paco Coursey cmdk Docs",
  "integration_target": "TGS CLI / TUI",
