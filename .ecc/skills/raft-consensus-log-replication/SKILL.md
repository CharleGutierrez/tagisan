...
description: "Raft state machine leader election, log replication, and commit index safety"
version: 1.0.0
tier: "Tier 9: Distributed Systems, Telemetry & SRE Resiliency"
source: "USENIX ATC Paper (Ongaro & Ousterhout)"
tags:
  - consensus
  - distributed
  - log
...
triggers:
  ...
  - "raft-consensus-log-replication"
  - "raft-consensus-log-replication execute"
  - "raft-consensus-log-replication verify"
---

# Raft Consensus Log Replication Skill

The `raft-consensus-log-replication` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **USENIX ATC Paper (Ongaro & Ousterhout)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `P2P Cluster Mesh`.
...
```json
{
  "skill": "raft-consensus-log-replication",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "USENIX ATC Paper (Ongaro & Ousterhout)",
