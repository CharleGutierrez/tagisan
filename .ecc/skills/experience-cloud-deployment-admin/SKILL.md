...
description: "Deploying an Experience Cloud site (formerly Community) between Salesforce orgs or\
  \ sandboxes: metadata ordering, ExperienceBundle enablement, post-deployment publishing,\
  \ change-set or SFDX-based migration. NOT for automating the deploy in a CI/CD pipeline,\
  \ or LWR DigitalExperienceBundle \u2014 use devops/experience-cloud-deployment-dev.\
  \ NOT for building the site in Experience Builder \u2014 use admin/experience-cloud-site-setup."
---
