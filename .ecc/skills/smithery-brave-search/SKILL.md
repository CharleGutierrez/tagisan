...
description: "Independent web search and news indexing with zero tracking"
version: 1.0.0
...
triggers:
  ...
  - "smithery-brave-search"
  - "smithery-brave-search execute"
  - "smithery-brave-search verify"
---

# Smithery Brave Search Skill

The `smithery-brave-search` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
