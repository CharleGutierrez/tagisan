...
description: "Use this skill when a developer needs to authenticate orgs with sf CLI, set up a\
  \ Salesforce DX project, create scratch orgs, push or pull source, deploy or retrieve\
  \ metadata with package.xml manifests, or diagnose common sf CLI errors. Trigger\
  \ keywords: sf CLI, sfdx, scratch org, source push, source pull, deploy, retrieve,\
  \ package.xml, org login, sf project. NOT for scripting the CLI in CI with --json,\
  \ aliases, and non-interactive auth \u2014 use devops/salesforce-cli-automation."
---
