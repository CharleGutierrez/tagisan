...
description: "Metadata API retrieve/deploy via sf CLI and package.xml: manifest authoring, destructiveChanges,\
  \ deploy options (checkOnly, testLevel, rollbackOnError), CI scripting. NOT for\
  \ what package.xml can hold or deploy-order concepts \u2014 use apex/metadata-api-and-package-xml.\
  \ NOT for a delete that fails on a still-referenced component \u2014 use devops/destructive-changes-deployment."
---
