---
name: agent-plan-and-solve-decomposition
description: "Decomposing multi-step programming tasks into explicit execution subgoals with dependencies"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent plan and solve decomposition"
  - "agent-plan-and-solve-decomposition"
  - "agent-plan-and-solve-decomposition execute"
  - "agent-plan-and-solve-decomposition verify"
  - "arxiv"
  - "consensus"
  - "debate"
  - "decomposition"
...
# Agent Plan And Solve Decomposition Skill

The `agent-plan-and-solve-decomposition` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Goal Decomposition`.
...
- **Subsystem Binding**: `Goal Decomposition`
...
```json
{
  "skill": "agent-plan-and-solve-decomposition",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
  "integration_target": "Goal Decomposition",
