---
name: quant-awq-4bit-gemm-fused
description: "Activation-aware Weight Quantization 4-bit matrix multiplication with FP16 scale"
version: 1.0.0
tier: "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration"
source: "AutoAWQ Project Docs"
tags:
  - 4bit
  - ai
  - autoawq
...
triggers:
  ...
  - "awq"
  - "cuda"
  - "quant awq 4bit gemm fused"
  - "quant-awq-4bit-gemm-fused"
  - "quant-awq-4bit-gemm-fused execute"
  - "quant-awq-4bit-gemm-fused verify"
---

# Quant Awq 4bit Gemm Fused Skill

The `quant-awq-4bit-gemm-fused` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **AutoAWQ Project Docs** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Quant`.
...
```json
{
  "skill": "quant-awq-4bit-gemm-fused",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "AutoAWQ Project Docs",
