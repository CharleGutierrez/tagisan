---
name: pypi-mcp-server-opencv-vision
description: "Computer vision image filtering, edge detection, and feature matching"
version: 1.0.0
...
triggers:
  ...
  - "opencv"
  - "pypi"
  - "pypi mcp server opencv vision"
  - "pypi-mcp-server-opencv-vision"
  - "pypi-mcp-server-opencv-vision execute"
  - "pypi-mcp-server-opencv-vision verify"
  - "server"
---

# Pypi Mcp Server Opencv Vision Skill

The `pypi-mcp-server-opencv-vision` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-opencv-vision",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
