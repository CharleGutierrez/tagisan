...
description: "Configuring and running Pipeline Inspection in Sales Cloud: enabling the feature,\
  \ mapping forecast categories into the inspection view, Days in Stage and other\
  \ deal-change metrics, and pipeline review cadence for sales managers. Use when\
  \ designing or improving how a team monitors deal health and pipeline movement.\
  \ NOT for the Revenue Intelligence app, Einstein deal insights, or forecast-accuracy\
  \ dashboards \u2014 use admin/revenue-intelligence-setup. NOT for forecast types,\
  \ quotas, or forecast hierarchy setup \u2014 use admin/collaborative-forecasts."
---
