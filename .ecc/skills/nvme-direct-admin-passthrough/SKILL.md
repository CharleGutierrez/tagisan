---
name: nvme-direct-admin-passthrough
description: "Raw NVMe Command Set administration submission via /dev/nvme0 passthrough"
version: 1.0.0
...
triggers:
  ...
  - "kernel"
  - "low-level"
  - "nvme direct admin passthrough"
  - "nvme-direct-admin-passthrough"
  - "nvme-direct-admin-passthrough execute"
  - "nvme-direct-admin-passthrough verify"
---

# Nvme Direct Admin Passthrough Skill

The `nvme-direct-admin-passthrough` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NVM Express Specification** (Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration). It integrates directly into `Storage / SPDK`.
...
- **Subsystem Binding**: `Storage / SPDK`
...
```json
{
  "skill": "nvme-direct-admin-passthrough",
  "tier": "Tier 3: Low-Level Systems, Linux Kernel & Hardware Acceleration",
  "source": "NVM Express Specification",
  "integration_target": "Storage / SPDK",
