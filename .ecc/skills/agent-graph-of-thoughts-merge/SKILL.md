---
name: agent-graph-of-thoughts-merge
description: "Non-linear graph representation enabling synergistic combination of divergent reasoning paths"
version: 1.0.0
...
triggers:
  - "agent"
  - "agent graph of thoughts merge"
  - "agent-graph-of-thoughts-merge"
  - "agent-graph-of-thoughts-merge execute"
  - "agent-graph-of-thoughts-merge verify"
  - "arxiv"
  - "consensus"
  - "debate"
  - "graph"
...
# Agent Graph Of Thoughts Merge Skill

The `agent-graph-of-thoughts-merge` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `Cognitive Engine`.
...
```json
{
  "skill": "agent-graph-of-thoughts-merge",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "ArXiv AI Research",
