---
name: pypi-mcp-server-whisper-transcribe
description: "Local audio transcription and timestamped speech-to-text synthesis"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "pypi"
  - "pypi mcp server whisper transcribe"
  - "pypi-mcp-server-whisper-transcribe"
  - "pypi-mcp-server-whisper-transcribe execute"
  - "pypi-mcp-server-whisper-transcribe verify"
  - "server"
  - "tools"
---

# Pypi Mcp Server Whisper Transcribe Skill

The `pypi-mcp-server-whisper-transcribe` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **PyPI** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "pypi-mcp-server-whisper-transcribe",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "PyPI",
