---
name: glama-resend-email
description: "Transactional email delivery, template rendering, and delivery status tracking"
version: 1.0.0
...
triggers:
  ...
  - "glama-ai"
  - "glama-resend-email"
  - "glama-resend-email execute"
  - "glama-resend-email verify"
  - "mcp"
  - "model-context-protocol"
---

# Glama Resend Email Skill

The `glama-resend-email` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Glama.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
