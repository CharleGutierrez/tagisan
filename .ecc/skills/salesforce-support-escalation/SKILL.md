...
description: 'Open, classify, and escalate support cases with Salesforce Technical Support via
  the Help portal: choosing severity, engaging Premier Success, the Escalate to Technical
  Support Management path, tracking incidents on the Trust site. NOT for escalating
  your own org''s cases after N hours - use admin/escalation-rules. NOT for SLA milestone
  timers and entitlement processes - use admin/entitlements-and-milestones.'
---
