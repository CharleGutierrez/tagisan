---
name: w3c-webgl2-geometry-rendering
description: "WebGL2 vertex/fragment shaders and framebuffers for interactive data canvas"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "W3C WebGL Specification"
tags:
  - bun
  - frontend
  - full-stack
...
triggers:
  ...
  - "geometry"
  - "rendering"
  - "w3c webgl2 geometry rendering"
  - "w3c-webgl2-geometry-rendering"
  - "w3c-webgl2-geometry-rendering execute"
  - "w3c-webgl2-geometry-rendering verify"
---

# W3c Webgl2 Geometry Rendering Skill

The `w3c-webgl2-geometry-rendering` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **W3C WebGL Specification** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Data Visualization`.
...
- **Subsystem Binding**: `Data Visualization`
...
```json
{
  "skill": "w3c-webgl2-geometry-rendering",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "W3C WebGL Specification",
  "integration_target": "Data Visualization",
