...
description: "Use when configuring reCAPTCHA on Web-to-Case, Web-to-Lead, Experience Cloud forms,\
  \ or Headless Identity flows, or when designing bot-mitigation strategies for Salesforce\
  \ public-facing surfaces. Triggers: 'enable reCAPTCHA on Web-to-Case'. NOT for AppExchange\
  \ security review or session-level login policies \u2014 use security/session-management-and-timeout."
---
