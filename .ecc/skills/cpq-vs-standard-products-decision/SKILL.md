...
description: "Use when deciding whether to implement Salesforce CPQ or stay with standard Products\
  \ and Pricebooks for quoting and pricing. Triggers: 'should we buy CPQ or use standard\
  \ pricebooks', 'is CPQ worth the cost for our quoting process', 'product bundling\
  \ without CPQ', 'guided selling vs manual product selection', 'complex pricing rules\
  \ or multi-dimensional discounting'. NOT for designing bundles, the pricing waterfall\
  \ or QCP once CPQ is chosen \u2014 use architect/cpq-architecture-patterns. NOT\
  \ for picking a CPQ pricing method for a product \u2014 use admin/pricing-model-design.\
  \ NOT for Revenue Cloud / RLM as the alternative to CPQ \u2014 use architect/revenue-cloud-architecture."
---
