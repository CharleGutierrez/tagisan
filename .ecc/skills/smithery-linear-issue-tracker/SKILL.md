---
name: smithery-linear-issue-tracker
description: "Issue lifecycle management, sprint cycle triage, and roadmap linking"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "smithery"
  - "smithery linear issue tracker"
  - "smithery-linear-issue-tracker"
  - "smithery-linear-issue-tracker execute"
  - "smithery-linear-issue-tracker verify"
---

# Smithery Linear Issue Tracker Skill

The `smithery-linear-issue-tracker` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Smithery.ai** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "smithery-linear-issue-tracker",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "Smithery.ai",
