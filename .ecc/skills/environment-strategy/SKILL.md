...
description: "Use when designing the full environment topology for a Salesforce program \u2014\
  \ selecting which org types to provision, how many, and how they map to your branching\
  \ strategy and release pipeline. Trigger keywords: 'environment strategy', 'org\
  \ topology', 'scratch org vs sandbox', 'how many environments do I need', 'environment\
  \ planning', 'DevOps environment design'. NOT for sandbox-type-only decisions (use\
  \ admin/sandbox-strategy), NOT for scratch org lifecycle or daily usage (use devops/scratch-org-management),\
  \ NOT for release pipeline mechanics (use devops/release-management)."
---
