...
description: "Alibaba Cloud OpenAPI troubleshooting skill. Use this skill when the user needs to\
  \ diagnose API call failures using Request ID, error codes, or error messages \u2014\
  \ via Aliyun CLI `openapiexplorer` plugin commands. Triggers: \"RequestId \u6392\
  \u67E5\", \"Request ID \u8BCA\u65AD\", \"\u9519\u8BEF\u7801\u89E3\u51B3\u65B9\u6848\
  \", \"API \u8C03\u7528\u5931\u8D25\", \"get-request-log\", \"get-own-request-log\"\
  , \"get-error-code-solutions\", \"OpenAPI \u6545\u969C\u6392\u67E5\", \"API troubleshoot\"\
  , \"diagnose OpenAPI\", \"diagnose OpenAPI error codes\", \"diagnose OpenAPI error\
  \ messages\", \"Diagnose OpenAPI API call failures using Request ID\"."
---
