...
description: "Use when setting up CMS workspaces, creating or publishing content types for Experience\
  \ Cloud sites, managing content scheduling, or configuring audience targeting on\
  \ content variants. Triggers: 'set up CMS workspace', 'publish content to Experience\
  \ Cloud site', 'content scheduling community', 'audience targeting content', 'managed\
  \ content vs unmanaged', 'custom content type metadata', 'CMS channel configuration'.\
  \ NOT for moderating member-posted content \u2014 use admin/experience-cloud-moderation.\
  \ NOT for Knowledge vs an external CMS or CMS Connect \u2014 use architect/knowledge-vs-external-cms."
---
