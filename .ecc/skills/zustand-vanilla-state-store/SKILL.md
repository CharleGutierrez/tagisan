---
name: zustand-vanilla-state-store
description: "Unopinionated, microscopic state store with transient updates outside React render"
version: 1.0.0
...
triggers:
  ...
  - "state"
  - "store"
  - "zustand vanilla state store"
  - "zustand-vanilla-state-store"
  - "zustand-vanilla-state-store execute"
  - "zustand-vanilla-state-store verify"
---

# Zustand Vanilla State Store Skill

The `zustand-vanilla-state-store` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Zustand Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Web Design & Dev`.
...
```json
{
  "skill": "zustand-vanilla-state-store",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Zustand Docs",
