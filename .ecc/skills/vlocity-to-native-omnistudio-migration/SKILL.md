...
description: "Use when migrating an org from the Vlocity managed package (vlocity_ins, vlocity_cmt,\
  \ vlocity_ps) to native OmniStudio. Trigger keywords: Vlocity to OmniStudio migration,\
  \ namespace migration, vlocity_ins to omnistudio. NOT for greenfield OmniStudio\
  \ setup or migrating between OmniStudio-native orgs \u2014 use omnistudio/omnistudio-deployment-datapacks."
---
