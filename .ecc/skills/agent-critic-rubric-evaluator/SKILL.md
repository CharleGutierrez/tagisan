---
name: agent-critic-rubric-evaluator
description: "Structured evaluation rubrics assessing code security, idiomatic patterns, and performance"
version: 1.0.0
tier: "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture"
source: "LLM-as-a-Judge Literature"
tags:
  - agent
  - consensus
  - critic
...
triggers:
  - "agent"
  - "agent critic rubric evaluator"
  - "agent-critic-rubric-evaluator"
  - "agent-critic-rubric-evaluator execute"
  - "agent-critic-rubric-evaluator verify"
  - "consensus"
  - "critic"
  - "debate"
  - "evaluator"
...
# Agent Critic Rubric Evaluator Skill

The `agent-critic-rubric-evaluator` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **LLM-as-a-Judge Literature** (Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture). It integrates directly into `LLM Judge`.
...
```json
{
  "skill": "agent-critic-rubric-evaluator",
  "tier": "Tier 6: Multi-Agent Swarms, MoA & Cognitive Architecture",
  "source": "LLM-as-a-Judge Literature",
  "integration_target": "LLM Judge",
