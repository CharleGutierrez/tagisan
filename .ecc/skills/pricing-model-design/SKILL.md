...
description: "Use when selecting the right Salesforce CPQ pricing model for a product line \u2014\
  \ the four native Pricing Methods (List, Cost Plus Markup, Block, Percent of Total)\
  \ and Range vs Slab Discount Schedule types \u2014 before any configuration begins.\
  \ Trigger keywords: CPQ pricing method, SBQQ__PricingMethod__c, Cost Plus Markup,\
  \ Block Pricing design, Percent of Total design, discount schedule type, Range vs\
  \ Slab discount, pricing model strategy, which CPQ pricing mechanism to use. NOT\
  \ for configuring Price Rule objects \u2014 use admin/cpq-pricing-rules. NOT for\
  \ pricing without CPQ \u2014 use admin/products-and-pricebooks."
---
