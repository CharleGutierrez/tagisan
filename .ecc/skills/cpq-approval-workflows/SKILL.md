...
description: 'Configuring or troubleshooting Salesforce CPQ Advanced Approvals: SBAA__ApprovalRule__c,
  SBAA__ApprovalVariable__c for cross-line aggregation, SBAA__ApprovalChain__c for
  ordered approver sequences, escalation timeouts, Smart Approvals for re-quote skip
  logic, and the managed package''s permission sets. Trigger keywords: CPQ Advanced
  Approvals, SBAA approval rule, approval variable, approval chain, discount approval,
  line-level approval, Smart Approvals, requote approval. NOT for standard non-CPQ
  Salesforce approval processes - use admin/approval-processes. NOT for CPQ price
  rules and discount schedules - use admin/cpq-pricing-rules.'
---
