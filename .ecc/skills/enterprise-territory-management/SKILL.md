...
description: "Use when configuring or troubleshooting Salesforce Enterprise Territory Management\
  \ (ETM): territory models, territory types, territory hierarchies, account assignment\
  \ rules, opportunity territory assignment, and forecast by territory. Trigger keywords:\
  \ territory model, territory hierarchy, ETM, assign accounts to territories, territory\
  \ forecast, territory activation. NOT for choosing the coverage model first \u2014\
  \ use admin/territory-design-requirements. NOT for role hierarchy \u2014 use admin/sharing-and-visibility."
---
