...
description: "Use this skill when defining AI governance policies, designing human oversight workflows,\
  \ documenting bias mitigation strategies, or meeting regulatory transparency requirements\
  \ for Salesforce AI features. Trigger keywords: responsible AI, AI bias, AI audit\
  \ trail, AI transparency, human-in-the-loop, AI risk inventory, AI disclosure. NOT\
  \ for the MLOps pipeline or Policy-as-Code engine architecture \u2014 use architect/ai-governance-architecture.\
  \ NOT for Trust Layer technical configuration \u2014 use agentforce/einstein-trust-layer."
---
