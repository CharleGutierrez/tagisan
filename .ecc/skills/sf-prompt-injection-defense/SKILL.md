---
name: sf-prompt-injection-defense
description: "Red-team an Agentforce agent against prompt-injection and jailbreak attacks; codify\
  \ adversarial test cases and guardrails, scoped to the agent boundary rather than\
  \ general application-security review. NOT for the overall agent test plan (topic\
  \ coverage, golden sets, regression harness) \u2014 use agentforce/agentforce-testing-strategy.\
  \ NOT for keeping PII out of prompts, model calls and logs \u2014 use agentforce/agentforce-pii-redaction."
---
