---
name: nextjs-shadcn
description: "Creates Next.js frontends with shadcn/ui. Use when building React UIs, components,\
  \ pages, or applications with shadcn, Tailwind, or modern frontend patterns. Also\
  \ use when the user asks to create a new Next.js project, add UI components, style\
  \ pages, or build any web interface \u2014 even if they don't mention shadcn explicitly."
---
# Next.js + shadcn/ui
