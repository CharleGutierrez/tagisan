...
description: "Use when configuring Workflow-based Outbound Messages to push SOAP payloads to external\
  \ endpoints \u2014 endpoint setup, field selection, retry behavior, and delivery\
  \ monitoring. NOT for the listener's session ID callback into Salesforce \u2014\
  \ use integration/outbound-messages-and-callbacks. NOT for JSON webhooks or Flow-triggered\
  \ pushes \u2014 use integration/outbound-webhook-from-salesforce."
---
