---
name: npm-mcp-server-google-maps
description: "Geocoding, route calculation, elevation, and location search queries"
version: 1.0.0
...
triggers:
  ...
  - "model-context-protocol"
  - "npm"
  - "npm mcp server google maps"
  - "npm-mcp-server-google-maps"
  - "npm-mcp-server-google-maps execute"
  - "npm-mcp-server-google-maps verify"
---

# Npm Mcp Server Google Maps Skill

The `npm-mcp-server-google-maps` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **NPM Registry** (Tier 1: Model Context Protocol (MCP) & Web Registries). It integrates directly into `MCP stdio client / ToolRegistry`.
...
```json
{
  "skill": "npm-mcp-server-google-maps",
  "tier": "Tier 1: Model Context Protocol (MCP) & Web Registries",
  "source": "NPM Registry",
