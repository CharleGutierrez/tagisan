...
description: "Alibaba Cloud SLS (Simple Log Service) log query & analysis skill. Use this skill\
  \ to help users write, explain, optimize, execute, or troubleshoot SLS index search,\
  \ SQL analytics, and SPL scan/pipeline statements through the aliyun CLI. Triggers:\
  \ \"SLS \u67E5\u8BE2\", \"SLS \u5206\u6790\", \"\u65E5\u5FD7\u67E5\u8BE2\", \"\u65E5\
  \u5FD7\u5206\u6790\", \"log query\", \"analyze sls logs\", \"aliyun log query\"."
---
