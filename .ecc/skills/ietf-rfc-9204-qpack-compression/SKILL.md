---
name: ietf-rfc-9204-qpack-compression
description: "QPACK header compression for HTTP/3 and QUIC connections reducing transport overhead"
version: 1.0.0
...
triggers:
  ...
  - "distributed"
  - "ietf"
  - "ietf rfc 9204 qpack compression"
  - "ietf-rfc-9204-qpack-compression"
  - "ietf-rfc-9204-qpack-compression execute"
  - "ietf-rfc-9204-qpack-compression verify"
  - "opentelemetry"
---

# Ietf Rfc 9204 Qpack Compression Skill

The `ietf-rfc-9204-qpack-compression` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **IETF RFCs (ietf.org)** (Tier 9: Distributed Systems, Telemetry & SRE Resiliency). It integrates directly into `Networking / Engine`.
...
- **Subsystem Binding**: `Networking / Engine`
...
```json
{
  "skill": "ietf-rfc-9204-qpack-compression",
  "tier": "Tier 9: Distributed Systems, Telemetry & SRE Resiliency",
  "source": "IETF RFCs (ietf.org)",
  "integration_target": "Networking / Engine",
