...
description: "Use when writing, reviewing, or debugging Apex test classes, test data factories,\
  \ async test behavior, negative-path assertions, or callout mocking. Triggers: 'SeeAllData',\
  \ 'Test.startTest', 'HttpCalloutMock', 'test data factory', 'missing assertions'.\
  \ NOT for the factory class itself \u2014 use apex/test-data-factory-patterns. NOT\
  \ for the mock class itself \u2014 use apex/apex-http-callout-mocking."
---
