---
name: composio-aws-iam-identity-center
description: "AWS IAM Identity Center permission set assignment and SSO audits"
version: 1.0.0
...
triggers:
  ...
  - "center"
  - "composio"
  - "composio aws iam identity center"
  - "composio-aws-iam-identity-center"
  - "composio-aws-iam-identity-center execute"
  - "composio-aws-iam-identity-center verify"
  - "composio-dev"
---

# Composio Aws Iam Identity Center Skill

The `composio-aws-iam-identity-center` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Composio.dev** (Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)). It integrates directly into `ToolRegistry / AgentShield`.
...
```json
{
  "skill": "composio-aws-iam-identity-center",
  "tier": "Tier 2: Enterprise Actions & API Orchestration (Composio / Postman / Zapier)",
  "source": "Composio.dev",
