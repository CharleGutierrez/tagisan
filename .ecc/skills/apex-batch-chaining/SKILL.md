...
description: "Use this skill when you need to run one Batch Apex job immediately after another\
  \ completes \u2014 chaining via finish(), managing Flex Queue capacity, or choosing\
  \ between batch-to-batch chaining and a Queueable bridge. NOT for single-job batch\
  \ design or scope sizing \u2014 use apex/batch-apex-patterns. NOT for choosing Batch\
  \ vs Queueable \u2014 use apex/async-apex."
---
# Apex Batch Chaining
