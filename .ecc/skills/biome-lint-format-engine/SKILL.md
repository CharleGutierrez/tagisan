---
name: biome-lint-format-engine
description: "Sub-millisecond Rust-native formatting and linting for JS/TS/JSX codebases"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Biome Project Docs (biomejs.dev)"
tags:
  - biome
  - bun
  - engine
...
triggers:
  - "biome"
  - "biome lint format engine"
  - "biome-lint-format-engine"
  - "biome-lint-format-engine execute"
  - "biome-lint-format-engine verify"
  - "bun"
  - "engine"
  - "format"
  - "frontend"
...
# Biome Lint Format Engine Skill

The `biome-lint-format-engine` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Biome Project Docs (biomejs.dev)** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `Self-Healing Compiler`.
...
```json
{
  "skill": "biome-lint-format-engine",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Biome Project Docs (biomejs.dev)",
