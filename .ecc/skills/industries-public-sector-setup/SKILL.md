...
description: "Public Sector Solutions (PSS) setup: licensing, permits, inspections, benefits, case\
  \ management for government, citizen portals, and grant management. NOT for standard\
  \ Service Cloud cases \u2014 use admin/case-management-setup. NOT for a plain portal\
  \ site \u2014 use admin/experience-cloud-site-setup."
---
