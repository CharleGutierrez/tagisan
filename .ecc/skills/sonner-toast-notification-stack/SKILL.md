---
name: sonner-toast-notification-stack
description: "Customizable stacking toast notifications for asynchronous agent task updates"
version: 1.0.0
tier: "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding"
source: "Emil Kowalski Sonner Docs"
tags:
  - bun
  - emil
  - frontend
...
triggers:
  ...
  - "sonner-toast-notification-stack"
  - "sonner-toast-notification-stack execute"
  - "sonner-toast-notification-stack verify"
---

# Sonner Toast Notification Stack Skill

The `sonner-toast-notification-stack` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **Emil Kowalski Sonner Docs** (Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding). It integrates directly into `NotificationHub`.
...
```json
{
  "skill": "sonner-toast-notification-stack",
  "tier": "Tier 8: Modern Full-Stack, Bun/TS & UI/UX Vibe Coding",
  "source": "Emil Kowalski Sonner Docs",
