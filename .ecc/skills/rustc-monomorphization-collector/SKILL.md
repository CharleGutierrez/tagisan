---
name: rustc-monomorphization-collector
description: "Generic code bloat analysis and monomorphization partition cost audits"
version: 1.0.0
...
triggers:
  ...
  - "formal-methods"
  - "monomorphization"
  - "rustc monomorphization collector"
  - "rustc-monomorphization-collector"
  - "rustc-monomorphization-collector execute"
  - "rustc-monomorphization-collector verify"
---

# Rustc Monomorphization Collector Skill

The `rustc-monomorphization-collector` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **rustc dev guide (doc.rust-lang.org)** (Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning). It integrates directly into `AST Codebase Graph`.
...
```json
{
  "skill": "rustc-monomorphization-collector",
  "tier": "Tier 4: Compiler Engineering, Formal Verification & Symbolic Reasoning",
  "source": "rustc dev guide (doc.rust-lang.org)",
