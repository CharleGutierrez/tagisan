...
description: "Choose and implement LWC communication \u2014 @api, events, LMS, @wire between parent,\
  \ child, sibling, or workspace components. Triggers: 'LWC communication pattern',\
  \ 'should I use LMS or @api', 'three components need to coordinate'. NOT for the\
  \ mechanics of a single child-to-parent CustomEvent \u2014 bubbles / composed /\
  \ cancelable, detail payload, event naming, or an event that is not reaching the\
  \ parent \u2014 use lwc/lwc-custom-event-patterns. NOT for @wire data provisioning\
  \ \u2014 use lwc/wire-service-patterns."
---
