---
name: speculative-decoding-draft-verifier
description: "Draft model lookahead speculative token generation and target model parallel verification"
version: 1.0.0
...
triggers:
  ...
  - "speculative-decoding-draft-verifier"
  - "speculative-decoding-draft-verifier execute"
  - "speculative-decoding-draft-verifier verify"
---

# Speculative Decoding Draft Verifier Skill

The `speculative-decoding-draft-verifier` skill equips Tagisan (`tgs`) autonomous agents and developers with authoritative capabilities sourced from **ArXiv AI Research** (Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration). It integrates directly into `Tensor Engine / Decoder`.
...
```json
{
  "skill": "speculative-decoding-draft-verifier",
  "tier": "Tier 5: Local Tensor Engines, Quantization & GGUF Acceleration",
  "source": "ArXiv AI Research",
