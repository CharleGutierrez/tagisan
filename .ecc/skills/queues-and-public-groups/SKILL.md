...
description: "Use this skill when creating or managing queues, configuring queue membership, setting\
  \ up case or lead queues, creating public groups, or using groups in sharing rules\
  \ and manual sharing. Trigger keywords: queue, public group, queue membership, queue\
  \ email, group sharing, case queue, lead queue. NOT for the rule that decides which\
  \ queue a record lands in \u2014 use admin/assignment-rules. NOT for Omni-Channel\
  \ routing configuration \u2014 use admin/omni-channel-routing-setup."
---
