...
description: "Scripting or automating Experience Cloud site deployment between orgs with the Metadata\
  \ API, sf CLI or CI/CD: ExperienceBundle (Aura sites), DigitalExperienceBundle (enhanced\
  \ LWR sites), the ExperienceBundleSettings prerequisite, CMS content exclusion,\
  \ post-deploy domain/SSO/CDN steps. NOT for the change-set path or a site left unpublished\
  \ \u2014 use devops/experience-cloud-deployment-admin. NOT for writing the site's\
  \ LWC components \u2014 use lwc/experience-cloud-lwc-components."
---
