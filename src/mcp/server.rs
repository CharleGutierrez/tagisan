        ...
        match name {
            ...
            "tagisan_copilot_status" => {
                ...
                let text = format!(
                    ...
                    - **Client ID:** `{}`\n\
                    - **Token Expired:** {}\n\
                    - **Registered Copilot Tools (43):** `copilot_teams_post`, `copilot_sharepoint_get`, `copilot_meeting_action_items`, `copilot_export_report`, `copilot_meeting_to_code`, `copilot_blast_radius_report`, `copilot_debate_dispatch`, `copilot_purview_guard`, `copilot_adr_sync`, `copilot_create_pr`, `copilot_export_deck`, `copilot_excel_functions`, `copilot_stream_gateway`, `copilot_planner_sync`, `copilot_incident_debugger`, `copilot_hardware_telemetry`, `copilot_obo_exchange`, `copilot_subscription_manage`, `copilot_purview_sync`, `copilot_sentinel_audit`, `copilot_certify`, `copilot_cae_handler`, `copilot_jwe_decrypt`, `copilot_graph_batch`, `copilot_delta_sync`, `copilot_universal_action`, `copilot_rms_guard`, `copilot_workload_identity`, `copilot_sharepoint_crawler`, `copilot_airgap_router`, `copilot_loop_sync`, `copilot_ooxml_generator`, `copilot_calendar_preread`, `copilot_outlook_draft`, `copilot_fabric_query`, `copilot_perms_auditor`, `copilot_ado_sync`, `copilot_substrate_ingest`, `copilot_wam_auth`, `copilot_icm_bridge`, `copilot_sdl_audit`, `copilot_studio_packager`, `copilot_viva_sync`\n\
