...
impl ToolRegistry {
    ...
    pub fn with_builtins() -> Self {
        ...
        registry.register_tool(python::PythonInstallTool::new());
        registry.register_tool(python::PythonAutoResolveTool::new());
        ...
        registry.register_tool(crate::copilot::CopilotExcelFunctionsTool::new());
        registry.register_tool(crate::copilot::CopilotStreamGatewayTool::new());
    ...
    pub fn with_builtins_in_dir(dir: impl Into<std::path::PathBuf>) -> Self {
        ...
        registry.register_tool(python::PythonInstallTool::new().with_working_dir(dir.clone()));
        registry.register_tool(python::PythonAutoResolveTool::new().with_working_dir(dir.clone()));
        // Perl 5 Runtime Tools
        ...
        registry.register_tool(perl::PerlInstallTool::new().with_working_dir(dir.clone()));
        registry.register_tool(perl::PerlAutoResolveTool::new().with_working_dir(dir.clone()));
        // Vella Phase 1 Domain Tools
        registry.register_tool(crate::vella::VellaTradingTool::default());
        registry.register_tool(crate::vella::VellaScadaTool::default());
        registry.register_tool(crate::vella::VellaRoboticsTool::default());
        ...
        registry.register_tool(crate::copilot::CopilotExcelFunctionsTool::with_working_dir(dir.clone()));
        registry.register_tool(crate::copilot::CopilotStreamGatewayTool::new());
        registry.register_tool(crate::copilot::CopilotPlannerSyncTool::new());
        registry.register_tool(crate::copilot::CopilotIncidentDebuggerTool::new());
        registry.register_tool(crate::copilot::CopilotHardwareTelemetryTool::new());
        ...
        registry.register_tool(crate::copilot::CopilotStudioPackagerTool::default());
        registry.register_tool(crate::copilot::CopilotVivaSyncTool::default());
        // Phase 7 Microsoft Power Platform Expansion Tools
        registry.register_tool(crate::copilot::CopilotDataverseSyncTool::default());
        registry.register_tool(crate::copilot::CopilotPowerAutomateTool::default());
        registry.register_tool(crate::copilot::CopilotPowerPlatformPackagerTool::default());
